  ...
  extends AbsSavedState
{
  ...
  public String toString()
  {
    ...
    StringBuilder localStringBuilder = new StringBuilder(String.valueOf(str1).length() + 35 + String.valueOf(str2).length());
...
/* Location:              /home/chengjian/CM_test/gp/apk/a.jar!/android/support/design/textfield/TextInputLayout$SavedState.class
