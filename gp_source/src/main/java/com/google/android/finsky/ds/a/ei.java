  ...
  public final boolean equals(Object paramObject)
  {
    if (paramObject != this)
    {
      ...
      if ((paramObject instanceof ei))
      {
        ...
        if (((ei)paramObject).a != null) {}
      }
      label213:
      label226:
      while (((af)localObject).equals(((ei)paramObject).a))
      {
        if (((this.g & 0x1) == (((ei)paramObject).g & 0x1)) && (this.f.equals(((ei)paramObject).f)) && ((this.g & 0x2) == (((ei)paramObject).g & 0x2)) && (this.e.equals(((ei)paramObject).e)))
        {
          localObject = this.c;
          if (localObject != null) {
            break label213;
          }
          if (((ei)paramObject).c != null) {}
        }
        while (((ah)localObject).equals(((ei)paramObject).c))
        {
          localObject = this.b;
          if (localObject == null) {
            if (((ei)paramObject).b != null) {}
          }
          while (((ag)localObject).equals(((ei)paramObject).b))
          {
            localObject = this.d;
            if (localObject == null) {
              if (((ei)paramObject).d != null) {}
            }
            while (((mf)localObject).equals(((ei)paramObject).d))
            {
              localObject = this.unknownFieldData;
              if ((localObject == null) || (((d)localObject).a()))
              {
                paramObject = ((ei)paramObject).unknownFieldData;
                return (paramObject == null) || (((d)paramObject).a());
              }
              return this.unknownFieldData.equals(((ei)paramObject).unknownFieldData);
            }
            return false;
          }
          return false;
...
/* Location:              /home/chengjian/CM_test/gp/apk/a.jar!/com/google/android/finsky/ds/a/ei.class
