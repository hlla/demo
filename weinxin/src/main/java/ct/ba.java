...
public final class ba
{
  ...
  private void b()
  {
    ...
    {
      bd.a();
      i2 = this.h.read(arrayOfByte, i1, n - i1);
      bd.a();
      if (i2 <= 0) {
        break label424;
      }
    ...
    for (;;)
    {
      if (i1 != n)
      {
        ...
        bd.c();
        a(-6, "readLen != packSize,rspBuff:" + be.b(arrayOfByte));
        break;
      }
      ...
      try
      {
        ((bi)localObject2).a(arrayOfByte);
        if (this.e == null) {
          break;
        }
        this.e.a = ((bi)localObject2);
        this.e.b = 0;
  ...
  private boolean b(bb parambb)
  {
    ...
    //   19: aload_1
    //   20: getfield 153	ct/bb:i	J
    //   23: lsub
    //   24: aload_1
    //   25: getfield 154	ct/bb:j	I
    //   28: i2l
    //   29: lcmp
    //   30: ifge +121 -> 151
    //   33: iconst_0
    ...
    //   47: istore_3
    //   48: aload_0
    //   49: invokespecial 157	ct/ba:c	()Z
    //   52: istore 5
    //   54: iload 5
    //   56: ifeq +203 -> 259
    ...
    //   68: aload_1
    //   69: invokevirtual 162	ct/bb:k	()I
    ...
    //   80: aload_0
    //   81: getfield 80	ct/ba:c	Ljava/net/Socket;
    //   84: invokevirtual 84	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   87: pop
    //   88: invokestatic 88	ct/bd:b	()V
    //   91: aload_1
    //   92: invokevirtual 167	ct/bb:l	()[B
    //   95: astore 6
    //   97: aload_0
    //   98: getfield 169	ct/ba:g	Ljava/io/OutputStream;
    //   101: aload 6
    //   103: iconst_0
    //   104: aload 6
    //   106: arraylength
    ...
    //   158: aload_1
    //   159: bipush -5
    //   161: putfield 60	ct/bb:b	I
    //   164: aload_1
    //   165: aload 6
    //   167: invokestatic 118	ct/be:a	(Ljava/lang/Exception;)Ljava/lang/String;
    //   170: putfield 63	ct/bb:c	Ljava/lang/String;
    //   173: iload_3
    //   174: istore_2
    //   175: iload 4
    //   177: ifne -170 -> 7
    //   180: aload_0
    //   181: aload_1
    //   182: getfield 60	ct/bb:b	I
    //   185: invokespecial 182	ct/ba:a	(I)V
    //   188: aload_0
    //   189: getfield 169	ct/ba:g	Ljava/io/OutputStream;
    //   192: invokevirtual 185	java/io/OutputStream:close	()V
    //   195: aload_0
    //   196: getfield 80	ct/ba:c	Ljava/net/Socket;
    //   199: invokevirtual 188	java/net/Socket:close	()V
    //   202: aload_0
    //   203: invokespecial 190	ct/ba:e	()V
    //   206: iload_3
    //   207: istore_2
    //   208: goto -201 -> 7
    //   211: astore 6
    ...
    //   225: aload_0
    //   226: aload_1
    //   227: getfield 60	ct/bb:b	I
    //   230: invokespecial 182	ct/ba:a	(I)V
    //   233: aload_0
    //   234: getfield 169	ct/ba:g	Ljava/io/OutputStream;
    //   237: invokevirtual 185	java/io/OutputStream:close	()V
    //   240: aload_0
    //   241: getfield 80	ct/ba:c	Ljava/net/Socket;
    //   244: invokevirtual 188	java/net/Socket:close	()V
    //   247: aload_0
    //   248: invokespecial 190	ct/ba:e	()V
    //   251: aload 6
    //   253: athrow
    //   254: astore_1
    //   255: aload_0
    ...
    //   258: athrow
    //   259: aload_0
    //   260: invokespecial 190	ct/ba:e	()V
    //   263: iload_3
    //   264: istore_2
    //   265: goto -258 -> 7
    //   268: aload_0
  ...
  private void d()
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 92	ct/ba:h	Ljava/io/InputStream;
    //   6: astore_1
    //   7: aload_1
    //   8: ifnull +15 -> 23
    //   11: aload_0
    //   12: getfield 92	ct/ba:h	Ljava/io/InputStream;
    //   15: invokevirtual 197	java/io/InputStream:close	()V
    //   18: aload_0
    //   19: aconst_null
    //   20: putfield 92	ct/ba:h	Ljava/io/InputStream;
    //   23: aload_0
    //   24: getfield 169	ct/ba:g	Ljava/io/OutputStream;
    //   27: astore_1
    //   28: aload_1
    //   29: ifnull +15 -> 44
    //   32: aload_0
    //   33: getfield 169	ct/ba:g	Ljava/io/OutputStream;
    //   36: invokevirtual 185	java/io/OutputStream:close	()V
    //   39: aload_0
    //   40: aconst_null
    //   41: putfield 169	ct/ba:g	Ljava/io/OutputStream;
    //   44: aload_0
    //   45: getfield 80	ct/ba:c	Ljava/net/Socket;
    //   48: astore_1
    //   49: aload_1
    //   50: ifnull +15 -> 65
    //   53: aload_0
    //   54: getfield 80	ct/ba:c	Ljava/net/Socket;
    //   57: invokevirtual 188	java/net/Socket:close	()V
    //   60: aload_0
    //   61: aconst_null
    //   62: putfield 80	ct/ba:c	Ljava/net/Socket;
    //   65: invokestatic 200	ct/ay:a	()V
    //   68: aload_0
    //   69: monitorexit
    //   70: return
    //   71: astore_1
    //   72: aload_0
    //   73: aconst_null
    //   74: putfield 92	ct/ba:h	Ljava/io/InputStream;
    //   77: goto -54 -> 23
    //   80: astore_1
    //   81: aload_0
    //   82: monitorexit
    ...
    //   86: aload_0
    //   87: aconst_null
    //   88: putfield 92	ct/ba:h	Ljava/io/InputStream;
    //   91: aload_1
    //   92: athrow
    //   93: astore_1
    //   94: aload_0
    //   95: aconst_null
    //   96: putfield 169	ct/ba:g	Ljava/io/OutputStream;
    //   99: goto -55 -> 44
    //   102: astore_1
    //   103: aload_0
    //   104: aconst_null
    //   105: putfield 169	ct/ba:g	Ljava/io/OutputStream;
    //   108: aload_1
    //   109: athrow
    //   110: astore_1
    //   111: aload_0
    //   112: aconst_null
    //   113: putfield 80	ct/ba:c	Ljava/net/Socket;
    //   116: goto -51 -> 65
    //   119: astore_1
    //   120: aload_0
    //   121: aconst_null
    //   122: putfield 80	ct/ba:c	Ljava/net/Socket;
    //   125: aload_1
    //   126: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  private void e()
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 131	ct/bd:c	()V
    //   5: new 202	ct/az
    //   8: dup
    //   9: invokespecial 203	ct/az:<init>	()V
    //   12: astore_3
    //   13: aload_0
    //   14: getfield 57	ct/ba:e	Lct/bb;
    //   17: getfield 154	ct/bb:j	I
    //   20: ifle +345 -> 365
    //   23: aload_3
    //   24: aload_0
    //   25: getfield 57	ct/ba:e	Lct/bb;
    //   28: getfield 154	ct/bb:j	I
    //   31: putfield 205	ct/az:c	I
    //   34: invokestatic 210	ct/b$a:b	()Lct/b$a;
    ...
    //   53: aload_3
    //   54: iload_1
    //   55: putfield 218	ct/az:a	I
    //   58: aload_3
    //   59: iload_1
    //   60: putfield 219	ct/az:b	I
    //   63: getstatic 224	ct/c:a	[I
    //   66: astore 4
    //   68: aload_3
    //   69: ldc -30
    //   71: putfield 228	ct/az:f	Ljava/lang/String;
    //   74: aload 4
    //   76: invokestatic 231	ct/az:a	([I)V
    ...
    //   114: aload_3
    //   115: aload 5
    //   117: putfield 254	ct/az:d	Ljava/util/ArrayList;
    //   120: invokestatic 210	ct/b$a:b	()Lct/b$a;
    ...
    //   137: pop2
    //   138: invokestatic 210	ct/b$a:b	()Lct/b$a;
    //   141: pop
    //   142: aload_3
    //   143: invokestatic 210	ct/b$a:b	()Lct/b$a;
    //   146: getfield 257	ct/b$a:a	Lct/c;
    //   149: invokevirtual 262	ct/c:c	()Ljava/util/ArrayList;
    //   152: putfield 264	ct/az:e	Ljava/util/ArrayList;
    //   155: aload_0
    //   156: iconst_0
    //   157: putfield 42	ct/ba:j	I
    //   160: aload_3
    //   161: invokevirtual 265	ct/az:a	()V
    //   164: aload_0
    //   165: aload_3
    //   166: getfield 266	ct/az:j	I
    //   169: putfield 40	ct/ba:i	I
    //   172: aload_0
    //   173: aload_3
    //   174: getfield 268	ct/az:k	I
    //   177: putfield 42	ct/ba:j	I
    //   180: aload_0
    //   181: getfield 57	ct/ba:e	Lct/bb;
    //   184: aload_0
    //   185: getfield 40	ct/ba:i	I
    //   188: putfield 270	ct/bb:e	I
    //   191: aload_0
    //   192: getfield 57	ct/ba:e	Lct/bb;
    //   195: aload_0
    //   196: getfield 42	ct/ba:j	I
    //   199: putfield 148	ct/bb:d	I
    //   202: aload_3
    //   203: getfield 272	ct/az:h	I
    //   206: ifne +289 -> 495
    //   209: aload_0
    //   210: aload_3
    //   211: getfield 274	ct/az:g	Ljava/net/Socket;
    //   214: putfield 80	ct/ba:c	Ljava/net/Socket;
    //   217: aload_0
    //   218: aload_3
    //   219: getfield 276	ct/az:l	Lct/s;
    //   222: putfield 278	ct/ba:f	Lct/s;
    //   225: aload_0
    //   226: getfield 57	ct/ba:e	Lct/bb;
    //   229: aload_0
    //   230: getfield 278	ct/ba:f	Lct/s;
    //   233: putfield 280	ct/bb:h	Lct/s;
    //   236: new 73	java/lang/StringBuilder
    //   239: dup
    //   240: ldc_w 282
    //   243: invokespecial 78	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   246: aload_0
    //   247: getfield 80	ct/ba:c	Ljava/net/Socket;
    ...
    //   397: aload_0
    //   398: getfield 80	ct/ba:c	Ljava/net/Socket;
    //   401: invokevirtual 84	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   404: pop
    //   405: invokestatic 305	ct/bd:d	()V
    //   408: aload_0
    //   409: bipush -3
    //   411: aload_3
    //   412: invokestatic 118	ct/be:a	(Ljava/lang/Exception;)Ljava/lang/String;
    //   415: invokespecial 55	ct/ba:a	(ILjava/lang/String;)V
    //   418: aload_0
    //   419: invokespecial 306	ct/ba:d	()V
    //   422: goto -60 -> 362
    //   425: astore_3
    //   426: aload_3
    //   427: athrow
    //   428: aload_0
    //   429: getfield 80	ct/ba:c	Ljava/net/Socket;
    //   432: ifnonnull +15 -> 447
    //   435: aload_0
    //   436: bipush -3
    //   438: ldc_w 308
    //   441: invokespecial 55	ct/ba:a	(ILjava/lang/String;)V
    //   444: goto -82 -> 362
    //   447: aload_0
    //   448: bipush -3
    ...
    //   460: aload_0
    //   461: getfield 80	ct/ba:c	Ljava/net/Socket;
    ...
    //   476: aload_0
    //   477: getfield 80	ct/ba:c	Ljava/net/Socket;
    ...
    //   489: invokespecial 55	ct/ba:a	(ILjava/lang/String;)V
    //   492: goto -130 -> 362
    //   495: invokestatic 319	ct/bc:e	()Z
    //   498: ifeq +63 -> 561
    //   501: ldc_w 321
    ...
    //   536: aload_3
    //   537: getfield 332	ct/az:i	Ljava/lang/String;
    ...
    //   546: invokespecial 55	ct/ba:a	(ILjava/lang/String;)V
    //   549: goto -187 -> 362
    //   552: aload_0
    //   553: bipush -16
    //   555: invokespecial 182	ct/ba:a	(I)V
    //   558: goto -196 -> 362
    //   561: aload_0
    //   562: bipush -4
    //   564: invokespecial 182	ct/ba:a	(I)V
    //   567: goto -205 -> 362
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	570	0	this	ba
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/ct/ba.class
