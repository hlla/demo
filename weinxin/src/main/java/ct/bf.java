...
public final class bf
{
  ...
  public bf(byte[] paramArrayOfByte, byte paramByte)
  {
    this.a = ByteBuffer.wrap(paramArrayOfByte);
    this.a.position(4);
  }
  ...
  public final bh a(bh parambh, int paramInt, boolean paramBoolean)
  {
    a locala = null;
    if (a(paramInt))
    {
      try
      {
        parambh = (bh)parambh.getClass().newInstance();
        locala = new a();
        a(locala, this.a);
        if (locala.a != 10) {
          throw new RuntimeException("type mismatch.");
      ...
      {
        throw new RuntimeException(parambh.getMessage());
      }
      parambh.a(this);
      a();
    }
  ...
  public final Object a(Object paramObject, int paramInt, boolean paramBoolean)
  {
    ...
    if ((paramObject instanceof bh)) {
      return a((bh)paramObject, paramInt, paramBoolean);
    }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/ct/bf.class
