...
public final class h
{
  ...
  public static a a(android.content.Context paramContext, String paramString1, String paramString2, String paramString3)
  {
    ...
    //   40: pop
    //   41: invokestatic 68	ct/bd:b	()V
    //   44: aload_0
    //   45: ifnull +10 -> 55
    //   48: aload_1
    //   49: invokestatic 73	ct/be:a	(Ljava/lang/String;)Z
    //   52: ifeq +41 -> 93
    //   55: new 75	ct/l
    //   58: dup
    ...
    //   89: invokespecial 86	ct/l:<init>	(Ljava/lang/String;)V
    //   92: athrow
    ...
    //   107: aload_3
    //   108: invokestatic 73	ct/be:a	(Ljava/lang/String;)Z
    //   111: ifne +18 -> 129
    //   114: aload_3
    //   115: astore 4
    //   117: aload_3
    //   118: invokevirtual 96	java/lang/String:toLowerCase	()Ljava/lang/String;
    //   121: ldc 98
    //   123: invokevirtual 102	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   126: ifeq +95 -> 221
    //   129: aload_0
    //   130: ldc 104
    //   132: iconst_0
    //   133: invokevirtual 110	android/content/Context:getSharedPreferences	(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    //   136: astore 5
    //   138: aload_3
    //   139: astore 4
    //   141: aload 5
    ...
    //   148: ldc 112
    //   150: ldc 114
    //   152: invokeinterface 120 3 0
    //   157: astore_3
    //   158: aload_3
    //   159: astore 4
    //   161: aload_3
    //   162: invokestatic 73	ct/be:a	(Ljava/lang/String;)Z
    //   165: ifeq +56 -> 221
    //   168: new 46	java/lang/StringBuilder
    //   171: dup
    //   172: invokespecial 121	java/lang/StringBuilder:<init>	()V
    //   175: aload_0
    //   176: invokestatic 124	ct/be:a	(Landroid/content/Context;)Ljava/lang/String;
    ...
    //   187: aload_0
    //   188: invokestatic 128	ct/be:b	(Landroid/content/Context;)Ljava/lang/String;
    //   191: invokevirtual 60	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   194: invokevirtual 85	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   197: astore 4
    //   199: aload 5
    //   201: invokeinterface 132 1 0
    //   206: ldc 112
    //   208: aload 4
    //   210: invokeinterface 138 3 0
    //   215: invokeinterface 142 1 0
    //   220: pop
    //   221: aload_2
    //   222: astore_3
    //   223: aload_2
    //   224: invokestatic 73	ct/be:a	(Ljava/lang/String;)Z
    //   227: ifeq +6 -> 233
    //   230: ldc -112
    //   232: astore_3
    //   233: aload_0
    ...
    //   235: aload_3
    //   236: aload 4
    //   238: invokestatic 147	ct/p:a	(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   241: aload_0
    //   242: invokestatic 152	ct/bc:a	(Landroid/content/Context;)V
    //   245: new 154	ct/e
    //   248: dup
    //   249: invokespecial 155	ct/e:<init>	()V
    //   252: putstatic 23	ct/h:c	Lct/a;
    //   255: new 157	java/lang/Thread
    //   258: dup
    //   259: getstatic 23	ct/h:c	Lct/a;
    //   262: checkcast 159	java/lang/Runnable
    //   265: ldc -95
    //   267: invokespecial 164	java/lang/Thread:<init>	(Ljava/lang/Runnable;Ljava/lang/String;)V
    //   270: invokevirtual 167	java/lang/Thread:start	()V
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/ct/h.class
