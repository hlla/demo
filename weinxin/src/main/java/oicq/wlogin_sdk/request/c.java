...
{
  Context xkU;
  TreeMap<Long, WloginAllSigInfo> xkV = new TreeMap();
  
  public c(Context paramContext)
  {
    this.xkU = paramContext;
  }
  ...
  private static int a(Context paramContext, String paramString, byte[] paramArrayOfByte)
  {
    ...
    //   193: astore_1
    //   194: aload_0
    //   195: invokestatic 108	oicq/wlogin_sdk/tools/util:j	(Ljava/lang/Exception;)V
    //   198: aload_1
    //   199: ifnull +7 -> 206
    //   202: aload_1
    ...
    //   210: astore_1
    //   211: aload_1
    //   212: invokestatic 108	oicq/wlogin_sdk/tools/util:j	(Ljava/lang/Exception;)V
    //   215: aload_0
    ...
    //   223: astore_1
    //   224: aload_1
    //   225: invokestatic 108	oicq/wlogin_sdk/tools/util:j	(Ljava/lang/Exception;)V
    //   228: aload_0
    ...
    //   236: astore_1
    //   237: aload_1
    //   238: invokestatic 108	oicq/wlogin_sdk/tools/util:j	(Ljava/lang/Exception;)V
    //   241: aload_3
    ...
    //   255: astore_1
    //   256: aload_1
    //   257: invokestatic 108	oicq/wlogin_sdk/tools/util:j	(Ljava/lang/Exception;)V
    //   260: aload_3
  ...
  private int b(TreeMap paramTreeMap, String paramString)
  {
    try
    {
      Object localObject2 = new SecretKeySpec(i.xlx, "DESede");
      ...
      i = a(this.xkU, paramString, ((ByteArrayOutputStream)localObject2).toByteArray());
      return i;
    }
    catch (Exception paramTreeMap)
    {
      for (;;)
      {
        ...
        paramString.flush();
        util.fq("exception", paramString.toString());
        int i = 64514;
      }
    }
    finally {}
  ...
  /* Error */
  private static TreeMap bL(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    //   2: aload_0
    //   3: aload_1
    //   4: invokestatic 190	oicq/wlogin_sdk/request/c:bM	(Landroid/content/Context;Ljava/lang/String;)[B
    //   7: astore 4
    //   9: aload 4
    //   11: ifnull +507 -> 518
    //   14: new 116	javax/crypto/spec/SecretKeySpec
    //   17: dup
    //   18: getstatic 122	oicq/wlogin_sdk/request/i:xlx	[B
    //   21: ldc 124
    //   23: invokespecial 127	javax/crypto/spec/SecretKeySpec:<init>	([BLjava/lang/String;)V
    //   26: astore_1
    //   27: ldc 124
    //   29: invokestatic 133	javax/crypto/Cipher:getInstance	(Ljava/lang/String;)Ljavax/crypto/Cipher;
    //   32: astore_3
    //   33: aload_3
    //   34: iconst_2
    //   35: aload_1
    //   36: invokevirtual 137	javax/crypto/Cipher:init	(ILjava/security/Key;)V
    //   39: new 192	java/io/ObjectInputStream
    //   42: dup
    //   43: new 194	javax/crypto/CipherInputStream
    //   46: dup
    //   47: new 196	java/io/ByteArrayInputStream
    //   50: dup
    //   51: aload 4
    //   53: invokespecial 199	java/io/ByteArrayInputStream:<init>	([B)V
    //   56: aload_3
    //   57: invokespecial 202	javax/crypto/CipherInputStream:<init>	(Ljava/io/InputStream;Ljavax/crypto/Cipher;)V
    //   60: invokespecial 205	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   63: astore_3
    //   64: aload_3
    //   65: invokevirtual 209	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   68: checkcast 16	java/util/TreeMap
    //   71: astore_1
    //   72: aload_1
    //   73: ifnull +440 -> 513
    //   76: aload_3
    //   77: invokevirtual 210	java/io/ObjectInputStream:close	()V
    //   80: aload_1
    //   81: areturn
    //   82: astore_1
    ...
    //   123: invokestatic 184	oicq/wlogin_sdk/tools/util:fq	(Ljava/lang/String;Ljava/lang/String;)V
    //   126: aload_0
    //   127: invokestatic 214	oicq/wlogin_sdk/tools/util:hP	(Landroid/content/Context;)[B
    //   130: astore_3
    //   131: aload_2
    //   132: astore_1
    //   133: aload_3
    ...
    //   140: arraylength
    //   141: ifle +77 -> 218
    //   144: new 116	javax/crypto/spec/SecretKeySpec
    //   147: dup
    //   148: aload_3
    //   149: ldc 124
    //   151: invokespecial 127	javax/crypto/spec/SecretKeySpec:<init>	([BLjava/lang/String;)V
    //   154: astore_1
    //   155: ldc 124
    //   157: invokestatic 133	javax/crypto/Cipher:getInstance	(Ljava/lang/String;)Ljavax/crypto/Cipher;
    //   160: astore_3
    //   161: aload_3
    //   162: iconst_2
    //   163: aload_1
    //   164: invokevirtual 137	javax/crypto/Cipher:init	(ILjava/security/Key;)V
    //   167: new 192	java/io/ObjectInputStream
    //   170: dup
    //   171: new 194	javax/crypto/CipherInputStream
    //   174: dup
    //   175: new 196	java/io/ByteArrayInputStream
    //   178: dup
    //   179: aload 4
    //   181: invokespecial 199	java/io/ByteArrayInputStream:<init>	([B)V
    //   184: aload_3
    //   185: invokespecial 202	javax/crypto/CipherInputStream:<init>	(Ljava/io/InputStream;Ljavax/crypto/Cipher;)V
    //   188: invokespecial 205	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   191: astore 5
    //   193: aload 5
    //   195: invokevirtual 209	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   198: checkcast 16	java/util/TreeMap
    //   201: astore_3
    //   202: aload_3
    //   203: astore_1
    //   204: aload_3
    //   205: ifnull +13 -> 218
    //   208: aload 5
    //   210: invokevirtual 210	java/io/ObjectInputStream:close	()V
    //   213: aload_3
    //   214: areturn
    //   215: astore_1
    //   216: aload_3
    //   217: astore_1
    //   218: aload_0
    //   219: invokestatic 217	oicq/wlogin_sdk/tools/util:hO	(Landroid/content/Context;)[B
    //   222: astore_3
    //   223: aload_1
    //   224: astore_2
    //   225: aload_3
    ...
    //   232: arraylength
    //   233: ifle +79 -> 312
    //   236: new 116	javax/crypto/spec/SecretKeySpec
    //   239: dup
    //   240: aload_3
    //   241: invokestatic 223	oicq/wlogin_sdk/tools/c:bS	([B)[B
    //   244: ldc 124
    //   246: invokespecial 127	javax/crypto/spec/SecretKeySpec:<init>	([BLjava/lang/String;)V
    //   249: astore_2
    //   250: ldc 124
    //   252: invokestatic 133	javax/crypto/Cipher:getInstance	(Ljava/lang/String;)Ljavax/crypto/Cipher;
    //   255: astore_3
    //   256: aload_3
    //   257: iconst_2
    //   258: aload_2
    //   259: invokevirtual 137	javax/crypto/Cipher:init	(ILjava/security/Key;)V
    //   262: new 192	java/io/ObjectInputStream
    //   265: dup
    //   266: new 194	javax/crypto/CipherInputStream
    //   269: dup
    //   270: new 196	java/io/ByteArrayInputStream
    //   273: dup
    //   274: aload 4
    //   276: invokespecial 199	java/io/ByteArrayInputStream:<init>	([B)V
    //   279: aload_3
    //   280: invokespecial 202	javax/crypto/CipherInputStream:<init>	(Ljava/io/InputStream;Ljavax/crypto/Cipher;)V
    //   283: invokespecial 205	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   286: astore_3
    //   287: aload_3
    //   288: invokevirtual 209	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   291: checkcast 16	java/util/TreeMap
    //   294: astore_2
    //   295: aload_2
    //   296: astore_1
    //   297: aload_2
    //   298: ifnull +12 -> 310
    //   301: aload_3
    //   302: invokevirtual 210	java/io/ObjectInputStream:close	()V
    //   305: aload_2
    //   306: areturn
    //   307: astore_1
    //   308: aload_2
    ...
    //   311: astore_2
    //   312: aload_0
    //   313: invokestatic 226	oicq/wlogin_sdk/tools/util:hN	(Landroid/content/Context;)[B
    //   316: astore_1
    //   317: aload_2
    //   318: astore_0
    //   319: aload_1
    ...
    //   326: arraylength
    //   327: ifle +77 -> 404
    //   330: new 116	javax/crypto/spec/SecretKeySpec
    //   333: dup
    //   334: aload_1
    //   335: invokestatic 223	oicq/wlogin_sdk/tools/c:bS	([B)[B
    //   338: ldc 124
    //   340: invokespecial 127	javax/crypto/spec/SecretKeySpec:<init>	([BLjava/lang/String;)V
    //   343: astore_0
    //   344: ldc 124
    //   346: invokestatic 133	javax/crypto/Cipher:getInstance	(Ljava/lang/String;)Ljavax/crypto/Cipher;
    //   349: astore_1
    //   350: aload_1
    //   351: iconst_2
    //   352: aload_0
    //   353: invokevirtual 137	javax/crypto/Cipher:init	(ILjava/security/Key;)V
    //   356: new 192	java/io/ObjectInputStream
    //   359: dup
    //   360: new 194	javax/crypto/CipherInputStream
    //   363: dup
    //   364: new 196	java/io/ByteArrayInputStream
    //   367: dup
    //   368: aload 4
    //   370: invokespecial 199	java/io/ByteArrayInputStream:<init>	([B)V
    //   373: aload_1
    //   374: invokespecial 202	javax/crypto/CipherInputStream:<init>	(Ljava/io/InputStream;Ljavax/crypto/Cipher;)V
    //   377: invokespecial 205	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   380: astore_3
    //   381: aload_3
    //   382: invokevirtual 209	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   385: checkcast 16	java/util/TreeMap
    //   388: astore_1
    //   389: aload_1
    //   390: astore_0
    //   391: aload_1
    //   392: ifnull +12 -> 404
    //   395: aload_3
    //   396: invokevirtual 210	java/io/ObjectInputStream:close	()V
    //   399: aload_1
    //   400: areturn
    //   401: astore_0
    //   402: aload_1
    //   403: astore_0
    //   404: new 116	javax/crypto/spec/SecretKeySpec
    //   407: dup
    //   408: new 63	java/lang/String
    //   411: dup
    //   412: ldc -28
    //   414: invokespecial 229	java/lang/String:<init>	(Ljava/lang/String;)V
    //   417: invokevirtual 232	java/lang/String:getBytes	()[B
    //   420: ldc 124
    //   422: invokespecial 127	javax/crypto/spec/SecretKeySpec:<init>	([BLjava/lang/String;)V
    //   425: astore_1
    //   426: ldc 124
    //   428: invokestatic 133	javax/crypto/Cipher:getInstance	(Ljava/lang/String;)Ljavax/crypto/Cipher;
    //   431: astore_2
    //   432: aload_2
    //   433: iconst_2
    //   434: aload_1
    //   435: invokevirtual 137	javax/crypto/Cipher:init	(ILjava/security/Key;)V
    //   438: new 192	java/io/ObjectInputStream
    //   441: dup
    //   442: new 194	javax/crypto/CipherInputStream
    //   445: dup
    //   446: new 196	java/io/ByteArrayInputStream
    //   449: dup
    //   450: aload 4
    //   452: invokespecial 199	java/io/ByteArrayInputStream:<init>	([B)V
    //   455: aload_2
    //   456: invokespecial 202	javax/crypto/CipherInputStream:<init>	(Ljava/io/InputStream;Ljavax/crypto/Cipher;)V
    //   459: invokespecial 205	java/io/ObjectInputStream:<init>	(Ljava/io/InputStream;)V
    //   462: astore_3
    //   463: aload_3
    //   464: invokevirtual 209	java/io/ObjectInputStream:readObject	()Ljava/lang/Object;
    //   467: checkcast 16	java/util/TreeMap
    //   470: astore_2
    //   471: aload_2
    //   472: astore_1
    //   473: aload_2
    //   474: ifnull -394 -> 80
    //   477: aload_3
    //   478: invokevirtual 210	java/io/ObjectInputStream:close	()V
    //   481: aload_2
    //   482: areturn
    //   483: astore_0
    //   484: aload_2
  ...
  /* Error */
  private static byte[] bM(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: iconst_0
    ...
    //   114: astore_1
    //   115: aload_0
    //   116: invokestatic 108	oicq/wlogin_sdk/tools/util:j	(Ljava/lang/Exception;)V
    //   119: aload_1
    //   120: ifnull +7 -> 127
    //   123: aload_1
    ...
    //   173: astore_1
    //   174: aload_0
    //   175: invokestatic 108	oicq/wlogin_sdk/tools/util:j	(Ljava/lang/Exception;)V
    //   178: aload_1
    //   179: ifnull +18 -> 197
    //   182: aload_1
  ...
  /* Error */
  private WloginAllSigInfo fh(long paramLong)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   22: invokestatic 281	oicq/wlogin_sdk/tools/util:fp	(Ljava/lang/String;Ljava/lang/String;)V
    //   25: aload_0
    //   26: getfield 19	oicq/wlogin_sdk/request/c:xkV	Ljava/util/TreeMap;
    ...
    //   51: areturn
    //   52: aload_0
    //   53: getfield 21	oicq/wlogin_sdk/request/c:xkU	Landroid/content/Context;
    //   56: ifnonnull +8 -> 64
    //   59: aconst_null
    //   60: astore_3
    //   61: goto -13 -> 48
    //   64: aload_0
    //   65: getfield 21	oicq/wlogin_sdk/request/c:xkU	Landroid/content/Context;
    //   68: ldc 111
    //   70: invokestatic 294	oicq/wlogin_sdk/request/c:bL	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/TreeMap;
    //   73: astore_3
    //   74: aload_3
    //   75: ifnonnull +8 -> 83
    //   78: aconst_null
    ...
    //   103: ldc_w 273
    //   106: ldc_w 296
    //   109: invokestatic 281	oicq/wlogin_sdk/tools/util:fp	(Ljava/lang/String;Ljava/lang/String;)V
    //   112: aconst_null
    //   113: astore_3
    //   114: goto -66 -> 48
    //   117: aload_0
    //   118: getfield 19	oicq/wlogin_sdk/request/c:xkV	Ljava/util/TreeMap;
  ...
  public final int a(long paramLong1, long paramLong2, long paramLong3, long paramLong4, long paramLong5, long paramLong6, byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, byte[] paramArrayOfByte3, byte[] paramArrayOfByte4, byte[] paramArrayOfByte5, byte[] paramArrayOfByte6, byte[] paramArrayOfByte7, byte[] paramArrayOfByte8, byte[] paramArrayOfByte9, byte[] paramArrayOfByte10, byte[] paramArrayOfByte11, byte[] paramArrayOfByte12, byte[] paramArrayOfByte13, byte[] paramArrayOfByte14, byte[] paramArrayOfByte15, byte[] paramArrayOfByte16, byte[][] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      try
      {
        WloginAllSigInfo localWloginAllSigInfo = (WloginAllSigInfo)this.xkV.get(new Long(paramLong1));
        ...
        if ((localObject != null) && (((WloginSigInfo)localObject)._en_A1 != null))
        {
          ...
          this.xkV.put(new Long(paramLong1), localWloginAllSigInfo);
          return i;
        }
      }
      finally {}
  ...
  public final void i(Long paramLong)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 19	oicq/wlogin_sdk/request/c:xkV	Ljava/util/TreeMap;
    //   6: aload_1
    //   7: invokevirtual 350	java/util/TreeMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   10: pop
    //   11: aload_0
    //   12: getfield 21	oicq/wlogin_sdk/request/c:xkU	Landroid/content/Context;
    //   15: ifnull +17 -> 32
    //   18: aload_0
    //   19: getfield 21	oicq/wlogin_sdk/request/c:xkU	Landroid/content/Context;
    //   22: ldc 111
    //   24: invokestatic 294	oicq/wlogin_sdk/request/c:bL	(Landroid/content/Context;Ljava/lang/String;)Ljava/util/TreeMap;
    //   27: astore_2
    //   28: aload_2
    //   29: ifnonnull +6 -> 35
    //   32: aload_0
    ...
    //   35: aload_2
    //   36: aload_1
    //   37: invokevirtual 350	java/util/TreeMap:remove	(Ljava/lang/Object;)Ljava/lang/Object;
    //   40: pop
    //   41: aload_0
    //   42: aload_2
    //   43: ldc 111
  ...
  public final WloginSigInfo y(long paramLong1, long paramLong2)
  {
    ...
    //   25: lload_3
    //   26: invokevirtual 278	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   29: invokevirtual 56	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   32: invokestatic 281	oicq/wlogin_sdk/tools/util:fp	(Ljava/lang/String;Ljava/lang/String;)V
    //   35: aload_0
    //   36: lload_1
    //   37: invokespecial 358	oicq/wlogin_sdk/request/c:fh	(J)Loicq/wlogin_sdk/request/WloginAllSigInfo;
    //   40: astore 5
    //   42: aload 5
    //   44: ifnonnull +11 -> 55
    //   47: aconst_null
    ...
    //   54: areturn
    //   55: aload 5
    //   57: getfield 309	oicq/wlogin_sdk/request/WloginAllSigInfo:_tk_map	Ljava/util/TreeMap;
    //   60: new 283	java/lang/Long
    //   63: dup
    //   64: lload_3
    //   65: invokespecial 286	java/lang/Long:<init>	(J)V
    //   68: invokevirtual 290	java/util/TreeMap:get	(Ljava/lang/Object;)Ljava/lang/Object;
    //   71: checkcast 311	oicq/wlogin_sdk/sharemem/WloginSigInfo
    //   74: astore 6
    //   76: aload 6
    //   78: astore 5
    //   80: aload 6
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/oicq/wlogin_sdk/request/c.class
