...
public class Grammar
{
  ...
  private String a()
  {
    ...
    for (;;)
    {
      if (i >= this.e.size())
      {
        ...
        ((d)this.e.get(i)).aIQ = a(((d)this.e.get(i)).userName);
        ((d)this.e.get(i)).aIR = a(((d)this.e.get(i)).aIO);
        ((d)this.e.get(i)).aIS = a(((d)this.e.get(i)).aIP);
        i += 1;
        break;
      }
      String str = ((d)this.e.get(i)).aIQ;
      if (!str.isEmpty())
      {
  ...
  public int getResult(a parama)
  {
    ...
    for (;;)
    {
      ...
      if (((d)this.e.get(j)).aIQ.compareTo(this.b.name) == 0)
      {
        parama.name = ((d)this.e.get(j)).userName;
        return 0;
      }
      if (((d)this.e.get(j)).aIR.compareTo(this.b.name) == 0)
      {
        parama.name = ((d)this.e.get(j)).userName;
        return 0;
      }
      if (((d)this.e.get(j)).aIS.compareTo(this.b.name) == 0)
      {
        parama.name = ((d)this.e.get(j)).userName;
        return 0;
      }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/qq/wx/voice/embed/recognizer/Grammar.class
