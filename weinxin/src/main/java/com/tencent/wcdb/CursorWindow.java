  ...
  implements Parcelable
{
  ...
  static
  {
    ...
    for (sCursorWindowSize = Resources.getSystem().getInteger(i) * 1024;; sCursorWindowSize = 2097152)
    {
      CREATOR = new Parcelable.Creator()
      {
        ...
        {
          return new CursorWindow(paramAnonymousParcel);
        }
  ...
  public CursorWindow(Parcel paramParcel)
  {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/wcdb/CursorWindow.class
