...
public class LruCache<K, V>
{
  ...
  public void trimToSize(int paramInt)
  {
    ...
    finally
    {
      ...
      {
        localObject2 = (Map.Entry)this.map.entrySet().iterator().next();
        if (localObject2 == null) {
          return;
        }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/wcdb/support/LruCache.class
