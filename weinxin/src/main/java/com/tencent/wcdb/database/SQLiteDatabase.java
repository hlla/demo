  ...
  extends SQLiteClosable
{
  ...
  private SQLiteDatabase(String paramString, int paramInt, CursorFactory paramCursorFactory, DatabaseErrorHandler paramDatabaseErrorHandler)
  {
    ...
    for (boolean bool = true;; bool = false)
    {
      paramDatabaseErrorHandler = new DefaultDatabaseErrorHandler(bool);
      break;
    }
  }
  ...
  private void beginTransaction(SQLiteTransactionListener paramSQLiteTransactionListener, boolean paramBoolean)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 144	com/tencent/wcdb/database/SQLiteDatabase:acquireReference	()V
    //   4: aload_0
    //   5: invokevirtual 148	com/tencent/wcdb/database/SQLiteDatabase:getThreadSession	()Lcom/tencent/wcdb/database/SQLiteSession;
    //   8: astore 4
    //   10: iload_2
    //   11: ifeq +23 -> 34
    //   14: iconst_2
    ...
    //   20: aload_0
    //   21: iconst_0
    //   22: invokevirtual 152	com/tencent/wcdb/database/SQLiteDatabase:getThreadDefaultConnectionFlags	(Z)I
    //   25: aconst_null
    //   26: invokevirtual 157	com/tencent/wcdb/database/SQLiteSession:beginTransaction	(ILcom/tencent/wcdb/database/SQLiteTransactionListener;ILcom/tencent/wcdb/support/CancellationSignal;)V
    //   29: aload_0
    //   30: invokevirtual 160	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   33: return
    //   34: iconst_1
    //   35: istore_3
    //   36: goto -20 -> 16
    //   39: astore_1
    //   40: aload_0
    //   41: invokevirtual 160	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   44: aload_1
    //   45: athrow
  ...
  public static boolean deleteDatabase(File paramFile)
  {
    ...
    boolean bool1 = paramFile.delete() | false | new File(paramFile.getPath() + "-journal").delete() | new File(paramFile.getPath() + "-shm").delete() | new File(paramFile.getPath() + "-wal").delete();
  ...
  public final int delete(String paramString1, String paramString2, String[] paramArrayOfString)
  {
    ...
    //   7: dup
    //   8: ldc_w 511
    //   11: invokespecial 385	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   14: aload_1
    ...
    //   30: dup
    //   31: ldc_w 513
    //   34: invokespecial 385	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   37: aload_2
    ...
    //   63: astore_1
    //   64: aload_1
    //   65: invokevirtual 280	com/tencent/wcdb/database/SQLiteStatement:executeUpdateDelete	()I
    //   68: istore 4
    //   70: aload_1
    //   71: invokevirtual 281	com/tencent/wcdb/database/SQLiteStatement:close	()V
    //   74: aload_0
    //   75: invokevirtual 160	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   78: iload 4
    //   80: ireturn
    //   81: ldc 98
    //   83: astore_1
    ...
    //   94: astore_1
    //   95: aload_0
    //   96: invokevirtual 160	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   99: aload_1
    //   100: athrow
    // Local variable table:
    //   start	length	slot	name	signature
  ...
  /* Error */
  public final java.util.List<android.util.Pair<String, String>> getAttachedDbs()
  {
    // Byte code:
    ...
    //   7: astore_1
    //   8: aload_0
    //   9: getfield 123	com/tencent/wcdb/database/SQLiteDatabase:mLock	Ljava/lang/Object;
    //   12: astore_2
    //   13: aload_2
    //   14: monitorenter
    //   15: aload_0
    //   16: getfield 164	com/tencent/wcdb/database/SQLiteDatabase:mConnectionPoolLocked	Lcom/tencent/wcdb/database/SQLiteConnectionPool;
    //   19: ifnonnull +7 -> 26
    //   22: aload_2
    //   23: monitorexit
    //   24: aconst_null
    ...
    //   30: ifne +29 -> 59
    //   33: aload_1
    //   34: new 550	android/util/Pair
    //   37: dup
    //   38: ldc_w 552
    //   41: aload_0
    //   42: getfield 134	com/tencent/wcdb/database/SQLiteDatabase:mConfigurationLocked	Lcom/tencent/wcdb/database/SQLiteDatabaseConfiguration;
    //   45: getfield 555	com/tencent/wcdb/database/SQLiteDatabaseConfiguration:path	Ljava/lang/String;
    //   48: invokespecial 558	android/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   51: invokevirtual 490	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   54: pop
    //   55: aload_2
    //   56: monitorexit
    //   57: aload_1
    //   58: areturn
    //   59: aload_0
    //   60: invokevirtual 144	com/tencent/wcdb/database/SQLiteDatabase:acquireReference	()V
    //   63: aload_2
    //   64: monitorexit
    //   65: aload_0
    //   66: ldc_w 560
    //   69: aconst_null
    //   70: invokevirtual 564	com/tencent/wcdb/database/SQLiteDatabase:rawQuery	(Ljava/lang/String;[Ljava/lang/String;)Lcom/tencent/wcdb/Cursor;
    //   73: astore_2
    //   74: aload_2
    //   75: invokeinterface 569 1 0
    //   80: ifeq +57 -> 137
    //   83: aload_1
    //   84: new 550	android/util/Pair
    //   87: dup
    //   88: aload_2
    //   89: iconst_1
    //   90: invokeinterface 573 2 0
    //   95: aload_2
    //   96: iconst_2
    //   97: invokeinterface 573 2 0
    //   102: invokespecial 558	android/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   105: invokevirtual 490	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   108: pop
    //   109: goto -35 -> 74
    //   112: astore_1
    //   113: aload_2
    //   114: ifnull +9 -> 123
    //   117: aload_2
    //   118: invokeinterface 574 1 0
    //   123: aload_1
    //   124: athrow
    //   125: astore_1
    //   126: aload_0
    //   127: invokevirtual 160	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   130: aload_1
    //   131: athrow
    //   132: astore_1
    //   133: aload_2
    ...
    //   138: ifnull +9 -> 147
    //   141: aload_2
    //   142: invokeinterface 574 1 0
    //   147: aload_0
    //   148: invokevirtual 160	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   151: aload_1
    //   152: areturn
    //   153: astore_1
    //   154: aconst_null
    ...
    //   132	20	1	localList	java.util.List<android.util.Pair<String, String>>
  ...
  public final boolean isDatabaseIntegrityOk()
  {
    ...
    //   1: invokevirtual 144	com/tencent/wcdb/database/SQLiteDatabase:acquireReference	()V
    //   4: aload_0
    //   5: invokevirtual 669	com/tencent/wcdb/database/SQLiteDatabase:getAttachedDbs	()Ljava/util/List;
    //   8: astore_3
    //   9: aload_3
    ...
    //   20: dup
    //   21: ldc_w 671
    //   24: invokespecial 385	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   27: aload_0
    //   28: invokevirtual 672	com/tencent/wcdb/database/SQLiteDatabase:getPath	()Ljava/lang/String;
    ...
    //   55: astore_3
    //   56: aload_3
    //   57: new 550	android/util/Pair
    //   60: dup
    //   61: ldc_w 552
    //   64: aload_0
    //   65: invokevirtual 672	com/tencent/wcdb/database/SQLiteDatabase:getPath	()Ljava/lang/String;
    //   68: invokespecial 558	android/util/Pair:<init>	(Ljava/lang/Object;Ljava/lang/Object;)V
    //   71: invokeinterface 677 2 0
    //   76: pop
    //   77: goto +172 -> 249
    //   80: iload_1
    //   81: aload_3
    //   82: invokeinterface 678 1 0
    //   87: if_icmpge +152 -> 239
    //   90: aload_3
    //   91: iload_1
    //   92: invokeinterface 681 2 0
    //   97: checkcast 550	android/util/Pair
    //   100: astore 4
    //   102: aload_0
    //   103: new 193	java/lang/StringBuilder
    //   106: dup
    //   107: ldc_w 683
    //   110: invokespecial 385	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   113: aload 4
    //   115: getfield 686	android/util/Pair:first	Ljava/lang/Object;
    //   118: checkcast 96	java/lang/String
    ...
    //   133: invokevirtual 690	com/tencent/wcdb/database/SQLiteDatabase:compileStatement	(Ljava/lang/String;)Lcom/tencent/wcdb/database/SQLiteStatement;
    //   136: astore_2
    //   137: aload_2
    //   138: invokevirtual 693	com/tencent/wcdb/database/SQLiteStatement:simpleQueryForString	()Ljava/lang/String;
    //   141: astore 5
    //   143: aload 5
    //   145: ldc_w 695
    //   148: invokevirtual 699	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   151: ifne +60 -> 211
    //   154: ldc 52
    //   156: new 193	java/lang/StringBuilder
    //   159: dup
    //   160: ldc_w 701
    //   163: invokespecial 385	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   166: aload 4
    //   168: getfield 704	android/util/Pair:second	Ljava/lang/Object;
    ...
    //   191: invokestatic 708	com/tencent/wcdb/support/Log:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   194: aload_2
    //   195: ifnull +7 -> 202
    //   198: aload_2
    //   199: invokevirtual 281	com/tencent/wcdb/database/SQLiteStatement:close	()V
    //   202: aload_0
    //   203: invokevirtual 160	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   206: iconst_0
    //   207: ireturn
    //   208: goto +41 -> 249
    //   211: aload_2
    ...
    //   232: astore_2
    //   233: aload_0
    //   234: invokevirtual 160	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   237: aload_2
    //   238: athrow
    //   239: aload_0
    //   240: invokevirtual 160	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   243: iconst_1
    //   244: ireturn
    //   245: astore_3
    //   246: goto -24 -> 222
    ...
    //   100	67	4	localPair	android.util.Pair
    //   141	43	5	str	String
    // Exception table:
    //   from	to	target	type
  ...
  public final Cursor rawQueryWithFactory(CursorFactory paramCursorFactory, String paramString1, String[] paramArrayOfString, String paramString2, CancellationSignal paramCancellationSignal)
  {
    ...
    //   0: aload_0
    //   1: invokevirtual 144	com/tencent/wcdb/database/SQLiteDatabase:acquireReference	()V
    //   4: new 756	com/tencent/wcdb/database/SQLiteDirectCursorDriver
    //   7: dup
    //   8: aload_0
    //   9: aload_2
    //   10: aload 4
    //   12: aload 5
    //   14: invokespecial 759	com/tencent/wcdb/database/SQLiteDirectCursorDriver:<init>	(Lcom/tencent/wcdb/database/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Lcom/tencent/wcdb/support/CancellationSignal;)V
    //   17: astore_2
    //   18: aload_1
    //   19: ifnull +18 -> 37
    //   22: aload_2
    //   23: aload_1
    //   24: aload_3
    //   25: invokeinterface 764 3 0
    //   30: astore_1
    //   31: aload_0
    //   32: invokevirtual 160	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   35: aload_1
    //   36: areturn
    //   37: aload_0
    //   38: getfield 125	com/tencent/wcdb/database/SQLiteDatabase:mCursorFactory	Lcom/tencent/wcdb/database/SQLiteDatabase$CursorFactory;
    //   41: astore_1
    //   42: goto -20 -> 22
    //   45: astore_1
    //   46: aload_0
    //   47: invokevirtual 160	com/tencent/wcdb/database/SQLiteDatabase:releaseReference	()V
    //   50: aload_1
    //   51: athrow
    // Local variable table:
    //   start	length	slot	name	signature
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/wcdb/database/SQLiteDatabase.class
