...
public class StnLogic
{
  ...
  private static int buf2Resp(int paramInt1, Object paramObject, byte[] paramArrayOfByte, int[] paramArrayOfInt, int paramInt2)
  {
    ...
    return callBack.buf2Resp(paramInt1, paramObject, paramArrayOfByte, paramArrayOfInt, paramInt2);
  }
  ...
  {
    public abstract int buf2Resp(int paramInt1, Object paramObject, byte[] paramArrayOfByte, int[] paramArrayOfInt, int paramInt2);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mars/stn/StnLogic.class
