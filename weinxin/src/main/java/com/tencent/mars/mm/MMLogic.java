...
public class MMLogic
{
  ...
  private static void reportFlow(final int paramInt1, final int paramInt2, final int paramInt3, final int paramInt4)
  {
    ...
    com.tencent.mm.network.a.b localb = z.ML().ifi;
    v.i("C2Java", "reportNetFlow time[%d,%d] sum:%d wr[%d,%d] ws[%d,%d] mr[%d,%d] ms[%d,%d] fgbg:%b Moniter:%s", new Object[] { Long.valueOf(lastReportTime), Long.valueOf(bf.az(lastReportTime)), Integer.valueOf(i), Integer.valueOf(paramInt1), Integer.valueOf(totalWifiRecv), Integer.valueOf(paramInt2), Integer.valueOf(totalWifiSend), Integer.valueOf(paramInt3), Integer.valueOf(totalMobileRecv), Integer.valueOf(paramInt4), Integer.valueOf(totalMobileSend), Boolean.valueOf(com.tencent.mm.sdk.a.b.foreground), localb });
    if (localb == null) {}
    while ((i < 102400) && (bf.az(lastReportTime) < 30L)) {
      return;
    }
    lastReportTime = bf.Nz();
    ...
    try
    {
      z.MN().post(new Runnable()
      {
        public final void run()
        {
          try
          {
            this.val$monitor.g(paramInt1, paramInt2, paramInt3, paramInt4);
            return;
          }
          catch (Throwable localThrowable)
          {
            v.e("C2Java", "reportFlowData :%s", new Object[] { bf.g(localThrowable) });
          }
        }
      });
      return;
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mars/mm/MMLogic.class
