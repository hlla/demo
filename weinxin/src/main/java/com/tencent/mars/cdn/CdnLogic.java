...
public class CdnLogic
{
  ...
  private static void onProgressChanged(String paramString, int paramInt1, int paramInt2)
  {
    if (callBack == null) {
      return;
    }
    callBack.onProgressChanged(paramString, paramInt1, paramInt2);
  }
  ...
  public static abstract interface ICallback
  {
    ...
    public abstract void onProgressChanged(String paramString, int paramInt1, int paramInt2);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mars/cdn/CdnLogic.class
