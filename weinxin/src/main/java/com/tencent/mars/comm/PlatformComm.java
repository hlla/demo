...
public class PlatformComm
{
  ...
  public static ad handler = null;
  public static IResetProcess resetprocessimp = null;
  
  public static void init(Context paramContext, ad paramad)
  {
  ...
  public static class C2Java
  {
    ...
    public static PlatformComm.APNInfo getAPNInfo()
    {
      ...
      {
        v.printErrStackTrace("PlatformComm", localException, "", new Object[0]);
      }
      return null;
    }
    ...
    public static PlatformComm.SIMInfo getCurSIMInfo()
    {
      try
      {
        ...
        int i = al.getISPCode(PlatformComm.context);
        if (i != 0)
        {
          PlatformComm.SIMInfo localSIMInfo = new PlatformComm.SIMInfo();
          localSIMInfo.ispCode = String.valueOf(i);
          v.d("PlatformComm", "getISPCode MCC_MNC=%s", new Object[] { localSIMInfo.ispCode });
          localSIMInfo.ispName = al.getISPName(PlatformComm.context);
          return localSIMInfo;
        }
      }
      catch (Exception localException)
    ...
    public static PlatformComm.WifiInfo getCurWifiInfo()
    {
      ...
      {
        v.printErrStackTrace("PlatformComm", localException2, "", new Object[0]);
        return null;
      }
    }
    ...
    public static int getStatisticsNetType()
    {
      ...
      try
      {
        int i = al.getNetType(PlatformComm.context);
        if (i == -1) {
          return -1;
        }
        if (al.is2G(PlatformComm.context)) {
          return 3;
        }
        if (al.is3G(PlatformComm.context)) {
          return 4;
        }
        if (al.is4G(PlatformComm.context)) {
          return 5;
        }
        if (al.isWifi(i)) {
          return 1;
        }
        boolean bool = al.isWap(i);
        if (bool) {
          return 2;
        }
        return 6;
    ...
    public static boolean isNetworkConnected()
    {
      ...
      try
      {
        boolean bool = al.isNetworkConnected(PlatformComm.context);
        return bool;
      }
      catch (Exception localException)
      {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mars/comm/PlatformComm.class
