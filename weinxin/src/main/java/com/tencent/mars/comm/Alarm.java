  ...
  extends BroadcastReceiver
{
  ...
  public static boolean start(long paramLong, int paramInt, Context paramContext)
  {
    ...
    v.i("MicroMsg.Alarm", "Alarm.start [id: %d, after: %d, size: %d]", new Object[] { Long.valueOf(paramLong), Integer.valueOf(paramInt), Integer.valueOf(gPendingAlarms.size()) });
    return true;
  }
  ...
  public void onReceive(Context arg1, Intent paramIntent)
  {
    ...
    for (;;)
    {
      synchronized (gPendingAlarms)
      {
        ...
        if (paramIntent != null)
        {
          v.i("MicroMsg.Alarm", "Alarm.onReceive [id: %d, delta miss time: %d, size: %d]", new Object[] { Long.valueOf(l), Long.valueOf(SystemClock.elapsedRealtime() - paramIntent.waitTime), Integer.valueOf(gPendingAlarms.size()) });
          if (wakerlock != null) {
      ...
      v.e("MicroMsg.Alarm", "onReceive not found id:%d, pid:%d, gPendingAlarms.size:%d", new Object[] { Long.valueOf(l), Integer.valueOf(i), Integer.valueOf(gPendingAlarms.size()) });
    }
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mars/comm/Alarm.class
