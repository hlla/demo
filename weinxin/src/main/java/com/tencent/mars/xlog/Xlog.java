  ...
  implements v.a
{
  ...
  private static String decryptTag(String paramString)
  {
    ...
    default: 
      return paramString;
    case '?': 
      return localw.uqY.decryptTag(paramString);
    }
    return localw.cA(paramString, paramString.length());
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mars/xlog/Xlog.class
