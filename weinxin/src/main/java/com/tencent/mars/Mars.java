...
public class Mars
{
  ...
  public static void checkLoadedModules(ArrayList<String> paramArrayList, String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        v.i(paramString, "loaded modules: " + Arrays.toString(paramArrayList.toArray(arrayOfString)));
  ...
  {
    PlatformComm.init(paramContext, paramad);
    hasInitialized = true;
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mars/Mars.class
