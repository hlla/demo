...
{
  public static byte[] wVp = null;
  
  static
  {
    try
    {
      wVp = "65dRa93L".getBytes("utf-8");
      return;
    }
  ...
  public static org.json.JSONObject a(ThirdAppInfoNew paramThirdAppInfoNew, Context paramContext)
  {
    ...
    //   171: aload_3
    //   172: ldc 126
    //   174: invokestatic 130	com/tencent/smtt/sdk/t:ceC	()J
    ...
    //   209: pop
    //   210: getstatic 145	com/tencent/smtt/sdk/i:wSs	I
    //   213: istore_2
    //   214: aload_0
    ...
    //   222: ldc -109
    //   224: aload_1
    //   225: invokestatic 153	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   228: invokevirtual 157	com/tencent/smtt/sdk/k:ceb	()I
    ...
    //   262: ifeq +88 -> 350
    //   265: invokestatic 185	com/tencent/smtt/utils/k:cfg	()Lcom/tencent/smtt/utils/k;
    //   268: pop
    //   269: aload_3
    //   270: ldc -69
    //   272: invokestatic 173	com/tencent/smtt/sdk/QbSdk:getTID	()Ljava/lang/String;
    //   275: invokestatic 191	com/tencent/smtt/utils/k:Vu	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   316: aload_3
    //   317: ldc 126
    //   319: invokestatic 200	com/tencent/smtt/sdk/l:cec	()I
    //   322: invokevirtual 99	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   325: pop
    //   326: aload_3
    //   327: ldc -54
    //   329: invokestatic 200	com/tencent/smtt/sdk/l:cec	()I
    //   332: invokevirtual 99	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   335: pop
    //   336: goto -155 -> 181
    //   339: aload_3
    //   340: ldc -109
    //   342: iload_2
    //   343: invokevirtual 99	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   346: pop
    //   347: goto -112 -> 235
    //   350: aload_0
    //   351: getfield 42	MTT/ThirdAppInfoNew:sAppName	Ljava/lang/String;
    //   354: ldc -52
    //   356: invokevirtual 179	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   359: ifeq -69 -> 290
    //   362: aload_3
    //   363: ldc -69
    //   365: invokestatic 173	com/tencent/smtt/sdk/QbSdk:getTID	()Ljava/lang/String;
    //   368: invokevirtual 46	org/json/JSONObject:put	(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;
    //   371: pop
    //   372: aload_3
    //   373: ldc -63
    //   375: iconst_0
    //   376: invokevirtual 99	org/json/JSONObject:put	(Ljava/lang/String;I)Lorg/json/JSONObject;
    //   379: pop
    //   380: aload_3
    //   381: areturn
    //   382: astore_0
    ...
    //   0	385	0	paramThirdAppInfoNew	ThirdAppInfoNew
    //   0	385	1	paramContext	Context
    //   213	130	2	i	int
    //   7	377	3	localJSONObject	org.json.JSONObject
    // Exception table:
    //   from	to	target	type
    ...
    //   316	336	306	java/lang/Exception
    //   339	347	306	java/lang/Exception
    //   247	290	382	java/lang/Exception
    //   350	380	382	java/lang/Exception
  }
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        if (paramBoolean)
        {
          ...
          paramString1 = c.gQ(paramContext);
          paramString2 = c.V(paramContext);
          paramString3 = c.gP(paramContext);
          localObject3 = c.gR(paramContext);
          ...
          if (t.ceI())
          {
            ...
            ((ThirdAppInfoNew)localObject1).sAppSignature = gJ(paramContext);
            if (!paramBoolean)
            {
            ...
            new Thread("HttpUtils")
            {
              ...
              public final void run()
              {
                ...
                //   5: if_icmpge +4 -> 9
                //   8: return
                //   9: getstatic 44	com/tencent/smtt/sdk/a/b:wVp	[B
                //   12: ifnonnull +13 -> 25
                //   15: ldc 46
                //   17: ldc 48
                //   19: invokevirtual 54	java/lang/String:getBytes	(Ljava/lang/String;)[B
                //   22: putstatic 44	com/tencent/smtt/sdk/a/b:wVp	[B
                //   25: getstatic 44	com/tencent/smtt/sdk/a/b:wVp	[B
                //   28: ifnonnull +26 -> 54
                //   31: ldc 56
                //   33: ldc 58
                ...
                //   39: astore_2
                //   40: aconst_null
                //   41: putstatic 44	com/tencent/smtt/sdk/a/b:wVp	[B
                //   44: ldc 56
                //   46: ldc 66
                //   48: invokestatic 64	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
                //   51: goto -26 -> 25
                //   54: aload_0
                //   55: getfield 14	com/tencent/smtt/sdk/a/b$1:qhD	Landroid/content/Context;
                //   58: invokestatic 72	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
                //   61: getfield 76	com/tencent/smtt/sdk/k:wSA	Landroid/content/SharedPreferences;
                //   64: ldc 78
                //   66: ldc 80
                ...
                //   142: iconst_1
                //   143: istore_1
                //   144: invokestatic 112	com/tencent/smtt/utils/q:cfm	()Lcom/tencent/smtt/utils/q;
                //   147: astore 4
                //   149: iload_1
                //   150: ifeq +129 -> 279
                ...
                //   160: aload 4
                //   162: getfield 120	com/tencent/smtt/utils/q:wWo	Ljava/lang/String;
                //   165: invokevirtual 124	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
                //   168: astore_3
                //   169: invokestatic 130	com/tencent/smtt/utils/j:cfd	()Lcom/tencent/smtt/utils/j;
                //   172: pop
                //   173: aload_3
                //   174: invokestatic 134	com/tencent/smtt/utils/j:cfe	()Ljava/lang/String;
                ...
                //   250: aload_0
                //   251: getfield 16	com/tencent/smtt/sdk/a/b$1:wVq	LMTT/ThirdAppInfoNew;
                //   254: aload_0
                //   255: getfield 14	com/tencent/smtt/sdk/a/b$1:qhD	Landroid/content/Context;
                ...
                //   286: aload 4
                //   288: getfield 181	com/tencent/smtt/utils/q:wWp	Ljava/lang/String;
                ...
                //   390: iload_1
                //   391: ifeq +92 -> 483
                //   394: invokestatic 130	com/tencent/smtt/utils/j:cfd	()Lcom/tencent/smtt/utils/j;
                //   397: aload_3
                //   398: invokevirtual 198	com/tencent/smtt/utils/j:bA	([B)[B
                //   401: astore_2
                //   402: aload 4
                //   404: ldc -56
                //   406: ldc -54
        ...
        {
          ((ThirdAppInfoNew)localObject1).sQua2 = p.gW(paramContext);
          continue;
        }
        paramInt = 1;
      }
  ...
  private static String gJ(Context paramContext)
  {
    int i = 0;
    try
    {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/sdk/a/b.class
