...
public class m
{
  ...
  /* Error */
  public final boolean bv(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
  ...
  public final void fR(Context paramContext)
  {
    for (;;)
    {
      try
      {
        boolean bool = this.wSP;
        if (bool) {
          return;
        }
        if (!bv(paramContext, "bugly_switch.txt"))
        {
      ...
      for (Object localObject1 = t.ceE();; localObject1 = ((File)localObject1).getAbsolutePath())
      {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/sdk/m.class
