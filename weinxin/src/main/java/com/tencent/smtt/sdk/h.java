...
final class h
{
  private static int wRQ = 5;
  private static int wRR = 1;
  private static final String[] wRS = { "tbs_downloading_com.tencent.mtt", "tbs_downloading_com.tencent.mm", "tbs_downloading_com.tencent.mobileqq", "tbs_downloading_com.tencent.tbs", "tbs_downloading_com.qzone" };
  private boolean RE;
  private int igS;
  Context mContext;
  ...
  File wRV;
  private long wRW;
  private int wRX = 30000;
  private int wRY = 20000;
  private boolean wRZ;
  private int wSa;
  private HttpURLConnection wSb;
  private String wSc;
  private r.b wSd;
  private String wSe;
  private int wSf;
  ...
  public h(Context paramContext)
  {
    ...
    r.gr(this.mContext);
    this.wSd = r.cet();
    this.wSi = new HashSet();
    this.wSc = ("tbs_downloading_" + this.mContext.getPackageName());
    p.ceq();
    this.wRV = p.gm(this.mContext);
    if (this.wRV == null) {
  ...
  private boolean CQ(int paramInt)
  {
    boolean bool = false;
    try
    {
      File localFile1 = new File(this.wRV, "x5.tbs");
      File localFile2 = fI(this.mContext);
      if (localFile2 != null)
      {
  ...
  private boolean M(boolean paramBoolean1, boolean paramBoolean2)
  {
    long l2 = 0L;
    TbsLog.i("TbsDownload", "[TbsApkDownloader.verifyTbsApk] isTempFile=" + paramBoolean1);
    Object localObject2 = this.wRV;
    Object localObject1;
    if (!paramBoolean1)
    {
      localObject1 = "x5.tbs";
    ...
    do
    {
      ...
      break;
      localObject2 = k.fM(this.mContext).wSA.getString("tbs_apk_md5", null);
      localObject3 = a.G((File)localObject1);
    ...
    if (paramBoolean1)
    {
      l3 = k.fM(this.mContext).wSA.getLong("tbs_apkfilesize", 0L);
      if (!((File)localObject1).exists()) {
        break label690;
      }
      l1 = l2;
    ...
    for (;;)
    {
      ...
      this.wSd.Vr("fileLength:" + l1 + ",contentLength:" + l3);
      return false;
      ...
      if (paramBoolean2)
      {
        ...
        int k = k.fM(this.mContext).wSA.getInt("tbs_download_version", 0);
        i = j;
        if (k != j)
        {
          ...
          this.wSd.Vr("fileVersion:" + j + ",configVersion:" + k);
          return false;
        }
      }
      ...
      if (paramBoolean1)
      {
        try
        {
          paramBoolean1 = ((File)localObject1).renameTo(new File(this.wRV, "x5.tbs"));
          localObject1 = null;
        }
        catch (Exception localException)
        {
        ...
        j(109, j((Throwable)localObject1), true);
        return false;
      }
      paramBoolean2 = false;
      label660:
  ...
  public static void a(File paramFile, Context paramContext)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        File localFile = fI(paramContext);
        if (localFile == null) {
          continue;
        }
        if (k.fM(paramContext).wSA.getInt("tbs_download_version_type", 0) == 1)
        {
          localObject = new File(localFile, "x5.tbs.decouple");
          ((File)localObject).delete();
          f.h(paramFile, (File)localObject);
          if ((k.fM(paramContext).wSA.getInt("tbs_download_version_type", 0) == 1) || (k.fM(paramContext).wSA.getInt("tbs_decouplecoreversion", 0) != a.c(paramContext, paramFile))) {
            continue;
          }
          localObject = new File(localFile, "x5.tbs.decouple");
  ...
  private static File ah(Context paramContext, int paramInt)
  {
    File localFile = new File(f.al(paramContext, paramInt));
  ...
  private boolean cdO()
  {
    ...
    if (this.wSm != null)
    {
      ...
      {
        bool1 = bool2;
        if (this.wSn < this.wSm.length)
        {
          String[] arrayOfString = this.wSm;
          int i = this.wSn;
          this.wSn = (i + 1);
          this.wRU = arrayOfString[i];
          this.igS = 0;
          this.wSa = 0;
          this.wRW = -1L;
          this.wRZ = false;
  ...
  {
    long l = 0L;
    File localFile = new File(this.wRV, "x5.tbs.temp");
    if (localFile.exists()) {
      l = localFile.length();
    }
    return l;
  ...
  private static boolean cdQ()
  {
    ...
    //   5: aconst_null
    //   6: astore 8
    //   8: invokestatic 389	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   11: astore 4
    //   13: aload 4
    ...
    //   34: invokevirtual 397	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   37: invokevirtual 403	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   40: astore 4
    //   42: new 405	java/io/InputStreamReader
    //   45: dup
    //   46: aload 4
    //   48: invokespecial 408	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   51: astore 6
    //   53: new 410	java/io/BufferedReader
    //   56: dup
    //   57: aload 6
    //   59: invokespecial 413	java/io/BufferedReader:<init>	(Ljava/io/Reader;)V
    //   62: astore 5
    //   64: iconst_0
    //   65: istore_0
    //   66: aload 5
    //   68: invokevirtual 416	java/io/BufferedReader:readLine	()Ljava/lang/String;
    //   71: astore 7
    //   73: iload_3
    //   74: istore_2
    //   75: aload 7
    ...
    //   80: aload 7
    //   82: ldc_w 418
    //   85: invokevirtual 422	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   88: ifne +16 -> 104
    //   91: aload 7
    //   93: ldc_w 424
    //   96: invokevirtual 422	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   99: istore_2
    //   100: iload_2
    //   101: ifeq +22 -> 123
    //   104: iconst_1
  ...
  @TargetApi(8)
  static File fI(Context paramContext)
  {
    for (;;)
    {
      try
      {
        ...
        {
          paramContext = new File(f.al(paramContext, 4));
  ...
  static File fJ(Context paramContext)
  {
    try
    {
      if (Build.VERSION.SDK_INT >= 8)
      {
        Object localObject2 = ah(paramContext, 4);
        Object localObject1 = localObject2;
        if (localObject2 == null) {
          localObject1 = ah(paramContext, 3);
        }
        localObject2 = localObject1;
        if (localObject1 == null) {
          localObject2 = ah(paramContext, 2);
        }
        localObject1 = localObject2;
        if (localObject2 == null) {
          localObject1 = ah(paramContext, 1);
        }
  ...
  private static String j(Throwable paramThrowable)
  {
  ...
  {
    if ((paramBoolean) || (this.igS > this.wSj))
    {
      this.wSd.setErrorCode(paramInt);
      this.wSd.Vs(paramString);
    }
  }
  ...
  {
    u.hb(this.mContext);
    Object localObject2 = k.fM(this.mContext);
    ((k)localObject2).wSz.put("request_full_package", Boolean.valueOf(false));
    ((k)localObject2).wSz.put("tbs_needdownload", Boolean.valueOf(false));
    ((k)localObject2).wSz.put("tbs_download_interrupt_code_reason", Integer.valueOf(-123));
    ((k)localObject2).commit();
    Object localObject1 = QbSdk.wRt;
    File localFile;
    label172:
    int j;
    if (paramBoolean)
    {
      i = 100;
      ((q)localObject1).ir(i);
      i = ((k)localObject2).wSA.getInt("tbs_responsecode", 0);
      k.fM(this.mContext).wSA.getInt("tbs_downloaddecouplecore", 0);
      if ((i != 3) && (i <= 10000)) {
        break label371;
      }
      localFile = fI(this.mContext);
      if (localFile == null) {
        break label343;
      }
      if (!l.fP(this.mContext)) {
      ...
      localObject1 = new File(this.wRV, "x5.tbs");
      if (!((File)localObject1).exists()) {
        break label337;
      }
    }
    ...
    {
      int k = ((k)localObject2).wSA.getInt("tbs_download_version", 0);
      ...
      p.ceq().f(this.mContext, (Bundle)localObject2);
      return;
      i = 120;
      break;
    ...
    label343:
    clearCache();
    ((k)localObject2).wSz.put("tbs_needdownload", Boolean.valueOf(true));
    ((k)localObject2).commit();
    return;
    label371:
    int i = ((k)localObject2).wSA.getInt("tbs_download_version", 0);
    p.ceq();
    p.o(this.mContext, new File(this.wRV, "x5.tbs").getAbsolutePath(), i);
    a(new File(this.wRV, "x5.tbs"), this.mContext);
  }
  
  private boolean mb(boolean paramBoolean)
  {
    TbsLog.i("TbsDownload", "[TbsApkDownloader.deleteFile] isApk=" + paramBoolean);
    if (paramBoolean) {}
    for (File localFile = new File(this.wRV, "x5.tbs"); localFile.exists(); localFile = new File(this.wRV, "x5.tbs.temp")) {
  ...
  {
    // Byte code:
    //   0: invokestatic 133	com/tencent/smtt/sdk/p:ceq	()Lcom/tencent/smtt/sdk/p;
    //   3: aload_0
    //   4: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   7: invokevirtual 593	com/tencent/smtt/sdk/p:fT	(Landroid/content/Context;)Z
    //   10: ifeq +25 -> 35
    //   13: iload_1
    //   14: ifne +21 -> 35
    //   17: iconst_0
    //   18: putstatic 596	com/tencent/smtt/sdk/l:wSI	Z
    //   21: aload_0
    //   22: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   25: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   28: sipush 65214
    //   31: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   34: return
    //   35: aload_0
    //   36: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   39: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   42: getfield 231	com/tencent/smtt/sdk/k:wSA	Landroid/content/SharedPreferences;
    //   45: ldc_w 544
    //   48: iconst_0
    //   49: invokeinterface 291 3 0
    //   54: istore_3
    //   55: iload_3
    //   56: iconst_1
    //   57: if_icmpeq +13 -> 70
    ...
    //   77: aload_0
    //   78: iload 5
    //   80: invokevirtual 602	com/tencent/smtt/sdk/h:lZ	(Z)Z
    //   83: ifeq +14 -> 97
    //   86: iconst_0
    //   87: putstatic 596	com/tencent/smtt/sdk/l:wSI	Z
    //   90: return
    //   91: iconst_0
    //   92: istore 5
    //   94: goto -21 -> 73
    //   97: aload_0
    //   98: iload_1
    //   99: putfield 604	com/tencent/smtt/sdk/h:wSk	Z
    //   102: aload_0
    //   103: aload_0
    //   104: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   107: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   110: getfield 231	com/tencent/smtt/sdk/k:wSA	Landroid/content/SharedPreferences;
    //   113: ldc_w 606
    //   116: aconst_null
    //   117: invokeinterface 239 3 0
    ...
    //   129: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   132: getfield 231	com/tencent/smtt/sdk/k:wSA	Landroid/content/SharedPreferences;
    //   135: ldc_w 610
    //   138: aconst_null
    //   139: invokeinterface 239 3 0
    //   144: astore 27
    //   146: ldc -65
    ...
    //   170: aload_0
    //   171: aconst_null
    //   172: putfield 80	com/tencent/smtt/sdk/h:wSm	[Ljava/lang/String;
    //   175: aload_0
    //   176: iconst_0
    //   177: putfield 82	com/tencent/smtt/sdk/h:wSn	I
    //   180: iload_1
    //   181: ifne +37 -> 218
    //   184: aload 27
    //   186: ifnull +32 -> 218
    ...
    //   197: invokevirtual 247	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   200: ifne +18 -> 218
    //   203: aload_0
    //   204: aload 27
    ...
    //   215: putfield 80	com/tencent/smtt/sdk/h:wSm	[Ljava/lang/String;
    //   218: ldc -65
    ...
    //   254: aload_0
    //   255: getfield 370	com/tencent/smtt/sdk/h:wRU	Ljava/lang/String;
    ...
    //   267: aload_0
    //   268: getfield 374	com/tencent/smtt/sdk/h:RE	Z
    //   271: invokevirtual 216	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   274: ldc_w 634
    //   277: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   280: aload_0
    //   281: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   284: invokevirtual 319	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   287: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   290: invokestatic 199	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   293: aload_0
    //   294: getfield 608	com/tencent/smtt/sdk/h:mDownloadUrl	Ljava/lang/String;
    //   297: ifnonnull +34 -> 331
    //   300: aload_0
    //   301: getfield 370	com/tencent/smtt/sdk/h:wRU	Ljava/lang/String;
    //   304: ifnonnull +27 -> 331
    //   307: getstatic 537	com/tencent/smtt/sdk/QbSdk:wRt	Lcom/tencent/smtt/sdk/q;
    //   310: bipush 110
    //   312: invokeinterface 542 2 0
    //   317: aload_0
    //   318: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   321: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   324: sipush 65234
    //   327: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   330: return
    //   331: aload_0
    //   332: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   335: ifnull +34 -> 369
    //   338: aload_0
    //   339: getfield 374	com/tencent/smtt/sdk/h:RE	Z
    //   342: ifne +27 -> 369
    //   345: getstatic 537	com/tencent/smtt/sdk/QbSdk:wRt	Lcom/tencent/smtt/sdk/q;
    //   348: bipush 110
    //   350: invokeinterface 542 2 0
    //   355: aload_0
    //   356: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   359: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   362: sipush 65233
    //   365: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   368: return
    //   369: iload_1
    //   370: ifne +54 -> 424
    //   373: aload_0
    //   374: getfield 107	com/tencent/smtt/sdk/h:wSi	Ljava/util/Set;
    //   377: aload_0
    //   378: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   381: invokestatic 642	com/tencent/smtt/utils/b:gO	(Landroid/content/Context;)Ljava/lang/String;
    //   384: invokeinterface 646 2 0
    //   389: ifeq +35 -> 424
    //   392: ldc -65
    //   394: ldc_w 648
    //   397: invokestatic 199	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   400: getstatic 537	com/tencent/smtt/sdk/QbSdk:wRt	Lcom/tencent/smtt/sdk/q;
    //   403: bipush 110
    //   405: invokeinterface 542 2 0
    //   410: aload_0
    //   411: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   414: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   417: sipush 65232
    //   420: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   423: return
    //   424: aload_0
    //   425: invokespecial 147	com/tencent/smtt/sdk/h:cdM	()V
    //   428: ldc -65
    //   430: ldc_w 650
    //   433: iconst_1
    ...
    //   441: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   444: invokevirtual 653	com/tencent/smtt/sdk/k:cdW	()J
    //   447: lstore 25
    //   449: iconst_0
    //   450: istore_2
    //   451: aload_0
    //   452: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   455: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   458: getfield 231	com/tencent/smtt/sdk/k:wSA	Landroid/content/SharedPreferences;
    //   461: ldc_w 655
    //   464: lconst_0
    //   465: invokeinterface 266 4 0
    //   470: lstore 9
    //   472: iload_1
    //   473: ifeq +525 -> 998
    //   476: aload_0
    //   477: getstatic 53	com/tencent/smtt/sdk/h:wRR	I
    //   480: putfield 78	com/tencent/smtt/sdk/h:wSj	I
    //   483: iconst_0
    //   484: istore_2
    //   485: iload 5
    //   487: istore 8
    ...
    //   490: istore 5
    //   492: aload_0
    //   493: getfield 362	com/tencent/smtt/sdk/h:igS	I
    //   496: aload_0
    //   497: getfield 78	com/tencent/smtt/sdk/h:wSj	I
    //   500: if_icmpgt +36 -> 536
    //   503: aload_0
    //   504: getfield 364	com/tencent/smtt/sdk/h:wSa	I
    //   507: bipush 8
    ...
    //   515: aconst_null
    //   516: iconst_1
    //   517: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   520: aload_0
    //   521: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   524: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   527: sipush 65230
    //   530: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   533: iload_2
    //   534: istore 5
    //   536: aload_0
    //   537: getfield 374	com/tencent/smtt/sdk/h:RE	Z
    //   540: ifne +183 -> 723
    //   543: iload 5
    //   545: istore_1
    //   546: aload_0
    //   547: getfield 376	com/tencent/smtt/sdk/h:mFinished	Z
    //   550: ifeq +102 -> 652
    //   553: iload 5
    //   555: istore_1
    //   556: aload_0
    //   557: getfield 80	com/tencent/smtt/sdk/h:wSm	[Ljava/lang/String;
    ...
    //   572: iconst_1
    //   573: iload 8
    //   575: invokespecial 657	com/tencent/smtt/sdk/h:M	(ZZ)Z
    //   578: istore_1
    //   579: aload_0
    //   580: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   583: astore 27
    //   585: iload_1
    //   586: ifeq +6045 -> 6631
    //   589: iconst_1
    ...
    //   591: aload 27
    //   593: iload_3
    //   594: putfield 660	com/tencent/smtt/sdk/r$b:wTF	I
    //   597: iload 8
    //   599: ifne +6042 -> 6641
    //   602: aload_0
    //   603: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   606: astore 27
    //   608: iload_1
    //   609: ifeq +6027 -> 6636
    //   612: iconst_1
    ...
    //   614: aload 27
    //   616: iload_3
    //   617: putfield 663	com/tencent/smtt/sdk/r$b:wTD	I
    //   620: iload_1
    //   621: ifeq +6031 -> 6652
    //   624: aload_0
    //   625: iconst_1
    //   626: invokespecial 665	com/tencent/smtt/sdk/h:ma	(Z)V
    //   629: aload_0
    //   630: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   633: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   636: sipush 65219
    //   639: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   642: aload_0
    //   643: bipush 100
    //   645: ldc_w 667
    //   648: iconst_1
    //   649: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   652: aload_0
    //   653: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   656: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   659: astore 27
    //   661: iload_1
    //   662: ifeq +6012 -> 6674
    //   665: aload 27
    //   667: getfield 231	com/tencent/smtt/sdk/k:wSA	Landroid/content/SharedPreferences;
    //   670: ldc_w 669
    //   673: iconst_0
    //   674: invokeinterface 291 3 0
    //   679: istore_3
    //   680: aload 27
    //   682: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   685: ldc_w 669
    //   688: iload_3
    //   689: iconst_1
    //   690: iadd
    //   691: invokestatic 328	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   694: invokeinterface 524 3 0
    //   699: pop
    //   700: aload 27
    //   702: invokevirtual 531	com/tencent/smtt/sdk/k:commit	()V
    //   705: aload_0
    //   706: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   709: astore 27
    //   711: iload_1
    //   712: ifeq +6023 -> 6735
    //   715: iconst_1
    ...
    //   717: aload 27
    //   719: iload_3
    //   720: putfield 672	com/tencent/smtt/sdk/r$b:wTI	I
    //   723: ldc -65
    //   725: ldc_w 674
    //   728: invokestatic 199	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   731: aload_0
    //   732: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   735: ifnull +39 -> 774
    //   738: aload_0
    //   739: getfield 374	com/tencent/smtt/sdk/h:RE	Z
    //   742: ifne +20 -> 762
    //   745: aload_0
    //   746: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   749: aload_0
    //   750: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    ...
    //   759: putfield 685	com/tencent/smtt/sdk/r$b:wTB	Ljava/lang/String;
    //   762: aload_0
    //   763: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   766: invokevirtual 688	java/net/HttpURLConnection:disconnect	()V
    //   769: aload_0
    //   770: aconst_null
    //   771: putfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   774: aload_0
    //   775: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   778: getfield 691	com/tencent/smtt/sdk/r$b:jTc	I
    //   781: istore_3
    //   782: aload_0
    //   783: getfield 374	com/tencent/smtt/sdk/h:RE	Z
    //   786: ifne +6022 -> 6808
    //   789: aload_0
    //   790: getfield 378	com/tencent/smtt/sdk/h:wSg	Z
    //   793: ifeq +6015 -> 6808
    //   796: aload_0
    //   797: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   800: invokestatic 696	java/lang/System:currentTimeMillis	()J
    //   803: putfield 699	com/tencent/smtt/sdk/r$b:wTz	J
    //   806: aload_0
    //   807: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   810: invokestatic 702	com/tencent/smtt/utils/b:gM	(Landroid/content/Context;)Ljava/lang/String;
    //   813: astore 28
    //   815: aload 28
    //   817: astore 27
    //   819: aload 28
    ...
    //   833: invokestatic 706	com/tencent/smtt/utils/b:gN	(Landroid/content/Context;)I
    //   836: istore 4
    //   838: aload_0
    //   839: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   842: aload 27
    //   844: putfield 709	com/tencent/smtt/sdk/r$b:wTG	Ljava/lang/String;
    //   847: aload_0
    //   848: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   851: iload 4
    //   853: putfield 712	com/tencent/smtt/sdk/r$b:wTH	I
    //   856: iload 4
    //   858: aload_0
    //   859: getfield 151	com/tencent/smtt/sdk/h:wSf	I
    //   862: if_icmpne +15 -> 877
    //   865: aload 27
    //   867: aload_0
    //   868: getfield 149	com/tencent/smtt/sdk/h:wSe	Ljava/lang/String;
    //   871: invokevirtual 247	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   874: ifne +11 -> 885
    //   877: aload_0
    //   878: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   881: iconst_0
    //   882: putfield 715	com/tencent/smtt/sdk/r$b:wTL	I
    //   885: aload_0
    //   886: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   889: getfield 691	com/tencent/smtt/sdk/r$b:jTc	I
    //   892: ifeq +15 -> 907
    //   895: aload_0
    //   896: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   899: getfield 691	com/tencent/smtt/sdk/r$b:jTc	I
    //   902: bipush 107
    //   904: if_icmpne +31 -> 935
    //   907: aload_0
    //   908: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   911: getfield 672	com/tencent/smtt/sdk/r$b:wTI	I
    //   914: ifne +21 -> 935
    //   917: aload_0
    ...
    //   930: aconst_null
    //   931: iconst_1
    //   932: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   935: aload_0
    //   936: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   939: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   942: getfield 231	com/tencent/smtt/sdk/k:wSA	Landroid/content/SharedPreferences;
    //   945: ldc_w 546
    //   948: iconst_0
    //   949: invokeinterface 291 3 0
    //   954: iconst_1
    ...
    //   965: getstatic 724	com/tencent/smtt/sdk/r$a:wTv	Lcom/tencent/smtt/sdk/r$a;
    //   968: aload_0
    //   969: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   972: invokevirtual 727	com/tencent/smtt/sdk/r:a	(Lcom/tencent/smtt/sdk/r$a;Lcom/tencent/smtt/sdk/r$b;)V
    //   975: aload_0
    //   976: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   979: invokevirtual 728	com/tencent/smtt/sdk/r$b:cdM	()V
    //   982: iload_3
    //   983: bipush 100
    //   985: if_icmpeq -951 -> 34
    //   988: getstatic 537	com/tencent/smtt/sdk/QbSdk:wRt	Lcom/tencent/smtt/sdk/q;
    //   991: iload_3
    //   992: invokeinterface 542 2 0
    //   997: return
    //   998: aload_0
    //   999: getstatic 51	com/tencent/smtt/sdk/h:wRQ	I
    //   1002: putfield 78	com/tencent/smtt/sdk/h:wSj	I
    //   1005: iload 5
    //   1007: istore 6
    //   1009: iload_2
    //   1010: istore 5
    ...
    //   1049: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   1052: getfield 231	com/tencent/smtt/sdk/k:wSA	Landroid/content/SharedPreferences;
    //   1055: ldc_w 730
    //   1058: lconst_0
    //   1059: invokeinterface 266 4 0
    //   1064: lsub
    //   1065: ldc2_w 731
    //   1068: lcmp
    //   1069: ifle +222 -> 1291
    ...
    //   1076: ldc -65
    //   1078: ldc_w 734
    //   1081: invokestatic 199	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   1084: lload 9
    //   1086: lstore 11
    //   1088: aload_0
    //   1089: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   1092: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   1095: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   1098: ldc_w 730
    //   1101: lload 23
    ...
    //   1120: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   1123: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   1126: ldc_w 655
    //   1129: lconst_0
    ...
    //   1147: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   1175: invokestatic 742	com/tencent/smtt/utils/f:gU	(Landroid/content/Context;)Z
    //   1178: ifne +237 -> 1415
    //   1181: lload 15
    //   1183: lstore 11
    //   1185: iload_2
    ...
    //   1215: aconst_null
    //   1216: iconst_1
    //   1217: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   1220: lload 15
    //   1222: lstore 11
    //   1224: iload_2
    //   1225: istore 5
    ...
    //   1235: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   1238: sipush 65228
    //   1241: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   1244: iload_2
    //   1245: istore 5
    //   1247: iload_1
    //   1248: ifne -712 -> 536
    ...
    //   1255: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   1258: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   1261: ldc_w 655
    //   1264: lload 15
    ...
    //   1279: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   1307: lload 9
    //   1309: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   1312: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   1315: invokestatic 199	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   1318: lload 9
    //   1320: lload 25
    //   1322: lcmp
    //   1323: iflt +5662 -> 6985
    ...
    //   1346: aconst_null
    //   1347: iconst_1
    //   1348: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   1351: lload 9
    //   1353: lstore 11
    //   1355: aload_0
    //   1356: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   1359: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   1362: sipush 65229
    //   1365: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   1368: iload_2
    //   1369: istore 5
    //   1371: iload_1
    //   1372: ifne -836 -> 536
    ...
    //   1379: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   1382: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   1385: ldc_w 655
    //   1388: lload 9
    ...
    //   1403: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   1426: aload_0
    //   1427: iconst_1
    //   1428: putfield 378	com/tencent/smtt/sdk/h:wSg	Z
    //   1431: lload 9
    //   1433: lstore 11
    //   1435: iload_2
    //   1436: istore 5
    ...
    //   1440: lstore 13
    //   1442: aload_0
    //   1443: getfield 370	com/tencent/smtt/sdk/h:wRU	Ljava/lang/String;
    ...
    //   1458: lstore 13
    //   1460: aload_0
    //   1461: getfield 370	com/tencent/smtt/sdk/h:wRU	Ljava/lang/String;
    //   1464: astore 27
    //   1466: lload 9
    //   1468: lstore 11
    //   1470: iload_2
    ...
    //   1500: aload_0
    //   1501: getfield 362	com/tencent/smtt/sdk/h:igS	I
    //   1504: invokevirtual 298	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    ...
    //   1525: aload 27
    //   1527: aload_0
    //   1528: getfield 754	com/tencent/smtt/sdk/h:wRT	Ljava/lang/String;
    //   1531: invokevirtual 247	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   1534: ifne +57 -> 1591
    //   1537: lload 9
    //   1539: lstore 11
    //   1541: iload_2
    ...
    //   1546: lstore 13
    //   1548: aload_0
    //   1549: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   1552: astore 28
    //   1554: lload 9
    //   1556: lstore 11
    //   1558: iload_2
    ...
    //   1563: lstore 13
    //   1565: aload 28
    //   1567: getfield 757	com/tencent/smtt/sdk/r$b:wTA	Ljava/lang/String;
    ...
    //   1584: aload 28
    //   1586: aload 27
    //   1588: putfield 757	com/tencent/smtt/sdk/r$b:wTA	Ljava/lang/String;
    //   1591: lload 9
    //   1593: lstore 11
    //   1595: iload_2
    //   1596: istore 5
    ...
    //   1602: aload_0
    //   1603: aload 27
    //   1605: putfield 754	com/tencent/smtt/sdk/h:wRT	Ljava/lang/String;
    //   1608: lload 9
    //   1610: lstore 11
    //   1612: iload_2
    //   1613: istore 5
    ...
    //   1639: lstore 13
    //   1641: aload_0
    //   1642: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   1645: astore 28
    //   1647: aload 28
    //   1649: ifnull +14 -> 1663
    //   1652: lload 9
    //   1654: lstore 13
    //   1656: aload_0
    //   1657: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    ...
    //   1683: putfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   1686: lload 9
    //   1688: lstore 11
    //   1690: iload_2
    //   1691: istore 5
    ...
    //   1695: lstore 13
    //   1697: aload_0
    //   1698: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   1701: ldc_w 764
    //   1704: invokestatic 767	com/tencent/smtt/sdk/l:cel	()Ljava/lang/String;
    ...
    //   1719: lstore 13
    //   1721: aload_0
    //   1722: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   1725: ldc_w 772
    //   1728: ldc_w 774
    ...
    //   1743: lstore 13
    //   1745: aload_0
    //   1746: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   1749: ldc_w 776
    ...
    //   1764: lstore 13
    //   1766: aload_0
    //   1767: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   1770: iconst_0
    ...
    //   1783: lstore 13
    //   1785: aload_0
    //   1786: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   1789: aload_0
    //   1790: getfield 76	com/tencent/smtt/sdk/h:wRY	I
    ...
    //   1805: lstore 13
    //   1807: aload_0
    //   1808: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   1811: aload_0
    //   1812: getfield 74	com/tencent/smtt/sdk/h:wRX	I
    ...
    //   1830: lstore 13
    //   1832: aload_0
    //   1833: getfield 372	com/tencent/smtt/sdk/h:wRZ	Z
    //   1836: ifne +154 -> 1990
    //   1839: lload 9
    //   1841: lstore 11
    //   1843: iload_2
    ...
    //   1848: lstore 13
    //   1850: aload_0
    //   1851: invokespecial 790	com/tencent/smtt/sdk/h:cdP	()J
    //   1854: lstore 19
    //   1856: lload 9
    //   1858: lstore 11
    //   1860: iload_2
    ...
    //   1879: lload 19
    //   1881: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   1884: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   1887: invokestatic 199	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   1890: lload 9
    //   1892: lstore 11
    //   1894: iload_2
    //   1895: istore 5
    ...
    //   1899: lstore 13
    //   1901: aload_0
    //   1902: getfield 368	com/tencent/smtt/sdk/h:wRW	J
    //   1905: lconst_0
    //   1906: lcmp
    //   1907: ifgt +920 -> 2827
    //   1910: lload 9
    ...
    //   1933: lload 19
    //   1935: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    ...
    //   1954: lstore 13
    //   1956: aload_0
    //   1957: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   1960: ldc_w 796
    ...
    //   1973: lload 19
    //   1975: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   1978: ldc_w 800
    ...
    //   1999: lstore 13
    //   2001: aload_0
    //   2002: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   2005: astore 27
    //   2007: lload 19
    //   2009: lconst_0
    //   2010: lcmp
    ...
    //   2027: aload 27
    //   2029: iload_3
    //   2030: putfield 803	com/tencent/smtt/sdk/r$b:wTE	I
    //   2033: lload 9
    //   2035: lstore 11
    //   2037: iload_2
    //   2038: istore 5
    ...
    //   2048: invokestatic 706	com/tencent/smtt/utils/b:gN	(Landroid/content/Context;)I
    //   2051: istore_3
    //   2052: lload 9
    //   2054: lstore 11
    //   2056: iload_2
    ...
    //   2067: invokestatic 702	com/tencent/smtt/utils/b:gM	(Landroid/content/Context;)Ljava/lang/String;
    //   2070: astore 27
    //   2072: lload 9
    //   2074: lstore 11
    //   2076: iload_2
    ...
    //   2081: lstore 13
    //   2083: aload_0
    //   2084: getfield 149	com/tencent/smtt/sdk/h:wSe	Ljava/lang/String;
    ...
    //   2099: lstore 13
    //   2101: aload_0
    //   2102: getfield 151	com/tencent/smtt/sdk/h:wSf	I
    //   2105: iconst_m1
    ...
    //   2120: aload_0
    //   2121: aload 27
    //   2123: putfield 149	com/tencent/smtt/sdk/h:wSe	Ljava/lang/String;
    //   2126: lload 9
    //   2128: lstore 11
    //   2130: iload_2
    //   2131: istore 5
    ...
    //   2137: aload_0
    //   2138: iload_3
    //   2139: putfield 151	com/tencent/smtt/sdk/h:wSf	I
    //   2142: lload 9
    //   2144: lstore 11
    //   2146: iload_2
    //   2147: istore 5
    ...
    //   2151: lstore 13
    //   2153: aload_0
    //   2154: getfield 362	com/tencent/smtt/sdk/h:igS	I
    //   2157: ifle +28 -> 2185
    //   2160: lload 9
    //   2162: lstore 11
    //   2164: iload_2
    ...
    //   2169: lstore 13
    //   2171: aload_0
    //   2172: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   2175: ldc_w 805
    //   2178: aload_0
    ...
    //   2194: lstore 13
    //   2196: aload_0
    //   2197: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    ...
    //   2227: iload_3
    //   2228: invokevirtual 298	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   2231: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   2234: invokestatic 199	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   2237: lload 9
    //   2239: lstore 11
    //   2241: iload_2
    //   2242: istore 5
    ...
    //   2246: lstore 13
    //   2248: aload_0
    //   2249: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   2252: iload_3
    //   2253: putfield 816	com/tencent/smtt/sdk/r$b:wTC	I
    //   2256: iload_1
    //   2257: ifne +157 -> 2414
    //   2260: lload 9
    //   2262: lstore 11
    ...
    //   2275: invokestatic 171	com/tencent/smtt/sdk/l:fP	(Landroid/content/Context;)Z
    //   2278: ifne +136 -> 2414
    //   2281: lload 9
    //   2283: lstore 11
    //   2285: iload_2
    ...
    //   2296: invokestatic 706	com/tencent/smtt/utils/b:gN	(Landroid/content/Context;)I
    //   2299: iconst_3
    ...
    //   2335: invokestatic 706	com/tencent/smtt/utils/b:gN	(Landroid/content/Context;)I
    //   2338: ifne +76 -> 2414
    //   2341: lload 9
    //   2343: lstore 11
    //   2345: iload_2
    ...
    //   2363: lload 9
    //   2365: lstore 13
    //   2367: getstatic 537	com/tencent/smtt/sdk/QbSdk:wRt	Lcom/tencent/smtt/sdk/q;
    //   2370: ifnull +24 -> 2394
    //   2373: lload 9
    //   2375: lstore 11
    //   2377: iload_2
    ...
    //   2380: lload 9
    //   2382: lstore 13
    //   2384: getstatic 537	com/tencent/smtt/sdk/QbSdk:wRt	Lcom/tencent/smtt/sdk/q;
    //   2387: bipush 111
    ...
    //   2423: lstore 13
    //   2425: aload_0
    //   2426: getfield 374	com/tencent/smtt/sdk/h:RE	Z
    //   2429: ifeq +4568 -> 6997
    //   2432: lload 9
    //   2434: lstore 11
    //   2436: iload_2
    ...
    //   2447: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   2450: sipush 65227
    //   2453: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   2456: iload_2
    //   2457: istore 5
    //   2459: iload_1
    //   2460: ifne -1924 -> 536
    ...
    //   2467: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   2470: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   2473: ldc_w 655
    //   2476: lload 9
    ...
    //   2491: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   2543: aload 28
    //   2545: getfield 757	com/tencent/smtt/sdk/r$b:wTA	Ljava/lang/String;
    ...
    //   2565: putfield 757	com/tencent/smtt/sdk/r$b:wTA	Ljava/lang/String;
    //   2568: goto -977 -> 1591
    //   2571: astore 27
    //   2573: lload 11
    //   2575: lstore 9
    ...
    //   2598: lstore 11
    //   2600: aload_0
    //   2601: getfield 80	com/tencent/smtt/sdk/h:wSm	[Ljava/lang/String;
    //   2604: ifnull +3927 -> 6531
    //   2607: lload 9
    //   2609: lstore 11
    //   2611: aload_0
    //   2612: invokespecial 829	com/tencent/smtt/sdk/h:cdO	()Z
    //   2615: ifeq +3916 -> 6531
    //   2618: lload 9
    //   2620: lstore 11
    //   2622: ldc -65
    ...
    //   2634: aload_0
    //   2635: getfield 370	com/tencent/smtt/sdk/h:wRU	Ljava/lang/String;
    ...
    //   2658: invokestatic 209	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   2661: lload 9
    //   2663: lstore 11
    //   2665: aload_0
    //   2666: bipush 125
    //   2668: aconst_null
    //   2669: iconst_1
    //   2670: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   2673: lload 9
    //   2675: lstore 11
    //   2677: aload_0
    //   2678: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   2681: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   2684: sipush 65220
    //   2687: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   2690: lload 9
    //   2692: lstore 11
    //   2694: iload_2
    //   2695: istore 5
    ...
    //   2709: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   2712: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   2715: ldc_w 655
    //   2718: lload 9
    ...
    //   2733: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   2778: invokestatic 209	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   2781: goto -1118 -> 1663
    //   2784: astore 27
    //   2786: iload_1
    //   2787: ifne +37 -> 2824
    ...
    //   2794: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   2797: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   2800: ldc_w 655
    //   2803: lload 13
    ...
    //   2818: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   2850: lload 19
    //   2852: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   2855: ldc_w 840
    //   2858: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   2861: aload_0
    //   2862: getfield 368	com/tencent/smtt/sdk/h:wRW	J
    //   2865: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    ...
    //   2884: lstore 13
    //   2886: aload_0
    //   2887: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   2890: ldc_w 796
    ...
    //   2903: lload 19
    //   2905: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   2908: ldc_w 800
    //   2911: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   2914: aload_0
    //   2915: getfield 368	com/tencent/smtt/sdk/h:wRW	J
    //   2918: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    ...
    //   2941: iload_3
    //   2942: aload_0
    //   2943: getfield 151	com/tencent/smtt/sdk/h:wSf	I
    ...
    //   2960: aload 27
    //   2962: aload_0
    //   2963: getfield 149	com/tencent/smtt/sdk/h:wSe	Ljava/lang/String;
    //   2966: invokevirtual 247	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   2969: ifne -827 -> 2142
    //   2972: lload 9
    //   2974: lstore 11
    //   2976: iload_2
    ...
    //   2981: lstore 13
    //   2983: aload_0
    //   2984: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   2987: iconst_0
    //   2988: putfield 715	com/tencent/smtt/sdk/r$b:wTL	I
    //   2991: lload 9
    //   2993: lstore 11
    //   2995: iload_2
    //   2996: istore 5
    ...
    //   3002: aload_0
    //   3003: aload 27
    //   3005: putfield 149	com/tencent/smtt/sdk/h:wSe	Ljava/lang/String;
    //   3008: lload 9
    //   3010: lstore 11
    //   3012: iload_2
    //   3013: istore 5
    ...
    //   3019: aload_0
    //   3020: iload_3
    //   3021: putfield 151	com/tencent/smtt/sdk/h:wSf	I
    //   3024: goto -882 -> 2142
    //   3027: lload 9
    //   3029: lstore 11
    //   3031: iload_2
    ...
    //   3038: aload_0
    //   3039: aload_0
    //   3040: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   3043: invokevirtual 843	java/net/HttpURLConnection:getContentLength	()I
    //   3046: i2l
    //   3047: lload 19
    //   3049: ladd
    //   3050: putfield 368	com/tencent/smtt/sdk/h:wRW	J
    //   3053: lload 9
    //   3055: lstore 11
    //   3057: iload_2
    //   3058: istore 5
    ...
    //   3076: aload_0
    //   3077: getfield 368	com/tencent/smtt/sdk/h:wRW	J
    //   3080: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   3083: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   3086: invokestatic 199	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   3089: lload 9
    //   3091: lstore 11
    //   3093: iload_2
    //   3094: istore 5
    ...
    //   3098: lstore 13
    //   3100: aload_0
    //   3101: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   3104: aload_0
    //   3105: getfield 368	com/tencent/smtt/sdk/h:wRW	J
    //   3108: putfield 848	com/tencent/smtt/sdk/r$b:wTJ	J
    //   3111: lload 9
    //   3113: lstore 11
    //   3115: iload_2
    //   3116: istore 5
    ...
    //   3126: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   3129: getfield 231	com/tencent/smtt/sdk/k:wSA	Landroid/content/SharedPreferences;
    //   3132: ldc_w 262
    //   3135: lconst_0
    //   3136: invokeinterface 266 4 0
    //   3141: lstore 15
    //   3143: lload 15
    //   3145: lconst_0
    //   3146: lcmp
    ...
    //   3159: lstore 13
    //   3161: aload_0
    //   3162: getfield 368	com/tencent/smtt/sdk/h:wRW	J
    //   3165: lload 15
    //   3167: lcmp
    //   3168: ifeq +360 -> 3528
    //   3171: lload 9
    ...
    //   3194: lload 15
    //   3196: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   3199: ldc_w 852
    //   3202: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   3205: aload_0
    //   3206: getfield 368	com/tencent/smtt/sdk/h:wRW	J
    //   3209: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    ...
    //   3232: lstore 13
    //   3234: aload_0
    //   3235: invokevirtual 855	com/tencent/smtt/sdk/h:cdR	()Z
    //   3238: ifne +41 -> 3279
    //   3241: lload 9
    //   3243: lstore 11
    //   3245: iload_2
    ...
    //   3288: lstore 13
    //   3290: aload_0
    //   3291: getfield 80	com/tencent/smtt/sdk/h:wSm	[Ljava/lang/String;
    //   3294: ifnull +66 -> 3360
    //   3297: lload 9
    //   3299: lstore 11
    //   3301: iload_2
    ...
    //   3306: lstore 13
    //   3308: aload_0
    //   3309: invokespecial 829	com/tencent/smtt/sdk/h:cdO	()Z
    //   3312: istore 6
    //   3314: iload 6
    //   3316: ifeq +44 -> 3360
    //   3319: iload_1
    ...
    //   3327: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   3330: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   3333: ldc_w 655
    //   3336: lload 9
    ...
    //   3351: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   3384: lload 15
    //   3386: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   3389: ldc_w 852
    //   3392: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   3395: aload_0
    //   3396: getfield 368	com/tencent/smtt/sdk/h:wRW	J
    //   3399: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   3402: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   3405: iconst_1
    //   3406: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   3409: lload 9
    //   3411: lstore 11
    //   3413: iload_2
    //   3414: istore 5
    ...
    //   3424: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   3427: sipush 65226
    //   3430: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   3433: iload_2
    //   3434: istore 5
    //   3436: iload_1
    //   3437: ifne -2901 -> 536
    ...
    //   3444: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   3447: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   3450: ldc_w 655
    //   3453: lload 9
    ...
    //   3468: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   3494: ldc_w 859
    //   3497: iconst_1
    //   3498: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   3501: lload 9
    //   3503: lstore 11
    //   3505: iload_2
    //   3506: istore 5
    ...
    //   3516: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   3519: sipush 65232
    //   3522: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   3525: goto -92 -> 3433
    //   3528: aconst_null
    //   3529: astore 31
    //   3531: aconst_null
    ...
    //   3545: ldc -65
    //   3547: ldc_w 861
    //   3550: invokestatic 199	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   3553: aload_0
    //   3554: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    ...
    //   3571: aload_0
    //   3572: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    ...
    //   3585: aload 27
    //   3587: ldc_w 867
    //   3590: invokevirtual 422	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   3593: ifeq +252 -> 3845
    ...
    //   3621: dup
    //   3622: aload_0
    //   3623: getfield 139	com/tencent/smtt/sdk/h:wRV	Ljava/io/File;
    //   3626: ldc -35
    ...
    //   3680: istore 7
    //   3682: aload_0
    //   3683: getfield 374	com/tencent/smtt/sdk/h:RE	Z
    //   3686: ifeq +353 -> 4039
    //   3689: lload 9
    //   3691: lstore 15
    //   3693: iload_2
    ...
    //   3730: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   3733: sipush 65227
    //   3736: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   3739: iconst_0
    //   3740: istore_3
    //   3741: iload_3
    //   3742: ifeq +1107 -> 4849
    ...
    //   3812: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   3815: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   3818: ldc_w 655
    //   3821: lload 9
    ...
    //   3836: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   3850: aload 27
    //   3852: ldc_w 879
    //   3855: invokevirtual 422	java/lang/String:contains	(Ljava/lang/CharSequence;)Z
    //   3858: ifeq +174 -> 4032
    ...
    //   3908: aload_0
    //   3909: ldc_w 893
    //   3912: putfield 74	com/tencent/smtt/sdk/h:wRX	I
    //   3915: aload_0
    //   3916: lconst_0
    //   3917: invokespecial 895	com/tencent/smtt/sdk/h:eZ	(J)V
    //   3920: aload_0
    //   3921: bipush 103
    //   3923: aload 29
    //   3925: invokestatic 338	com/tencent/smtt/sdk/h:j	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   3928: iconst_0
    //   3929: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   3932: lload 9
    //   3934: lstore 11
    //   3936: lload 9
    //   3938: lstore 13
    ...
    //   3999: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   4002: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   4005: ldc_w 655
    //   4008: lload 9
    ...
    //   4023: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   4081: istore 7
    //   4083: aload_0
    //   4084: getfield 80	com/tencent/smtt/sdk/h:wSm	[Ljava/lang/String;
    //   4087: ifnull +83 -> 4170
    //   4090: lload 9
    //   4092: lstore 15
    //   4094: iload_2
    ...
    //   4105: iconst_1
    //   4106: iload 8
    //   4108: invokespecial 657	com/tencent/smtt/sdk/h:M	(ZZ)Z
    //   4111: ifne +59 -> 4170
    //   4114: iload_1
    //   4115: ifne +29 -> 4144
    //   4118: lload 9
    ...
    //   4130: istore 7
    //   4132: aload_0
    //   4133: invokespecial 829	com/tencent/smtt/sdk/h:cdO	()Z
    //   4136: ifeq +8 -> 4144
    //   4139: iconst_1
    //   4140: istore_3
    //   4141: goto -400 -> 3741
    ...
    //   4158: aload_0
    //   4159: iconst_1
    //   4160: putfield 376	com/tencent/smtt/sdk/h:mFinished	Z
    //   4163: iconst_0
    //   4164: istore_3
    //   4165: iconst_0
    //   4166: istore_2
    ...
    //   4184: aload_0
    //   4185: iconst_1
    //   4186: putfield 376	com/tencent/smtt/sdk/h:mFinished	Z
    //   4189: iload_2
    //   4190: istore 5
    //   4192: lload 9
    //   4194: lstore 15
    ...
    //   4204: istore 7
    //   4206: aload_0
    //   4207: getfield 80	com/tencent/smtt/sdk/h:wSm	[Ljava/lang/String;
    //   4210: ifnull +6 -> 4216
    //   4213: iconst_1
    //   4214: istore 5
    //   4216: lload 9
    ...
    //   4236: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   4239: sipush 65225
    //   4242: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   4245: iconst_0
    //   4246: istore_3
    //   4247: iload 5
    //   4249: istore_2
    ...
    //   4368: lload 9
    //   4370: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   4373: ldc_w 912
    //   4376: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   4379: lload 25
    //   4381: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   4384: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   4387: iconst_1
    //   4388: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   4391: lload 9
    //   4393: lstore 15
    //   4395: iload_2
    //   4396: istore 6
    ...
    //   4409: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   4412: sipush 65229
    //   4415: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   4418: iconst_0
    //   4419: istore_3
    //   4420: goto -679 -> 3741
    //   4423: lload 9
    ...
    //   4445: invokestatic 742	com/tencent/smtt/utils/f:gU	(Landroid/content/Context;)Z
    //   4448: ifne +117 -> 4565
    //   4451: lload 9
    //   4453: lstore 15
    //   4455: iload_2
    ...
    //   4501: invokestatic 919	com/tencent/smtt/utils/u:cfq	()J
    //   4504: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   4507: ldc_w 921
    ...
    //   4517: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   4520: invokevirtual 924	com/tencent/smtt/sdk/k:cdY	()J
    //   4523: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   4526: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   4529: iconst_1
    //   4530: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   4533: lload 9
    //   4535: lstore 15
    //   4537: iload_2
    //   4538: istore 6
    ...
    //   4551: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   4554: sipush 65228
    //   4557: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   4560: iconst_0
    //   4561: istore_3
    //   4562: goto -821 -> 3741
    //   4565: iload_3
    ...
    //   4572: lstore 17
    //   4574: aload_0
    //   4575: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   4578: astore 31
    //   4580: aload 31
    //   4582: lload 17
    //   4584: lload 23
    //   4586: lsub
    //   4587: aload 31
    //   4589: getfield 927	com/tencent/smtt/sdk/r$b:wTK	J
    //   4592: ladd
    //   4593: putfield 927	com/tencent/smtt/sdk/r$b:wTK	J
    //   4596: aload_0
    //   4597: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   4600: astore 31
    //   4602: aload 31
    //   4604: lload 9
    //   4606: aload 31
    //   4608: getfield 930	com/tencent/smtt/sdk/r$b:wTO	J
    //   4611: ladd
    //   4612: putfield 930	com/tencent/smtt/sdk/r$b:wTO	J
    ...
    //   4651: lload 15
    //   4653: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   4656: ldc_w 840
    //   4659: invokevirtual 122	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   4662: aload_0
    //   4663: getfield 368	com/tencent/smtt/sdk/h:wRW	J
    //   4666: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    ...
    //   4676: getstatic 537	com/tencent/smtt/sdk/QbSdk:wRt	Lcom/tencent/smtt/sdk/q;
    //   4679: ifnull +27 -> 4706
    //   4682: lload 15
    //   4684: l2d
    //   4685: aload_0
    //   4686: getfield 368	com/tencent/smtt/sdk/h:wRW	J
    //   4689: l2d
    //   4690: ddiv
    //   4691: ldc2_w 935
    //   4694: dmul
    //   4695: d2i
    //   4696: istore_3
    //   4697: getstatic 537	com/tencent/smtt/sdk/QbSdk:wRt	Lcom/tencent/smtt/sdk/q;
    //   4700: iload_3
    ...
    //   4734: invokestatic 171	com/tencent/smtt/sdk/l:fP	(Landroid/content/Context;)Z
    //   4737: ifne +81 -> 4818
    //   4740: aload_0
    //   4741: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   4744: invokestatic 706	com/tencent/smtt/utils/b:gN	(Landroid/content/Context;)I
    //   4747: iconst_3
    ...
    //   4761: invokestatic 706	com/tencent/smtt/utils/b:gN	(Landroid/content/Context;)I
    //   4764: ifne +54 -> 4818
    //   4767: aload_0
    //   4768: invokevirtual 822	com/tencent/smtt/sdk/h:stopDownload	()V
    //   4771: getstatic 537	com/tencent/smtt/sdk/QbSdk:wRt	Lcom/tencent/smtt/sdk/q;
    //   4774: ifnull +13 -> 4787
    //   4777: getstatic 537	com/tencent/smtt/sdk/QbSdk:wRt	Lcom/tencent/smtt/sdk/q;
    //   4780: bipush 111
    ...
    //   4800: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   4803: sipush 65232
    //   4806: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   4809: iconst_0
    //   4810: istore_3
    //   4811: lload 11
    //   4813: lstore 9
    ...
    //   4906: lstore 13
    //   4908: aload_0
    //   4909: getfield 376	com/tencent/smtt/sdk/h:mFinished	Z
    //   4912: ifne +27 -> 4939
    //   4915: lload 9
    //   4917: lstore 11
    //   4919: iload_2
    ...
    //   4930: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   4933: sipush 65217
    //   4936: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   4939: iload_2
    //   4940: istore 5
    //   4942: iload_1
    //   4943: ifne -4407 -> 536
    ...
    //   4950: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   4953: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   4956: ldc_w 655
    //   4959: lload 9
    ...
    //   4974: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   4994: invokestatic 742	com/tencent/smtt/utils/f:gU	(Landroid/content/Context;)Z
    //   4997: ifne +156 -> 5153
    //   5000: aload_0
    //   5001: bipush 105
    ...
    //   5013: invokestatic 919	com/tencent/smtt/utils/u:cfq	()J
    //   5016: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   5019: ldc_w 921
    ...
    //   5029: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5032: invokevirtual 924	com/tencent/smtt/sdk/k:cdY	()J
    //   5035: invokevirtual 277	java/lang/StringBuilder:append	(J)Ljava/lang/StringBuilder;
    //   5038: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   5041: iconst_1
    //   5042: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   5045: aload_0
    //   5046: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   5049: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5052: sipush 65228
    //   5055: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   5058: lload 9
    //   5060: lstore 11
    //   5062: lload 9
    //   5064: lstore 13
    ...
    //   5117: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5120: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   5123: ldc_w 655
    //   5126: lload 9
    ...
    //   5141: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   5153: aload_0
    //   5154: lconst_0
    //   5155: invokespecial 895	com/tencent/smtt/sdk/h:eZ	(J)V
    //   5158: iconst_0
    //   5159: istore_3
    //   5160: new 157	java/io/File
    //   5163: dup
    //   5164: aload_0
    //   5165: getfield 139	com/tencent/smtt/sdk/h:wRV	Ljava/io/File;
    //   5168: ldc -35
    //   5170: invokespecial 162	java/io/File:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   5173: invokevirtual 219	java/io/File:exists	()Z
    //   5176: ifeq +5 -> 5181
    //   5179: iconst_1
    //   5180: istore_3
    //   5181: iload_3
    ...
    //   5186: bipush 106
    //   5188: aload 29
    //   5190: invokestatic 338	com/tencent/smtt/sdk/h:j	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   5193: iconst_0
    //   5194: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   5197: lload 9
    //   5199: lstore 11
    //   5201: lload 9
    //   5203: lstore 13
    ...
    //   5264: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5267: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   5270: ldc_w 655
    //   5273: lload 9
    ...
    //   5288: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5291: invokevirtual 531	com/tencent/smtt/sdk/k:commit	()V
    //   5294: goto -4805 -> 489
    //   5297: aload_0
    //   5298: bipush 104
    //   5300: aload 29
    //   5302: invokestatic 338	com/tencent/smtt/sdk/h:j	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   5305: iconst_0
    //   5306: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   5309: goto -112 -> 5197
    //   5312: astore 29
    //   5314: aload 27
    //   5316: astore 31
    ...
    //   5407: lstore 13
    //   5409: aload_0
    //   5410: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   5413: ldc_w 945
    ...
    //   5451: aload_0
    //   5452: aload 27
    //   5454: putfield 370	com/tencent/smtt/sdk/h:wRU	Ljava/lang/String;
    //   5457: lload 9
    //   5459: lstore 11
    //   5461: iload_2
    //   5462: istore 5
    ...
    //   5468: aload_0
    //   5469: aload_0
    //   5470: getfield 364	com/tencent/smtt/sdk/h:wSa	I
    //   5473: iconst_1
    //   5474: iadd
    //   5475: putfield 364	com/tencent/smtt/sdk/h:wSa	I
    //   5478: iload_1
    //   5479: ifne +1483 -> 6962
    //   5482: aload_0
    //   5483: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   5486: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5489: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   5492: ldc_w 655
    //   5495: lload 9
    ...
    //   5510: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   5533: aconst_null
    //   5534: iconst_1
    //   5535: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   5538: lload 9
    //   5540: lstore 11
    //   5542: iload_2
    //   5543: istore 5
    ...
    //   5553: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5556: sipush 65224
    //   5559: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   5562: iload_2
    //   5563: istore 5
    //   5565: iload_1
    //   5566: ifne -5030 -> 536
    ...
    //   5573: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5576: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   5579: ldc_w 655
    //   5582: lload 9
    ...
    //   5597: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   5627: iconst_0
    //   5628: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   5631: iload_3
    //   5632: sipush 416
    ...
    //   5650: iconst_1
    //   5651: iload 8
    //   5653: invokespecial 657	com/tencent/smtt/sdk/h:M	(ZZ)Z
    //   5656: ifeq +76 -> 5732
    //   5659: iconst_1
    //   5660: istore 5
    //   5662: iconst_1
    ...
    //   5676: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5679: sipush 65322
    //   5682: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   5685: iload_2
    //   5686: istore 5
    //   5688: iload_1
    //   5689: ifne -5153 -> 536
    ...
    //   5696: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5699: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   5702: ldc_w 655
    //   5705: lload 9
    ...
    //   5720: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   5743: aload_0
    //   5744: iconst_0
    //   5745: invokespecial 959	com/tencent/smtt/sdk/h:mb	(Z)Z
    //   5748: pop
    //   5749: lload 9
    //   5751: lstore 11
    //   5753: iload_2
    ...
    //   5764: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5767: sipush 65223
    //   5770: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   5773: iload_2
    //   5774: istore 5
    //   5776: iload_1
    //   5777: ifne -5241 -> 536
    ...
    //   5784: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5787: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   5790: ldc_w 655
    //   5793: lload 9
    ...
    //   5808: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   5843: lstore 13
    //   5845: aload_0
    //   5846: getfield 368	com/tencent/smtt/sdk/h:wRW	J
    //   5849: ldc2_w 365
    //   5852: lcmp
    //   5853: ifne +74 -> 5927
    //   5856: lload 9
    ...
    //   5871: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5874: sipush 65222
    //   5877: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   5880: iload_2
    //   5881: istore 5
    //   5883: iload_1
    //   5884: ifne -5348 -> 536
    ...
    //   5891: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5894: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   5897: ldc_w 655
    //   5900: lload 9
    ...
    //   5915: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   5942: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   5945: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   5948: ldc_w 655
    //   5951: lload 9
    ...
    //   5966: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   5984: lstore 13
    //   5986: aload_0
    //   5987: getfield 362	com/tencent/smtt/sdk/h:igS	I
    //   5990: aload_0
    //   5991: getfield 78	com/tencent/smtt/sdk/h:wSj	I
    ...
    //   6015: aload_0
    //   6016: aload_0
    //   6017: getfield 636	com/tencent/smtt/sdk/h:wSb	Ljava/net/HttpURLConnection;
    //   6020: ldc_w 961
    ...
    //   6029: invokespecial 895	com/tencent/smtt/sdk/h:eZ	(J)V
    //   6032: lload 9
    //   6034: lstore 11
    //   6036: iload_2
    //   6037: istore 5
    ...
    //   6041: lstore 13
    //   6043: aload_0
    //   6044: getfield 374	com/tencent/smtt/sdk/h:RE	Z
    //   6047: ifeq +74 -> 6121
    //   6050: lload 9
    //   6052: lstore 11
    //   6054: iload_2
    ...
    //   6065: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   6068: sipush 65227
    //   6071: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   6074: iload_2
    //   6075: istore 5
    //   6077: iload_1
    //   6078: ifne -5542 -> 536
    ...
    //   6085: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   6088: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   6091: ldc_w 655
    //   6094: lload 9
    ...
    //   6109: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   6129: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   6132: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   6135: ldc_w 655
    //   6138: lload 9
    ...
    //   6153: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   6171: lstore 13
    //   6173: aload_0
    //   6174: getfield 362	com/tencent/smtt/sdk/h:igS	I
    //   6177: aload_0
    //   6178: getfield 78	com/tencent/smtt/sdk/h:wSj	I
    ...
    //   6223: aload_0
    //   6224: lconst_0
    //   6225: invokespecial 895	com/tencent/smtt/sdk/h:eZ	(J)V
    //   6228: lload 9
    //   6230: lstore 11
    //   6232: iload_2
    //   6233: istore 5
    ...
    //   6237: lstore 13
    //   6239: aload_0
    //   6240: getfield 374	com/tencent/smtt/sdk/h:RE	Z
    //   6243: ifeq +74 -> 6317
    //   6246: lload 9
    //   6248: lstore 11
    //   6250: iload_2
    ...
    //   6261: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   6264: sipush 65227
    //   6267: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   6270: iload_2
    //   6271: istore 5
    //   6273: iload_1
    //   6274: ifne -5738 -> 536
    ...
    //   6281: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   6284: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   6287: ldc_w 655
    //   6290: lload 9
    ...
    //   6305: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   6325: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   6328: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   6331: ldc_w 655
    //   6334: lload 9
    ...
    //   6349: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   6367: lstore 13
    //   6369: aload_0
    //   6370: invokespecial 790	com/tencent/smtt/sdk/h:cdP	()J
    //   6373: lconst_0
    //   6374: lcmp
    //   6375: ifgt +85 -> 6460
    //   6378: lload 9
    ...
    //   6387: lstore 13
    //   6389: aload_0
    //   6390: getfield 372	com/tencent/smtt/sdk/h:wRZ	Z
    //   6393: ifne +67 -> 6460
    //   6396: iload_3
    //   6397: sipush 410
    ...
    //   6414: aload_0
    //   6415: iconst_1
    //   6416: putfield 372	com/tencent/smtt/sdk/h:wRZ	Z
    //   6419: iload_1
    //   6420: ifne +542 -> 6962
    //   6423: aload_0
    //   6424: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   6427: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   6430: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   6433: ldc_w 655
    //   6436: lload 9
    ...
    //   6451: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   6475: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   6478: sipush 65221
    //   6481: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   6484: iload_2
    //   6485: istore 5
    //   6487: iload_1
    //   6488: ifne -5952 -> 536
    ...
    //   6495: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   6498: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   6501: ldc_w 655
    //   6504: lload 9
    ...
    //   6519: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   6535: aload_0
    //   6536: lconst_0
    //   6537: invokespecial 895	com/tencent/smtt/sdk/h:eZ	(J)V
    //   6540: lload 9
    //   6542: lstore 11
    //   6544: aload_0
    //   6545: bipush 107
    //   6547: aload 27
    //   6549: invokestatic 338	com/tencent/smtt/sdk/h:j	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   6552: iconst_0
    //   6553: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   6556: lload 9
    //   6558: lstore 11
    //   6560: aload_0
    //   6561: getfield 374	com/tencent/smtt/sdk/h:RE	Z
    //   6564: ifeq -3891 -> 2673
    //   6567: lload 9
    //   6569: lstore 11
    //   6571: aload_0
    //   6572: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   6575: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   6578: sipush 65227
    //   6581: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   6584: iload_2
    //   6585: istore 5
    //   6587: iload_1
    //   6588: ifne +371 -> 6959
    ...
    //   6595: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   6598: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   6601: ldc_w 655
    //   6604: lload 9
    ...
    //   6619: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    ...
    //   6638: goto -6024 -> 614
    //   6641: aload_0
    //   6642: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   6645: iconst_0
    //   6646: putfield 663	com/tencent/smtt/sdk/r$b:wTD	I
    //   6649: goto -6029 -> 620
    //   6652: aload_0
    //   6653: getfield 90	com/tencent/smtt/sdk/h:mContext	Landroid/content/Context;
    //   6656: invokestatic 227	com/tencent/smtt/sdk/k:fM	(Landroid/content/Context;)Lcom/tencent/smtt/sdk/k;
    //   6659: sipush 65218
    //   6662: invokevirtual 599	com/tencent/smtt/sdk/k:CR	(I)V
    //   6665: aload_0
    //   6666: iconst_0
    //   6667: invokespecial 959	com/tencent/smtt/sdk/h:mb	(Z)Z
    //   6670: pop
    //   6671: goto -6019 -> 652
    //   6674: aload 27
    //   6676: getfield 231	com/tencent/smtt/sdk/k:wSA	Landroid/content/SharedPreferences;
    //   6679: ldc_w 967
    //   6682: iconst_0
    //   6683: invokeinterface 291 3 0
    //   6688: istore_3
    //   6689: aload 27
    //   6691: getfield 511	com/tencent/smtt/sdk/k:wSz	Ljava/util/Map;
    //   6694: astore 28
    //   6696: iload_3
    //   6697: iconst_1
    //   6698: iadd
    ...
    //   6702: ldc_w 967
    //   6705: iload_3
    //   6706: invokestatic 328	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   6709: invokeinterface 524 3 0
    //   6714: pop
    //   6715: iload_3
    //   6716: aload 27
    //   6718: invokevirtual 970	com/tencent/smtt/sdk/k:cea	()I
    //   6721: if_icmpne -6021 -> 700
    //   6724: aload_0
    //   6725: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   6728: iconst_2
    //   6729: putfield 803	com/tencent/smtt/sdk/r$b:wTE	I
    //   6732: goto -6032 -> 700
    //   6735: iconst_0
    //   6736: istore_3
    //   6737: goto -6020 -> 717
    ...
    //   6765: invokestatic 209	com/tencent/smtt/utils/TbsLog:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   6768: goto -5999 -> 769
    //   6771: invokestatic 974	com/tencent/smtt/sdk/h:cdQ	()Z
    //   6774: ifne -5839 -> 935
    //   6777: aload_0
    //   6778: bipush 101
    //   6780: aconst_null
    //   6781: iconst_1
    //   6782: invokespecial 341	com/tencent/smtt/sdk/h:j	(ILjava/lang/String;Z)V
    //   6785: goto -5850 -> 935
    //   6788: aload_0
    ...
    //   6795: getstatic 977	com/tencent/smtt/sdk/r$a:wTs	Lcom/tencent/smtt/sdk/r$a;
    //   6798: aload_0
    //   6799: getfield 102	com/tencent/smtt/sdk/h:wSd	Lcom/tencent/smtt/sdk/r$b;
    //   6802: invokevirtual 727	com/tencent/smtt/sdk/r:a	(Lcom/tencent/smtt/sdk/r$a;Lcom/tencent/smtt/sdk/r$b;)V
    //   6805: goto -5830 -> 975
    //   6808: iconst_0
    //   6809: putstatic 596	com/tencent/smtt/sdk/l:wSI	Z
    //   6812: return
    //   6813: astore 27
    //   6815: lload 11
    //   6817: lstore 13
  ...
  public final boolean cdN()
  {
    ...
    try
    {
      File localFile1 = new File(f.al(this.mContext, 4), "x5.tbs.decouple");
      if (localFile1.exists()) {
        TbsLog.i("TbsApkDownloader", "verifyAndInstallDecoupleCoreFromBackup #2");
      }
      while (a.a(this.mContext, localFile1, k.fM(this.mContext).wSA.getInt("tbs_decouplecoreversion", -1)))
      {
        TbsLog.i("TbsApkDownloader", "verifyAndInstallDecoupleCoreFromBackup #3");
        p.ceq();
        return p.fV(this.mContext);
        File localFile2 = l.CU(k.fM(this.mContext).wSA.getInt("tbs_decouplecoreversion", -1));
        if ((localFile2 != null) && (localFile2.exists())) {
          f.h(localFile2, localFile1);
        }
      }
      TbsLog.i("TbsApkDownloader", "verifyAndInstallDecoupleCoreFromBackup no backup file !!!");
      localFile1 = new File(f.al(this.mContext, 4), "x5.tbs.decouple");
      if (localFile1.exists()) {
        localFile1.delete();
      }
    }
  ...
  public final boolean cdR()
  {
    ...
    //   16: invokestatic 706	com/tencent/smtt/utils/b:gN	(Landroid/content/Context;)I
    //   19: iconst_3
    ...
    //   37: iload_3
    //   38: invokevirtual 216	java/lang/StringBuilder:append	(Z)Ljava/lang/StringBuilder;
    //   41: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   44: invokestatic 199	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   47: iload 5
    //   49: istore_2
    //   50: iload_3
    //   51: ifeq +135 -> 186
    ...
    //   58: invokestatic 642	com/tencent/smtt/utils/b:gO	(Landroid/content/Context;)Ljava/lang/String;
    //   61: astore 6
    //   63: ldc -65
    ...
    //   83: invokestatic 199	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   156: iload_1
    //   157: invokevirtual 298	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   160: invokevirtual 125	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   163: invokestatic 199	com/tencent/smtt/utils/TbsLog:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   166: iload_1
    //   167: sipush 204
    ...
    //   195: ifne +81 -> 276
    //   198: aload_0
    //   199: getfield 107	com/tencent/smtt/sdk/h:wSi	Ljava/util/Set;
    //   202: aload 6
    //   204: invokeinterface 646 2 0
    //   209: ifne +67 -> 276
    //   212: aload_0
    //   213: getfield 107	com/tencent/smtt/sdk/h:wSi	Ljava/util/Set;
    //   216: aload 6
    //   218: invokeinterface 1011 2 0
    //   223: pop
    //   224: aload_0
    //   225: getfield 1013	com/tencent/smtt/sdk/h:wSh	Landroid/os/Handler;
    //   228: ifnonnull +21 -> 249
    //   231: aload_0
    //   232: new 6	com/tencent/smtt/sdk/h$1
    //   235: dup
    //   236: aload_0
    //   237: invokestatic 1019	com/tencent/smtt/sdk/n:cep	()Lcom/tencent/smtt/sdk/n;
    ...
    //   246: putfield 1013	com/tencent/smtt/sdk/h:wSh	Landroid/os/Handler;
    //   249: aload_0
    //   250: getfield 1013	com/tencent/smtt/sdk/h:wSh	Landroid/os/Handler;
    //   253: sipush 150
    //   256: aload 6
    //   258: invokevirtual 1032	android/os/Handler:obtainMessage	(ILjava/lang/Object;)Landroid/os/Message;
    //   261: astore 7
    //   263: aload_0
    //   264: getfield 1013	com/tencent/smtt/sdk/h:wSh	Landroid/os/Handler;
    //   267: aload 7
    //   269: ldc2_w 1033
    ...
    //   277: ifeq +29 -> 306
    //   280: aload_0
    //   281: getfield 107	com/tencent/smtt/sdk/h:wSi	Ljava/util/Set;
    //   284: aload 6
    //   286: invokeinterface 646 2 0
    //   291: ifeq +15 -> 306
    //   294: aload_0
    //   295: getfield 107	com/tencent/smtt/sdk/h:wSi	Ljava/util/Set;
    //   298: aload 6
  ...
  public final boolean lZ(boolean paramBoolean)
  {
    boolean bool = true;
    int i = k.fM(this.mContext).wSA.getInt("use_backup_version", 0);
    int j = p.ceq().gc(this.mContext);
    if (i == 0) {
      i = k.fM(this.mContext).wSA.getInt("tbs_download_version", 0);
    }
    for (this.wSl = "by default key"; (i == 0) || (i == j); this.wSl = "by new key")
    {
      paramBoolean = false;
      return paramBoolean;
    }
    ...
    if (paramBoolean)
    {
      ...
      for (;;)
      {
        try
        {
          if (k.fM(this.mContext).wSA.getInt("tbs_download_version_type", 0) == 1) {
            break label426;
          }
          f.h(localFile, (File)localObject1);
          j = 1;
          str = f.al(this.mContext, 4);
          if (!l.fP(this.mContext)) {
            break label431;
          ...
          localObject1 = "x5.oversea.tbs.org";
          localObject1 = new File(str, (String)localObject1);
          int m = k.fM(this.mContext).wSA.getInt("use_backup_version", 0);
          int k = m;
          if (m == 0) {
            k = k.fM(this.mContext).wSA.getInt("tbs_download_version", 0);
          }
          ...
          k.fM(this.mContext).wSz.put("tbs_download_interrupt_code_reason", Integer.valueOf(65322));
          k.fM(this.mContext).CR(65322);
          ma(false);
          paramBoolean = bool;
          if (j == 0) {
            break;
          }
          j(100, "use local backup apk in startDownload" + this.wSl, true);
          if (k.fM(this.mContext).wSA.getInt("tbs_downloaddecouplecore", 0) != 1) {
            break label438;
          }
          r.gr(this.mContext).a(r.a.wTv, this.wSd);
          this.wSd.cdM();
          return true;
        }
        ...
        continue;
        label438:
        r.gr(this.mContext).a(r.a.wTs, this.wSd);
      }
    }
    try
    {
      label458:
      j = k.fM(this.mContext).wSA.getInt("tbs_downloaddecouplecore", 0);
      if (j != 1) {
        break label555;
      }
    }
  ...
  public final void stopDownload()
  {
    ...
    if (t.gu(this.mContext))
    {
      ...
      localb.k(new Exception());
      if (k.fM(this.mContext).wSA.getInt("tbs_downloaddecouplecore", 0) == 1) {
        r.gr(this.mContext).a(r.a.wTv, localb);
      }
    }
    else
    {
    ...
    r.gr(this.mContext).a(r.a.wTs, localb);
  }
}


/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/sdk/h.class
