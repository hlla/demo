...
public class CookieManager
{
  ...
  private static CookieManager wQx;
  int wQA = a.wQD;
  ...
  public boolean acceptCookie()
  {
    ...
    {
      localObject = ((ac)localObject).ceT().wUo.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_acceptCookie", new Class[0], new Object[0]);
      if (localObject == null) {
        return false;
      }
  ...
  public boolean acceptThirdPartyCookies(WebView paramWebView)
  {
    ...
    //   0: aload_0
    //   1: monitorenter
    //   2: invokestatic 93	com/tencent/smtt/sdk/ac:ceR	()Lcom/tencent/smtt/sdk/ac;
    //   5: astore_3
    //   6: aload_3
    //   7: ifnull +70 -> 77
    //   10: aload_3
    //   11: invokevirtual 96	com/tencent/smtt/sdk/ac:ceS	()Z
    //   14: ifeq +63 -> 77
    //   17: aload_3
    //   18: invokevirtual 100	com/tencent/smtt/sdk/ac:ceT	()Lcom/tencent/smtt/sdk/ad;
    //   21: getfield 106	com/tencent/smtt/sdk/ad:wUo	Lcom/tencent/smtt/export/external/DexLoader;
    //   24: astore_3
    //   25: aload_1
  ...
  final void cdE()
  {
    ...
    for (;;)
    {
      try
      {
        ...
        Object localObject1 = ac.ceR();
        if ((localObject1 == null) || (!((ac)localObject1).ceS())) {
          break;
        }
        localObject1 = this.wQy.iterator();
        if (!((Iterator)localObject1).hasNext()) {
          break label292;
        }
        localObject3 = (b)((Iterator)localObject1).next();
        switch (((b)localObject3).wQH)
        {
        case 1: 
          setCookie(((b)localObject3).url, ((b)localObject3).value, ((b)localObject3).wQI);
          break;
        case 2: 
    ...
    Iterator localIterator = this.wQy.iterator();
    for (;;)
    {
      Object localObject4;
      ...
      case 1: 
        if (Build.VERSION.SDK_INT >= 21)
        {
          ...
          localObject4 = ((b)localObject4).wQI;
  ...
  public void flush()
  {
    ...
    if ((localac != null) && (localac.ceS())) {
      localac.ceT().wUo.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_flush", new Class[0], new Object[0]);
    }
  ...
  public String getCookie(String paramString)
  {
    ...
    if ((localac != null) && (localac.ceS()))
    {
      paramString = localac.ceT().wUo.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "getCookie", new Class[] { String.class }, new Object[] { paramString });
      if (paramString == null) {
        return null;
      }
  ...
  public boolean hasCookies()
  {
    ...
    if ((localObject != null) && (((ac)localObject).ceS()))
    {
      localObject = ((ac)localObject).ceT().wUo.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_hasCookies", new Class[0], new Object[0]);
      if (localObject == null) {
        return false;
      }
      return ((Boolean)localObject).booleanValue();
  ...
  protected final void n(Context paramContext, boolean paramBoolean)
  {
    int k = 0;
    int i = 0;
    for (;;)
    {
      ...
      try
      {
        if ((this.wQA != a.wQD) && (paramContext != null) && (m.ceo().bv(paramContext, "cookie_switch.txt")))
        {
          bool = this.wQB;
          if (!bool) {}
        }
        ...
        if ((QbSdk.getIsSysWebViewForcedByOuter()) || (QbSdk.wQZ)) {
          break label479;
        }
        bool = m.ceo().bv(paramContext, "usex5.txt");
        TbsLog.i(LOGTAG, "usex5 : mUseX5LastProcess->" + bool + ",useX5:" + paramBoolean);
        m.ceo().n(paramContext, "usex5.txt", paramBoolean);
        if (bool == paramBoolean) {
          continue;
        }
        r.gr(paramContext);
        localb = r.cet();
        if (TextUtils.isEmpty(this.wQz)) {
          break label450;
        }
        if ((p.ceq().ge(paramContext) > 0) && (p.ceq().ge(paramContext) < 36001)) {
          continue;
        }
        if (!bool) {
          break label329;
      ...
      label254:
      localb.Vs("x5->sys:" + bool + " from:" + j + " to:" + i + ",timeused:" + l1);
      r.gr(paramContext).a(r.a.wTx, localb);
      continue;
      label329:
      i = g.fH(paramContext);
      int j = i;
      if (i > 0)
      {
        String str = p.ceq().bz(paramContext, "cookies_database_version");
      ...
      do
      {
        do
        {
          ...
          g.a(paramContext, this.wQA, this.wQz, paramBoolean);
  ...
  public void removeAllCookie()
  {
    ...
    if ((localac != null) && (localac.ceS()))
    {
      localac.ceT().wUo.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeAllCookie", new Class[0], new Object[0]);
      return;
    }
    android.webkit.CookieManager.getInstance().removeAllCookie();
  }
  
  public void removeAllCookies(y<Boolean> paramy)
  {
    if (this.wQy != null) {
      this.wQy.clear();
    }
    ac localac = ac.ceR();
    if ((localac != null) && (localac.ceS())) {
      localac.ceT().wUo.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeAllCookies", new Class[] { ValueCallback.class }, new Object[] { paramy });
    }
    while (Build.VERSION.SDK_INT < 21) {
      return;
    }
    o.a(android.webkit.CookieManager.getInstance(), "removeAllCookies", new Class[] { ValueCallback.class }, new Object[] { paramy });
  }
  ...
  public void removeExpiredCookie()
  {
    ...
    if ((localac != null) && (localac.ceS()))
    {
      localac.ceT().wUo.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeExpiredCookie", new Class[0], new Object[0]);
      return;
    }
  ...
  public void removeSessionCookie()
  {
    ...
    if ((localac != null) && (localac.ceS()))
    {
      localac.ceT().wUo.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeSessionCookie", new Class[0], new Object[0]);
      return;
    }
    android.webkit.CookieManager.getInstance().removeSessionCookie();
  }
  
  public void removeSessionCookies(y<Boolean> paramy)
  {
    ac localac = ac.ceR();
    if ((localac != null) && (localac.ceS())) {
      localac.ceT().wUo.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_removeSessionCookies", new Class[] { ValueCallback.class }, new Object[] { paramy });
    }
    while (Build.VERSION.SDK_INT < 21) {
      return;
    }
    o.a(android.webkit.CookieManager.getInstance(), "removeSessionCookies", new Class[] { ValueCallback.class }, new Object[] { paramy });
  }
  ...
  public void setAcceptCookie(boolean paramBoolean)
  {
    ...
    //   33: dup
    //   34: iconst_0
    //   35: getstatic 393	java/lang/Boolean:TYPE	Ljava/lang/Class;
    //   38: aastore
    //   39: iconst_1
    ...
    //   44: iconst_0
    //   45: iload_1
    //   46: invokestatic 397	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   49: aastore
    ...
    //   60: iload_1
    //   61: invokevirtual 399	android/webkit/CookieManager:setAcceptCookie	(Z)V
    //   64: goto -10 -> 54
    //   67: astore_2
    //   68: goto -14 -> 54
    //   71: astore_2
  ...
  public void setAcceptThirdPartyCookies(WebView paramWebView, boolean paramBoolean)
  {
    ...
    //   21: getfield 106	com/tencent/smtt/sdk/ad:wUo	Lcom/tencent/smtt/export/external/DexLoader;
    //   24: astore_3
    //   25: getstatic 393	java/lang/Boolean:TYPE	Ljava/lang/Class;
    //   28: astore 4
    //   30: aload_1
    ...
    //   64: iconst_1
    //   65: iload_2
    //   66: invokestatic 397	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   69: aastore
    ...
    //   88: astore_3
    //   89: getstatic 393	java/lang/Boolean:TYPE	Ljava/lang/Class;
    //   92: astore 4
    //   94: aload_1
    //   95: invokevirtual 138	com/tencent/smtt/sdk/WebView:getView	()Landroid/view/View;
    //   98: astore_1
    ...
    //   126: iconst_1
    //   127: iload_2
    //   128: invokestatic 397	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   131: aastore
  ...
  /* Error */
  public void setCookie(String paramString1, String paramString2, y<Boolean> paramy)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   9: ifnull +66 -> 75
    //   12: aload 4
    //   14: invokevirtual 96	com/tencent/smtt/sdk/ac:ceS	()Z
    //   17: ifeq +58 -> 75
    //   20: aload 4
    //   22: invokevirtual 100	com/tencent/smtt/sdk/ac:ceT	()Lcom/tencent/smtt/sdk/ad;
    //   25: getfield 106	com/tencent/smtt/sdk/ad:wUo	Lcom/tencent/smtt/export/external/DexLoader;
    //   28: ldc 108
    //   30: ldc_w 409
    //   33: iconst_3
    ...
    //   73: monitorexit
    //   74: return
    //   75: invokestatic 93	com/tencent/smtt/sdk/ac:ceR	()Lcom/tencent/smtt/sdk/ac;
    //   78: getfield 412	com/tencent/smtt/sdk/ac:wRC	Z
    //   81: ifne +65 -> 146
    //   84: new 9	com/tencent/smtt/sdk/CookieManager$b
    //   87: dup
    //   88: aload_0
    //   89: invokespecial 415	com/tencent/smtt/sdk/CookieManager$b:<init>	(Lcom/tencent/smtt/sdk/CookieManager;)V
    //   92: astore 4
    //   94: aload 4
    //   96: iconst_1
    //   97: putfield 173	com/tencent/smtt/sdk/CookieManager$b:wQH	I
    //   100: aload 4
    //   102: aload_1
    ...
    //   112: aload 4
    //   114: aload_3
    //   115: putfield 183	com/tencent/smtt/sdk/CookieManager$b:wQI	Lcom/tencent/smtt/sdk/y;
    //   118: aload_0
    //   119: getfield 151	com/tencent/smtt/sdk/CookieManager:wQy	Ljava/util/ArrayList;
    //   122: ifnonnull +14 -> 136
    //   125: aload_0
    //   126: new 153	java/util/ArrayList
    //   129: dup
    //   130: invokespecial 416	java/util/ArrayList:<init>	()V
    //   133: putfield 151	com/tencent/smtt/sdk/CookieManager:wQy	Ljava/util/ArrayList;
    //   136: aload_0
    //   137: getfield 151	com/tencent/smtt/sdk/CookieManager:wQy	Ljava/util/ArrayList;
    //   140: aload 4
    //   142: invokevirtual 420	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   145: pop
    //   146: aload_0
    //   147: getfield 42	com/tencent/smtt/sdk/CookieManager:wQC	Z
    //   150: ifeq -78 -> 72
  ...
  public void setCookie(String paramString1, String paramString2, boolean paramBoolean)
  {
    ...
    //   65: return
    //   66: aload_0
    //   67: getfield 42	com/tencent/smtt/sdk/CookieManager:wQC	Z
    //   70: ifne +7 -> 77
    //   73: iload_3
    //   74: ifeq +11 -> 85
    ...
    //   85: invokestatic 93	com/tencent/smtt/sdk/ac:ceR	()Lcom/tencent/smtt/sdk/ac;
    //   88: getfield 412	com/tencent/smtt/sdk/ac:wRC	Z
    //   91: ifne -28 -> 63
    //   94: new 9	com/tencent/smtt/sdk/CookieManager$b
    //   97: dup
    //   98: aload_0
    //   99: invokespecial 415	com/tencent/smtt/sdk/CookieManager$b:<init>	(Lcom/tencent/smtt/sdk/CookieManager;)V
    //   102: astore 4
    //   104: aload 4
    //   106: iconst_2
    //   107: putfield 173	com/tencent/smtt/sdk/CookieManager$b:wQH	I
    //   110: aload 4
    //   112: aload_1
    ...
    //   122: aload 4
    //   124: aconst_null
    //   125: putfield 183	com/tencent/smtt/sdk/CookieManager$b:wQI	Lcom/tencent/smtt/sdk/y;
    //   128: aload_0
    //   129: getfield 151	com/tencent/smtt/sdk/CookieManager:wQy	Ljava/util/ArrayList;
    //   132: ifnonnull +14 -> 146
    //   135: aload_0
    //   136: new 153	java/util/ArrayList
    //   139: dup
    //   140: invokespecial 416	java/util/ArrayList:<init>	()V
    //   143: putfield 151	com/tencent/smtt/sdk/CookieManager:wQy	Ljava/util/ArrayList;
    //   146: aload_0
    //   147: getfield 151	com/tencent/smtt/sdk/CookieManager:wQy	Ljava/util/ArrayList;
    //   150: aload 4
    //   152: invokevirtual 420	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   155: pop
    //   156: goto -93 -> 63
    //   159: astore_1
    //   160: aload_0
  ...
  public boolean setCookieCompatialbeMode$4fb4c7d(Context paramContext, int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    if ((paramContext == null) || (!m.ceo().bv(paramContext, "cookie_switch.txt"))) {
      return false;
    }
    this.wQA = paramInt;
    if (paramString != null) {
      this.wQz = paramString;
    }
    if ((this.wQA != a.wQD) && (paramBoolean) && (!ac.ceR().wRC)) {
  ...
  public void setCookies(Map<String, String[]> paramMap)
  {
    ...
    if ((localObject != null) && (((ac)localObject).ceS()))
    {
      localObject = ((ac)localObject).ceT().wUo.invokeStaticMethod("com.tencent.tbs.tbsshell.WebCoreProxy", "cookieManager_setCookies", new Class[] { Map.class }, new Object[] { paramMap });
      if (localObject == null) {
        bool = false;
      }
    }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/sdk/CookieManager.class
