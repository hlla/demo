...
public final class g
{
  ...
  public static void a(Context paramContext, int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    do
    {
      do
      {
        ...
        {
          return;
        } while ((paramInt == CookieManager.a.wQE) && (TextUtils.isEmpty(paramString)));
        arrayOfString = paramString.split(",");
      } while ((arrayOfString == null) || (arrayOfString.length <= 0));
      localSQLiteDatabase = fG(paramContext);
      ...
      try
      {
        ...
        if (((Cursor)localObject2).getCount() > 0)
        {
          ...
          if (((Cursor)localObject2).moveToFirst())
          {
            ...
            paramString = (String)localObject2;
            localObject1 = localObject2;
            if (paramInt == CookieManager.a.wQE)
            {
              paramString = (String)localObject2;
              localObject1 = localObject2;
  ...
  private static ArrayList<String> d(SQLiteDatabase paramSQLiteDatabase)
  {
    Object localObject2 = null;
  ...
  private static File fF(Context paramContext)
  {
    if ((wRP == null) && (paramContext != null)) {
      wRP = new File(paramContext.getDir("webview", 0), "Cookies");
    }
    if (wRP == null) {
      wRP = new File("/data/data/" + paramContext.getPackageName() + File.separator + "app_webview" + File.separator + "Cookies");
    }
    return wRP;
  }
  
  private static SQLiteDatabase fG(Context paramContext)
  {
    Object localObject2 = null;
    Object localObject1 = null;
    if (paramContext == null) {}
  ...
  public static int fH(Context paramContext)
  {
    ...
    //   13: aconst_null
    //   14: astore 7
    //   16: invokestatic 279	java/lang/System:currentTimeMillis	()J
    //   19: pop2
    //   20: aload_0
    //   21: invokestatic 44	com/tencent/smtt/sdk/g:fG	(Landroid/content/Context;)Landroid/database/sqlite/SQLiteDatabase;
    //   24: astore_0
    //   25: aload_0
    //   26: ifnonnull +22 -> 48
    //   29: aload_0
    ...
    //   167: invokestatic 288	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   170: istore_1
    //   171: aload 8
    //   173: ifnull +10 -> 183
    //   176: aload 8
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/sdk/g.class
