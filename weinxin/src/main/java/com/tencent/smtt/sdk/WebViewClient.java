...
public class WebViewClient
{
  ...
  {
    if (this.wUS != null) {
      this.wUS.v(paramString, paramBitmap);
    }
  }
  ...
  {
    if ((this.wUS != null) && (paramWebResourceRequest.isForMainFrame())) {
      this.wUS.onReceivedError(paramWebView.wUy, paramWebResourceError.getErrorCode(), paramWebResourceError.getDescription().toString(), paramWebResourceRequest.getUrl().toString());
    }
  }
  ...
  {
    if (this.wUS != null) {
      return this.wUS.shouldInterceptRequest(paramWebView.wUy, paramWebResourceRequest.getUrl().toString());
    }
    return null;
  }
  ...
  {
    if (this.wUS != null) {
      return this.wUS.shouldInterceptRequest(paramWebView.wUy, paramWebResourceRequest);
    }
    return null;
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/sdk/WebViewClient.class
