  ...
  implements com.tencent.smtt.export.external.interfaces.DownloadListener
{
  ...
  public final void onDownloadStart(String paramString1, String paramString2, byte[] paramArrayOfByte, String paramString3, String paramString4, String paramString5, long paramLong, String paramString6, String paramString7)
  {
    if (this.wQP == null)
    {
      if (QbSdk.canOpenMimeFileType(this.vqH.getContext(), paramString5))
      {
        ...
        this.vqH.getContext().startActivity(paramString2);
        return;
      }
      c.a(this.vqH.getContext(), paramString1, null, null);
      return;
    }
    this.wQP.onDownloadStart(paramString1, paramString3, paramString4, paramString5, paramLong);
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/sdk/b.class
