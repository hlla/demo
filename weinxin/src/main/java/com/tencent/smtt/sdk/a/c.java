...
public final class c
{
  public static int a(Context paramContext, String paramString, HashMap<String, String> paramHashMap, WebView paramWebView)
  {
    ...
    Object localObject2 = gL(paramContext);
    if (((a)localObject2).sBc == -1) {
      return 4;
    }
    if ((((a)localObject2).sBc == 2) && (((a)localObject2).ver < 33)) {
      return 5;
    }
    paramString = new Intent("android.intent.action.VIEW");
    if (((a)localObject2).sBc == 2) {
    ...
    for (;;)
    {
            ...
            if (((Iterator)localObject1).hasNext())
            {
              ...
              if (!TextUtils.isEmpty(str))
              {
                ...
                if ((localObject2 != null) && (!TextUtils.isEmpty(((b)localObject2).classname))) {
                  paramString.setClassName(((b)localObject2).sBe, ((b)localObject2).classname);
                }
                break;
                if (((a)localObject2).sBc == 1)
                {
      ...
      try
      {
        paramString.putExtra("loginType", gK(paramContext));
  ...
  public static int a(Context paramContext, String paramString1, HashMap<String, String> paramHashMap, String paramString2, WebView paramWebView)
  {
    ...
    if (i != 0)
    {
      ...
      localStringBuilder.append("mttbrowser://url=").append(paramString1).append(",product=TBS,packagename=").append(paramContext.getPackageName()).append(",from=").append(paramString2).append(",version=3.5.0.1016").append((String)localObject);
  ...
  public static boolean a(Context paramContext, String paramString1, int paramInt, String paramString2, HashMap<String, String> paramHashMap, Bundle paramBundle)
  {
    try
    {
      ...
      for (;;)
      {
        ...
        localIntent.putExtra("loginType", gK(paramContext.getApplicationContext()));
        if (paramBundle != null) {
  ...
  private static int gK(Context paramContext)
  {
    int i = 26;
  ...
  private static a gL(Context paramContext)
  {
        ...
        try
        {
          ...
          if (localObject6 != null)
          {
            ...
            if (((PackageInfo)localObject6).versionCode > 420000)
            {
              ...
              localObject1 = localObject6;
              locala.wVr = ((PackageInfo)localObject6).versionName.replaceAll("\\.", "");
              return locala;
            }
          }
        }
          ...
          catch (PackageManager.NameNotFoundException localNameNotFoundException4)
          {
            ...
            catch (Exception localException)
            {
              ...
              try
              {
                ...
                locala.packageName = ((b)localObject6).sBe;
                localObject5 = paramContext;
                locala.sBc = 2;
                localObject5 = paramContext;
                locala.sBd = "ADRQB_";
    ...
    if (paramContext != null)
    {
      ...
      locala.wVr = paramContext.versionName.replaceAll("\\.", "");
    }
    return locala;
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/sdk/a/c.class
