...
{
  public static Looper wVA = null;
  private static e wVB = null;
  private static DexClassLoader wVz = null;
  public String wVy = "";
  
  private e(Context paramContext)
  {
    this.wVy = (paramContext.getDir("debugtbs", 0).getAbsolutePath() + File.separator + "plugin");
  }
  
  public static e gS(Context paramContext)
  {
    if (wVB == null) {
      wVB = new e(paramContext);
    }
    return wVB;
  }
  ...
  public final void a(final String paramString, final WebView paramWebView, final Context paramContext, final Looper paramLooper)
  {
    ...
    final Object localObject1 = this.wVy + File.separator + "DebugPlugin.tbs";
    Object localObject2 = this.wVy + File.separator + "DebugPlugin.apk";
    ...
    if (!((File)localObject1).exists())
    {
      ...
      localObject2 = this.wVy + File.separator + "DebugPlugin.tbs";
      f.J(new File((String)localObject2));
      new Thread()
      {
        public final void ceX()
        {
          paramWebView.post(new Runnable()
          {
            public final void run()
            {
              ...
              e.1.this.wVD.setVisibility(4);
              e.this.a(e.1.this.val$url, e.1.this.wVC, e.1.this.val$context, e.wVA);
            }
          });
        }
        ...
        public final void it(final int paramAnonymousInt)
        {
          paramWebView.post(new Runnable()
          {
            public final void run()
            {
              e.1.this.wVE.setText("已下载" + paramAnonymousInt + "%");
            }
          });
        }
      }
      {
        ...
        public final void run()
        {
          ...
          //   52: dup
          //   53: aload_0
          //   54: getfield 14	com/tencent/smtt/utils/e$2:hZl	Ljava/lang/String;
          //   57: invokespecial 54	java/io/File:<init>	(Ljava/lang/String;)V
          //   60: invokestatic 60	com/tencent/smtt/utils/f:L	(Ljava/io/File;)Ljava/io/FileOutputStream;
          //   63: astore 5
          //   65: aload 5
          //   67: astore 6
          //   69: sipush 8192
          ...
          //   109: istore_3
          //   110: aload_0
          //   111: getfield 16	com/tencent/smtt/utils/e$2:wVI	Lcom/tencent/smtt/utils/e$a;
          //   114: iload_3
          ...
          //   131: astore 4
          //   133: aload_0
          //   134: getfield 16	com/tencent/smtt/utils/e$2:wVI	Lcom/tencent/smtt/utils/e$a;
          ...
          //   152: return
          //   153: aload_0
          //   154: getfield 16	com/tencent/smtt/utils/e$2:wVI	Lcom/tencent/smtt/utils/e$a;
    ...
    {
      f.J((File)localObject1);
      return;
    }
    localObject3 = this.wVy + File.separator + "opt";
    Object localObject4 = new File((String)localObject3);
    if (!((File)localObject4).exists()) {
      ((File)localObject4).mkdirs();
    }
    if (wVz == null) {
      wVz = new DexClassLoader((String)localObject2, (String)localObject3, null, paramContext.getClassLoader());
    }
    ...
    paramString = wVz.loadClass("com.tencent.tbs.debug.plugin.DebugView").getConstructor(new Class[] { Context.class, Map.class }).newInstance(new Object[] { paramContext, localObject2 });
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/utils/e.class
