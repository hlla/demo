...
public final class h
{
  ...
  public static void a(java.io.File paramFile, String paramString1, byte[] paramArrayOfByte, String paramString2)
  {
    ...
    //   6: aload_1
    //   7: aload_3
    //   8: invokestatic 19	com/tencent/smtt/utils/h:fg	(Ljava/lang/String;Ljava/lang/String;)[B
    //   11: astore 4
    //   13: aload 5
    //   15: astore_1
    //   16: aload 4
    ...
    //   68: pop
    //   69: getstatic 10	com/tencent/smtt/utils/h:wUw	Ljava/io/OutputStream;
    //   72: ifnonnull +22 -> 94
    ...
    //   91: putstatic 10	com/tencent/smtt/utils/h:wUw	Ljava/io/OutputStream;
    //   94: aload_3
    //   95: ifnull +31 -> 126
    //   98: getstatic 10	com/tencent/smtt/utils/h:wUw	Ljava/io/OutputStream;
    //   101: aload_3
    //   102: invokevirtual 64	java/lang/String:getBytes	()[B
    //   105: invokevirtual 70	java/io/OutputStream:write	([B)V
    //   108: getstatic 10	com/tencent/smtt/utils/h:wUw	Ljava/io/OutputStream;
    //   111: astore_0
    //   112: aload_0
    //   113: ifnull +9 -> 122
    //   116: getstatic 10	com/tencent/smtt/utils/h:wUw	Ljava/io/OutputStream;
    //   119: invokevirtual 73	java/io/OutputStream:flush	()V
    //   122: ldc 2
    //   124: monitorexit
    //   125: return
    //   126: getstatic 10	com/tencent/smtt/utils/h:wUw	Ljava/io/OutputStream;
    //   129: aload_2
    //   130: invokevirtual 70	java/io/OutputStream:write	([B)V
    //   133: getstatic 10	com/tencent/smtt/utils/h:wUw	Ljava/io/OutputStream;
    //   136: aload_1
    //   137: invokevirtual 70	java/io/OutputStream:write	([B)V
    //   140: getstatic 10	com/tencent/smtt/utils/h:wUw	Ljava/io/OutputStream;
    //   143: iconst_2
    ...
    //   159: goto -51 -> 108
    //   162: astore_0
    //   163: getstatic 10	com/tencent/smtt/utils/h:wUw	Ljava/io/OutputStream;
    //   166: astore_0
    //   167: aload_0
    //   168: ifnull -46 -> 122
    //   171: getstatic 10	com/tencent/smtt/utils/h:wUw	Ljava/io/OutputStream;
    //   174: invokevirtual 73	java/io/OutputStream:flush	()V
    //   177: goto -55 -> 122
    //   180: astore_0
    //   181: goto -59 -> 122
    //   184: astore_0
    //   185: getstatic 10	com/tencent/smtt/utils/h:wUw	Ljava/io/OutputStream;
    //   188: astore_1
    //   189: aload_1
    //   190: ifnull +9 -> 199
    //   193: getstatic 10	com/tencent/smtt/utils/h:wUw	Ljava/io/OutputStream;
  ...
  private static byte[] fg(String paramString1, String paramString2)
  {
    try
    {
  ...
  private static byte[] fh(String paramString1, String paramString2)
  {
    try
    {
      paramString2 = paramString2.getBytes("UTF-8");
  ...
  public static byte[] fi(String paramString1, String paramString2)
  {
    try
    {
      paramString1 = fh(paramString1, paramString2);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/utils/h.class
