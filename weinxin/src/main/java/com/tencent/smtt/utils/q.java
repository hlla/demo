...
{
  private static q wWn = null;
  private Context mContext = null;
  private File wWm = null;
  public String wWo = "http://log.tbs.qq.com/ajax?c=pu&v=2&k=";
  public String wWp = "http://log.tbs.qq.com/ajax?c=pu&tk=";
  private String wWq = "http://wup.imtt.qq.com:8080";
  public String wWr = "http://log.tbs.qq.com/ajax?c=dl&k=";
  public String wWs = "http://cfg.imtt.qq.com/tbs?v=2&mk=";
  public String wWt = "http://log.tbs.qq.com/ajax?c=ul&v=2&k=";
  private String wWu = "http://mqqad.html5.qq.com/adjs";
  private String wWv = "http://log.tbs.qq.com/ajax?c=ucfu&k=";
  ...
  private void cfn()
  {
    ...
    //   3: astore_1
    //   4: aload_0
    //   5: invokespecial 97	com/tencent/smtt/utils/q:cfo	()Ljava/io/File;
    //   8: astore_2
    //   9: aload_2
    //   10: ifnonnull +13 -> 23
    //   13: ldc 69
    ...
    //   70: aload_0
    //   71: aload_3
    //   72: putfield 39	com/tencent/smtt/utils/q:wWo	Ljava/lang/String;
    //   75: aload_1
    //   76: ldc -122
    //   78: ldc 122
    ...
    //   93: aload_0
    //   94: aload_3
    //   95: putfield 47	com/tencent/smtt/utils/q:wWq	Ljava/lang/String;
    //   98: aload_1
    //   99: ldc -120
    //   101: ldc 122
    ...
    //   116: aload_0
    //   117: aload_3
    //   118: putfield 51	com/tencent/smtt/utils/q:wWr	Ljava/lang/String;
    //   121: aload_1
    //   122: ldc -118
    //   124: ldc 122
    ...
    //   139: aload_0
    //   140: aload_3
    //   141: putfield 55	com/tencent/smtt/utils/q:wWs	Ljava/lang/String;
    //   144: aload_1
    //   145: ldc -116
    //   147: ldc 122
    ...
    //   162: aload_0
    //   163: aload_3
    //   164: putfield 59	com/tencent/smtt/utils/q:wWt	Ljava/lang/String;
    //   167: aload_1
    //   168: ldc -114
    //   170: ldc 122
    ...
    //   185: aload_0
    //   186: aload_3
    //   187: putfield 63	com/tencent/smtt/utils/q:wWu	Ljava/lang/String;
    //   190: aload_1
    //   191: ldc -112
    //   193: ldc 122
    ...
    //   208: aload_0
    //   209: aload_3
    //   210: putfield 67	com/tencent/smtt/utils/q:wWv	Ljava/lang/String;
    //   213: aload_1
    //   214: ldc -110
    //   216: ldc 122
    ...
    //   231: aload_0
    //   232: aload_1
    //   233: putfield 43	com/tencent/smtt/utils/q:wWp	Ljava/lang/String;
    //   236: aload_2
  ...
  private File cfo()
  {
    try
    {
      if (this.wWm == null)
      {
        this.wWm = new File(f.al(this.mContext, 5));
        if ((this.wWm == null) || (!this.wWm.isDirectory())) {
          break label177;
        }
      }
      localFile = new File(this.wWm, "tbsnet.conf");
      if (!localFile.exists())
      {
  ...
  public static q gZ(Context paramContext)
  {
    try
    {
      if (wWn == null) {
        wWn = new q(paramContext);
      }
      paramContext = wWn;
      return paramContext;
    }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/utils/q.class
