...
public final class g
{
  public static String a(String paramString, byte[] paramArrayOfByte, a parama, boolean paramBoolean)
  {
    ...
    try
    {
      String str = k.cfg().cfi();
      str = paramString + str;
      if (paramBoolean) {}
      try
      {
        paramString = a.k(k.cfg().wVX.getBytes(), paramArrayOfByte);
      ...
      do
      {
        ...
        str = j.cfe();
        break;
        paramString = j.cfd().bA(paramArrayOfByte);
        paramArrayOfByte = paramString;
        break label53;
  ...
  public static String a(HttpURLConnection paramHttpURLConnection, a parama, boolean paramBoolean)
  {
    ...
    //   99: astore 4
    //   101: aload_0
    //   102: invokestatic 139	com/tencent/smtt/utils/g:h	(Ljava/io/Closeable;)V
    //   105: aload_1
    //   106: invokestatic 139	com/tencent/smtt/utils/g:h	(Ljava/io/Closeable;)V
    //   109: aconst_null
    //   110: areturn
    //   111: aload_0
    //   112: ifnull +40 -> 152
    ...
    //   174: astore 4
    //   176: aload_0
    //   177: invokestatic 139	com/tencent/smtt/utils/g:h	(Ljava/io/Closeable;)V
    //   180: aload_1
    //   181: invokestatic 139	com/tencent/smtt/utils/g:h	(Ljava/io/Closeable;)V
    //   184: aload 4
    //   186: areturn
    //   187: invokestatic 55	com/tencent/smtt/utils/j:cfd	()Lcom/tencent/smtt/utils/j;
    //   190: pop
    //   191: new 39	java/lang/String
    //   194: dup
    //   195: aload_1
    //   196: invokevirtual 154	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   199: invokestatic 162	com/tencent/smtt/utils/j:bB	([B)[B
    ...
    //   212: astore_0
    //   213: aload_0
    //   214: invokestatic 139	com/tencent/smtt/utils/g:h	(Ljava/io/Closeable;)V
    //   217: aload 4
    //   219: invokestatic 139	com/tencent/smtt/utils/g:h	(Ljava/io/Closeable;)V
    //   222: aload_1
    //   223: athrow
    //   224: astore_1
    //   225: goto -12 -> 213
  ...
  /* Error */
  public static HttpURLConnection p(String paramString, Map<String, String> paramMap)
  {
    // Byte code:
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/utils/g.class
