...
public final class c
{
  ...
  public static String wVs = "";
  public static String wVt = "";
  public static String wVu = "";
  ...
  private static String H(File paramFile)
  {
    for (;;)
    {
      try
      {
        ...
        String str1 = bz(a(localJarFile, paramFile, arrayOfByte)[0].getEncoded());
        ...
        if (localEnumeration.hasMoreElements())
        {
          ...
          if (paramFile != null)
          {
            paramFile = bz(paramFile[0].getEncoded());
            if (paramFile == null)
            {
  ...
  private static PackageInfo Vt(String paramString)
  {
    for (;;)
    {
      int i;
  ...
  private static String b(Context paramContext, File paramFile, boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      paramContext = Vt(paramFile.getAbsolutePath());
  ...
  public static String bC(Context paramContext, String paramString)
  {
    // Byte code:
    //   0: aload_0
    //   1: invokevirtual 249	android/content/Context:getPackageName	()Ljava/lang/String;
    //   4: astore_2
    //   5: aload_0
    //   6: invokevirtual 228	android/content/Context:getPackageManager	()Landroid/content/pm/PackageManager;
    //   9: aload_2
    //   10: sipush 128
    //   13: invokevirtual 253	android/content/pm/PackageManager:getApplicationInfo	(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    //   16: getfield 259	android/content/pm/ApplicationInfo:metaData	Landroid/os/Bundle;
    //   19: aload_1
    //   20: invokevirtual 264	android/os/Bundle:get	(Ljava/lang/String;)Ljava/lang/Object;
    //   23: invokestatic 267	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   26: astore_0
    //   27: aload_0
    //   28: invokestatic 270	java/lang/Integer:parseInt	(Ljava/lang/String;)I
    //   31: invokestatic 274	java/lang/Integer:toHexString	(I)Ljava/lang/String;
    //   34: invokestatic 267	java/lang/String:valueOf	(Ljava/lang/Object;)Ljava/lang/String;
    //   37: astore_1
    //   38: aload_1
    //   39: areturn
    //   40: astore_0
  ...
  private static String bz(byte[] paramArrayOfByte)
  {
  ...
  {
    // Byte code:
    //   0: getstatic 20	com/tencent/smtt/utils/c:wVt	Ljava/lang/String;
    //   3: invokestatic 95	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   6: ifne +9 -> 15
    //   9: getstatic 20	com/tencent/smtt/utils/c:wVt	Ljava/lang/String;
    //   12: astore_0
    //   13: aload_0
    //   14: areturn
    ...
    //   64: astore_2
    //   65: ldc_w 319
    //   68: invokestatic 321	com/tencent/smtt/utils/c:Vo	(Ljava/lang/String;)Ljava/lang/String;
    //   71: astore 4
    //   73: aload 4
    //   75: astore_2
    //   76: aload_0
    ...
    //   99: invokestatic 321	com/tencent/smtt/utils/c:Vo	(Ljava/lang/String;)Ljava/lang/String;
    //   102: astore 4
    //   104: aload 4
    //   106: astore_2
    //   107: goto -31 -> 76
    ...
    //   125: invokestatic 321	com/tencent/smtt/utils/c:Vo	(Ljava/lang/String;)Ljava/lang/String;
    //   128: astore 4
    //   130: aload 4
    //   132: astore_2
    //   133: aload_0
  ...
  {
    if (!TextUtils.isEmpty(wVu)) {
      return wVu;
    }
    try
    {
      wVu = Settings.Secure.getString(paramContext.getContentResolver(), "android_id");
      return wVu;
    }
    catch (Exception paramContext)
    {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/utils/c.class
