...
public final class r
{
  ...
  private void cfn()
  {
    ...
    //   3: astore_2
    //   4: aload_0
    //   5: getfield 33	com/tencent/smtt/utils/r:wWz	Ljava/io/File;
    //   8: ifnonnull +11 -> 19
    //   11: aload_0
    //   12: aload_0
    //   13: invokespecial 50	com/tencent/smtt/utils/r:cfo	()Ljava/io/File;
    //   16: putfield 33	com/tencent/smtt/utils/r:wWz	Ljava/io/File;
    //   19: aload_0
    //   20: getfield 33	com/tencent/smtt/utils/r:wWz	Ljava/io/File;
    //   23: astore_1
    //   24: aload_1
    //   25: ifnonnull +6 -> 31
    //   28: aload_0
    ...
    //   38: dup
    //   39: aload_0
    //   40: getfield 33	com/tencent/smtt/utils/r:wWz	Ljava/io/File;
    ...
    //   86: putfield 29	com/tencent/smtt/utils/r:wWw	Z
    //   89: aload_1
  ...
  private File cfo()
  {
    try
    {
      if (this.wWm == null)
      {
        this.wWm = new File(this.mContext.getDir("tbs", 0), "core_private");
        if (this.wWm == null) {
          break label87;
        }
        if (!this.wWm.isDirectory()) {
          return null;
        }
      }
      File localFile2 = new File(this.wWm, "debug.conf");
  ...
  public static r ha(Context paramContext)
  {
    try
    {
      if (wWy == null) {
        wWy = new r(paramContext);
      }
      paramContext = wWy;
      return paramContext;
    }
  ...
  public final void mc(boolean paramBoolean)
  {
    ...
    //   5: aload_0
    //   6: iload_1
    //   7: putfield 31	com/tencent/smtt/utils/r:wWx	Z
    //   10: aload_0
    //   11: invokespecial 50	com/tencent/smtt/utils/r:cfo	()Ljava/io/File;
    //   14: astore 5
    //   16: aload 5
    //   18: ifnonnull +19 -> 37
    ...
    //   71: ldc 68
    //   73: aload_0
    //   74: getfield 29	com/tencent/smtt/utils/r:wWw	Z
    ...
    //   86: ldc -121
    //   88: aload_0
    //   89: getfield 31	com/tencent/smtt/utils/r:wWx	Z
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/smtt/utils/r.class
