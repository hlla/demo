  ...
  extends q
{
  ...
  {
    return (s.k(this.context, "android.permission.WRITE_EXTERNAL_STORAGE")) && (Environment.getExternalStorageState().equals("mounted"));
  }
  ...
  protected final String nL()
  {
    for (;;)
    {
      ...
      try
      {
        ...
        try
        {
          localObject1 = c.c((File)localObject1).iterator();
  ...
  protected final void write(String paramString)
  {
    ...
    //   20: ldc 112
    //   22: invokestatic 54	com/tencent/b/a/a/s:decode	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   31: invokestatic 119	com/tencent/b/a/a/c:aG	(Ljava/lang/String;)Ljava/io/File;
    //   34: pop
    //   35: new 44	java/io/File
    //   38: dup
    //   39: invokestatic 48	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   42: ldc 50
    //   44: invokestatic 54	com/tencent/b/a/a/s:decode	(Ljava/lang/String;)Ljava/lang/String;
    ...
    //   71: dup
    //   72: ldc 86
    //   74: invokestatic 54	com/tencent/b/a/a/s:decode	(Ljava/lang/String;)Ljava/lang/String;
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/b/a/a/d.class
