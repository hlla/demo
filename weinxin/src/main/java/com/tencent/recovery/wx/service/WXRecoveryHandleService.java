  ...
  extends RecoveryHandleService
{
  ...
  private RecoveryHandleItem a(RecoveryData paramRecoveryData, String paramString)
  {
    ...
    localRecoveryHandleItem.mpX = paramRecoveryData.mpX;
    ...
    localRecoveryHandleItem.arH = paramString;
    localRecoveryHandleItem.processName = paramRecoveryData.processName;
    paramRecoveryData = NetUtil.fv(this);
    boolean bool1 = this.rSf.isScreenOn();
    boolean bool2 = UV("dldir1.qq.com");
    boolean bool3 = UV("www.qq.com");
    localRecoveryHandleItem.wOm = (paramRecoveryData + "|" + bool1 + "|" + bool2 + "|" + bool3);
  ...
  private static String a(String paramString, RecoveryHandleItem paramRecoveryHandleItem)
  {
    ...
    //   107: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   110: aconst_null
    //   111: areturn
    //   112: astore_0
    //   113: aconst_null
    ...
    //   149: goto -99 -> 50
    //   152: aload_0
    //   153: invokestatic 167	com/tencent/recovery/wx/util/WXUtil:UW	(Ljava/lang/String;)Ljava/lang/String;
    //   156: astore_0
    ...
    //   208: aload_1
    //   209: iload_2
    //   210: invokestatic 199	com/tencent/recovery/wx/util/WXUtil:CK	(I)Ljava/lang/String;
    //   213: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   216: aconst_null
    //   217: astore 6
    //   219: aconst_null
    //   220: astore 4
    ...
    //   258: aload_1
    //   259: ldc -48
    //   261: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   264: aconst_null
    //   265: astore 4
    //   267: aload_0
    //   268: astore 6
    ...
    //   284: aload_1
    //   285: ldc -45
    //   287: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   290: aload_0
    //   291: astore 6
    //   293: aload 5
    //   295: astore 4
    ...
    //   349: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   352: aload_0
    //   353: ifnull +7 -> 360
    //   356: aload_0
    ...
    //   390: aload_1
    //   391: ldc -32
    //   393: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   396: aload_0
    //   397: astore 6
    //   399: aload 5
    //   401: astore 4
    ...
    //   498: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   501: aconst_null
    //   502: areturn
    //   503: astore_0
    //   504: aload_3
  ...
  private static byte[] a(String paramString1, String paramString2, RecoveryHandleItem paramRecoveryHandleItem)
  {
    ...
    //   87: areturn
    //   88: aload_0
    //   89: invokestatic 167	com/tencent/recovery/wx/util/WXUtil:UW	(Ljava/lang/String;)Ljava/lang/String;
    //   92: astore_0
    ...
    //   144: aload_2
    //   145: iload_3
    //   146: invokestatic 235	com/tencent/recovery/wx/util/WXUtil:CL	(I)Ljava/lang/String;
    //   149: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   152: aconst_null
    //   153: astore 4
    //   155: aload 6
    //   157: astore_1
    ...
    //   193: aload_2
    //   194: ldc -19
    //   196: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   199: aload 6
    //   201: astore_1
    //   202: goto -44 -> 158
    //   205: astore 5
    ...
    //   254: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   257: aload 4
    //   259: ifnull +8 -> 267
    //   262: aload 4
    ...
    //   291: aload_2
    //   292: ldc -13
    //   294: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   297: aload 5
    //   299: astore_1
    //   300: goto -142 -> 158
    //   303: aload 5
    ...
    //   309: aload_2
    //   310: ldc -11
    //   312: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   315: aload 5
    //   317: astore_1
    //   318: goto -160 -> 158
    //   321: aload 5
    ...
    //   333: aload_2
    //   334: ldc -5
    //   336: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   339: aload 6
    //   341: astore_1
    //   342: goto -184 -> 158
    //   345: astore 6
  ...
  protected final com.tencent.recovery.model.RecoveryHandleResult a(android.content.Context paramContext, RecoveryData paramRecoveryData, ArrayList<RecoveryHandleItem> paramArrayList, boolean paramBoolean)
  {
    ...
    //   56: ifeq +500 -> 556
    //   59: aload_2
    //   60: getfield 298	com/tencent/recovery/model/RecoveryData:wOk	Ljava/lang/String;
    //   63: astore_2
    //   64: ldc -115
    //   66: ldc_w 300
    //   69: iconst_1
    ...
    //   160: astore_2
    //   161: aload_0
    //   162: invokestatic 329	com/tencent/recovery/util/Util:fs	(Landroid/content/Context;)I
    //   165: iload 5
    //   167: irem
    //   168: iload 6
    ...
    //   294: aload_1
    //   295: aload 10
    //   297: invokestatic 362	com/tencent/recovery/wx/RecoveryTinkerManager:br	(Landroid/content/Context;Ljava/lang/String;)I
    //   300: istore 5
    //   302: iload 5
    //   304: ifeq +111 -> 415
    //   307: aload 9
    ...
    //   332: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   335: ldc -115
    //   337: ldc_w 369
    //   340: iconst_1
    ...
    //   355: aload 8
    //   357: iconst_1
    //   358: putfield 378	com/tencent/recovery/model/RecoveryHandleResult:fDL	Z
    //   361: aload_3
    //   362: aload 9
    ...
    //   415: aload 9
    //   417: ldc_w 380
    //   420: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   423: ldc -115
    //   425: ldc_w 382
    //   428: iconst_0
    ...
    //   438: aload 9
    //   440: ldc_w 384
    //   443: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   446: ldc -115
    //   448: ldc_w 386
    //   451: iconst_0
    ...
    //   488: aload 9
    //   490: ldc_w 392
    //   493: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   496: goto -135 -> 361
    //   499: ldc -115
    //   501: ldc_w 394
    //   504: iconst_0
    ...
    //   511: aload 9
    //   513: ldc_w 396
    //   516: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   519: goto -158 -> 361
    //   522: ldc -115
    //   524: ldc_w 398
    //   527: iconst_0
    ...
    //   534: aload 9
    //   536: getfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   539: invokestatic 401	com/tencent/recovery/util/Util:mA	(Ljava/lang/String;)Z
    //   542: ifeq -181 -> 361
    //   545: aload 9
    //   547: ldc_w 403
    //   550: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   553: goto -192 -> 361
    //   556: ldc -115
    //   558: ldc_w 405
    //   561: iconst_0
    ...
    //   573: aload 8
    //   575: iconst_1
    //   576: putfield 408	com/tencent/recovery/model/RecoveryHandleResult:wOn	Z
    //   579: aload 9
    //   581: ldc_w 272
    //   584: iconst_2
    ...
    //   605: putfield 54	com/tencent/recovery/model/RecoveryHandleItem:arH	Ljava/lang/String;
    //   608: goto -247 -> 361
    //   611: astore_2
    //   612: goto -326 -> 286
    //   615: astore_2
  ...
  public void onCreate()
  {
    ...
    this.rSf = ((PowerManager)getSystemService("power"));
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/recovery/wx/service/WXRecoveryHandleService.class
