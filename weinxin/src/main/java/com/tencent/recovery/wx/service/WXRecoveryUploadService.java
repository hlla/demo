  ...
  extends RecoveryUploadService
{
  ...
  private boolean pushData(JSONArray paramJSONArray, String paramString)
  {
    try
    {
      Object localObject1 = WXUtil.fx(this);
      ...
      String str = EncryptUtil.n(String.format("weixin#$()%d%d", new Object[] { Integer.decode(paramString), Integer.valueOf(i) }).getBytes()).toLowerCase();
  ...
  protected boolean tryToUploadData()
  {
    ...
    if ((((List)localObject).size() == 0) || (bool)) {
      RecoveryReporter.bq(this, "HandleStatus");
    }
    return bool;
  }
  ...
  protected boolean uploadData(List<RecoveryHandleItem> paramList)
  {
    ...
    Object localObject1 = "0x26050D33";
    ...
    for (;;)
    {
      try
      {
        localJSONArray.put(new JSONObject().put("tag", "RecoveryHandle").put("info", ((RecoveryHandleItem)localObject2).arH).put("uin", ((RecoveryHandleItem)localObject2).mpX).put("deviceUUID", i).put("time", Util.eY(((RecoveryHandleItem)localObject2).timestamp)).put("cver", ((RecoveryHandleItem)localObject2).clientVersion).put("processName", ((RecoveryHandleItem)localObject2).processName).put("phoneStatus", ((RecoveryHandleItem)localObject2).wOm));
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/recovery/wx/service/WXRecoveryUploadService.class
