...
{
  private static volatile boolean fBe;
  ...
  protected final void onHandleIntent(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        for (;;)
        {
          RecoveryLog.i("Recovery.RecoveryHandleService", "start to handle %s's exception uuid: %s threadId: %d", new Object[] { localRecoveryData.processName, localRecoveryData.mpX, Long.valueOf(Thread.currentThread().getId()) });
          ...
          if ((paramIntent.wOn) && (!bool))
          {
            ...
            localObject2 = OptionFactory.fq(this);
            localObject1 = PendingIntent.getService(this, 1000002, (Intent)localObject1, 0);
            l = System.currentTimeMillis() + ((CommonOptions)localObject2).wOs - 2000L;
            ((AlarmManager)getSystemService("alarm")).set(0, l, (PendingIntent)localObject1);
            RecoveryLog.i("Recovery.RecoveryHandleService", "startAlarm pendingIntent success: %d will retry %s", new Object[] { Integer.valueOf(((PendingIntent)localObject1).hashCode()), Util.eY(l) });
          }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/recovery/service/RecoveryHandleService.class
