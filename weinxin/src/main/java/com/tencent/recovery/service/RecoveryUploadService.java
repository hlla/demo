  ...
  extends IntentService
{
  ...
  public static void startAlarm(Context paramContext, String paramString)
  {
    ...
    //   2: monitorenter
    //   3: aload_1
    //   4: invokestatic 56	com/tencent/recovery/util/Util:mA	(Ljava/lang/String;)Z
    //   7: istore_2
    //   8: iload_2
    //   9: ifeq +7 -> 16
    //   12: ldc 2
    ...
    //   15: return
    //   16: aload_0
    //   17: invokestatic 62	com/tencent/recovery/option/OptionFactory:fq	(Landroid/content/Context;)Lcom/tencent/recovery/option/CommonOptions;
    //   20: astore 7
    //   22: aload_0
    //   23: ldc 64
    //   25: iconst_0
    ...
    //   60: iconst_1
    //   61: lload_3
    //   62: invokestatic 92	com/tencent/recovery/util/Util:eY	(J)Ljava/lang/String;
    //   65: aastore
    ...
    //   113: lsub
    //   114: aload 7
    //   116: getfield 104	com/tencent/recovery/option/CommonOptions:wOr	J
    //   119: lcmp
    //   120: ifle +122 -> 242
    //   123: aload_1
    //   124: ifnull +18 -> 142
    ...
    //   174: astore_1
    //   175: aload 7
    //   177: getfield 104	com/tencent/recovery/option/CommonOptions:wOr	J
    //   180: lload 5
    //   182: ladd
    //   183: ldc2_w 122
    //   186: lsub
    ...
    //   224: iconst_1
    //   225: lload_3
    //   226: invokestatic 92	com/tencent/recovery/util/Util:eY	(J)Ljava/lang/String;
    //   229: aastore
  ...
  public static void startAlarmAfter(Context paramContext, String paramString, long paramLong)
  {
    ...
    try
    {
      ...
      RecoveryLog.i("Recovery.RecoveryUploadService", "startAlarmAfter pendingIntent:%d %s", new Object[] { Integer.valueOf(paramString.hashCode()), Util.eY(paramLong) });
      return;
    }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/recovery/service/RecoveryUploadService.class
