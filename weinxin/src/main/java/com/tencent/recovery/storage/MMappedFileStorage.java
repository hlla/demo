...
public class MMappedFileStorage
{
  ...
  private File wOw;
  private File wOx;
  private MappedByteBuffer wOy;
  private RandomAccessFile wOz;
  
  public MMappedFileStorage(String paramString)
  {
    this.wOw = new File(paramString);
    this.wOx = new File(this.wOw.getParentFile(), "temp-" + this.wOw.getName());
    this.wOv = 153600;
    if (!this.wOw.getParentFile().exists()) {
      this.wOw.getParentFile().mkdirs();
    }
    if (this.wOx.exists())
    {
      f(this.wOx, this.wOw);
  ...
  /* Error */
  private static void f(File paramFile1, File paramFile2)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 6
  ...
  public final void c(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    ...
    //   1: monitorenter
    //   2: aload_0
    //   3: getfield 117	com/tencent/recovery/storage/MMappedFileStorage:wOz	Ljava/io/RandomAccessFile;
    //   6: ifnonnull +38 -> 44
    //   9: aload_0
    //   10: getfield 50	com/tencent/recovery/storage/MMappedFileStorage:wOx	Ljava/io/File;
    //   13: invokevirtual 57	java/io/File:exists	()Z
    //   16: ifne +11 -> 27
    //   19: aload_0
    //   20: getfield 50	com/tencent/recovery/storage/MMappedFileStorage:wOx	Ljava/io/File;
    ...
    //   31: dup
    //   32: aload_0
    //   33: getfield 50	com/tencent/recovery/storage/MMappedFileStorage:wOx	Ljava/io/File;
    //   36: ldc 124
    //   38: invokespecial 125	java/io/RandomAccessFile:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   41: putfield 117	com/tencent/recovery/storage/MMappedFileStorage:wOz	Ljava/io/RandomAccessFile;
    //   44: aload_0
    //   45: getfield 127	com/tencent/recovery/storage/MMappedFileStorage:wOy	Ljava/nio/MappedByteBuffer;
    //   48: ifnonnull +26 -> 74
    //   51: aload_0
    //   52: aload_0
    //   53: getfield 117	com/tencent/recovery/storage/MMappedFileStorage:wOz	Ljava/io/RandomAccessFile;
    ...
    //   62: lconst_0
    //   63: aload_0
    //   64: getfield 53	com/tencent/recovery/storage/MMappedFileStorage:wOv	I
    //   67: i2l
    ...
    //   71: putfield 127	com/tencent/recovery/storage/MMappedFileStorage:wOy	Ljava/nio/MappedByteBuffer;
    //   74: aload_0
    //   75: getfield 50	com/tencent/recovery/storage/MMappedFileStorage:wOx	Ljava/io/File;
    //   78: ifnull +12 -> 90
    //   81: aload_0
    //   82: getfield 127	com/tencent/recovery/storage/MMappedFileStorage:wOy	Ljava/nio/MappedByteBuffer;
    //   85: astore_3
    //   86: aload_3
    //   87: ifnonnull +6 -> 93
    //   90: aload_0
    ...
    //   99: iadd
    //   100: aload_0
    //   101: getfield 53	com/tencent/recovery/storage/MMappedFileStorage:wOv	I
    //   104: if_icmpgt +7 -> 111
    //   107: iload_2
    //   108: ifeq +104 -> 212
    //   111: aload_0
    //   112: getfield 127	com/tencent/recovery/storage/MMappedFileStorage:wOy	Ljava/nio/MappedByteBuffer;
    //   115: invokevirtual 151	java/nio/MappedByteBuffer:force	()Ljava/nio/MappedByteBuffer;
    //   118: pop
    //   119: aload_0
    //   120: getfield 117	com/tencent/recovery/storage/MMappedFileStorage:wOz	Ljava/io/RandomAccessFile;
    //   123: invokevirtual 152	java/io/RandomAccessFile:close	()V
    //   126: aload_0
    //   127: getfield 50	com/tencent/recovery/storage/MMappedFileStorage:wOx	Ljava/io/File;
    //   130: aload_0
    //   131: getfield 25	com/tencent/recovery/storage/MMappedFileStorage:wOw	Ljava/io/File;
    //   134: invokestatic 64	com/tencent/recovery/storage/MMappedFileStorage:f	(Ljava/io/File;Ljava/io/File;)V
    //   137: aload_0
    //   138: iconst_4
    //   139: putfield 145	com/tencent/recovery/storage/MMappedFileStorage:currentIndex	I
    //   142: aload_0
    //   143: getfield 50	com/tencent/recovery/storage/MMappedFileStorage:wOx	Ljava/io/File;
    //   146: invokevirtual 67	java/io/File:delete	()Z
    //   149: pop
    //   150: aload_0
    //   151: getfield 50	com/tencent/recovery/storage/MMappedFileStorage:wOx	Ljava/io/File;
    ...
    //   162: dup
    //   163: aload_0
    //   164: getfield 50	com/tencent/recovery/storage/MMappedFileStorage:wOx	Ljava/io/File;
    //   167: ldc 124
    //   169: invokespecial 125	java/io/RandomAccessFile:<init>	(Ljava/io/File;Ljava/lang/String;)V
    //   172: putfield 117	com/tencent/recovery/storage/MMappedFileStorage:wOz	Ljava/io/RandomAccessFile;
    //   175: aload_0
    //   176: aload_0
    //   177: getfield 117	com/tencent/recovery/storage/MMappedFileStorage:wOz	Ljava/io/RandomAccessFile;
    ...
    //   186: lconst_0
    //   187: aload_0
    //   188: getfield 53	com/tencent/recovery/storage/MMappedFileStorage:wOv	I
    //   191: i2l
    ...
    //   195: putfield 127	com/tencent/recovery/storage/MMappedFileStorage:wOy	Ljava/nio/MappedByteBuffer;
    //   198: aload_0
    //   199: getfield 127	com/tencent/recovery/storage/MMappedFileStorage:wOy	Ljava/nio/MappedByteBuffer;
    //   202: aload_0
    ...
    //   214: iflt -124 -> 90
    //   217: aload_0
    //   218: getfield 127	com/tencent/recovery/storage/MMappedFileStorage:wOy	Ljava/nio/MappedByteBuffer;
    //   221: aload_0
    ...
    //   228: pop
    //   229: aload_0
    //   230: getfield 127	com/tencent/recovery/storage/MMappedFileStorage:wOy	Ljava/nio/MappedByteBuffer;
    //   233: aload_1
    //   234: invokevirtual 164	java/nio/MappedByteBuffer:put	([B)Ljava/nio/ByteBuffer;
    //   237: pop
    //   238: aload_0
    //   239: getfield 127	com/tencent/recovery/storage/MMappedFileStorage:wOy	Ljava/nio/MappedByteBuffer;
    //   242: iconst_0
    ...
    //   258: aload_0
    //   259: getfield 127	com/tencent/recovery/storage/MMappedFileStorage:wOy	Ljava/nio/MappedByteBuffer;
    //   262: aload_0
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/recovery/storage/MMappedFileStorage.class
