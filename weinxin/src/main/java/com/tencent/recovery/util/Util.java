...
public class Util
{
  ...
  public static final int fs(Context paramContext)
  {
  ...
  {
    return q(paramContext, Process.myPid());
  }
  ...
  private static String q(Context paramContext, int paramInt)
  {
    if (!mA(processName)) {
      return processName;
    }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/recovery/util/Util.class
