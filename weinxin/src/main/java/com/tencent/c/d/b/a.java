...
{
  private static final byte[] wQd = { 127, 69, 76, 70 };
  
  public static boolean UY(String paramString)
  {
    byte[] arrayOfByte = new byte[wQd.length];
    try
    {
      localFileInputStream = new FileInputStream(paramString);
      try
      {
        if (localFileInputStream.read(arrayOfByte, 0, wQd.length) == arrayOfByte.length) {
          break label70;
        }
  ...
  /* Error */
  public static byte[] Va(String paramString)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore_2
    ...
    //   23: aload_0
    //   24: aload_3
    //   25: invokestatic 66	com/tencent/c/d/b/b:b	(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    //   28: pop2
    //   29: aload_3
    //   30: invokevirtual 70	java/io/ByteArrayOutputStream:toByteArray	()[B
    //   33: astore_1
    //   34: aload_1
    //   35: ifnull +13 -> 48
    //   38: aload_0
    //   39: invokestatic 51	com/tencent/c/d/b/b:c	(Ljava/io/Closeable;)V
    //   42: aload_3
    //   43: invokestatic 51	com/tencent/c/d/b/b:c	(Ljava/io/Closeable;)V
    //   46: aload_1
    //   47: areturn
    //   48: ldc 72
    //   50: invokevirtual 77	java/lang/String:getBytes	()[B
    //   53: astore_1
    //   54: goto -16 -> 38
    //   57: astore_0
    //   58: aconst_null
    //   59: astore_1
    //   60: aload_2
    //   61: invokestatic 51	com/tencent/c/d/b/b:c	(Ljava/io/Closeable;)V
    //   64: aload_1
    //   65: invokestatic 51	com/tencent/c/d/b/b:c	(Ljava/io/Closeable;)V
    //   68: aload_0
    //   69: athrow
    //   70: astore_3
    //   71: aconst_null
  ...
  /* Error */
  public static byte[] di(String paramString, int paramInt)
  {
    // Byte code:
    //   0: iconst_0
    //   1: istore_2
    ...
    //   67: ifne +9 -> 76
    //   70: aload_0
    //   71: invokestatic 51	com/tencent/c/d/b/b:c	(Ljava/io/Closeable;)V
    //   74: aconst_null
    //   75: areturn
    //   76: iload_3
    //   77: iload_1
    ...
    //   98: astore 5
    //   100: aload_0
    //   101: invokestatic 51	com/tencent/c/d/b/b:c	(Ljava/io/Closeable;)V
    //   104: aload 5
    //   106: areturn
    //   107: astore_0
    //   108: aconst_null
    //   109: astore_0
    //   110: aload_0
    //   111: invokestatic 51	com/tencent/c/d/b/b:c	(Ljava/io/Closeable;)V
    //   114: aconst_null
    //   115: areturn
    //   116: astore 5
    //   118: aconst_null
    //   119: astore_0
    //   120: aload_0
    //   121: invokestatic 51	com/tencent/c/d/b/b:c	(Ljava/io/Closeable;)V
    //   124: aload 5
    //   126: athrow
    //   127: astore 5
    //   129: goto -9 -> 120
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/c/d/b/a.class
