  ...
  extends c
{
  ...
  static
  {
    ...
    gaA = new String[] { "CREATE INDEX IF NOT EXISTS lbsverifymessage_unread_index ON LBSVerifyMessage(status)", "CREATE INDEX IF NOT EXISTS lbsverifymessage_createtimeIndex ON LBSVerifyMessage(createtime)" };
    gnj = "svrid".hashCode();
    gaP = "status".hashCode();
    gbQ = "type".hashCode();
    gci = "scene".hashCode();
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/e/b/bz.class
