...
public final class b
{
  ...
  static
  {
    ...
    uLL = Environment.getExternalStorageDirectory() + "/tencent/MicroMsg/memory/";
  ...
  private static boolean F(boolean paramBoolean1, boolean paramBoolean2)
  {
    ...
    Object localObject = new File(uLL);
  ...
  public static String G(boolean paramBoolean1, boolean paramBoolean2)
  {
    GMTrace.i(13151189860352L, 97984);
    if (!F(paramBoolean1, paramBoolean2))
    {
    ...
    ((StringBuffer)localObject).append(uLL).append(str).append(".hprof");
    localObject = ((StringBuffer)localObject).toString();
    if (!B(new File((String)localObject).getParentFile()))
    {
      v.i("MicroMsg.MemoryDumpManager", "failed to create dir for hprof file: %s", new Object[] { localObject });
      GMTrace.o(13151189860352L, 97984);
      return null;
    }
    try
    {
      ...
      v.i("MicroMsg.MemoryDumpManager", "dump file %s, use time %d", new Object[] { str, Long.valueOf(bf.aA(l)) });
      GMTrace.o(13151189860352L, 97984);
  ...
  {
    GMTrace.i(13151324078080L, 97985);
    if (!bNU())
    {
      GMTrace.o(13151324078080L, 97985);
      return null;
    }
    paramString = uLL + paramString + ".hprof";
    if (!B(new File(paramString).getParentFile()))
    {
      v.i("MicroMsg.MemoryDumpManager", "failed to create dir for hprof file: %s", new Object[] { paramString });
      GMTrace.o(13151324078080L, 97985);
      return null;
    }
    try
    {
      ...
      Toast.makeText(aa.getContext(), paramString + " hprof file has saved ", 0).show();
      GMTrace.o(13151324078080L, 97985);
      return paramString;
    }
    catch (Exception paramString)
    {
      v.printErrStackTrace("MicroMsg.MemoryDumpManager", paramString, "dumpHprofFile Exception", new Object[0]);
      GMTrace.o(13151324078080L, 97985);
    }
    return null;
  }
  ...
  public static String Sx(String paramString)
  {
    ...
    long l = System.currentTimeMillis();
    Object localObject = new StringBuffer();
    ((StringBuffer)localObject).append(uLL).append(paramString).append(".hprof");
    localObject = ((StringBuffer)localObject).toString();
    if (!B(new File((String)localObject).getParentFile()))
    {
      v.i("MicroMsg.MemoryDumpManager", "failed to create dir for hprof file: %s", new Object[] { localObject });
    ...
    try
    {
      ...
      Debug.dumpHprofData((String)localObject);
      Toast.makeText(aa.getContext(), (String)localObject + " hprof file has saved ", 0).show();
      v.i("MicroMsg.MemoryDumpManager", "dump file %s, use time %d", new Object[] { paramString, Long.valueOf(bf.aA(l)) });
  ...
  public static void bNW()
  {
    ...
    //   18: getstatic 281	android/os/Build$VERSION:SDK_INT	I
    //   21: bipush 14
    //   23: if_icmplt +16 -> 39
    //   26: invokestatic 284	com/tencent/mm/bl/b:bNX	()V
    //   29: ldc2_w 273
    //   32: ldc_w 275
    ...
    //   49: invokestatic 292	android/os/Process:myPid	()I
    ...
    //   58: astore_0
    //   59: invokestatic 261	java/lang/Runtime:getRuntime	()Ljava/lang/Runtime;
    //   62: aload_0
    //   63: invokevirtual 296	java/lang/Runtime:exec	(Ljava/lang/String;)Ljava/lang/Process;
    //   66: astore 5
    //   68: new 298	java/io/InputStreamReader
    //   71: dup
    //   72: aload 5
    //   74: invokevirtual 304	java/lang/Process:getInputStream	()Ljava/io/InputStream;
    //   77: invokespecial 307	java/io/InputStreamReader:<init>	(Ljava/io/InputStream;)V
    //   80: astore_0
    //   81: aload_0
    //   82: astore_3
    //   83: new 309	java/io/LineNumberReader
    //   86: dup
    //   87: aload_0
    //   88: invokespecial 312	java/io/LineNumberReader:<init>	(Ljava/io/Reader;)V
    //   91: astore_2
    //   92: aload_2
    //   93: invokevirtual 315	java/io/LineNumberReader:readLine	()Ljava/lang/String;
    //   96: astore_1
    //   97: aload_1
    //   98: ifnull +51 -> 149
    //   101: ldc 114
    //   103: aload_1
    //   104: invokestatic 252	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   107: goto -15 -> 92
    //   110: astore_1
    //   111: aload_0
    //   112: astore_1
    ...
    //   115: ldc 114
    //   117: ldc_w 317
    //   120: invokestatic 215	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   123: aload_0
    //   124: ifnull +7 -> 131
    //   127: aload_0
    //   128: invokevirtual 320	java/io/LineNumberReader:close	()V
    //   131: aload_1
    //   132: ifnull +7 -> 139
    //   135: aload_1
    //   136: invokevirtual 321	java/io/InputStreamReader:close	()V
    //   139: ldc2_w 273
    //   142: ldc_w 275
    //   145: invokestatic 46	com/tencent/gmtrace/GMTrace:o	(JI)V
    //   148: return
    //   149: aload 5
    //   151: invokevirtual 324	java/lang/Process:waitFor	()I
    //   154: pop
    //   155: aload 5
    //   157: invokevirtual 327	java/lang/Process:destroy	()V
    //   160: aload_2
    //   161: invokevirtual 320	java/io/LineNumberReader:close	()V
    //   164: aload_0
    //   165: invokevirtual 321	java/io/InputStreamReader:close	()V
    //   168: ldc2_w 273
    //   171: ldc_w 275
    ...
    //   208: ldc 114
    //   210: ldc_w 329
    //   213: invokestatic 215	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   216: aload_1
    //   217: ifnull +7 -> 224
    //   220: aload_1
    //   221: invokevirtual 320	java/io/LineNumberReader:close	()V
    //   224: aload_0
    //   225: ifnull +7 -> 232
    //   228: aload_0
    //   229: invokevirtual 321	java/io/InputStreamReader:close	()V
    //   232: ldc2_w 273
    //   235: ldc_w 275
    ...
    //   259: ifnull +7 -> 266
    //   262: aload_2
    //   263: invokevirtual 320	java/io/LineNumberReader:close	()V
    //   266: aload_0
    //   267: ifnull +7 -> 274
    //   270: aload_0
    //   271: invokevirtual 321	java/io/InputStreamReader:close	()V
    //   274: aload_1
    //   275: athrow
    //   276: astore_0
    //   277: goto -3 -> 274
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/bl/b.class
