...
{
  private static final HashMap<String, String> lXS;
  private static String[] lXT;
  
  static
  {
    GMTrace.i(18640023846912L, 138879);
    lXS = new HashMap();
    lXT = new String[] { "wxid_", "wx_", "gh_" };
  ...
  public static String X(String paramString, boolean paramBoolean)
  {
    ...
    Object localObject3 = wV(paramString).toLowerCase();
  ...
  public static final void aD(List<i> paramList)
  {
    ...
    while (paramList.hasNext())
    {
      ...
      if ((locali.userData instanceof String)) {
        lXS.put(locali.lYb, (String)locali.userData);
      } else {
        lXS.put(locali.lYb, "");
      }
    }
  ...
  public static final HashMap<String, String> axC()
  {
    GMTrace.i(18638010580992L, 138864);
    HashMap localHashMap = new HashMap();
    Iterator localIterator = lXS.entrySet().iterator();
  ...
  public static String k(int[] paramArrayOfInt)
  {
  ...
  public static final String s(String[] paramArrayOfString)
  {
  ...
  public static String wT(String paramString)
  {
    ...
    if (!bf.mA(localx.field_conRemarkPYFull))
    {
    ...
    if (!bf.mA(localx.pC()))
    {
      paramString = localx.pC();
      GMTrace.o(18637876363264L, 138863);
      return paramString;
    }
    if (!bf.mA(localx.pA()))
    {
      paramString = localx.pA();
      GMTrace.o(18637876363264L, 138863);
      return paramString;
    }
    GMTrace.o(18637876363264L, 138863);
  ...
  public static final String wV(String paramString)
  {
    ...
    paramString = SpellMap.mx(((a)com.tencent.mm.kernel.h.h(a.class)).bJ(paramString, "‎"));
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/plugin/fts/a/d.class
