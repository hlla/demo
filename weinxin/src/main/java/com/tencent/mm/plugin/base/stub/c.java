...
{
  private static final Map<String, Object> jNq;
  ...
  static
  {
    ...
    jNq = localHashMap;
    localHashMap.put("_build_info_sdk_int_", Integer.valueOf(620757000));
    jNq.put("_build_info_sdk_name_", "android 5.0.8");
    jNq.put("_wxapp_pay_entry_classname_", "com.tencent.mm.plugin.base.stub.WXPayEntryActivity");
  ...
  public static Cursor a(String[] paramArrayOfString1, String[] paramArrayOfString2)
  {
    ...
    Object localObject = jNq.get(paramArrayOfString2);
    if (localObject == null)
    {
  ...
  public final boolean bI(Context paramContext)
  {
    GMTrace.i(12837791465472L, 95649);
    super.bI(paramContext);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/plugin/base/stub/c.class
