...
public final class d
{
  ...
  private static final int ilx;
  private static final int ily;
  private static final int ilz;
  
  static
  {
    GMTrace.i(16390400507904L, 122118);
    ilo = J(new byte[] { 102, 114, 101, 101 });
    ilp = J(new byte[] { 106, 117, 110, 107 });
    ilq = J(new byte[] { 109, 100, 97, 116 });
    ilr = J(new byte[] { 109, 111, 111, 118 });
    ils = J(new byte[] { 112, 110, 111, 116 });
    ilt = J(new byte[] { 115, 107, 105, 112 });
    ilu = J(new byte[] { 119, 105, 100, 101 });
    ilv = J(new byte[] { 80, 73, 67, 84 });
    ilw = J(new byte[] { 102, 116, 121, 112 });
    ilx = J(new byte[] { 117, 117, 105, 100 });
    ily = J(new byte[] { 99, 109, 111, 118 });
    ilz = J(new byte[] { 115, 116, 99, 111 });
    ilA = J(new byte[] { 99, 111, 54, 52 });
  ...
  private static boolean a(FileChannel paramFileChannel1, FileChannel paramFileChannel2, PInt paramPInt)
  {
      ...
      if (a(paramFileChannel1, localByteBuffer))
      {
        ...
        if (m == ilw)
        {
          ...
          if (paramFileChannel1.read((ByteBuffer)localObject1) >= n - 8)
          {
            ...
            v.w("MicroMsg.FastStart", "atom size less 8, it error mp4.");
        ...
        else if (m == ilr)
        {
          ...
          if (j == 0)
          {
            v.d("MicroMsg.FastStart", "it moov before mdat, needn't fast start");
            paramPInt.value = 1;
            GMTrace.o(16390266290176L, 122117);
            return false;
          }
          v.d("MicroMsg.FastStart", "it moov after mdat, need fast start");
          j = 1;
          l4 = l2 - 8L;
          l2 = l1;
          k = m;
    ...
    for (;;)
    {
      if ((i == 0) || (j == 0))
      {
        v.w("MicroMsg.FastStart", "it can not find moov or ftyp");
        GMTrace.o(16390266290176L, 122117);
        return false;
        if (m == ilq) {
          j = 1;
      ...
      if ((k != ilr) || (l4 < 0L))
      {
        v.w("MicroMsg.FastStart", "it can not find moov atom");
        GMTrace.o(16390266290176L, 122117);
        return false;
      }
      j = aC(l2);
      ...
      for (i = 1; i == 0; i = 0)
      {
        v.w("MicroMsg.FastStart", "failed to read moov atom");
        GMTrace.o(16390266290176L, 122117);
        return false;
      }
      if (paramPInt.getInt(12) == ily)
      {
        v.w("MicroMsg.FastStart", "this utility does not support compressed moov atoms yet");
        GMTrace.o(16390266290176L, 122117);
        return false;
      }
      while (paramPInt.remaining() >= 8)
      {
        ...
        else
        {
          ...
          {
            v.w("MicroMsg.FastStart", "bad atom size");
            GMTrace.o(16390266290176L, 122117);
            return false;
          }
          ...
          {
            v.w("MicroMsg.FastStart", "malformed atom");
            GMTrace.o(16390266290176L, 122117);
            return false;
          }
          k = aC(paramPInt.getInt());
          if (i == ilz)
          {
            if (paramPInt.remaining() < k * 4)
            {
              v.w("MicroMsg.FastStart", "bad atom size/element count");
              GMTrace.o(16390266290176L, 122117);
              return false;
            }
            i = 0;
  ...
  private static boolean ar(String paramString1, String paramString2)
  {
    ...
    //   46: ldc -91
    //   48: ldc_w 271
    //   51: invokestatic 173	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   54: ldc2_w 261
    //   57: ldc_w 263
    ...
    //   72: aload_0
    //   73: invokevirtual 279	com/tencent/mm/plugin/a/b:mC	(Ljava/lang/String;)J
    //   76: lstore 4
    ...
    //   89: aload_0
    //   90: lload 4
    //   92: invokevirtual 286	com/tencent/mm/plugin/a/f:m	(Ljava/lang/String;J)Z
    //   95: pop
    //   96: aload 10
    //   98: getfield 289	com/tencent/mm/plugin/a/f:ilJ	I
    //   101: istore_3
    //   102: new 273	com/tencent/mm/plugin/a/b
    //   105: dup
    //   106: invokespecial 275	com/tencent/mm/plugin/a/b:<init>	()V
    //   109: aload_1
    //   110: invokevirtual 279	com/tencent/mm/plugin/a/b:mC	(Ljava/lang/String;)J
    //   113: lstore 4
    ...
    //   126: aload_1
    //   127: lload 4
    //   129: invokevirtual 286	com/tencent/mm/plugin/a/f:m	(Ljava/lang/String;J)Z
    //   132: pop
    //   133: aload 9
    //   135: getfield 289	com/tencent/mm/plugin/a/f:ilJ	I
    //   138: istore_2
    //   139: iload_2
    //   140: iload_3
    ...
    //   144: ldc -91
    //   146: ldc_w 291
    //   149: invokestatic 173	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   152: ldc2_w 261
    //   155: ldc_w 263
    ...
    //   192: invokestatic 178	com/tencent/mm/sdk/platformtools/v:d	(Ljava/lang/String;Ljava/lang/String;)V
    ...
    //   287: ldc -91
    //   289: ldc_w 321
    //   292: invokestatic 173	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   295: ldc2_w 261
    //   298: ldc_w 263
    ...
    //   392: ldc -91
    //   394: ldc_w 340
    //   397: invokestatic 173	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   400: aload 6
    ...
    //   470: invokestatic 173	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   473: aload_1
    //   474: ifnull +7 -> 481
    //   477: aload_1
  ...
  public static boolean b(String paramString1, String paramString2, PInt paramPInt)
  {
    ...
    //   83: aload_0
    //   84: aload_1
    //   85: invokestatic 363	com/tencent/mm/plugin/a/d:ar	(Ljava/lang/String;Ljava/lang/String;)Z
    //   88: istore 4
    //   90: aload 5
    ...
    //   153: invokestatic 173	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   156: aload_0
  ...
  private static void d(Closeable paramCloseable)
  {
    ...
    if (paramCloseable != null) {
      ...
      {
        v.w("MicroMsg.FastStart", "Failed to close file: ");
      }
    }
    GMTrace.o(16389997854720L, 122115);
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/plugin/a/d.class
