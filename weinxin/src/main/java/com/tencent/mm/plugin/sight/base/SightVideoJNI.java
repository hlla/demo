...
public class SightVideoJNI
{
  ...
  public static String getMp4RecordInfo(String paramString)
  {
    ...
    for (;;)
    {
      v.i("MicroMsg.SightVideoJNI", "getMp4RecordInfo, index: %s", new Object[] { Integer.valueOf(i) });
  ...
  public static void tagMP4Dscp(String paramString, byte[] paramArrayOfByte)
  {
    ...
    if ((bf.mA(paramString)) || (paramArrayOfByte == null))
    {
    ...
    v.i("MicroMsg.SightVideoJNI", "tagMP4Dscp used %sms", new Object[] { Long.valueOf(bf.aB(l)) });
    GMTrace.o(9383564017664L, 69913);
  }
  ...
  public static void tagMp4RecordInfo(String paramString1, String paramString2)
  {
    ...
    v.i("MicroMsg.SightVideoJNI", "tagMP4RecordInfo used %sms", new Object[] { Long.valueOf(bf.aB(l)) });
    GMTrace.o(9383295582208L, 69911);
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/plugin/sight/base/SightVideoJNI.class
