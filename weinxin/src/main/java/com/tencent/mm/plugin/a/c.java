...
public final class c
{
  ...
  public static a a(RandomAccessFile paramRandomAccessFile, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    catch (Exception paramRandomAccessFile)
    {
      for (;;)
      {
        ...
        int k;
        long l;
        v.printErrStackTrace("MicroMsg.AtomUtil", paramRandomAccessFile, "", new Object[0]);
        v.e("MicroMsg.AtomUtil", "find Atom error: " + paramRandomAccessFile.toString());
  ...
  public static boolean a(RandomAccessFile paramRandomAccessFile, long paramLong)
  {
    ...
    if (l != paramLong)
    {
      v.w("MicroMsg.AtomUtil", "can not skip.skip: " + paramLong + " trueSkip : " + l);
  ...
  public static boolean mD(String paramString)
  {
    ...
    //   8: aload_0
    //   9: invokestatic 166	com/tencent/mm/plugin/a/c:mA	(Ljava/lang/String;)Z
    //   12: ifeq +13 -> 25
    //   15: ldc2_w 162
    //   18: ldc -92
    ...
    //   23: iconst_0
    //   24: ireturn
    //   25: new 168	java/io/FileInputStream
    //   28: dup
    //   29: aload_0
    //   30: invokespecial 169	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   33: astore 4
    //   35: aload 4
    //   37: astore_0
    //   38: bipush 8
    ...
    //   51: iconst_0
    //   52: bipush 8
    //   54: invokevirtual 174	java/io/InputStream:read	([BII)I
    //   57: istore_1
    //   58: iload_1
    //   59: bipush 8
    //   61: if_icmpge +34 -> 95
    //   64: aload 4
    //   66: invokevirtual 178	java/io/InputStream:close	()V
    //   69: ldc2_w 162
    //   72: ldc -92
    ...
    //   89: invokestatic 69	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   92: goto -23 -> 69
    //   95: aload 4
    //   97: astore_0
    //   98: aload 5
    ...
    //   115: aload 4
    //   117: astore_0
    //   118: getstatic 181	com/tencent/mm/plugin/a/a:ijI	I
    //   121: istore_3
    //   122: iload_2
    //   123: iload_3
    ...
    //   156: invokestatic 69	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   159: goto -23 -> 136
    //   162: aload 4
    //   164: invokevirtual 178	java/io/InputStream:close	()V
    //   167: ldc2_w 162
    //   170: ldc -92
    ...
    //   187: invokestatic 69	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   190: goto -23 -> 167
    //   193: astore 5
    //   195: aconst_null
    //   196: astore 4
    ...
    //   211: invokestatic 69	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   214: aload 4
    //   216: ifnull +8 -> 224
    //   219: aload 4
    //   221: invokevirtual 178	java/io/InputStream:close	()V
    //   224: ldc2_w 162
    //   227: ldc -92
    ...
    //   244: invokestatic 69	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   247: goto -23 -> 224
    //   250: astore 4
    //   252: aconst_null
    //   253: astore_0
    ...
    //   275: invokestatic 69	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   278: goto -16 -> 262
    //   281: astore 4
    //   283: goto -29 -> 254
    //   286: astore 5
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/plugin/a/c.class
