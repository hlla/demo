...
public final class f
{
  ...
  private static i a(RandomAccessFile paramRandomAccessFile, byte[] paramArrayOfByte, long paramLong)
  {
    ...
    paramRandomAccessFile = (i)c.a(paramRandomAccessFile, paramArrayOfByte, a.iki);
    GMTrace.o(16391474249728L, 122126);
  ...
  public final int bi(int paramInt1, int paramInt2)
  {
    ...
    paramInt1 = i;
    i = paramInt2;
    if (paramInt1 < this.ilI.length)
    {
      if (this.ilI[paramInt1] == l) {
        i = paramInt1;
      }
    }
    else
  ...
  public final boolean m(String paramString, long paramLong)
  {
    ...
    //   13: aload_0
    //   14: aconst_null
    //   15: putfield 72	com/tencent/mm/plugin/a/f:ilI	[J
    //   18: aload_0
    //   19: iconst_0
    //   20: putfield 95	com/tencent/mm/plugin/a/f:ilJ	I
    //   23: aload_0
    //   24: lconst_0
    //   25: putfield 97	com/tencent/mm/plugin/a/f:duration	J
    //   28: aload_0
    //   29: lconst_0
    //   30: putfield 99	com/tencent/mm/plugin/a/f:ilE	J
    //   33: aload_0
    //   34: lconst_0
    //   35: putfield 101	com/tencent/mm/plugin/a/f:ilH	J
    //   38: aload_0
    //   39: aload_1
    //   40: putfield 93	com/tencent/mm/plugin/a/f:filePath	Ljava/lang/String;
    //   43: aload_0
    //   44: lload_2
    //   45: putfield 101	com/tencent/mm/plugin/a/f:ilH	J
    ...
    //   100: aload 7
    //   102: aload_0
    //   103: getfield 101	com/tencent/mm/plugin/a/f:ilH	J
    ...
    //   130: aload 5
    //   132: getfield 127	com/tencent/mm/plugin/a/a:ilj	J
    ...
    //   141: invokestatic 51	com/tencent/mm/sdk/platformtools/v:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   144: aload 6
    //   146: astore_1
    //   147: aload 6
    //   149: aload 7
    ...
    //   178: astore_1
    //   179: aload 8
    //   181: getfield 147	com/tencent/mm/plugin/a/e:ilF	J
    //   184: getstatic 150	com/tencent/mm/plugin/a/e:ilB	I
    //   187: i2l
    //   188: lcmp
    //   189: ifne +426 -> 615
    //   192: iconst_1
    ...
    //   202: astore_1
    //   203: aload 5
    //   205: invokevirtual 154	com/tencent/mm/plugin/a/i:NG	()J
    //   208: aload 6
    ...
    //   236: invokestatic 51	com/tencent/mm/sdk/platformtools/v:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   239: aload 6
    //   241: astore_1
    //   242: aload 6
    //   244: aload 7
    ...
    //   258: aload_0
    //   259: aload 8
    //   261: getfield 160	com/tencent/mm/plugin/a/e:ilE	J
    //   264: putfield 99	com/tencent/mm/plugin/a/f:ilE	J
    //   267: aload 6
    //   269: astore_1
    //   270: aload_0
    //   271: aload 8
    ...
    //   293: aload_0
    //   294: getfield 99	com/tencent/mm/plugin/a/f:ilE	J
    ...
    //   315: invokestatic 51	com/tencent/mm/sdk/platformtools/v:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   318: aload 6
    //   320: astore_1
    //   321: aload 6
    //   323: aload 8
    //   325: getfield 171	com/tencent/mm/plugin/a/e:ilG	J
    //   328: invokevirtual 175	java/io/RandomAccessFile:seek	(J)V
    //   331: aload 6
    //   333: astore_1
    //   334: aload 6
    //   336: aload 7
    //   338: getstatic 178	com/tencent/mm/plugin/a/a:ikl	I
    ...
    //   369: aload 5
    //   371: aload_0
    //   372: getfield 99	com/tencent/mm/plugin/a/f:ilE	J
    //   375: putfield 182	com/tencent/mm/plugin/a/h:ilE	J
    //   378: aload 6
    //   380: astore_1
    //   381: aload 5
    //   383: aload 6
    //   385: invokevirtual 185	com/tencent/mm/plugin/a/h:b	(Ljava/io/RandomAccessFile;)V
    //   388: aload 6
    //   390: astore_1
    //   391: aload_0
    //   392: aload 5
    //   394: getfield 186	com/tencent/mm/plugin/a/h:ilI	[J
    //   397: putfield 72	com/tencent/mm/plugin/a/f:ilI	[J
    //   400: aload 6
    //   402: astore_1
    //   403: aload_0
    //   404: aload_0
    //   405: getfield 72	com/tencent/mm/plugin/a/f:ilI	[J
    //   408: arraylength
    //   409: iconst_2
    //   410: isub
    //   411: putfield 95	com/tencent/mm/plugin/a/f:ilJ	I
    //   414: aload 6
    //   416: astore_1
    //   417: aload_0
    //   418: aload 5
    //   420: getfield 188	com/tencent/mm/plugin/a/h:ilK	Ljava/util/List;
    //   423: putfield 189	com/tencent/mm/plugin/a/f:ilK	Ljava/util/List;
    //   426: aload 6
    //   428: astore_1
    //   429: aload_0
    //   430: aload 5
    //   432: getfield 191	com/tencent/mm/plugin/a/h:ilL	Ljava/util/List;
    //   435: putfield 192	com/tencent/mm/plugin/a/f:ilL	Ljava/util/List;
    //   438: aload 6
    //   440: invokevirtual 195	java/io/RandomAccessFile:close	()V
    //   443: ldc2_w 89
    //   446: ldc 91
    ...
    //   456: ldc 43
    //   458: ldc -59
    //   460: invokestatic 200	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   463: aconst_null
    //   464: astore 5
    //   466: goto -355 -> 111
    //   469: astore_1
    ...
    //   479: invokestatic 206	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   482: goto -39 -> 443
    //   485: astore 7
    //   487: aconst_null
    //   488: astore 5
    ...
    //   503: invokestatic 206	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   506: aload 5
    //   508: astore_1
    //   509: ldc 43
    ...
    //   520: aload 7
    //   522: invokevirtual 209	java/lang/Exception:toString	()Ljava/lang/String;
    ...
    //   531: invokestatic 212	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   534: aload 5
    //   536: ifnull +8 -> 544
    //   539: aload 5
    //   541: invokevirtual 195	java/io/RandomAccessFile:close	()V
    //   544: ldc2_w 89
    //   547: ldc 91
    ...
    //   564: invokestatic 206	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   567: goto -23 -> 544
    //   570: astore 5
    //   572: aconst_null
    //   573: astore_1
    ...
    //   575: ifnull +7 -> 582
    //   578: aload_1
    //   579: invokevirtual 195	java/io/RandomAccessFile:close	()V
    //   582: aload 5
    //   584: athrow
    //   585: astore_1
    //   586: ldc 43
    ...
    //   595: invokestatic 206	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   598: goto -16 -> 582
    //   601: astore 5
    //   603: goto -29 -> 574
    //   606: astore 7
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/plugin/a/f.class
