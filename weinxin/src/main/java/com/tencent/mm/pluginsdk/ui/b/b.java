...
public abstract class b
  implements a
{
  public WeakReference<Context> sLV;
  public View view;
  ...
  public b(Context paramContext)
  {
    ...
    this.view = null;
    this.sLV = null;
    this.sLV = new WeakReference(paramContext);
    if (getLayoutId() > 0) {
      this.view = View.inflate((Context)this.sLV.get(), getLayoutId(), null);
    }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/pluginsdk/ui/b/b.class
