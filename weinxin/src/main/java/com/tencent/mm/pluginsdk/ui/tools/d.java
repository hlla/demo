  ...
  implements i
{
  ...
  public final String Nn()
  {
    ...
    String str = b.xb() + "/" + g.n(this.url.getBytes());
  ...
  public final Bitmap Nt()
  {
    ...
    Bitmap localBitmap = BitmapFactory.decodeResource(aa.getContext().getResources(), a.c.bhP);
  ...
  public final Bitmap a(Bitmap paramBitmap, i.a parama, String paramString)
  {
    ...
    //   9: aload_1
    //   10: astore_3
    //   11: getstatic 138	com/tencent/mm/platformtools/i$a:ihn	Lcom/tencent/mm/platformtools/i$a;
    //   14: aload_2
    ...
    //   34: aastore
    //   35: invokestatic 148	com/tencent/mm/sdk/platformtools/v:v	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   38: aload_1
    //   39: astore_2
    //   40: aload_1
    //   41: astore_3
    ...
    //   71: iconst_1
    //   72: invokestatic 153	com/tencent/mm/sdk/platformtools/d:a	(Landroid/graphics/Bitmap;IIZ)Landroid/graphics/Bitmap;
    //   75: astore_2
    //   76: aload_2
    //   77: astore_3
    //   78: new 155	java/io/File
    //   81: dup
    //   82: aload_0
    //   83: invokevirtual 157	com/tencent/mm/pluginsdk/ui/tools/d:Nn	()Ljava/lang/String;
    //   86: invokespecial 160	java/io/File:<init>	(Ljava/lang/String;)V
    //   89: astore_1
    //   90: aload_2
    //   91: astore_3
    //   92: aload_1
    //   93: invokevirtual 163	java/io/File:createNewFile	()Z
    //   96: pop
    //   97: new 165	java/io/FileOutputStream
    //   100: dup
    //   101: aload_1
    //   102: invokespecial 168	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   105: astore_1
    //   106: aload_1
    //   107: astore_3
    //   108: aload_2
    //   109: getstatic 174	android/graphics/Bitmap$CompressFormat:PNG	Landroid/graphics/Bitmap$CompressFormat;
    //   112: bipush 100
    //   114: aload_1
    //   115: invokevirtual 180	android/graphics/Bitmap:compress	(Landroid/graphics/Bitmap$CompressFormat;ILjava/io/OutputStream;)Z
    //   118: pop
    //   119: aload_1
    //   120: astore_3
    //   121: aload_1
    //   122: invokevirtual 183	java/io/FileOutputStream:flush	()V
    //   125: aload_2
    //   126: astore_3
    //   127: aload_1
    ...
    //   160: invokestatic 192	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   163: aload_2
    //   164: astore_3
    //   165: aload_1
    //   166: ifnull -33 -> 133
    ...
    //   170: astore_3
    //   171: aload_1
    //   172: invokevirtual 186	java/io/FileOutputStream:close	()V
    //   175: aload_2
    //   176: astore_3
    //   177: goto -44 -> 133
    //   180: astore_1
    ...
    //   190: invokestatic 192	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   193: goto -60 -> 133
    //   196: astore_1
    //   197: aconst_null
    //   198: astore 4
    ...
    //   206: astore_3
    //   207: aload 4
    //   209: invokevirtual 186	java/io/FileOutputStream:close	()V
    //   212: aload_2
    //   213: astore_3
    //   214: aload_1
    //   215: athrow
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/pluginsdk/ui/tools/d.class
