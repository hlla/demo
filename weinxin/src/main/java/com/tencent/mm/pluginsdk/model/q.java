  ...
  extends t
{
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        else
        {
          ...
          {
            localObject1 = dv(paramContext);
            if (((a)localObject1).sBc != -1) {
              break label242;
            }
            i = 0;
          }
          for (;;)
          {
            ...
            localObject3 = dv(paramContext);
            if (((a)localObject3).sBc != -1) {
              break;
            }
            GMTrace.o(758867034112L, 5654);
            return 4;
            label242:
            if (((a)localObject1).sBc == 2)
            {
      ...
      else
      {
        ...
        if (((a)localObject3).ver >= 46)
        {
          ...
          if (localObject3 != null)
          {
            ...
            {
              ((Intent)localObject2).setClassName(((b)localObject3).sBe, ((b)localObject3).classname);
              paramString = (String)localObject2;
              continue;
              if (((a)localObject3).sBc == 1)
              {
  ...
  private static b c(Context paramContext, Uri paramUri)
  {
    ...
    while (paramUri.hasNext())
    {
      ...
      if (str.contains("com.tencent.mtt"))
      {
        ...
        paramContext.sBe = ((ResolveInfo)localObject).activityInfo.packageName;
        GMTrace.o(759135469568L, 5656);
        return paramContext;
      }
  ...
  private static a dv(Context paramContext)
  {
        ...
        try
        {
          ...
          if (localObject6 != null)
          {
            ...
            if (((PackageInfo)localObject6).versionCode > 420000)
            {
              ...
              localObject1 = localObject6;
              locala.sBd += ((PackageInfo)localObject6).versionName.replaceAll("\\.", "");
          ...
          catch (PackageManager.NameNotFoundException localNameNotFoundException4)
          {
            ...
            catch (Exception localException)
            {
              ...
              try
              {
                ...
                if (TextUtils.isEmpty(((b)localObject6).sBe)) {
                  continue;
                }
                localObject5 = localObject2;
                paramContext = localPackageManager.getPackageInfo(((b)localObject6).sBe, 0);
    ...
    if (paramContext != null)
    {
      ...
      locala.sBd += paramContext.versionName.replaceAll("\\.", "");
    }
    GMTrace.o(759001251840L, 5655);
    return locala;
  }
  ...
  public final boolean dt(Context paramContext)
  {
    ...
    paramContext = dv(paramContext);
    if (paramContext.sBc == -1)
    {
      GMTrace.o(757793292288L, 5646);
      return false;
    }
    if ((paramContext.sBc == 2) && (paramContext.ver < 33))
    {
      GMTrace.o(757793292288L, 5646);
      return false;
    }
  ...
  public final boolean s(Context paramContext, Intent paramIntent)
  {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/pluginsdk/model/q.class
