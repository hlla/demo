...
public final class k
{
  ...
  public static String Nl()
  {
    ...
    String str = com.tencent.mm.platformtools.d.Nl();
  ...
  public static void a(Activity paramActivity, int paramInt1, int paramInt2, int paramInt3, int paramInt4, boolean paramBoolean, Intent paramIntent)
  {
    ...
    com.tencent.mm.bb.d.b(paramActivity, "gallery", ".ui.GalleryEntryUI", localIntent, paramInt1);
  ...
  private static void a(Fragment paramFragment, int paramInt1, int paramInt2, int paramInt3, int paramInt4, String paramString1, String paramString2)
  {
    ...
    {
      localIntent.addFlags(67108864);
      com.tencent.mm.bb.d.a(paramFragment, "gallery", ".ui.AlbumPreviewUI", localIntent, paramInt1);
  ...
  public static boolean a(Context paramContext, int paramInt1, Intent paramIntent, int paramInt2, String paramString, int paramInt3)
  {
    ...
    if (paramInt2 == 1)
    {
      paramString = s.lv(paramString);
      o.KW();
      localObject1 = s.lw(paramString);
      o.KW();
      ((SightParams)localObject2).h(paramString, (String)localObject1, s.lx(paramString), com.tencent.mm.compatible.util.e.gSp + String.format("%s%d.%s", new Object[] { "capture", Long.valueOf(System.currentTimeMillis()), "jpg" }));
    }
    ...
    com.tencent.mm.bb.d.b(paramContext, "mmsight", ".ui.SightCaptureUI", paramIntent, paramInt1);
    if ((paramContext instanceof Activity)) {
      ((Activity)paramContext).overridePendingTransition(a.a.qYH, -1);
    }
  ...
  public static boolean a(Fragment paramFragment, Intent paramIntent, String paramString, int paramInt)
  {
    ...
    paramString = s.lv(paramString);
    o.KW();
    String str = s.lw(paramString);
    o.KW();
    localSightParams.h(paramString, str, s.lx(paramString), com.tencent.mm.compatible.util.e.gSp + String.format("%s%d.%s", new Object[] { "capture", Long.valueOf(System.currentTimeMillis()), "jpg" }));
    paramIntent.putExtra("KEY_SIGHT_PARAMS", localSightParams);
    com.tencent.mm.bb.d.a(paramFragment, "mmsight", ".ui.SightCaptureUI", paramIntent, 226);
    paramFragment.aG().overridePendingTransition(a.a.qYH, -1);
    GMTrace.o(1111054352384L, 8278);
    return true;
  }
  
  public static boolean a(q paramq, String paramString1, String paramString2)
  {
    GMTrace.i(1111591223296L, 8282);
    boolean bool = a(paramq, paramString1, paramString2, 201);
    v.i("MicroMsg.TakePhotoUtil", "takePhoto(), dir = [%s], filename = [%s], cmd = [%s], result = [%s]", new Object[] { paramString1, paramString2, Integer.valueOf(201), Boolean.valueOf(bool) });
    GMTrace.o(1111591223296L, 8282);
    return bool;
  }
  
  private static boolean a(q paramq, String paramString1, String paramString2, int paramInt)
  {
    GMTrace.i(1111725441024L, 8283);
    if ((com.tencent.mm.n.a.aI(paramq.uRf.uRz)) || (com.tencent.mm.n.a.aH(paramq.uRf.uRz)))
    {
    ...
    try
    {
      ...
      if (!localFile.exists())
      {
        v.e("MicroMsg.TakePhotoUtil", "takePhotoFromSys(), dir not exist. " + paramString1);
        GMTrace.o(1111725441024L, 8283);
        return false;
      }
    }
    catch (Exception localException)
    {
      for (;;)
      {
        v.printErrStackTrace("MicroMsg.TakePhotoUtil", localException, "", new Object[0]);
      }
      paramString2.putExtra("output", Uri.fromFile(new File(filePath)));
      try
      {
        paramq.startActivityForResult(paramString2, 201);
        GMTrace.o(1111725441024L, 8283);
        return true;
      }
      catch (ActivityNotFoundException paramq)
      {
        v.e("MicroMsg.TakePhotoUtil", "takePhotoFromSys(), " + paramq.getMessage());
        GMTrace.o(1111725441024L, 8283);
      }
    }
    return false;
  ...
  public static String bGv()
  {
    ...
    String str = com.tencent.mm.compatible.util.e.gSp;
  ...
  public static void c(Activity paramActivity, int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    com.tencent.mm.bb.d.b(paramActivity, "gallery", ".ui.GalleryEntryUI", paramIntent, 4);
  ...
  public static boolean c(Activity paramActivity, String paramString1, String paramString2, int paramInt)
  {
    ...
    v.i("MicroMsg.TakePhotoUtil", "takePhoto(), dir = [%s], filename = [%s], cmd = [%s], result = [%s]", new Object[] { paramString1, paramString2, Integer.valueOf(paramInt), Boolean.valueOf(bool) });
  ...
  private static boolean d(Activity paramActivity, String paramString1, String paramString2, int paramInt)
  {
    ...
    if ((com.tencent.mm.n.a.aI(paramActivity)) || (com.tencent.mm.n.a.aH(paramActivity)))
    {
    ...
    catch (Exception localException)
    {
      ...
      {
        v.e("MicroMsg.TakePhotoUtil", "takePhotoFromSys(), " + paramActivity.getMessage());
        GMTrace.o(1111993876480L, 8285);
      }
    }
    return false;
  ...
  public static void h(String paramString, Context paramContext)
  {
    ...
    com.tencent.mm.platformtools.d.a(paramString, paramContext, a.h.qYN);
  ...
  public static String ms(String paramString)
  {
    ...
    paramString = com.tencent.mm.platformtools.d.ms(paramString);
    GMTrace.o(1114275577856L, 8302);
    return paramString;
  }
  
  public static boolean t(Context paramContext, Intent paramIntent)
  {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/pluginsdk/ui/tools/k.class
