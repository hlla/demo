...
{
  private final HashMap<T, a<T>> gYr;
  private final Set<T> gYs;
  
  public f()
  {
    GMTrace.i(13532099772416L, 100822);
    this.gYr = new HashMap();
    this.gYs = new HashSet();
  ...
  private void a(ArrayList<a> paramArrayList, ArrayList<T> paramArrayList1)
  {
    ...
    for (;;)
    {
      ...
      if (paramArrayList.hasNext())
      {
        ...
        boolean bool = locala1.gYw;
        localObject = locala1.gYt;
        if (!locala1.gYw)
        {
          localObject = locala1.gYt.iterator();
          a locala2;
          do
          {
      ...
      else
      {
        for (int i = 0;; i = 1)
        {
          ...
          locala1.gYw = true;
          paramArrayList1.add(locala1.gYv);
          localObject = locala1.gYv;
          if (locala1.gYu == null) {
            break;
          }
          a(locala1.gYu, paramArrayList1);
          break;
          GMTrace.o(13533039296512L, 100829);
          return;
        }
  ...
  private a<T> ap(T paramT)
  {
    try
    {
      GMTrace.i(13532368207872L, 100824);
      a locala2 = (a)this.gYr.get(paramT);
      a locala1 = locala2;
      if (locala2 == null)
      {
        locala1 = new a(paramT);
        this.gYr.put(paramT, locala1);
      }
  ...
  private void reset()
  {
    ...
    Iterator localIterator = this.gYr.entrySet().iterator();
    while (localIterator.hasNext()) {
      ((a)((Map.Entry)localIterator.next()).getValue()).gYw = false;
    }
    GMTrace.o(13532770861056L, 100827);
  }
  
  /* Error */
  public final boolean aq(T paramT)
  {
    // Byte code:
    //   0: aload_0
    //   1: monitorenter
    ...
    //   10: aload_0
    //   11: getfield 32	com/tencent/mm/kernel/f:gYr	Ljava/util/HashMap;
    //   14: aload_1
    ...
    //   23: ifnull +34 -> 57
    //   26: aload_3
    //   27: getfield 82	com/tencent/mm/kernel/f$a:gYt	Ljava/util/ArrayList;
    //   30: ifnull +27 -> 57
    //   33: aload_3
    //   34: getfield 82	com/tencent/mm/kernel/f$a:gYt	Ljava/util/ArrayList;
    ...
    //   56: ireturn
    //   57: aload_0
    //   58: getfield 37	com/tencent/mm/kernel/f:gYs	Ljava/util/Set;
    //   61: aload_1
  ...
  public final void n(T paramT1, T paramT2)
  {
    ...
    //   18: aload_0
    //   19: aload_1
    //   20: invokespecial 152	com/tencent/mm/kernel/f:ap	(Ljava/lang/Object;)Lcom/tencent/mm/kernel/f$a;
    //   23: astore_3
    //   24: aload_0
    //   25: aload_2
    //   26: invokespecial 152	com/tencent/mm/kernel/f:ap	(Ljava/lang/Object;)Lcom/tencent/mm/kernel/f$a;
    //   29: astore_2
    //   30: aload_3
    //   31: aload_2
    //   32: if_acmpeq +70 -> 102
    //   35: aload_3
    //   36: getfield 82	com/tencent/mm/kernel/f$a:gYt	Ljava/util/ArrayList;
    //   39: ifnonnull +15 -> 54
    //   42: aload_3
    ...
    //   51: putfield 82	com/tencent/mm/kernel/f$a:gYt	Ljava/util/ArrayList;
    //   54: aload_3
    //   55: getfield 82	com/tencent/mm/kernel/f$a:gYt	Ljava/util/ArrayList;
    //   58: aload_2
    //   59: invokevirtual 90	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   62: pop
    //   63: aload_2
    //   64: getfield 93	com/tencent/mm/kernel/f$a:gYu	Ljava/util/ArrayList;
    //   67: ifnonnull +15 -> 82
    //   70: aload_2
    ...
    //   79: putfield 93	com/tencent/mm/kernel/f$a:gYu	Ljava/util/ArrayList;
    //   82: aload_2
    //   83: getfield 93	com/tencent/mm/kernel/f$a:gYu	Ljava/util/ArrayList;
    //   86: aload_3
    ...
    //   101: return
    //   102: aload_0
    //   103: getfield 37	com/tencent/mm/kernel/f:gYs	Ljava/util/Set;
    //   106: aload_1
  ...
  public final ArrayList<T> vD()
  {
    ...
    ArrayList localArrayList = new ArrayList();
    new HashMap(this.gYr);
    Object localObject1 = new ArrayList();
    Object localObject2 = this.gYr.entrySet().iterator();
    Object localObject3;
    while (((Iterator)localObject2).hasNext())
    {
      localObject3 = (Map.Entry)((Iterator)localObject2).next();
      if (((a)((Map.Entry)localObject3).getValue()).gYt == null)
      {
        ((a)((Map.Entry)localObject3).getValue()).gYw = true;
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      localObject3 = ((a)localObject2).gYu;
      localObject3 = ((a)localObject2).gYt;
      a(((a)localObject2).gYu, localArrayList);
    }
  ...
  {
    public ArrayList<a> gYt;
    public ArrayList<a> gYu;
    T gYv;
    boolean gYw;
    ...
    public final String toString()
    {
      ...
      String str = "Ref-" + this.gYv.toString();
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/kernel/f.class
