...
public final class e
{
  ...
  public e gXQ;
  e gXR;
  public List<com.tencent.mm.kernel.api.a> gXS;
  public List<ac> gXT;
  public String gXU;
  public String gXV;
  public g gXW;
  ...
  ba gXZ;
  bu gYa;
  ConcurrentHashMap<String, SharedPreferences> gYb;
  private long gYc;
  private ad gYd;
  ...
  static
  {
    ...
    gJh = localHashMap;
    localHashMap.put(Integer.valueOf("CONFIG_TABLE".hashCode()), new g.c()
    {
      public final String[] pP()
      {
        GMTrace.i(13502571872256L, 100602);
        String[] arrayOfString = t.gUn;
  ...
  public e(List<com.tencent.mm.kernel.api.a> paramList, a parama, List<ac> paramList1, b paramb, c paramc)
  {
    ...
    this.gXM = vk();
    a.gWW.gXp = this.gXM;
    String str1 = w.hgg + "alphahold.ini";
    v.i("MMKernel.CoreStorage", "initialize dkalpha client:%x  isapha:%b %s", new Object[] { Integer.valueOf(d.sXh), Boolean.valueOf(d.sXk), str1 });
    String str2;
    int i;
    if ((d.sXk) || (d.sXl))
    {
    ...
    {
      v.w("MMKernel.CoreStorage", "dkalpha version need  reset to DefaultAccount , hold it! client:%x  isapha:%b", new Object[] { Integer.valueOf(i), Boolean.valueOf(d.sXk) });
      a.uK();
      com.tencent.mm.sdk.e.a.aa(str1, "noneedhold", String.valueOf(i));
    }
    for (;;)
    {
      this.gXU = vq();
  ...
  private static final boolean aS(String paramString)
  {
    ...
    v.i("MMKernel.CoreStorage", "forceMkdirs absolutePath[%s], f.exists[%b], f.isDirectory[%b]", new Object[] { paramString, Boolean.valueOf(((File)localObject).exists()), Boolean.valueOf(((File)localObject).isDirectory()) });
    ...
    localObject = "/";
    v.i("MMKernel.CoreStorage", "forceMkdirs absolutePath arr len: " + arrayOfString.length);
    int i = 0;
    while (i < arrayOfString.length)
    {
      ...
      if (!bf.mA(arrayOfString[i]))
      {
        ...
        {
          v.i("MMKernel.CoreStorage", "forceMkdirs renameTo false ret false file[%s]", new Object[] { localFile.getName() });
          GMTrace.o(13504182484992L, 100614);
          return false;
        }
        paramString = (String)localObject;
        if (!localFile.exists())
        {
          ...
          if (!localFile.mkdir())
          {
            v.i("MMKernel.CoreStorage", "forceMkdirs mkdir false ret false file[%s]", new Object[] { localFile.getName() });
            GMTrace.o(13504182484992L, 100614);
            return false;
          }
        }
  ...
  private static s vk()
  {
    ...
    v.i("MMKernel.CoreStorage", "initialize packageInfo:%s version:%x", new Object[] { com.tencent.mm.sdk.platformtools.e.aKl(), Integer.valueOf(d.sXh) });
    Object localObject1 = new File(w.hgg);
    if (!((File)localObject1).exists()) {
      ((File)localObject1).mkdirs();
    }
    localObject1 = new s(w.hgg + "systemInfo.cfg");
    Object localObject2 = (String)((s)localObject1).get(258);
    if (localObject2 != null) {
      k.rj().set(258, localObject2);
    }
    try
    {
      localObject2 = com.tencent.mm.compatible.util.h.getDataDirectory();
      StatFs localStatFs = new StatFs(((File)localObject2).getPath());
      v.i("MMKernel.CoreStorage", "CheckData path[%s] blocksize:%d blockcount:%d availcount:%d", new Object[] { ((File)localObject2).getAbsolutePath(), Integer.valueOf(localStatFs.getBlockSize()), Integer.valueOf(localStatFs.getBlockCount()), Integer.valueOf(localStatFs.getAvailableBlocks()) });
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        v.e("MMKernel.CoreStorage", "check data size failed :%s", new Object[] { localException.getMessage() });
      }
    }
  }
  ...
  private static String vq()
  {
    ...
    localObject1 = w.hgg;
    File localFile = new File(com.tencent.mm.compatible.util.e.hgi);
    v.i("MMKernel.CoreStorage", "summer buildSysPath sysPath[" + (String)localObject1 + "] SDCARD_ROOT[" + com.tencent.mm.compatible.util.e.hgi + "] file.exists:" + localFile.exists() + " CUtil.isSDCardAvail():" + com.tencent.mm.compatible.util.f.rZ());
    ...
    if (localFile.exists())
    {
      ...
      {
        if (aS(com.tencent.mm.compatible.util.e.hgk)) {
          localObject1 = com.tencent.mm.compatible.util.e.hgk;
        }
        localObject2 = new File(com.tencent.mm.compatible.util.e.gSp);
        if (!((File)localObject2).exists()) {
          ((File)localObject2).mkdirs();
        }
        localObject2 = new File(com.tencent.mm.compatible.util.e.gSq);
        if (!((File)localObject2).exists()) {
          ((File)localObject2).mkdirs();
        }
        localObject2 = new File(com.tencent.mm.compatible.util.e.gSr);
        if (!((File)localObject2).exists()) {
          ((File)localObject2).mkdirs();
        }
        localObject2 = new File(com.tencent.mm.compatible.util.e.gSs);
        if (!((File)localObject2).exists()) {
          ((File)localObject2).mkdirs();
        }
        localFile = new File(com.tencent.mm.compatible.util.e.gSq + ".nomedia");
        localObject2 = localObject1;
        if (localFile.exists()) {}
      }
    }
    ...
    catch (IOException localIOException)
    {
      for (;;)
      {
        v.e("MMKernel.CoreStorage", "exception:%s", new Object[] { bf.g(localIOException) });
    ...
    v.i("MMKernel.CoreStorage", "summer buildSysPath ret sysPath: " + (String)localObject2);
  ...
  private static boolean vw()
  {
    ...
    //   11: invokestatic 488	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   14: invokevirtual 407	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   17: astore 8
    //   19: getstatic 433	com/tencent/mm/compatible/util/e:hgi	Ljava/lang/String;
    //   22: aload 8
    //   24: invokevirtual 491	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   27: istore_3
    //   28: invokestatic 494	android/os/Environment:getExternalStorageState	()Ljava/lang/String;
    //   31: ldc_w 496
    //   34: invokevirtual 256	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   37: istore 4
    //   39: new 307	java/io/File
    //   42: dup
    //   43: invokestatic 488	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    ...
    //   52: invokevirtual 499	java/io/File:canWrite	()Z
    //   55: istore_1
    //   56: new 307	java/io/File
    //   59: dup
    //   60: invokestatic 488	android/os/Environment:getExternalStorageDirectory	()Ljava/io/File;
    //   63: invokevirtual 407	java/io/File:getAbsolutePath	()Ljava/lang/String;
    //   66: ldc_w 501
    //   69: invokespecial 503	java/io/File:<init>	(Ljava/lang/String;Ljava/lang/String;)V
    //   72: astore 7
    //   74: aload 7
    //   76: invokevirtual 471	java/io/File:createNewFile	()Z
    //   79: pop
    //   80: new 505	java/io/FileOutputStream
    //   83: dup
    //   84: aload 7
    //   86: invokespecial 508	java/io/FileOutputStream:<init>	(Ljava/io/File;)V
    //   89: astore 6
    //   91: aload 6
    //   93: astore 5
    //   95: aload 6
    //   97: ldc_w 510
    //   100: invokevirtual 514	java/lang/String:getBytes	()[B
    //   103: invokevirtual 518	java/io/FileOutputStream:write	([B)V
    //   106: aload 6
    //   108: astore 5
    //   110: aload 6
    //   112: invokevirtual 521	java/io/FileOutputStream:flush	()V
    //   115: aload 6
    //   117: astore 5
    //   119: aload 6
    //   121: invokevirtual 524	java/io/FileOutputStream:close	()V
    //   124: aload 6
    //   126: astore 5
    //   128: aload 7
    //   130: invokevirtual 527	java/io/File:delete	()Z
    //   133: istore_0
    //   134: aload 6
    //   136: invokevirtual 524	java/io/FileOutputStream:close	()V
    //   139: ldc -52
    ...
    //   162: getstatic 433	com/tencent/mm/compatible/util/e:hgi	Ljava/lang/String;
    ...
    //   212: invokestatic 305	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   215: ldc2_w 481
    //   218: ldc_w 483
    ...
    //   251: invokestatic 543	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   254: iconst_0
    //   255: istore_1
    //   256: goto -200 -> 56
    //   259: astore 5
    ...
    //   271: iconst_0
    //   272: aload 5
    //   274: invokestatic 479	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   277: aastore
    //   278: invokestatic 423	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   281: goto -142 -> 139
    //   284: astore 7
    //   286: aconst_null
    //   287: astore 6
    ...
    //   316: invokestatic 543	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   319: iload_2
    //   320: istore_0
    //   321: aload 6
    //   323: ifnull -184 -> 139
    //   326: aload 6
    //   328: invokevirtual 524	java/io/FileOutputStream:close	()V
    //   331: iload_2
    //   332: istore_0
    //   333: goto -194 -> 139
    //   336: astore 5
    ...
    //   348: iconst_0
    //   349: aload 5
    //   351: invokestatic 479	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   354: aastore
    //   355: invokestatic 423	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   358: iload_2
    //   359: istore_0
    //   360: goto -221 -> 139
    //   363: astore 6
    ...
    //   370: ifnull +8 -> 378
    //   373: aload 5
    //   375: invokevirtual 524	java/io/FileOutputStream:close	()V
    //   378: aload 6
    //   380: athrow
    //   381: astore 5
    //   383: ldc -52
    ...
    //   393: iconst_0
    //   394: aload 5
    //   396: invokestatic 479	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   399: aastore
    //   400: invokestatic 423	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   403: goto -25 -> 378
    //   406: astore 6
    //   408: goto -40 -> 368
    //   411: astore 7
  ...
  private static boolean vx()
  {
    ...
    boolean bool2 = com.tencent.mm.compatible.util.e.hgi.equalsIgnoreCase(str);
    ...
    try
    {
      ...
      File localFile = new File(com.tencent.mm.compatible.util.e.hgk);
      boolean bool4 = localFile.exists();
      if (bool4) {
        v.i("MMKernel.CoreStorage", "testSdcardReadable testFile isDirectory:" + localFile.isDirectory() + " isFile:" + localFile.isFile());
      }
      v.i("MMKernel.CoreStorage", "testSdcardWritable primaryExtStg: " + str + " CConstants.SDCARD_ROOT: " + com.tencent.mm.compatible.util.e.hgi + " CConstants.DATAROOT_SDCARD_PATH: " + com.tencent.mm.compatible.util.e.hgk + " isPrimaryExtStg: " + bool2 + " mounted: " + bool3 + " canRead: " + bool1 + " canTrueRead:" + bool4);
    ...
    catch (Exception localException)
    {
      ...
      {
        boolean bool1 = false;
        v.w("MMKernel.CoreStorage", "testSdcardReadable 1 e: " + localException.getMessage());
      }
    }
  }
  ...
  public final void cQ(String paramString)
  {
    ...
    this.gXN.onDataBaseClosed(this.gXW, this.gXX);
    if (this.gXX != null) {
      this.gXX.wL();
    }
    if (this.gXW != null) {
      this.gXW.cQ(paramString);
    }
    GMTrace.o(13503779831808L, 100611);
  }
  
  public final SharedPreferences ef(String paramString)
  {
    ...
    int i = a.uH();
    if (i != 0) {
      if (this.gYb.containsKey(paramString))
      {
        paramString = (SharedPreferences)this.gYb.get(paramString);
    ...
    try
    {
      ...
      Object localObject2 = aa.bIN() + paramString + i + ".xml";
      String str = aa.bIN() + paramString + i + ".xml.bak";
    ...
    localObject1 = z.Pp(String.valueOf(i / 2));
    localObject1 = aa.bIN() + paramString + z.Pp(new StringBuilder().append(i).append((String)localObject1).toString());
    localObject1 = aa.getContext().getSharedPreferences((String)localObject1, 0);
    this.gYb.put(paramString, localObject1);
    GMTrace.o(13503914049536L, 100612);
  ...
  public final boolean isSDCardAvailable()
  {
    ...
    boolean bool1 = this.gXU.startsWith(com.tencent.mm.compatible.util.e.hgi);
    long l1 = bf.NA();
    long l2 = l1 - this.gYc;
    if (bool1)
    {
      h.vJ();
      if ((h.vG().uV()) && (l2 > 0L) && (l2 < 1000L) && (new File(this.gXU).exists()))
      {
    ...
    this.gYc = l1;
    boolean bool2 = com.tencent.mm.compatible.util.f.rZ();
    h.vJ();
    h.vG();
    v.i("MMKernel.CoreStorage", "isSDCardAvail:%b uin:%s toNow:%d sysPath:[%s] sdRoot:[%s], acc init:[%b]", new Object[] { Boolean.valueOf(bool2), o.getString(a.uH()), Long.valueOf(l2), this.gXU, com.tencent.mm.compatible.util.e.hgi, Boolean.valueOf(h.vG().uV()) });
    if (!bool2)
    {
      GMTrace.o(13504719355904L, 100618);
      return false;
  ...
  final HashMap<Integer, g.c> uh()
  {
    ...
    synchronized (this.gXS)
    {
      ...
      while (((Iterator)localObject2).hasNext())
      {
        ...
        if (localHashMap2 != null) {
          v.i("MMKernel.CoreStorage", "storage add db provider %s %s %s", new Object[] { localObject3, Integer.valueOf(localHashMap2.size()), Integer.valueOf(localHashMap1.size()) });
        }
      }
    }
    ...
    while (((Iterator)???).hasNext())
    {
      ...
      localObject3 = ((g.c)localHashMap.get(localObject2)).pP();
      int j = localObject3.length;
      int i = 0;
      while (i < j)
      {
        v.d("MMKernel.CoreStorage", "create table key %s table %s", new Object[] { localObject2, localObject3[i] });
        i += 1;
      }
    }
  ...
  final boolean vl()
  {
    ...
    int i = bf.f((Integer)this.gXY.get(14, null));
    int j = d.sXh;
    v.d("MMKernel.CoreStorage", "tryDataTransfer, sVer = " + i + ", cVer = " + j);
    Object localObject1 = new ac()
    {
      public final List<ab> getDataTransferList()
      {
        ...
        synchronized (e.this.gXT)
        {
          Iterator localIterator = e.this.gXT.iterator();
          while (localIterator.hasNext())
          {
            List localList2 = ((ac)localIterator.next()).getDataTransferList();
            if (localList2 != null) {
    ...
    do
    {
      v.d("MMKernel.CoreStorage", "tryDataTransfer dataTransferList size = " + ((List)localObject1).size());
      v.d("MMKernel.CoreStorage", "tryDataTransfer, threadId = " + Thread.currentThread().getId() + ", name = " + Thread.currentThread().getName());
      l1 = this.gXW.cs(Thread.currentThread().getId());
      localObject1 = ((List)localObject1).iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localObject2 = (ab)((Iterator)localObject1).next();
        long l2 = System.currentTimeMillis();
        ((ab)localObject2).transfer(i);
        ((ab)localObject2).hlz = (System.currentTimeMillis() - l2);
        v.d("MicroMsg.DataTransferBase", "doTransfer, timeConsumed = " + ((ab)localObject2).hlz + ", tag = " + ((ab)localObject2).getTag());
      }
      if (i == j)
      {
        v.i("MMKernel.CoreStorage", "tryDataTransfer, no need to transfer, sVer = " + i + ", cVer = " + j);
        GMTrace.o(13503377178624L, 100608);
        return false;
      }
      bool1 = false;
      ...
      while (((Iterator)localObject2).hasNext())
      {
        boolean bool2 = ((ab)((Iterator)localObject2).next()).eX(i);
        bool1 = bool2;
        if (bool2) {
          bool1 = bool2;
        }
      }
      v.d("MMKernel.CoreStorage", "tryDataTransfer, needTransfer = " + bool1);
    } while (bool1);
    GMTrace.o(13503377178624L, 100608);
    return false;
    if ((r.iiu != 0) && (r.iiv != 0))
      ...
      for (;;)
      {
        if (i < r.iiu) {
          ...
          catch (InterruptedException localInterruptedException)
          {
            for (;;)
            {
              v.e("MMKernel.CoreStorage", "exception:%s", new Object[] { bf.g(localInterruptedException) });
            }
          }
        }
      }
  ...
  final void vm()
  {
    ...
    Object localObject = this.gXP.collectStoragePaths();
    v.i("MMKernel.CoreStorage", "all account storage folder %s", new Object[] { localObject.toString() });
    String[] arrayOfString = new String[((List)localObject).size() + 1];
    arrayOfString[0] = this.gXV;
    int i = 0;
    while (i < ((List)localObject).size())
    {
      arrayOfString[(i + 1)] = (this.gXV + (String)((List)localObject).get(i));
      i += 1;
    }
    com.tencent.mm.a.e.c(arrayOfString);
    this.gXO.eg(this.gXV);
    localObject = new File(this.gXV + ".nomedia");
  ...
  public final void vt()
  {
    ...
    this.gYe = Boolean.valueOf(isSDCardAvailable());
  ...
  public final boolean vu()
  {
    ...
    for (;;)
    {
      boolean bool = this.gYe.booleanValue();
      GMTrace.o(14610404999168L, 108856);
      return bool;
      long l = System.currentTimeMillis() - this.gYg;
      if ((l <= 0L) || (l >= 1000L))
      {
        if (this.gYd == null) {
          this.gYd = new ad(h.vL().nIe.getLooper());
        }
        this.gYd.removeCallbacksAndMessages(null);
        this.gYd.postDelayed(this.gYf, 1000L);
  ...
  public final void vv()
  {
    ...
    //   9: invokestatic 598	com/tencent/mm/kernel/h:vJ	()Lcom/tencent/mm/kernel/h;
    //   12: pop
    //   13: invokestatic 602	com/tencent/mm/kernel/h:vG	()Lcom/tencent/mm/kernel/a;
    //   16: getfield 960	com/tencent/mm/kernel/a:gWV	[B
    //   19: astore_2
    //   20: aload_2
    //   21: monitorenter
    //   22: invokestatic 271	com/tencent/mm/kernel/e:vq	()Ljava/lang/String;
    //   25: astore_3
    //   26: ldc -52
    //   28: ldc_w 962
    //   31: iconst_4
    ...
    //   35: dup
    //   36: iconst_0
    //   37: invokestatic 605	com/tencent/mm/kernel/a:uH	()I
    //   40: invokestatic 124	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
    //   43: aastore
    //   44: dup
    //   45: iconst_1
    //   46: aload_0
    //   47: getfield 273	com/tencent/mm/kernel/e:gXU	Ljava/lang/String;
    //   50: aastore
    //   51: dup
    //   52: iconst_2
    //   53: aload_3
    ...
    //   55: dup
    //   56: iconst_3
    //   57: invokestatic 602	com/tencent/mm/kernel/h:vG	()Lcom/tencent/mm/kernel/a;
    //   60: invokevirtual 661	com/tencent/mm/kernel/a:uV	()Z
    //   63: invokestatic 221	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   66: aastore
    //   67: invokestatic 226	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   70: aload_3
    //   71: invokestatic 300	com/tencent/mm/sdk/platformtools/bf:mA	(Ljava/lang/String;)Z
    //   74: ifne +287 -> 361
    //   77: aload_3
    //   78: aload_0
    //   79: getfield 273	com/tencent/mm/kernel/e:gXU	Ljava/lang/String;
    //   82: invokevirtual 491	java/lang/String:equalsIgnoreCase	(Ljava/lang/String;)Z
    //   85: istore_1
    //   86: iload_1
    //   87: ifeq +126 -> 213
    //   90: ldc -52
    ...
    //   102: invokestatic 966	com/tencent/mm/kernel/e:vw	()Z
    ...
    //   111: invokestatic 305	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   114: ldc -52
    //   116: new 186	java/lang/StringBuilder
    //   119: dup
    //   120: ldc_w 968
    //   123: invokespecial 332	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   126: invokestatic 970	com/tencent/mm/kernel/e:vx	()Z
    ...
    //   135: invokestatic 305	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   138: aload_2
    //   139: monitorexit
    //   140: ldc2_w 954
    //   143: ldc_w 956
    ...
    //   173: invokestatic 543	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   176: goto -62 -> 114
    //   179: astore_3
    //   180: aload_2
    //   181: monitorexit
    ...
    //   207: invokestatic 543	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;)V
    //   210: goto -72 -> 138
    //   213: ldc -52
    //   215: ldc_w 976
    //   218: iconst_4
    ...
    //   223: iconst_0
    //   224: aload_0
    //   225: getfield 273	com/tencent/mm/kernel/e:gXU	Ljava/lang/String;
    //   228: aastore
    //   229: dup
    //   230: iconst_1
    //   231: aload_3
    ...
    //   234: iconst_2
    //   235: aload_0
    //   236: getfield 853	com/tencent/mm/kernel/e:gXV	Ljava/lang/String;
    //   239: aastore
    //   240: dup
    //   241: iconst_3
    //   242: aload_0
    //   243: getfield 868	com/tencent/mm/kernel/e:cachePath	Ljava/lang/String;
    //   246: aastore
    //   247: invokestatic 226	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   250: aload_3
    //   251: invokestatic 300	com/tencent/mm/sdk/platformtools/bf:mA	(Ljava/lang/String;)Z
    //   254: ifne +79 -> 333
    //   257: aload_0
    //   258: aload_3
    //   259: putfield 273	com/tencent/mm/kernel/e:gXU	Ljava/lang/String;
    //   262: new 186	java/lang/StringBuilder
    //   265: dup
    //   266: ldc_w 978
    //   269: invokespecial 332	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   272: astore_3
    //   273: invokestatic 598	com/tencent/mm/kernel/h:vJ	()Lcom/tencent/mm/kernel/h;
    //   276: pop
    //   277: invokestatic 602	com/tencent/mm/kernel/h:vG	()Lcom/tencent/mm/kernel/a;
    //   280: pop
    //   281: aload_3
    //   282: invokestatic 605	com/tencent/mm/kernel/a:uH	()I
    ...
    //   291: invokevirtual 514	java/lang/String:getBytes	()[B
    //   294: invokestatic 984	com/tencent/mm/a/g:n	([B)Ljava/lang/String;
    //   297: astore_3
    //   298: aload_0
    ...
    //   306: aload_0
    //   307: getfield 273	com/tencent/mm/kernel/e:gXU	Ljava/lang/String;
    //   310: invokevirtual 196	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   313: aload_3
    ...
    //   326: putfield 853	com/tencent/mm/kernel/e:gXV	Ljava/lang/String;
    //   329: aload_0
    //   330: invokevirtual 986	com/tencent/mm/kernel/e:vm	()V
    //   333: aload_0
    //   334: getfield 283	com/tencent/mm/kernel/e:gXO	Lcom/tencent/mm/kernel/e$c;
    //   337: invokevirtual 989	com/tencent/mm/kernel/e$c:vB	()V
    //   340: ldc -52
    //   342: ldc_w 991
    //   345: iconst_1
    ...
    //   349: dup
    //   350: iconst_0
    //   351: invokestatic 449	com/tencent/mm/compatible/util/f:rZ	()Z
    //   354: invokestatic 221	java/lang/Boolean:valueOf	(Z)Ljava/lang/Boolean;
    //   357: aastore
    //   358: invokestatic 226	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   361: aload_2
    //   362: monitorexit
    //   363: ldc2_w 954
    //   366: ldc_w 956
  ...
  public static final class a
    extends com.tencent.mm.bn.a<com.tencent.mm.kernel.api.b>
    implements com.tencent.mm.kernel.api.b
  {
    ...
    public final List<String> collectStoragePaths()
    {
      ...
      while (((Iterator)localObject1).hasNext())
      {
        ...
        if (localObject2 != null)
        {
          localObject2 = ((com.tencent.mm.kernel.api.b)((com.tencent.mm.vending.b.b)localObject2).wAt).collectStoragePaths();
          if (localObject2 != null) {
  ...
  static final class b
    extends com.tencent.mm.bn.a<com.tencent.mm.kernel.api.e>
  ...
  static final class c
    extends com.tencent.mm.bn.a<com.tencent.mm.kernel.api.f>
    implements com.tencent.mm.kernel.api.f
  {
    ...
    public final void aR(final boolean paramBoolean)
    {
    ...
    public final void eg(final String paramString)
    {
  ...
  public static final class e
    extends com.tencent.mm.bn.a<g.a>
    implements g.a
  {
    e()
    {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/kernel/e.class
