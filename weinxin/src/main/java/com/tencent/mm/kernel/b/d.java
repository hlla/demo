  ...
  implements c
{
  ...
  private void checkIfNeedDefaultDependency()
  {
    ...
    i.vN();
    Object localObject = i.vE();
    Class localClass = getClass();
    if (!((com.tencent.mm.kernel.c)localObject).gXG.aq(localClass))
    {
      i.vN();
      localObject = i.vE().gXJ;
      if (localObject != null)
      {
  ...
  public void pin(b paramb)
  {
    try
    {
      ...
      if (!this.mPins.contains(paramb))
      {
        ...
        i.vN();
        i.vE().a(paramb.getClass(), new com.tencent.mm.kernel.c.c(paramb));
      }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/kernel/b/d.class
