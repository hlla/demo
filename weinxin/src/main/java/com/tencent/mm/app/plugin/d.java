  ...
  implements l.i
{
  ...
  private static String a(String paramString1, int paramInt1, int paramInt2, String paramString2)
  {
    ...
    if ((bf.mA(paramString1)) || (bf.mA(paramString2)) || (paramInt1 >= paramInt2))
    {
  ...
  public final String p(Context paramContext, String paramString)
  {
    ...
    paramContext = a.aU(paramContext, paramString);
    ...
    if (localIterator.hasNext())
    {
      ...
      default: 
        ...
        {
          str2 = locali.url;
          if ((locali.type == 1) && (!str2.startsWith("http://")))
          {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/app/plugin/d.class
