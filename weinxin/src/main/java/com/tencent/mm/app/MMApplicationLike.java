  ...
  extends DefaultApplicationLike
{
  ...
  private void clearOldDirIfNewVersion()
  {
    ...
    com.tencent.mm.sdk.e.a locala = new com.tencent.mm.sdk.e.a(com.tencent.mm.loader.stub.a.hgg + "NowRev.ini");
    ...
    if (!this.mNewVersionCode.equals(this.mOldVersionCode))
    {
      ...
      locala.eC("NowRev", this.mNewVersionCode);
      this.mSetRevTime = (System.currentTimeMillis() - l2);
      v.w("MicroMsg.MMApplication", "application hash:%s, %s", new Object[] { hash, new ag().toString() });
    }
    v.i("MicroMsg.MMApplication", "clearOldDirIfNewVersion oldversion:%s, newversion:%s, gettime:%d, settime:%d", new Object[] { this.mOldVersionCode, this.mNewVersionCode, Long.valueOf(this.mGetRevTime), Long.valueOf(this.mSetRevTime) });
  ...
  private void setPatchRev(ApplicationLike paramApplicationLike)
  {
    ...
    if ((paramApplicationLike != null) && (ShareIntentUtil.an(paramApplicationLike) == 0)) {}
    for (paramApplicationLike = ShareIntentUtil.at(paramApplicationLike);; paramApplicationLike = null)
    {
      if (paramApplicationLike != null)
      {
        BaseBuildInfo.PATCH_REV = (String)paramApplicationLike.get("patch.rev");
        v.w("MicroMsg.MMApplication", "application set patch rev:%s", new Object[] { BaseBuildInfo.PATCH_REV });
      }
      GMTrace.o(14012867674112L, 104404);
      return;
    }
  ...
  public Resources getResources(Resources paramResources)
  {
    ...
    paramResources = aa.getResources();
    GMTrace.o(14013672980480L, 104410);
    return paramResources;
  }
  ...
  public void onBaseContextAttached(Context paramContext)
  {
    ...
    String str = d.q(paramContext, Process.myPid());
    v.yp(0);
    Application localApplication = getApplication();
    if (!"com.tencent.mm:cuploader".equals(str))
    {
      ah.a(new g.1(localApplication, str));
      ah.a(new g.2());
    }
    ...
    try
    {
      this.wrapper = ((ApplicationLifeCycle)Class.forName(aa.getPackageName() + ".app.MMApplicationWrapper").getConstructor(new Class[] { MMApplicationLike.class, String.class }).newInstance(new Object[] { this, str }));
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/app/MMApplicationLike.class
