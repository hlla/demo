    ...
    for (;;)
    {
      ...
      for (int j = 1;; j = 0)
      {
        if (j != 0)
        {
          ...
          ShareTinkerInternals.hG(localApplicationLike.getApplication());
          b.d(localApplicationLike);
          ShareTinkerInternals.hC(localApplicationLike.getApplication());
          GMTrace.o(14012465020928L, 104401);
          return;
          i = 0;
          break;
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/app/n.class
