...
public final class s
{
  ...
  public static int a(String paramString, int paramInt, byte[] paramArrayOfByte)
  {
    ...
    //   9: aload_0
    //   10: invokestatic 163	com/tencent/mm/sdk/platformtools/bf:mA	(Ljava/lang/String;)Z
    //   13: ifeq +48 -> 61
    //   16: ldc -91
    ...
    //   27: invokestatic 175	com/tencent/mm/compatible/util/g:sd	()Ljava/lang/String;
    ...
    //   41: invokestatic 183	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   44: invokestatic 187	com/tencent/mm/compatible/util/g:sb	()I
    //   47: istore_1
    //   48: ldc2_w 156
    //   51: sipush 2596
    ...
    //   76: invokestatic 175	com/tencent/mm/compatible/util/g:sd	()Ljava/lang/String;
    ...
    //   103: invokestatic 183	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   106: invokestatic 187	com/tencent/mm/compatible/util/g:sb	()I
    //   109: istore_1
    //   110: ldc2_w 156
    //   113: sipush 2596
    ...
    //   122: ireturn
    //   123: aload_2
    //   124: invokestatic 198	com/tencent/mm/sdk/platformtools/bf:bm	([B)Z
    //   127: ifeq +57 -> 184
    //   130: ldc -91
    ...
    //   141: invokestatic 175	com/tencent/mm/compatible/util/g:sd	()Ljava/lang/String;
    ...
    //   164: invokestatic 183	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   167: invokestatic 187	com/tencent/mm/compatible/util/g:sb	()I
    //   170: istore_1
    //   171: ldc2_w 156
    //   174: sipush 2596
    ...
    //   207: astore 12
    //   209: aload 14
    //   211: invokevirtual 213	com/tencent/mm/compatible/util/g$a:se	()J
    //   214: lstore 4
    //   216: aload 13
    //   218: astore 12
    //   220: aload 13
    ...
    //   229: astore 12
    //   231: aload 14
    //   233: invokevirtual 213	com/tencent/mm/compatible/util/g$a:se	()J
    //   236: lstore 6
    //   238: aload 13
    //   240: astore 12
    //   242: aload 13
    ...
    //   253: astore 12
    //   255: aload 14
    //   257: invokevirtual 213	com/tencent/mm/compatible/util/g$a:se	()J
    //   260: lstore 8
    //   262: aload 13
    //   264: astore 12
    //   266: aload 13
    ...
    //   275: astore 12
    //   277: aload 14
    //   279: invokevirtual 213	com/tencent/mm/compatible/util/g$a:se	()J
    //   282: lstore 10
    //   284: aload 13
    ...
    //   300: invokestatic 175	com/tencent/mm/compatible/util/g:sd	()Ljava/lang/String;
    ...
    //   337: invokestatic 236	com/tencent/mm/sdk/platformtools/v:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   340: ldc -91
    //   342: new 130	java/lang/StringBuilder
    //   345: dup
    //   346: ldc -27
    //   348: invokespecial 170	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   351: invokestatic 175	com/tencent/mm/compatible/util/g:sd	()Ljava/lang/String;
    ...
    //   409: invokestatic 236	com/tencent/mm/sdk/platformtools/v:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   412: ldc2_w 156
    //   415: sipush 2596
    ...
    //   441: invokestatic 175	com/tencent/mm/compatible/util/g:sd	()Ljava/lang/String;
    ...
    //   487: invokestatic 183	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   490: aload_2
    //   491: astore 12
    //   493: invokestatic 187	com/tencent/mm/compatible/util/g:sb	()I
    //   496: istore_1
    //   497: aload_2
    //   498: ifnull +7 -> 505
    //   501: aload_2
  ...
  private boolean al(String paramString1, String paramString2)
  {
    ...
    v.i("MicroMsg.VideoInfoStorage", "saveVideoHash path:%s xml:%s stack:%s", new Object[] { paramString1, paramString2, bf.bJP() });
    long l1 = bf.NA();
    ...
    Object localObject = lz(paramString1);
    ...
    localObject = this.hnp.a("select cdnxml from VideoHash where size = " + j + " and hash = \"" + localStringBuffer.toString() + "\"", null, 2);
    ...
    {
      v.w("MicroMsg.VideoInfoStorage", "saveVideoHash Check exist now return,time:%d,  path:%s xml:%s", new Object[] { Long.valueOf(bf.aA(l1)), paramString1, paramString2 });
      GMTrace.o(349100310528L, 2601);
      return true;
    }
    if (localVector.size() > 0)
    {
      com.tencent.mm.plugin.report.service.g.oSF.i(12696, new Object[] { Integer.valueOf(102), Integer.valueOf(j), "", "", Integer.valueOf(localVector.size()) });
      ...
      this.hnp.eE("VideoHash", "delete from VideoHash where size = " + j + " and hash = \"" + localStringBuffer.toString() + "\"");
    }
    localObject = new ContentValues();
    ((ContentValues)localObject).put("size", Integer.valueOf(j));
    ((ContentValues)localObject).put("CreateTime", Long.valueOf(bf.Nz()));
    ...
    long l2 = this.hnp.insert("VideoHash", "", (ContentValues)localObject);
    v.i("MicroMsg.VideoInfoStorage", "summersafecdn saveVideoHash time:%d insert:%d path:%s hash:%s xml:%s", new Object[] { Long.valueOf(bf.aA(l1)), Long.valueOf(l2), paramString1, localStringBuffer, paramString2 });
    if (l2 < 0L)
    {
      com.tencent.mm.plugin.report.service.g.oSF.i(12696, new Object[] { Integer.valueOf(103), Integer.valueOf(j) });
  ...
  public static b h(String paramString, int paramInt1, int paramInt2)
  {
    ...
    //   16: astore 16
    //   18: aload_0
    //   19: invokestatic 163	com/tencent/mm/sdk/platformtools/bf:mA	(Ljava/lang/String;)Z
    //   22: ifeq +53 -> 75
    //   25: ldc -91
    ...
    //   36: invokestatic 175	com/tencent/mm/compatible/util/g:sd	()Ljava/lang/String;
    ...
    //   50: invokestatic 183	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   53: aload 16
    //   55: iconst_0
    //   56: invokestatic 187	com/tencent/mm/compatible/util/g:sb	()I
    //   59: isub
    ...
    //   90: invokestatic 175	com/tencent/mm/compatible/util/g:sd	()Ljava/lang/String;
    //   93: invokevirtual 147	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   96: ldc -67
    ...
    //   118: invokestatic 183	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   121: aload 16
    //   123: iconst_0
    //   124: invokestatic 187	com/tencent/mm/compatible/util/g:sb	()I
    //   127: isub
    ...
    //   158: invokestatic 175	com/tencent/mm/compatible/util/g:sd	()Ljava/lang/String;
    ...
    //   182: invokestatic 183	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   185: aload 16
    //   187: iconst_0
    //   188: invokestatic 187	com/tencent/mm/compatible/util/g:sb	()I
    //   191: isub
    ...
    //   239: astore 13
    //   241: aload 15
    //   243: invokevirtual 213	com/tencent/mm/compatible/util/g$a:se	()J
    //   246: lstore 5
    //   248: aload 14
    //   250: astore 13
    //   252: aload 14
    ...
    //   261: astore 13
    //   263: aload 15
    //   265: invokevirtual 213	com/tencent/mm/compatible/util/g$a:se	()J
    //   268: lstore 7
    //   270: aload 14
    //   272: astore 13
    //   274: aload 14
    ...
    //   290: astore 13
    //   292: aload 15
    //   294: invokevirtual 213	com/tencent/mm/compatible/util/g$a:se	()J
    //   297: lstore 9
    //   299: aload 14
    //   301: astore 13
    //   303: aload 15
    //   305: invokevirtual 213	com/tencent/mm/compatible/util/g$a:se	()J
    //   308: lstore 11
    //   310: iload 4
    //   312: istore_3
    //   313: iload 4
    ...
    //   324: aload 16
    //   326: iload_3
    //   327: putfield 434	com/tencent/mm/modelvideo/s$b:fAB	I
    //   330: aload 14
    //   332: astore 13
    //   334: aload 16
    //   336: iload_3
    //   337: iload_1
    //   338: iadd
    //   339: putfield 437	com/tencent/mm/modelvideo/s$b:iav	I
    //   342: aload 14
    ...
    //   358: invokestatic 175	com/tencent/mm/compatible/util/g:sd	()Ljava/lang/String;
    ...
    //   395: invokestatic 236	com/tencent/mm/sdk/platformtools/v:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   398: ldc -91
    //   400: new 130	java/lang/StringBuilder
    //   403: dup
    //   404: ldc -27
    //   406: invokespecial 170	java/lang/StringBuilder:<init>	(Ljava/lang/String;)V
    //   409: invokestatic 175	com/tencent/mm/compatible/util/g:sd	()Ljava/lang/String;
    ...
    //   467: invokestatic 236	com/tencent/mm/sdk/platformtools/v:d	(Ljava/lang/String;Ljava/lang/String;)V
    //   470: ldc2_w 411
    //   473: sipush 2597
    ...
    //   502: invokestatic 175	com/tencent/mm/compatible/util/g:sd	()Ljava/lang/String;
    ...
    //   522: aload 16
    //   524: getfield 437	com/tencent/mm/modelvideo/s$b:iav	I
    ...
    //   552: invokestatic 183	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   555: aload 14
    //   557: astore 13
    //   559: aload 16
    //   561: iconst_0
    //   562: invokestatic 187	com/tencent/mm/compatible/util/g:sb	()I
    //   565: isub
  ...
  public static String lx(String paramString)
  {
    ...
    paramString = Lt() + paramString + ".jpg";
    GMTrace.o(348295004160L, 2595);
    return paramString;
  }
  ...
  /* Error */
  static int[] lz(String paramString)
  {
    // Byte code:
    //   0: ldc2_w 510
    //   3: sipush 2600
    ...
    //   13: astore 10
    //   15: invokestatic 272	com/tencent/mm/sdk/platformtools/bf:NA	()J
    //   18: lstore 4
    //   20: aload_0
    //   21: invokestatic 514	com/tencent/mm/a/e:aN	(Ljava/lang/String;)I
    //   24: istore_2
    //   25: iload_2
    //   26: ldc_w 515
    //   29: if_icmplt +10 -> 39
    ...
    //   57: aload_0
    //   58: aastore
    //   59: invokestatic 276	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   62: getstatic 362	com/tencent/mm/plugin/report/service/g:oSF	Lcom/tencent/mm/plugin/report/service/g;
    //   65: astore_0
    //   66: iload_2
    //   67: ldc_w 515
    //   70: if_icmpge +45 -> 115
    ...
    //   250: iconst_0
    //   251: lload 4
    //   253: invokestatic 348	com/tencent/mm/sdk/platformtools/bf:aA	(J)J
    ...
    //   269: aload_0
    //   270: aastore
    //   271: invokestatic 269	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   274: aload 9
    ...
    //   314: iconst_1
    //   315: aload 10
    //   317: invokestatic 536	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
    //   320: aastore
    //   321: invokestatic 276	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   324: aload 9
    //   326: ifnull +8 -> 334
    //   329: aload 9
  ...
  public final List<r> Ln()
  {
    ...
    ((Cursor)localObject).close();
    v.d("MicroMsg.VideoInfoStorage", "getUnfinishMassInfo resCount:" + i);
    GMTrace.o(347087044608L, 2586);
    return localArrayList;
  }
  
  public final List<r> Lo()
  {
  ...
  public final List<String> Lp()
  {
    ...
    //   51: astore_2
    //   52: aload_0
    //   53: getfield 123	com/tencent/mm/modelvideo/s:hnp	Lcom/tencent/mm/bj/g;
    //   56: aload_2
    //   57: aconst_null
    //   58: iconst_2
    //   59: invokevirtual 306	com/tencent/mm/bj/g:a	(Ljava/lang/String;[Ljava/lang/String;I)Landroid/database/Cursor;
    //   62: astore_2
    //   63: aload_2
    //   64: invokeinterface 577 1 0
    //   69: ifeq +36 -> 105
    //   72: new 546	java/util/ArrayList
    //   75: dup
    //   76: invokespecial 547	java/util/ArrayList:<init>	()V
    //   79: astore_3
    //   80: aload_3
    //   81: aload_2
    //   82: iconst_0
    //   83: invokeinterface 318 2 0
    //   88: invokeinterface 556 2 0
    //   93: pop
    //   94: aload_2
  ...
  public final List<String> Lq()
  {
    ...
    try
    {
      localObject1 = this.hnp.a((String)localObject1, null, 2);
      boolean bool;
  ...
  public final List<r> a(int paramInt1, int paramInt2, long paramLong)
  {
    ...
    //   55: astore 6
    //   57: aload_0
    //   58: getfield 123	com/tencent/mm/modelvideo/s:hnp	Lcom/tencent/mm/bj/g;
    //   61: aload 6
    //   63: aconst_null
    //   64: iconst_2
    //   65: invokevirtual 306	com/tencent/mm/bj/g:a	(Ljava/lang/String;[Ljava/lang/String;I)Landroid/database/Cursor;
    //   68: astore 6
    //   70: aload 6
    //   72: invokeinterface 577 1 0
    //   77: ifeq +52 -> 129
    //   80: new 546	java/util/ArrayList
    //   83: dup
    //   84: invokespecial 547	java/util/ArrayList:<init>	()V
    //   87: astore 7
    //   89: new 549	com/tencent/mm/modelvideo/r
    //   92: dup
    //   93: invokespecial 550	com/tencent/mm/modelvideo/r:<init>	()V
    //   96: astore 8
    //   98: aload 8
    //   100: aload 6
    //   102: invokevirtual 553	com/tencent/mm/modelvideo/r:b	(Landroid/database/Cursor;)V
    //   105: aload 7
    //   107: aload 8
  ...
  public final boolean a(r paramr)
  {
    ...
    paramr.fRM = -1;
    ContentValues localContentValues = paramr.pv();
    if ((int)this.hnp.insert("videoinfo2", "filename", localContentValues) != -1)
    {
      paramr = new s.a.a(paramr.getFileName(), s.a.b.ian, s.a.c.iar, paramr.iac, paramr.hYm);
      this.hqL.by(paramr);
      this.hqL.doNotify();
  ...
  public final List<r> au(long paramLong)
  {
  ...
  public final boolean b(r paramr)
  {
    ...
    label71:
    label76:
    while (this.hnp.update("videoinfo2", (ContentValues)localObject, "filename= ?", new String[] { paramr.getFileName() }) <= 0)
    {
    ...
    Object localObject = s.a.c.iar;
    if (paramr.status == 112) {}
    for (localObject = s.a.c.iat;; localObject = s.a.c.ias) {
      do
      {
        paramr = new s.a.a(paramr.getFileName(), s.a.b.iap, (s.a.c)localObject, paramr.iac, paramr.hYm);
        this.hqL.by(paramr);
        this.hqL.doNotify();
        GMTrace.o(347355480064L, 2588);
        return true;
  ...
  public final r lt(String paramString)
  {
    Object localObject = null;
    GMTrace.i(346818609152L, 2584);
    paramString = "select videoinfo2.filename,videoinfo2.clientid,videoinfo2.msgsvrid,videoinfo2.netoffset,videoinfo2.filenowsize,videoinfo2.totallen,videoinfo2.thumbnetoffset,videoinfo2.thumblen,videoinfo2.status,videoinfo2.createtime,videoinfo2.lastmodifytime,videoinfo2.downloadtime,videoinfo2.videolength,videoinfo2.msglocalid,videoinfo2.nettimes,videoinfo2.cameratype,videoinfo2.user,videoinfo2.human,videoinfo2.reserved1,videoinfo2.reserved2,videoinfo2.reserved3,videoinfo2.reserved4,videoinfo2.videofuncflag,videoinfo2.masssendid,videoinfo2.masssendlist,videoinfo2.videomd5,videoinfo2.streamvideo,videoinfo2.statextstr,videoinfo2.downloadscene,videoinfo2.mmsightextinfo,videoinfo2.preloadsize,videoinfo2.videoformat from videoinfo2   where videoinfo2.filename = \"" + bf.my(paramString) + "\"";
  ...
  public final boolean lu(String paramString)
  {
    ...
    if (this.hnp.delete("videoinfo2", "filename= ?", new String[] { paramString }) > 0)
    {
      paramString = new s.a.a(paramString, s.a.b.iao, s.a.c.iar, 1, -1L);
  ...
  public final boolean o(String paramString1, String paramString2, String paramString3)
  {
    ...
    boolean bool = al(paramString1, paramString2 + "##" + paramString3);
  ...
  public static abstract interface a
  {
    ...
    public static enum c
    {
      static
      {
        ...
        iar = new c("NORMAL", 0);
        ias = new c("UPLOAD", 1);
        iat = new c("DOWNLOAD", 2);
        iau = new c[] { iar, ias, iat };
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/modelvideo/s.class
