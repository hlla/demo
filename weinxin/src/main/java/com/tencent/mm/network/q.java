  ...
  extends IInterface
{
    ...
    implements q
  {
    ...
    public static q F(IBinder paramIBinder)
    {
    ...
    public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
    {
      ...
      case 5: 
        paramParcel1.enforceInterface("com.tencent.mm.network.IReqResp_AIDL");
        a(i.a.D(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt());
        paramParcel2.writeNoException();
        GMTrace.o(13677591789568L, 101906);
        return true;
      case 6: 
      ...
      case 9: 
        paramParcel1.enforceInterface("com.tencent.mm.network.IReqResp_AIDL");
        hz(paramParcel1.readString());
        paramParcel2.writeNoException();
        GMTrace.o(13677591789568L, 101906);
        return true;
      case 10: 
        paramParcel1.enforceInterface("com.tencent.mm.network.IReqResp_AIDL");
        a(i.a.D(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt(), paramParcel1.readString());
        paramParcel2.writeNoException();
        GMTrace.o(13677591789568L, 101906);
        return true;
      case 11: 
        paramParcel1.enforceInterface("com.tencent.mm.network.IReqResp_AIDL");
        a(d.a.A(paramParcel1.readStrongBinder()), i.a.D(paramParcel1.readStrongBinder()), paramParcel1.readInt(), paramParcel1.readInt());
        paramParcel2.writeNoException();
        GMTrace.o(13677591789568L, 101906);
        return true;
      }
      ...
      implements q
    {
      ...
      public final g Cm()
      {
        ...
        try
        {
          ...
          localParcel2.readException();
          g localg = g.a.Y(localParcel2.readStrongBinder());
          localParcel2.recycle();
          localParcel1.recycle();
      ...
      public final h Cn()
      {
        ...
        try
        {
          ...
          localParcel2.readException();
          h localh = h.a.Z(localParcel2.readStrongBinder());
          localParcel2.recycle();
          localParcel1.recycle();
      ...
      public final void a(d paramd, i parami, int paramInt1, int paramInt2)
      {
        ...
        //   78: aload_0
        //   79: getfield 27	com/tencent/mm/network/q$a$a:mRemote	Landroid/os/IBinder;
        //   82: bipush 11
        //   84: aload 6
        //   86: aload 7
        //   88: iconst_0
      ...
      public final void a(i parami, int paramInt1, int paramInt2)
      {
        ...
        //   54: aload_0
        //   55: getfield 27	com/tencent/mm/network/q$a$a:mRemote	Landroid/os/IBinder;
        //   58: iconst_5
        //   59: aload 4
        //   61: aload 5
        //   63: iconst_0
      ...
      public final void a(i parami, int paramInt1, int paramInt2, String paramString)
      {
        ...
        //   61: aload_0
        //   62: getfield 27	com/tencent/mm/network/q$a$a:mRemote	Landroid/os/IBinder;
        //   65: bipush 10
        //   67: aload 5
        //   69: aload 6
        //   71: iconst_0
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/network/q.class
