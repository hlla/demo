...
{
  public static final String ifp;
  ...
  static
  {
    ...
    {
      ifq = 270L;
      new StringBuilder("getNoopIntervalInMs use hard code noop:").append(ifq);
      l = ifq * 1000L;
    }
    for (;;)
    {
      ...
      {
        ifq = 270L;
        new StringBuilder("getNoopIntervalInMs use wx noop:").append(ifq);
        l = ifq * 1000L;
      }
    }
    ...
    label268:
    for (ifq = localObject[0];; ifq = 270L)
    {
      lastUpdateTime = l;
      new StringBuilder("getNoopIntervalInMs use sync noop:").append(ifq);
      l = ifq * 1000L;
      break;
    }
  }
  ...
  private static long[] MV()
  {
    ...
    //   27: dup
    //   28: getstatic 42	com/tencent/mm/network/ac:ifp	Ljava/lang/String;
  ...
  public static void f(long paramLong1, long paramLong2)
  {
    ...
    //   39: lcmp
    //   40: ifgt +40 -> 80
    //   43: invokestatic 50	com/tencent/mm/sdk/platformtools/aa:getContext	()Landroid/content/Context;
    //   46: ldc 52
    //   48: iconst_0
    ...
    //   92: lcmp
    //   93: ifgt +48 -> 141
    //   96: invokestatic 50	com/tencent/mm/sdk/platformtools/aa:getContext	()Landroid/content/Context;
    //   99: ldc 52
    //   101: iconst_0
    ...
    //   172: return
    //   173: invokestatic 50	com/tencent/mm/sdk/platformtools/aa:getContext	()Landroid/content/Context;
    //   176: ldc 52
    //   178: iconst_0
    ...
    //   250: dup
    //   251: getstatic 42	com/tencent/mm/network/ac:ifp	Ljava/lang/String;
    //   254: invokespecial 116	java/io/File:<init>	(Ljava/lang/String;)V
    //   257: astore 8
    //   259: aload 8
    //   261: invokevirtual 120	java/io/File:exists	()Z
    //   264: ifeq +39 -> 303
    //   267: invokestatic 105	com/tencent/mm/network/ac:MV	()[J
    //   270: astore 8
    //   272: aload 8
    //   274: iconst_1
    //   275: laload
    ...
    //   337: dup
    //   338: getstatic 42	com/tencent/mm/network/ac:ifp	Ljava/lang/String;
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/network/ac.class
