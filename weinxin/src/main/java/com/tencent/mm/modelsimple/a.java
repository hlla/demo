...
final class a
{
  ...
  public static BindWordingContent kw(String paramString)
  {
          ...
          if (str2.trim().length() > 0)
          {
            ...
            else
            {
              ...
              if (paramString.equalsIgnoreCase("type")) {
                try
                {
                  localBindWordingContent.hRg = Integer.valueOf(str2);
                  localObject = paramString;
                }
                catch (Exception localException)
                {
                  localBindWordingContent.hRg = Integer.valueOf(0);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/modelsimple/a.class
