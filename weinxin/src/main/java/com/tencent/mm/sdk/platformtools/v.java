...
public final class v
{
  ...
  private static a uqU;
  private static a uqV;
  ...
  static
  {
    ...
    try
    {
      ...
      rmD = ((StringBuilder)localObject).toString();
  ...
  public static void d(String paramString1, String paramString2, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      uqV.logD(paramString1, "", "", Process.myTid(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), paramVarArgs);
  ...
  public static void e(String paramString1, String paramString2, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      uqV.logE(paramString1, "", "", Process.myTid(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), paramVarArgs);
  ...
  public static void f(String paramString1, String paramString2, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      uqV.logF(paramString1, "", "", Process.myTid(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), paramString2);
  ...
  public static void h(String paramString1, String paramString2, Object... paramVarArgs)
  {
    ...
    if ((uqV != null) && (uqV.getLogLevel() <= 1))
    {
      ...
      paramString2 = paramString2 + "  " + new ag();
      uqV.logI(paramString1, "", "", Process.myTid(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), paramString2);
    }
  ...
  public static void i(String paramString1, String paramString2, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      uqV.logI(paramString1, "", "", Process.myTid(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), paramVarArgs);
  ...
  public static void printErrStackTrace(String paramString1, Throwable paramThrowable, String paramString2, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      uqV.logE(paramString1, "", "", Process.myTid(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), paramThrowable);
  ...
  public static void v(String paramString1, String paramString2, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      uqV.logV(paramString1, "", "", Process.myTid(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), paramVarArgs);
  ...
  public static void w(String paramString1, String paramString2, Object... paramVarArgs)
  {
    ...
    for (;;)
    {
      ...
      uqV.logW(paramString1, "", "", Process.myTid(), Process.myPid(), Thread.currentThread().getId(), Looper.getMainLooper().getThread().getId(), paramVarArgs);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/sdk/platformtools/v.class
