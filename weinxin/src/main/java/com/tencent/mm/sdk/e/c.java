...
public abstract class c
{
  ...
  public static boolean a(ContentValues paramContentValues, Cursor paramCursor)
  {
    ...
    for (;;)
    {
      ...
      {
        v.printErrStackTrace("MicroMsg.SDK.IAutoDBItem", paramContentValues, "", new Object[0]);
        GMTrace.o(13965220380672L, 104049);
        return false;
      }
      GMTrace.o(13965220380672L, 104049);
  ...
  private static Map<String, String> b(Field[] paramArrayOfField)
  {
    ...
    if (i < paramArrayOfField.length)
    {
      ...
      String str = b.t(((Field)localObject).getType());
      if (str == null) {
  ...
  private static String c(Field[] paramArrayOfField)
  {
    ...
    if (i < paramArrayOfField.length)
    {
      ...
      localObject = b.t(localField.getType());
      if (localObject == null) {
      ...
      str1 = " default '" + ((h)localField.getAnnotation(h.class)).bKe() + "' ";
    }
    for (int j = ((h)localField.getAnnotation(h.class)).bKf();; j = 0)
    {
  ...
  public static Field[] u(Class<?> paramClass)
  {
    GMTrace.i(13965086162944L, 104048);
    a locala = new a();
    ...
    if (i < j)
    {
      ...
      if ((str != null) && (Modifier.isPublic(k)) && (!Modifier.isFinal(k)))
      {
        ...
        if (((h)localField.getAnnotation(h.class)).bKf() == 1) {
          locala.uvq = paramClass;
        }
      }
      for (;;)
      {
    ...
    locala.hXn = ((Field[])localLinkedList.toArray(new Field[0]));
    locala.columns = a(locala.hXn);
    locala.uvr = b(locala.hXn);
    locala.uvs = c(locala.hXn);
    paramClass = locala.hXn;
    GMTrace.o(13965086162944L, 104048);
    return paramClass;
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/sdk/e/c.class
