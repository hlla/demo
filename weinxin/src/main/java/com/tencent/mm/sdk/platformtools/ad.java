  ...
  implements af.a
{
  ...
  public ad()
  {
    ...
    if (getLooper().getThread().getName().equals("initThread")) {
      v.e("MicroMsg.MMHandler", "MMHandler can not init handler with initThread looper, stack %s", new Object[] { bf.bJP() });
    }
    GMTrace.o(13941195407360L, 103870);
  }
  
  public ad(Looper paramLooper)
  {
    GMTrace.i(13941329625088L, 103871);
    this.map = new ConcurrentHashMap();
    this.latestTasks = new LinkedList();
    this.toStringResult = null;
    this.handler = new af(paramLooper, this);
  ...
  public ad(Looper paramLooper, a parama)
  {
    GMTrace.i(13941598060544L, 103873);
    this.map = new ConcurrentHashMap();
    this.latestTasks = new LinkedList();
    this.toStringResult = null;
    this.handler = new af(paramLooper, parama, this);
    if (paramLooper.getThread().getName().equals("initThread")) {
      v.e("MicroMsg.MMHandler", "MMHandler can not init handler with initThread looper, stack %s", new Object[] { bf.bJP() });
    }
  ...
  public ad(a parama)
  {
    ...
    this.latestTasks = new LinkedList();
    this.toStringResult = null;
    this.handler = new af(parama, this);
    if (getLooper().getThread().getName().equals("initThread")) {
      v.e("MicroMsg.MMHandler", "MMHandler can not init handler with initThread looper, stack %s", new Object[] { bf.bJP() });
    }
  ...
  public static String dump(Runnable paramRunnable, boolean paramBoolean)
  {
    ...
    if ((paramRunnable instanceof aj))
    {
      paramRunnable = ((aj)paramRunnable).dump(paramBoolean);
      GMTrace.o(13947235205120L, 103915);
  ...
  public String dump(boolean paramBoolean)
  {
    ...
    if (localIterator != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (aj)((WeakReference)localObject2).get();
          ((StringBuilder)localObject1).append("[index = " + i + " | taskinfo:" + ((aj)localObject2).dump(paramBoolean) + "]\n");
        }
        i += 1;
      }
    }
  ...
  public String dumpLatestTasks(boolean paramBoolean)
  {
    ...
    if (localIterator != null)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          localObject2 = (aj)((WeakReference)localObject2).get();
          ((StringBuilder)localObject1).append("[index = " + i + "|task=" + ((aj)localObject2).dump(paramBoolean) + "]");
        }
        i += 1;
      }
    }
  ...
  public Runnable findTaskByName(String paramString)
  {
    ...
    if (localIterator != null) {
      while (localIterator.hasNext())
      {
        ...
        {
          localObject = (aj)((WeakReference)localObject).get();
          if (((aj)localObject).mih.equals(paramString))
          {
            v.i("MicroMsg.MMHandler", "findTaskByName: %s, found task info: %s", new Object[] { paramString, ((aj)localObject).dump(true) });
            GMTrace.o(13947503640576L, 103917);
  ...
  public Runnable findTaskByRunTime(long paramLong)
  {
    ...
    while ((localIterator != null) && (localIterator.hasNext()))
    {
      ...
      {
        localObject = (aj)((WeakReference)localObject).get();
        if ((((aj)localObject).started) && (((aj)localObject).hpd >= ((aj)localObject).urP) && (l - ((aj)localObject).hpd > paramLong))
        {
          v.i("MicroMsg.MMHandler", "findTaskByRunTime limit: %d, found task info: %s", new Object[] { Long.valueOf(paramLong), ((aj)localObject).dump(true) });
  ...
  public final void onTaskAdded(Runnable paramRunnable, aj paramaj)
  {
    GMTrace.i(13945758810112L, 103904);
    this.map.put(paramRunnable, new WeakReference(paramaj));
    GMTrace.o(13945758810112L, 103904);
  }
  
  public final void onTaskRunEnd(Runnable paramRunnable, aj paramaj)
  {
    GMTrace.i(13945893027840L, 103905);
    WeakReference localWeakReference = (WeakReference)this.map.get(paramRunnable);
    if ((localWeakReference != null) && (localWeakReference.get() != null) && (localWeakReference.get() == paramaj))
    {
  ...
  public final void removeCallbacks(Runnable paramRunnable, Object paramObject)
  {
    ...
    WeakReference localWeakReference = (WeakReference)this.map.get(paramRunnable);
    if ((localWeakReference != null) && (localWeakReference.get() != null) && ((paramObject == null) || (((aj)localWeakReference.get()).urN == paramObject))) {
    ...
    if (localIterator != null) {
      while (localIterator.hasNext())
      {
        ...
        if (localObject != null)
        {
          ...
          if ((localObject != null) && (((WeakReference)localObject).get() != null) && (((aj)((WeakReference)localObject).get()).urN == paramObject)) {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/sdk/platformtools/ad.class
