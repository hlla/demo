...
public final class BackwardSupportUtil
{
  ...
  {
    public static int Pb(String paramString)
    {
    ...
    public static LatLongData Pc(String paramString)
    {
      ...
      if (paramString != null)
      {
        ...
        localLatLongData.fNS = ((float)paramString.latitude);
        localLatLongData.hGC = ((float)paramString.longitude);
        GMTrace.o(13772349505536L, 102612);
      ...
      implements Parcelable
    {
      ...
      public LatLongData(float paramFloat1, float paramFloat2)
      {
        ...
        this.fNS = paramFloat1;
        this.hGC = paramFloat2;
      ...
      public boolean equals(Object paramObject)
      {
        ...
        if ((Math.abs(this.fNS - ((LatLongData)paramObject).fNS) < 1.0E-6F) && (Math.abs(this.hGC - ((LatLongData)paramObject).hGC) < 1.0E-6F))
        {
          GMTrace.o(13770202021888L, 102596);
          return true;
        }
      ...
      public int hashCode()
      {
        ...
        int i = (int)(this.fNS * 10000.0F);
        int j = (int)(this.hGC * 10000.0F);
      ...
      public void writeToParcel(Parcel paramParcel, int paramInt)
      {
        ...
        paramParcel.writeFloat(this.fNS);
        paramParcel.writeFloat(this.hGC);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/sdk/platformtools/BackwardSupportUtil.class
