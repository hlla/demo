...
public class MMessageActV2
{
  ...
  public static boolean send(Context paramContext, Args paramArgs)
  {
    ...
    localIntent.putExtra("_mmessage_sdkVersion", 620757000);
    localIntent.putExtra("_mmessage_appPackage", str);
    localIntent.putExtra("_mmessage_content", paramArgs.content);
    localIntent.putExtra("_mmessage_checksum", b.a(paramArgs.content, 620757000, str));
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/opensdk/channel/MMessageActV2.class
