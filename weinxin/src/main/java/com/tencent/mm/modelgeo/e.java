  ...
  implements TencentLocationListener
{
  ...
  public void onLocationChanged(TencentLocation paramTencentLocation, int paramInt, String paramString)
  {
    ...
    v.i("MicroMsg.SLocationListener", "lat=%f, lng=%f, accuracy=%f errcode=%d, areastat=%d, speed=%f, bearing=%f, reason=%s, provider=%s", new Object[] { Double.valueOf(paramTencentLocation.getLatitude()), Double.valueOf(paramTencentLocation.getLongitude()), Float.valueOf(paramTencentLocation.getAccuracy()), Integer.valueOf(paramInt), paramTencentLocation.getAreaStat(), Float.valueOf(paramTencentLocation.getSpeed()), Float.valueOf(paramTencentLocation.getBearing()), paramString, paramTencentLocation.getProvider() });
    if (paramInt == 0)
    {
      g.oSF.a(584L, 1L, 1L, true);
    ...
    g.oSF.a(584L, 2L, 1L, true);
    if (paramInt == 1) {
      g.oSF.a(584L, 3L, 1L, true);
    }
    for (;;)
    {
  ...
  public void onStatusUpdate(String paramString1, int paramInt, String paramString2)
  {
    ...
    v.d("MicroMsg.SLocationListener", "onStatusUpdate, name=%s, status=%d, desc=%s", new Object[] { paramString1, Integer.valueOf(paramInt), paramString2 });
    GMTrace.o(488552529920L, 3640);
  }
}


/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/modelgeo/e.class
