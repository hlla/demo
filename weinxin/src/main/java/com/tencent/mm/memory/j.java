  ...
  extends l
{
  ...
  private Bitmap a(InputStream paramInputStream, BitmapFactory.Options paramOptions, MMBitmapFactory.DecodeResultLogger paramDecodeResultLogger)
  {
    ...
    //   9: getstatic 32	com/tencent/mm/memory/h:hgx	Lcom/tencent/mm/memory/h;
    //   12: invokevirtual 36	com/tencent/mm/memory/h:bF	()Ljava/lang/Object;
    ...
    //   36: aload 4
    //   38: ifnull +101 -> 139
    //   41: getstatic 32	com/tencent/mm/memory/h:hgx	Lcom/tencent/mm/memory/h;
    //   44: aload 4
    ...
    //   78: aastore
    //   79: invokestatic 63	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   82: aload_1
    //   83: ifnull +51 -> 134
    //   86: getstatic 32	com/tencent/mm/memory/h:hgx	Lcom/tencent/mm/memory/h;
    //   89: aload_1
    ...
    //   102: aload_1
    //   103: ifnull +11 -> 114
    //   106: getstatic 32	com/tencent/mm/memory/h:hgx	Lcom/tencent/mm/memory/h;
    //   109: aload_1
    ...
    for (;;)
    {
      ...
      try
      {
        if (paramInputStream.getWidth() > paramRect.right - paramRect.left)
        {
          ...
          {
            v.i("MicroMsg.InBitmapFactory", "fuck region decode size not match, clip it, reqWidth: %s, reqHeight: %s, resultWidth: %s, resultHeight: %s", new Object[] { Integer.valueOf(paramRect.right - paramRect.left), Integer.valueOf(paramRect.bottom - paramRect.top), Integer.valueOf(paramInputStream.getWidth()), Integer.valueOf(paramInputStream.getHeight()) });
            paramOptions = Bitmap.createBitmap(paramInputStream, 0, 0, paramRect.right - paramRect.left, paramRect.bottom - paramRect.top);
          }
        }
        if (paramOptions != null) {
          v.i("MicroMsg.InBitmapFactory", "finish decode, decodedBitmap: %s, width: %s, height: %s", new Object[] { paramOptions, Integer.valueOf(paramOptions.getWidth()), Integer.valueOf(paramOptions.getHeight()) });
        }
      ...
      v.printErrStackTrace("MicroMsg.InBitmapFactory", localException, "decode with inBitmap error: %s, outWidth: %s, outHeight: %s, sampleSize: %s, reuseBitmapWidth: %s, reuseBitmapHeight: %s", new Object[] { str, Integer.valueOf(k), Integer.valueOf(m), Integer.valueOf(n), Integer.valueOf(i), Integer.valueOf(j) });
    }
  }
  ...
  private static BitmapFactory.Options a(InputStream paramInputStream, BitmapFactory.Options paramOptions, ByteBuffer paramByteBuffer, boolean paramBoolean, Rect paramRect)
  {
    ...
    if (paramRect == null)
    {
      v.i("MicroMsg.InBitmapFactory", "options.outWidth: %s, options.outHeight: %s, sampleSize: %s", new Object[] { Integer.valueOf(i), Integer.valueOf(j), Integer.valueOf(localOptions.inSampleSize) });
      if (!paramBoolean) {
        break label417;
      }
      paramInputStream = c.hgp;
      paramOptions = c.hgp;
      paramOptions = (Bitmap)paramInputStream.c(c.d(Integer.valueOf(i * j)));
    ...
    {
      v.i("MicroMsg.InBitmapFactory", "bitmapToReuse: %s, isRecycle: %s, isRegionDecode: %s, width: %s, height: %s", new Object[] { paramInputStream, Boolean.valueOf(bool), Boolean.valueOf(paramBoolean), Integer.valueOf(i), Integer.valueOf(j) });
      ...
      v.i("MicroMsg.InBitmapFactory", "mimetype: %s", new Object[] { localOptions.outMimeType });
      GMTrace.o(1286342705152L, 9584);
      return localOptions;
      i = paramRect.right - paramRect.left;
      j = paramRect.bottom - paramRect.top;
      v.i("MicroMsg.InBitmapFactory", "region decode, width: %s, height: %s, rect: %s", new Object[] { Integer.valueOf(i), Integer.valueOf(j), paramRect });
      break;
      paramInputStream = c.hgp;
      paramOptions = c.hgp;
      paramInputStream = paramInputStream.e(c.d(Integer.valueOf(j * i)));
      break label210;
      bool = false;
      break label224;
      i = 0;
  ...
  public final Bitmap a(String paramString, BitmapFactory.Options paramOptions, MMBitmapFactory.DecodeResultLogger paramDecodeResultLogger)
  {
    ...
    //   70: aastore
    //   71: invokestatic 151	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   74: aload 4
  ...
  public final Bitmap a(String paramString, Rect paramRect, BitmapFactory.Options paramOptions, MMBitmapFactory.DecodeResultLogger paramDecodeResultLogger)
  {
    ...
    //   19: astore_1
    //   20: getstatic 32	com/tencent/mm/memory/h:hgx	Lcom/tencent/mm/memory/h;
    //   23: invokevirtual 36	com/tencent/mm/memory/h:bF	()Ljava/lang/Object;
    ...
    //   48: aload 5
    //   50: ifnull +12 -> 62
    //   53: getstatic 32	com/tencent/mm/memory/h:hgx	Lcom/tencent/mm/memory/h;
    //   56: aload 5
    ...
    //   99: aastore
    //   100: invokestatic 63	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   103: aload_3
    //   104: ifnull +11 -> 115
    //   107: getstatic 32	com/tencent/mm/memory/h:hgx	Lcom/tencent/mm/memory/h;
    //   110: aload_3
    ...
    //   130: aload_3
    //   131: ifnull +11 -> 142
    //   134: getstatic 32	com/tencent/mm/memory/h:hgx	Lcom/tencent/mm/memory/h;
    //   137: aload_3
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/memory/j.class
