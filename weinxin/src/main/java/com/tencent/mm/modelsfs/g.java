...
final class g
{
  static boolean a(String paramString1, int paramInt1, String paramString2, int paramInt2, EnumSet<a> paramEnumSet)
  {
    ...
    for (;;)
    {
      ...
      {
        if ((paramEnumSet.contains(a.hRc)) && (paramString2.charAt(paramInt2) == '/'))
        {
      ...
      case 63: 
        ...
        if ((paramString2.charAt(paramInt2) == '/') && (paramEnumSet.contains(a.hRa)))
        {
          GMTrace.o(13842679595008L, 103136);
          return false;
        }
    ...
    for (;;)
    {
      ...
      if (paramInt1 == paramString1.length())
      {
        if (paramEnumSet.contains(a.hRa))
        {
          if ((paramEnumSet.contains(a.hRc)) || (paramString2.indexOf('/', paramInt2) == -1))
          {
            GMTrace.o(13842679595008L, 103136);
            return true;
          }
      ...
      while ((paramString2.charAt(j) != '/') || (!paramEnumSet.contains(a.hRa)))
      {
        j += 1;
        localEnumSet = paramEnumSet;
        if (j < paramString2.length())
        {
          ...
          if (localEnumSet.contains(a.hRb))
          {
            paramEnumSet = EnumSet.copyOf(localEnumSet);
            paramEnumSet.remove(a.hRb);
          }
      ...
      {
        char c4 = c1;
        if (paramEnumSet.contains(a.hRd)) {
        ...
        if (c1 != ']')
        {
          if ((c1 != '\\') || (paramEnumSet.contains(a.hQZ))) {
            break label1097;
          }
          paramInt1 = m + 1;
        ...
        for (;;)
        {
          if ((c1 == '/') && (paramEnumSet.contains(a.hRa)))
          {
            paramInt1 = 0;
            break label616;
          }
          ...
          for (;;)
          {
            ...
            for (char c3 = Character.toLowerCase(c1);; c3 = c1)
            {
              ...
              paramInt2 += 1;
              break;
              if (paramEnumSet.contains(a.hQZ)) {
                break label132;
              }
              if (j >= paramString1.length())
              {
              ...
              break label139;
              if ((c1 != paramString2.charAt(paramInt2)) && ((!paramEnumSet.contains(a.hRd)) || (Character.toLowerCase(c1) != Character.toLowerCase(paramString2.charAt(paramInt2)))))
              {
                GMTrace.o(13842679595008L, 103136);
                return false;
              }
  ...
  private static boolean a(String paramString, int paramInt, EnumSet<a> paramEnumSet)
  {
    ...
    if (((paramInt == 0) || ((paramEnumSet.contains(a.hRa)) && (paramString.charAt(paramInt - 1) == '/'))) && (paramString.charAt(paramInt) == '.') && (paramEnumSet.contains(a.hRb)))
    {
      GMTrace.o(13842813812736L, 103137);
      return true;
    }
  ...
  public static enum a
  {
    static
    {
      ...
      hQZ = new a("NOESCAPE", 0);
      hRa = new a("PATHNAME", 1);
      hRb = new a("PERIOD", 2);
      hRc = new a("LEADING_DIR", 3);
      hRd = new a("CASEFOLD", 4);
      hRe = new a[] { hQZ, hRa, hRb, hRc, hRd };
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/modelsfs/g.class
