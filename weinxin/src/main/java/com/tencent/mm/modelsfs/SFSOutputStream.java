  ...
  extends OutputStream
{
  ...
  public SFSOutputStream(long paramLong)
  {
    ...
    this.hRf = Thread.currentThread().getStackTrace();
  ...
  protected void finalize()
  {
    ...
    if (this.mNativePtr != 0L)
    {
      ...
      StackTraceElement[] arrayOfStackTraceElement = this.hRf;
      ...
      v.e("MicroMsg.SFSOutputStream", localStringBuilder.toString());
      close();
    }
    super.finalize();
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/modelsfs/SFSOutputStream.class
