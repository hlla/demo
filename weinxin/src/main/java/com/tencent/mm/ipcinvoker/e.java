...
public class e
{
  ...
  public static <T extends k> Bundle a(String paramString, Bundle paramBundle, Class<T> paramClass)
  {
    ...
    {
      v.e("IPC.IPCInvoker", "invokeSync failed, process is null or nil.");
    ...
    if (d.dS(paramString))
    {
      ...
      if (paramString == null)
      {
        v.e("IPC.IPCInvoker", "invokeSync failed, newInstance(%s) return null.", new Object[] { paramClass });
        GMTrace.o(18693308284928L, 139276);
        return null;
      }
    ...
    com.tencent.mm.ipcinvoker.b.a locala = b.un().dQ(paramString);
    if (locala == null)
    {
      v.e("IPC.IPCInvoker", "invokeSync failed, get bridge is null by process(%s).", new Object[] { paramString });
      GMTrace.o(18693308284928L, 139276);
      return null;
    }
    try
    ...
    {
      v.d("IPC.IPCInvoker", "invokeSync failed, ipc invoke error : %s", new Object[] { paramString });
      GMTrace.o(18693308284928L, 139276);
    }
    return null;
  }
  ...
  public static <T extends a> boolean a(String paramString, final Bundle paramBundle, final Class<T> paramClass, final c paramc)
  {
    ...
    if ((paramString == null) || (paramString.length() == 0))
    {
      v.e("IPC.IPCInvoker", "invokeAsync failed, process is null or nil.");
    ...
    boolean bool = l.d(new Runnable()
    {
      public final void run()
      {
        ...
        if (d.dS(this.gVx))
        {
          ...
          if (localObject == null)
          {
            v.e("IPC.IPCInvoker", "invokeAsync failed, newInstance(%s) return null.", new Object[] { paramClass });
        ...
        com.tencent.mm.ipcinvoker.b.a locala = b.un().dQ(this.gVx);
        if (locala == null)
        {
          v.e("IPC.IPCInvoker", "invokeAsync failed, get bridge is null by process(%s).", new Object[] { this.gVx });
          GMTrace.o(18692637196288L, 139271);
          return;
        }
          ...
          if (paramc != null) {
            localObject = new b.a()
            {
              public final void k(Bundle paramAnonymous2Bundle)
              {
                ...
                e.1.this.gVH.k(paramAnonymous2Bundle);
        ...
        {
          v.d("IPC.IPCInvoker", "invokeAsync failed, ipc invoke error : %s", new Object[] { localRemoteException });
          GMTrace.o(18692637196288L, 139271);
        }
      }
    });
        ...
        if (d.dS(this.gVx))
        {
          ((e.a)n.a(e.a.class, e.a.class)).a(e.a(paramInputType, paramClass), new c()
          {
            public final void k(Bundle paramAnonymous2Bundle)
            {
              ...
              if (e.2.this.gVK != null)
              {
                paramAnonymous2Bundle.setClassLoader(e.class.getClassLoader());
                e.2.this.gVK.ak(paramAnonymous2Bundle.getParcelable("__remote_task_result_data"));
              }
    ...
    implements a
  {
    ...
    public final void a(Bundle paramBundle, final c paramc)
    {
      ...
      {
        v.e("IPC.IPCInvoker", "proxy AsyncInvoke failed, class is null or nil.");
        GMTrace.o(18690489712640L, 139255);
        return;
      }
      g localg = (g)n.b(paramBundle, g.class);
      if (localg == null)
      {
        v.w("IPC.IPCInvoker", "proxy AsyncInvoke failed, newInstance(%s) return null.", new Object[] { paramBundle });
        GMTrace.o(18690489712640L, 139255);
        return;
      }
    ...
    implements k
  {
    ...
    public final Bundle l(Bundle paramBundle)
    {
      ...
      {
        v.e("IPC.IPCInvoker", "proxy SyncInvoke failed, class is null or nil.");
        GMTrace.o(18696797945856L, 139302);
        return null;
      }
      paramBundle = (i)n.b((String)localObject, i.class);
      if (paramBundle == null)
      {
        v.w("IPC.IPCInvoker", "proxy SyncInvoke failed, newInstance(%s) return null.", new Object[] { localObject });
        GMTrace.o(18696797945856L, 139302);
        return null;
      }
      localObject = new Bundle();
      ((Bundle)localObject).putParcelable("__remote_task_result_data", (Parcelable)paramBundle.al(localParcelable));
      GMTrace.o(18696797945856L, 139302);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/ipcinvoker/e.class
