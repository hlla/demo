  ...
  extends m
{
  ...
  public final int a(long paramLong, ad paramad)
  {
    ...
    paramad = paramad.FP();
    if (paramad.size() > 0) {
      i = this.hnp.update("qqlist", paramad, "qq=?", new String[] { String.valueOf(paramLong) });
    }
    if (i > 0) {
  ...
  public final boolean a(ad paramad)
  {
    ...
    v.d("MicroMsg.QQListStorage", "insert: name:" + paramad.FR());
    paramad.fRM = -1;
    ContentValues localContentValues = paramad.FP();
    if ((int)this.hnp.insert("qqlist", "qq", localContentValues) != -1)
    {
      b(2, this, paramad.hBJ);
      GMTrace.o(4427037540352L, 32984);
      return true;
    }
    GMTrace.o(4427037540352L, 32984);
  ...
  public final ad af(long paramLong)
  {
    ad localad = null;
  ...
  public final Cursor b(int paramInt, String paramString, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      paramString = this.hnp.a(localStringBuilder.toString(), null, 0);
  ...
  public final boolean fJ(int paramInt)
  {
    bool3 = false;
    bool2 = false;
    ...
    try
    {
      Cursor localCursor = this.hnp.a("select reserved3 from qqlist where groupid=? and reserved3=?  limit 1", new String[] { String.valueOf(paramInt), "0" }, 2);
      boolean bool1 = bool2;
      if (localCursor != null)
      {
  ...
  public final ad jl(String paramString)
  {
  ...
  public final Cursor v(int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      localObject = this.hnp.a((String)localObject, arrayOfString, 0);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/modelfriend/ae.class
