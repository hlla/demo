...
{
  private RandomAccessFile gQH;
  private RandomAccessFile gQI;
  private a gQJ;
  ...
  private void rw()
  {
    ...
    //   8: aload_0
    //   9: getfield 48	com/tencent/mm/compatible/d/o:gQI	Ljava/io/RandomAccessFile;
    //   12: ifnull +149 -> 161
    //   15: aload_0
    //   16: getfield 48	com/tencent/mm/compatible/d/o:gQI	Ljava/io/RandomAccessFile;
    //   19: lconst_0
    //   20: invokevirtual 53	java/io/RandomAccessFile:seek	(J)V
    //   23: aload_0
    //   24: getfield 48	com/tencent/mm/compatible/d/o:gQI	Ljava/io/RandomAccessFile;
    //   27: invokevirtual 57	java/io/RandomAccessFile:readLine	()Ljava/lang/String;
    //   30: astore_2
    //   31: aload_0
    //   32: getfield 59	com/tencent/mm/compatible/d/o:gQH	Ljava/io/RandomAccessFile;
    //   35: ifnull +201 -> 236
    //   38: aload_0
    //   39: getfield 59	com/tencent/mm/compatible/d/o:gQH	Ljava/io/RandomAccessFile;
    //   42: lconst_0
    //   43: invokevirtual 53	java/io/RandomAccessFile:seek	(J)V
    //   46: iconst_m1
    //   47: istore_1
    //   48: aload_0
    //   49: getfield 59	com/tencent/mm/compatible/d/o:gQH	Ljava/io/RandomAccessFile;
    ...
    //   90: if_icmpne +76 -> 166
    //   93: aload_0
    //   94: getfield 79	com/tencent/mm/compatible/d/o:gQJ	Lcom/tencent/mm/compatible/d/o$a;
    //   97: ifnonnull +19 -> 116
    //   100: aload_0
    ...
    //   113: putfield 79	com/tencent/mm/compatible/d/o:gQJ	Lcom/tencent/mm/compatible/d/o$a;
    //   116: aload_0
    //   117: getfield 79	com/tencent/mm/compatible/d/o:gQJ	Lcom/tencent/mm/compatible/d/o$a;
    //   120: aload 4
    //   122: aload_2
    ...
    //   158: invokestatic 107	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   161: aconst_null
    //   162: astore_2
    //   163: goto -132 -> 31
    //   166: aload_0
    //   167: getfield 109	com/tencent/mm/compatible/d/o:gQK	Ljava/util/ArrayList;
    //   170: ifnonnull +14 -> 184
    //   173: aload_0
    //   174: new 111	java/util/ArrayList
    //   177: dup
    //   178: invokespecial 112	java/util/ArrayList:<init>	()V
    //   181: putfield 109	com/tencent/mm/compatible/d/o:gQK	Ljava/util/ArrayList;
    //   184: iload_1
    //   185: aload_0
    //   186: getfield 109	com/tencent/mm/compatible/d/o:gQK	Ljava/util/ArrayList;
    //   189: invokevirtual 115	java/util/ArrayList:size	()I
    //   192: if_icmpge +53 -> 245
    //   195: aload_0
    //   196: getfield 109	com/tencent/mm/compatible/d/o:gQK	Ljava/util/ArrayList;
    //   199: iload_1
    ...
    //   233: invokestatic 107	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   236: ldc2_w 44
    //   239: ldc 46
    ...
    //   262: aload_0
    //   263: getfield 109	com/tencent/mm/compatible/d/o:gQK	Ljava/util/ArrayList;
    //   266: aload 5
    ...
    //   289: aastore
    //   290: invokestatic 142	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   293: goto -167 -> 126
    //   296: iload_1
    //   297: iconst_1
    //   298: iadd
  ...
  private void update()
  {
    ...
    try
    {
      this.gQH = new RandomAccessFile("/proc/stat", "r");
      if (this.pid > 0L) {
        this.gQI = new RandomAccessFile("/proc/" + this.pid + "/stat", "r");
      }
      rw();
      if (this.gQH != null) {
        this.gQH.close();
    ...
    {
      v.printErrStackTrace(" MicroMsg.CpuUsage", localException1, "update e:", new Object[0]);
      if (this.gQH == null) {}
    }
    try
    {
  ...
  public final String toString()
  {
    ...
    if (this.gQJ != null)
    {
      ...
      ((StringBuffer)localObject).append(this.gQJ.gQL);
      ((StringBuffer)localObject).append("%");
      if (this.pid > 0L)
      {
        ((StringBuffer)localObject).append("pid(");
        ((StringBuffer)localObject).append(this.pid + ") :");
        ((StringBuffer)localObject).append(this.gQJ.gQP);
        ((StringBuffer)localObject).append("%");
      }
    }
    if (this.gQK != null)
    {
      int i = 0;
      while (i < this.gQK.size())
      {
        a locala = (a)this.gQK.get(i);
        ((StringBuffer)localObject).append(" Cpu Core(" + i + ") : ");
        ((StringBuffer)localObject).append(locala.gQL);
        ((StringBuffer)localObject).append("%");
        i += 1;
      }
    }
  ...
  public final class a
  {
    ...
    public final void a(String[] paramArrayOfString, String paramString)
    {
      ...
      if ((paramString != null) && (paramString.length() > 0))
      {
        ...
        if ((arrayOfString != null) && (arrayOfString.length > 0) && (arrayOfString[0] != null) && (Long.parseLong(arrayOfString[0], 10) == this.gQN))
        {
          ...
          long l9 = l1 - this.gQM;
          long l10 = l6 - this.gQO;
          this.gQL = ((int)((float)(l9 - l8) / (float)l9 * 100.0F));
          this.gQP = ((int)((float)l10 / (float)l9 * 100.0F));
          this.gQM = l1;
          this.mLastIdle = l7;
          this.gQO = l6;
          v.i(" MicroMsg.CpuUsage", "CpuUsageInfo(%d) CPU total=%d idle=%d usage=%d pid=%d pidTotal=%d mPidUsage=%d [%d, %d, %d, %d], [%d, %d, %d]", new Object[] { Integer.valueOf(hashCode()), Long.valueOf(l1), Long.valueOf(l7), Integer.valueOf(this.gQL), Long.valueOf(this.gQN), Long.valueOf(l6), Integer.valueOf(this.gQP), Long.valueOf(l2), Long.valueOf(l3), Long.valueOf(l4), Long.valueOf(l5), Long.valueOf(l9), Long.valueOf(l8), Long.valueOf(l10) });
          GMTrace.o(13806440808448L, 102866);
          return;
        }
      }
      v.e(" MicroMsg.CpuUsage", "update but pid not match[%d, %s] update nothing", new Object[] { Long.valueOf(this.gQN), paramString });
      GMTrace.o(13806440808448L, 102866);
    }
    ...
    public final void e(String[] paramArrayOfString)
    {
      ...
      long l4 = l1 - this.gQM;
      this.gQL = ((int)((float)(l4 - (l2 - l3)) / (float)l4 * 100.0F));
      this.gQM = l1;
      this.mLastIdle = l2;
      v.i(" MicroMsg.CpuUsage", "CpuUsageInfo(" + hashCode() + ") CPU total=" + l1 + "; idle=" + l2 + "; usage=" + this.gQL);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/compatible/d/o.class
