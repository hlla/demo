...
public final class p
{
  ...
  static
  {
    ...
    gSQ.set(46);
    gSQ.set(42);
    gSR = (String)AccessController.doPrivileged(new i("file.encoding"));
  ...
  public static String encode(String paramString)
  {
    ...
    try
    {
      paramString = encode(paramString, gSR);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/compatible/util/p.class
