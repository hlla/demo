...
{
  private static Map<String, String> gQD;
  ...
  private static String ds(String paramString)
  {
    ...
    if (paramString != null)
    {
      ...
      {
        v.printErrStackTrace("CpuFeatures", paramString, "", new Object[0]);
        localObject = str;
      }
    }
  ...
  private static String dt(String paramString)
  {
    ...
    for (int i = 0;; i = j)
    {
      ...
      {
        v.printErrStackTrace("CpuFeatures", localException, "", new Object[0]);
        GMTrace.o(13798253527040L, 102805);
        return paramString;
      }
    }
  ...
  public static String rq()
  {
    ...
    ((StringBuilder)localObject).append(b(gQD, "Features"));
    ((StringBuilder)localObject).append(": ");
    ((StringBuilder)localObject).append(b(gQD, "Processor"));
    ((StringBuilder)localObject).append(": ");
    ((StringBuilder)localObject).append(b(gQD, "CPU architecture"));
    ((StringBuilder)localObject).append(": ");
    ((StringBuilder)localObject).append(b(gQD, "Hardware"));
    ((StringBuilder)localObject).append(": ");
    ((StringBuilder)localObject).append(b(gQD, "Serial"));
  ...
  public static boolean rt()
  {
    ...
    if (gQD != null)
    {
      String str = b(gQD, "CPU architecture");
  ...
  /* Error */
  public static java.util.HashMap<String, String> rv()
  {
    // Byte code:
    //   0: ldc2_w 209
    //   3: ldc -45
    ...
    //   183: invokestatic 78	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   186: aload_0
    //   187: ifnull +7 -> 194
    //   190: aload_0
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/compatible/d/m.class
