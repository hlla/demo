  ...
  extends BitmapFactory
{
  ...
  public static Bitmap decodeResource(Resources paramResources, int paramInt, BitmapFactory.Options paramOptions)
  {
    ...
    if (gSa != null)
    {
      Bitmap localBitmap = gSa.decodeResource(paramResources, paramInt, paramOptions);
      if (localBitmap != null)
      {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/compatible/f/a.class
