...
public final class f
{
  ...
  public static boolean G(long paramLong)
  {
    ...
    //   8: invokestatic 21	com/tencent/mm/compatible/util/f:rZ	()Z
    //   11: ifne +20 -> 31
    //   14: ldc 23
    //   16: ldc 25
    //   18: invokestatic 30	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   21: ldc2_w 9
    //   24: ldc 11
    ...
    //   34: dup
    //   35: getstatic 41	com/tencent/mm/compatible/util/e:hgi	Ljava/lang/String;
    ...
    //   94: aload 7
    //   96: aastore
    //   97: invokestatic 58	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   100: lconst_0
    //   101: lstore 5
    //   103: goto -41 -> 62
    //   106: lload_3
    ...
    //   184: invokestatic 30	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   187: ldc2_w 9
    //   190: ldc 11
  ...
  public static boolean rZ()
  {
    ...
    if (e.hgi.equalsIgnoreCase(str)) {
      ...
      {
        v.w("MicroMsg.CUtil", "summer isSDCardAvail 1 e: " + localException1.getMessage() + " SDCARD_ROOT: " + e.hgi);
        GMTrace.o(13786710802432L, 102719);
        return false;
      }
    }
    try
    {
      boolean bool = new File(e.hgi).canWrite();
      GMTrace.o(13786710802432L, 102719);
      return bool;
    }
    catch (Exception localException2)
    {
      v.w("MicroMsg.CUtil", "summer isSDCardAvail 1 e: " + localException2.getMessage() + " SDCARD_ROOT: " + e.hgi);
      GMTrace.o(13786710802432L, 102719);
    }
    return false;
  }
  ...
  public static boolean sa()
  {
    ...
    for (;;)
    {
      try
      {
        StatFs localStatFs = new StatFs(e.hgi);
        l1 = l4;
      }
      catch (Exception localException1)
      {
      ...
      v.e("MicroMsg.CUtil", "checkSDCardFull", tmp122_119);
      l2 = 0L;
    }
    if (l1 <= 0L)
    {
    ...
    i = (int)((l1 - l3) * 100L / l1);
    l4 = l2 * l3;
    v.i("MicroMsg.CUtil", "checkSDCardFull blockCount: %d, availCount: %d, blockSize: %d, totalSize: %d, availSize: %d, used percent: %d", new Object[] { Long.valueOf(l1), Long.valueOf(l3), Long.valueOf(l2), Long.valueOf(l2 * l1), Long.valueOf(l4), Integer.valueOf(i) });
    if (95 > i)
    {
      GMTrace.o(13786845020160L, 102720);
      return false;
    ...
    v.i("MicroMsg.CUtil", "checkSDCardFull is full!");
    GMTrace.o(13786845020160L, 102720);
    return true;
  }
}
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/compatible/util/f.class
