  ...
  implements e
{
  ...
  protected final void KD()
  {
    ...
    b(new MenuItem.OnMenuItemClickListener()
    {
      public final boolean onMenuItemClick(MenuItem paramAnonymousMenuItem)
      {
        ...
        RegByMobileVoiceVerifyUI.this.aGY();
        RegByMobileVoiceVerifyUI.this.finish();
        GMTrace.o(2774012002304L, 20668);
        return true;
      }
    });
    this.itk = ((TextView)findViewById(R.h.cak));
    Button localButton = (Button)findViewById(R.h.btm);
    this.uWk = RegByMobileVoiceVerifySelectUI.SP(this.fOz);
    this.itk.setText(this.uWk);
    this.pjF = com.tencent.mm.ai.b.jP(this.fOz);
    findViewById(R.h.cbr).setOnClickListener(new View.OnClickListener()
    {
    ...
    localButton.setOnClickListener(new View.OnClickListener()
    {
      public final void onClick(View paramAnonymousView)
      {
        ...
        if ((RegByMobileVoiceVerifyUI.b(RegByMobileVoiceVerifyUI.this) == 0) || (RegByMobileVoiceVerifyUI.b(RegByMobileVoiceVerifyUI.this) == 2) || (RegByMobileVoiceVerifyUI.b(RegByMobileVoiceVerifyUI.this) == 3))
        {
          ...
          g.a(RegByMobileVoiceVerifyUI.this, R.l.dOg, R.l.dIG, new DialogInterface.OnClickListener()
          {
  ...
  public final void a(int paramInt1, int paramInt2, String paramString, k paramk)
  {
    ...
    v.i("MicroMsg.RegByMobileVoiceVerifyUI", "onSceneEnd: errType = " + paramInt1 + " errCode = " + paramInt2 + " errMsg = " + paramString);
  ...
  protected void onActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    if (paramInt1 == 10000)
    {
      ...
      this.uWk = paramIntent.getStringExtra("voice_verify_language");
      this.pjF = paramIntent.getStringExtra("voice_verify_code");
      this.itk.setText(this.uWk);
    }
    GMTrace.o(2636304613376L, 19642);
  }
  ...
  public void onCreate(Bundle paramBundle)
  {
    ...
    this.uYN = getIntent().getExtras().getInt("voice_verify_type");
    if ((this.uYN == 0) || (this.uYN == 2) || (this.uYN == 3)) {
      ap.vd().a(145, this);
    }
    for (;;)
    {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/ui/account/RegByMobileVoiceVerifyUI.class
