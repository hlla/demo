...
public final class e
{
  ...
  private static Bundle TY(String paramString)
  {
  ...
  public static Bundle TZ(String paramString)
  {
    ...
    try
    {
      ...
      Bundle localBundle = TY(paramString.getQuery());
      localBundle.putAll(TY(paramString.getRef()));
  ...
  public static JSONObject Ua(String paramString)
  {
  ...
  public static String ae(Bundle paramBundle)
  {
  ...
  public static String e(String paramString1, String paramString2, Bundle paramBundle)
  {
    ...
    if (paramString2.equals("GET")) {
      localObject1 = paramString1 + "?" + ae(paramBundle);
    }
    ...
    if (!paramString2.equals("GET"))
    {
      ...
      paramString2.write(i(paramBundle, "3i2ndDfv2rTHiSisAbouNdArYfORhtTPEefj3q2f").getBytes());
    ...
    try
    {
      paramString1 = n(((HttpURLConnection)localObject1).getInputStream());
    ...
    catch (FileNotFoundException paramString1)
    {
      for (;;)
      {
        paramString1 = n(((HttpURLConnection)localObject1).getErrorStream());
      }
    }
  }
  
  private static String i(Bundle paramBundle, String paramString)
  {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/ui/g/a/e.class
