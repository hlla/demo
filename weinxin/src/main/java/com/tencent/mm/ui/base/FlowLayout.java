  ...
  extends ViewGroup
{
  ...
  private void c(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, a.m.fpY);
    try
    {
      this.veT = paramContext.getDimensionPixelSize(a.m.hfu, 0);
      this.veU = paramContext.getDimensionPixelSize(a.m.hfv, 0);
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    if (j < i1)
    {
      ...
      if (localView.getVisibility() != 8)
      {
        ...
        i = getPaddingLeft();
        paramInt2 += ((Integer)this.veV.get(paramInt4)).intValue() + this.veU;
        paramInt4 += 1;
      }
    }
    label228:
    for (;;)
    {
      n = (((Integer)this.veV.get(paramInt4)).intValue() - m) / 2;
      ...
      while (i1 < i6)
      {
        ...
        if (localView.getVisibility() != 8)
        {
          ...
          if (k + i7 > i5)
          {
            i2 = 0;
            m = j + (this.veU + i);
            this.veV.add(Integer.valueOf(i));
            i3 = 0;
          }
  ...
  public final int zF(int paramInt)
  {
    GMTrace.i(3247129493504L, 24193);
    int j = Math.max(0, Math.min(this.veV.size(), paramInt));
    paramInt = getPaddingTop();
    int i = 0;
    while (i < j - 1)
    {
      paramInt += ((Integer)this.veV.get(i)).intValue() + this.veU;
      i += 1;
    }
    i = ((Integer)this.veV.get(j - 1)).intValue();
    j = getPaddingBottom();
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/ui/base/FlowLayout.class
