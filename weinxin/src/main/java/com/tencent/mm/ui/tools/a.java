...
public final class a
{
  ...
  public static void b(final Activity paramActivity, Intent paramIntent1, final Intent paramIntent2, final String paramString, final int paramInt, final a parama)
  {
    ...
    if (!paramIntent1.getData().toString().startsWith("content://com.google.android.gallery3d"))
    {
      ...
      if (!bf.mA(paramIntent1))
      {
        if (parama != null) {
          paramIntent2.putExtra("CropImage_OutputPath", parama.GN(paramIntent1));
        }
    ...
    new AsyncTask()
    {
      ...
      protected final void onPreExecute()
      {
        ...
        try
        {
          this.uri = this.jNT.getData();
          this.wiD = false;
          Activity localActivity = paramActivity;
          paramActivity.getString(a.k.dIG);
          this.wiC = com.tencent.mm.ui.base.g.a(localActivity, paramActivity.getString(a.k.heT), true, new DialogInterface.OnCancelListener()
          {
  ...
  public static String u(String paramString, Bitmap paramBitmap)
  {
    ...
    try
    {
      Object localObject = com.tencent.mm.a.g.n(DateFormat.format("yyyy-MM-dd-HH-mm-ss", System.currentTimeMillis()).toString().getBytes()) + ".jpg";
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/ui/tools/a.class
