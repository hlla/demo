  ...
  extends WxViewPager
{
  ...
  public e vlF;
  public c vlG;
  public ViewPager.e vlH;
  private float vlI;
  private MotionEvent vlJ;
  private long vlK;
  public b vlL;
  ...
  public MMViewPager(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.vlx = new k(new WeakReference(this));
    this.iWM = new GestureDetector(paramContext, new d((byte)0));
  ...
  private boolean a(float paramFloat1, float paramFloat2, View paramView, float paramFloat3)
  {
    ...
    label242:
    if (this.yr.j(paramView) == bSt()) {
      if (this.vlB) {
        if (paramFloat3 < 0.0F)
        {
          if (paramFloat1 <= this.mgX.left) {
            this.mhn.G(-paramFloat3, 0.0F);
          }
        }
        else {
    ...
    for (;;)
    {
      ...
      GMTrace.o(3163646066688L, 23571);
      return true;
      if ((paramFloat1 <= this.mgX.left) || (paramFloat1 >= this.jWD * 0.3F)) {
        break;
      }
      this.mhn.G(-(paramFloat3 * 0.3F), 0.0F);
      i = 1;
    ...
    extends GestureDetector.SimpleOnGestureListener
  {
    ...
    public final boolean onDoubleTap(MotionEvent paramMotionEvent)
    {
      ...
      if (MMViewPager.a(MMViewPager.this).getScale() <= MMViewPager.a(MMViewPager.this).oZL) {
        MMViewPager.a(MMViewPager.this).F(f.i(paramMotionEvent, 0), f.j(paramMotionEvent, 0));
      }
      for (;;)
      {
        GMTrace.o(3349403402240L, 24955);
        return true;
        MMViewPager.a(MMViewPager.this).E(f.i(paramMotionEvent, 0), f.j(paramMotionEvent, 0));
      }
    }
    ...
    public final boolean onFling(MotionEvent paramMotionEvent1, MotionEvent paramMotionEvent2, float paramFloat1, float paramFloat2)
    {
      ...
      if (localMultiTouchImageView != null)
      {
        ...
        if ((localMultiTouchImageView.vmx) || (localMultiTouchImageView.vmy) || ((int)f2 > MMViewPager.b(MMViewPager.this)) || ((int)f5 > MMViewPager.d(MMViewPager.this)))
        {
          float[] arrayOfFloat = new float[9];
          ...
          f4 = f3 + f2;
          f6 = arrayOfFloat[5];
          v.d("MicroMsg.MMViewPager", "left: %f,right: %f isGestureRight=> %B, vX: %s, vY: %s", new Object[] { Float.valueOf(f3), Float.valueOf(f4), Boolean.valueOf(MMViewPager.c(paramMotionEvent1, paramMotionEvent2)), Float.valueOf(paramFloat1), Float.valueOf(paramFloat2) });
    ...
    public final void onLongPress(MotionEvent paramMotionEvent)
    {
      ...
      if (MMViewPager.o(MMViewPager.this) != null) {
        MMViewPager.o(MMViewPager.this).atY();
      }
    ...
    public final boolean onSingleTapConfirmed(MotionEvent paramMotionEvent)
    {
      ...
      if (MMViewPager.l(MMViewPager.this) != null) {
        MMViewPager.l(MMViewPager.this).ahu();
      }
    ...
    public final void play()
    {
      ...
      MMViewPager.c(MMViewPager.this).post(new Runnable()
      {
        public final void run()
        {
          ...
          MMViewPager.a(MMViewPager.this).getImageMatrix().getValues(MMViewPager.f.this.mhm);
          float f1 = MMViewPager.a(MMViewPager.this).getScale();
          float f2 = MMViewPager.a(MMViewPager.this).imageHeight * f1;
          float f3 = MMViewPager.f.this.mhm[5];
          ...
          f1 -= f3 + f2;
          if (f1 <= 0.0F) {
            MMViewPager.f.this.mhk = true;
          }
          for (;;)
          {
            MMViewPager.a(MMViewPager.this).G(0.0F, f1);
    ...
    public final void play()
    {
      ...
      MMViewPager.c(MMViewPager.this).post(new Runnable()
      {
        public final void run()
        {
          ...
          MMViewPager.a(MMViewPager.this).getImageMatrix().getValues(MMViewPager.g.this.mhm);
          ...
          float f6 = MMViewPager.g.this.mhm[2];
          float f9 = MMViewPager.g.this.mhm[5];
          float f5 = MMViewPager.g.this.mhm[2];
          float f8 = MMViewPager.g.this.mhm[5];
              ...
              for (;;)
              {
                ...
                for (;;)
                {
                  ...
                  if ((Math.abs(f2) <= 5.0F) && (Math.abs(f1) <= 5.0F)) {
                    MMViewPager.g.this.mhk = true;
                  }
                  for (;;)
                  {
                    MMViewPager.a(MMViewPager.this).G(f2, f1);
    ...
    public final void play()
    {
      ...
      MMViewPager.c(MMViewPager.this).post(new Runnable()
      {
        public final void run()
        {
          ...
          MMViewPager.a(MMViewPager.this).getImageMatrix().getValues(MMViewPager.h.this.mhm);
          float f2 = MMViewPager.h.this.mhm[2];
          ...
          for (f1 = MMViewPager.b(MMViewPager.this) / 2.0F - f1 / 2.0F;; f1 = 0.0F)
          {
            f1 -= f2;
            if (f1 >= 0.0F) {
              MMViewPager.h.this.mhk = true;
            }
            for (;;)
            {
              MMViewPager.a(MMViewPager.this).G(f1, 0.0F);
    ...
    public final void play()
    {
      ...
      MMViewPager.c(MMViewPager.this).post(new Runnable()
      {
        public final void run()
        {
          ...
          MMViewPager.a(MMViewPager.this).getImageMatrix().getValues(MMViewPager.i.this.mhm);
          float f1 = MMViewPager.a(MMViewPager.this).getScale();
          float f2 = MMViewPager.a(MMViewPager.this).imageWidth * f1;
          float f3 = MMViewPager.i.this.mhm[2];
    ...
    public final void play()
    {
      ...
      MMViewPager.c(MMViewPager.this).post(new Runnable()
      {
        public final void run()
        {
          ...
          MMViewPager.a(MMViewPager.this).getImageMatrix().getValues(MMViewPager.j.this.mhm);
          float f2 = MMViewPager.j.this.mhm[5];
    ...
    extends ad
  {
    ...
    public final void handleMessage(Message paramMessage)
    {
      ...
      if (this.vlU != null)
      {
        MMViewPager localMMViewPager = (MMViewPager)this.vlU.get();
        if ((localMMViewPager != null) && (paramMessage.what == 1))
        {
          if ((MMViewPager.r(localMMViewPager) != null) && (!MMViewPager.r(localMMViewPager).ayY()))
          {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/ui/base/MMViewPager.class
