  ...
  implements Filterable
{
  ...
  public c(Context paramContext, String[] paramArrayOfString, String paramString)
  {
    ...
    this.oCM = Arrays.asList(paramArrayOfString);
    this.uVs = paramString;
  ...
  private String hM(int paramInt)
  {
    ...
    String str = (String)this.oCM.get(paramInt);
  ...
  public final View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      paramView = View.inflate(this.mContext, R.i.cUQ, null);
      paramViewGroup = new b();
      paramViewGroup.itk = ((TextView)paramView.findViewById(R.h.cHD));
      paramView.setTag(paramViewGroup);
    }
    for (;;)
    {
      String str = hM(paramInt);
      paramViewGroup.itk.setText(str);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/ui/account/c.class
