  ...
  implements a.a, d.a
{
  ...
  public AddressView(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    this.drawable = getResources().getDrawable(R.g.bjV);
    this.needUpdatePostion = true;
    this.AVATAR_LAYOUT_WIDTH = getResources().getDimensionPixelSize(R.f.aWK);
    this.AVATAR_WIDTH = getResources().getDimensionPixelSize(R.f.aWK);
    this.NAME_TEXT_SIZE = com.tencent.mm.bg.a.T(paramContext, R.f.aXH);
    this.DESCRIPTION_TEXT_SIZE = com.tencent.mm.bg.a.T(paramContext, R.f.aXV);
    this.WEIBO_ICON_SIZE = getResources().getDimensionPixelSize(R.f.aXO);
    this.AVATAR_START_POS = 0;
    this.AVATAR_PADDING = getResources().getDimensionPixelSize(R.f.aWC);
    this.COMMON_PADDING = 0;
    this.DESCRIPTION_PADDING = (getResources().getDimensionPixelSize(R.f.aXu) * 2);
    this.TEXT_TOP_PADDING = getResources().getDimensionPixelSize(R.f.aXU);
  ...
  private TextPaint generateDescriptionPaint()
  {
    ...
    localTextPaint.setColor(getResources().getColor(R.e.aUo));
  ...
  private TextPaint generateOnePaint()
  {
    ...
    localTextPaint.setColor(getResources().getColor(R.e.aVo));
  ...
  private void installAccessibilityDelegate()
  {
    ...
    z.a(this, new android.support.v4.view.a()
    {
      public final void a(View paramAnonymousView, b paramAnonymousb)
      {
        ...
        if (bf.mA((String)localCharSequence)) {
  ...
  public float getDesiredWidth(CharSequence paramCharSequence, TextPaint paramTextPaint)
  {
    ...
    {
      v.w("MicroMsg.AddressView", "source is null, set it empty.");
      localObject = "";
    }
  ...
  public void resumeAvatarLoad()
  {
    ...
    if (this.avatarDrawable != null) {
      ((com.tencent.mm.pluginsdk.ui.a)this.avatarDrawable).bEa();
    }
  ...
  public void stopAvatarLoad()
  {
    ...
    if (this.avatarDrawable != null) {
      ((com.tencent.mm.pluginsdk.ui.a)this.avatarDrawable).bDZ();
    }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/ui/AddressView.class
