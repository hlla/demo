...
{
  private static HashMap<String, Constructor<?>> vqa;
  private static final Class<?>[] vqb;
  final Object[] HD;
  ...
  static
  {
    ...
    vqa = new HashMap();
    vqb = new Class[] { Context.class, AttributeSet.class };
  ...
  private Preference a(String paramString1, String paramString2, AttributeSet paramAttributeSet)
  {
    ...
    Object localObject1 = (Constructor)vqa.get(paramString1);
    ...
    for (;;)
    {
      try
      {
        ...
        if (paramString2 != null)
        {
          ...
          localObject2 = ((ClassLoader)localObject3).loadClass((String)localObject2).getConstructor(vqb);
      ...
      try
      {
        vqa.put(paramString1, localObject2);
        localObject1 = localObject2;
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/ui/base/preference/j.class
