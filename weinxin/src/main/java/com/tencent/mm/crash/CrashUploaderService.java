  ...
  extends IntentService
{
  ...
  private static boolean a(String paramString1, byte[] paramArrayOfByte, int paramInt, String paramString2, String paramString3, String paramString4)
  {
    ...
    paramString2 = new StringBuilder().append(paramString3).append("/cgi-bin/mmsupport-bin/stackreport?version=").append(Integer.toHexString(paramInt)).append("&devicetype=").append(paramString2).append("&filelength=").append(i).append("&sum=").append(str).append("&reporttype=1&NewReportType=").append(bf.f((Integer)gTJ.get(paramString4)));
    ...
    try
    {
      ...
      v.i("MicroMsg.CrashUploaderService", bf.convertStreamToString(paramString1.execute(paramString2).getEntity().getContent()));
      GMTrace.o(13715843842048L, 102191);
      return true;
    }
    catch (Exception paramString1)
    {
      v.printErrStackTrace("MicroMsg.CrashUploaderService", paramString1, "", new Object[0]);
      GMTrace.o(13715843842048L, 102191);
    }
    return false;
  }
  ...
  private static void j(String paramString1, String paramString2, String paramString3)
  {
    ...
    if (!new File(paramString1).exists())
    {
      ...
      if ((!bf.mA(paramString3)) && (!paramString3.equals("0"))) {
        break label206;
      }
  ...
  protected void onHandleIntent(Intent paramIntent)
  {
    ...
    localObject1 = (String)localObject1 + "exception,time_" + bf.Nz() + ",error_" + (String)localObject4;
    for (;;)
    {
      try
      {
        ...
        j((String)localObject3 + "crash_" + localSimpleDateFormat.format((Date)localObject4) + ".txt", (String)localObject1, str2);
      }
      ...
      j((String)localObject3, (String)localObject1, str2);
      ...
      if (localObject4 != null)
      {
        ...
        if (j < k)
        {
          ...
          if (bf.aA(localSimpleDateFormat.lastModified()) > 2592000000L) {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/crash/CrashUploaderService.class
