  ...
  extends AbstractCursor
{
  ...
  private Object get(int paramInt)
  {
    ...
    if (this.mPos >= this.uKG) {
      throw new CursorIndexOutOfBoundsException("After last row.");
    }
    int i = this.mPos / this.uKF;
    int j = this.mPos;
    int k = this.uKF;
    int m = this.columnCount;
    Object localObject = ((Object[])this.uKE.get(i))[(j % k * m + paramInt)];
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/bj/a/c.class
