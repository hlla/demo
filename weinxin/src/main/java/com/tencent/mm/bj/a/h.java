  ...
  extends SQLiteDirectQuery
{
  ...
  final int a(b paramb, int paramInt1, int paramInt2)
  {
    ...
    //   11: aload_0
    //   12: invokevirtual 35	com/tencent/mm/bj/a/h:acquireReference	()V
    //   15: aload_1
    //   16: invokevirtual 38	com/tencent/mm/bj/a/b:acquireReference	()V
    //   19: iload_2
    //   20: ifle +61 -> 81
    //   23: aload_0
    //   24: iload_2
    //   25: invokevirtual 42	com/tencent/mm/bj/a/h:step	(I)I
    //   28: istore 4
    //   30: iload 4
    //   32: iload_2
    //   33: if_icmpge +48 -> 81
    ...
    //   62: aload_1
    //   63: invokevirtual 63	com/tencent/mm/bj/a/b:releaseReference	()V
    //   66: aload_0
    //   67: invokevirtual 64	com/tencent/mm/bj/a/h:releaseReference	()V
    //   70: ldc2_w 29
    //   73: ldc 31
    ...
    //   80: ireturn
    //   81: aload_0
    //   82: invokevirtual 68	com/tencent/mm/bj/a/h:getColumnNames	()[Ljava/lang/String;
    //   85: arraylength
    //   86: istore 7
    //   88: iload_2
    //   89: istore 4
    ...
    //   103: aload_0
    //   104: iconst_1
    //   105: invokevirtual 42	com/tencent/mm/bj/a/h:step	(I)I
    //   108: iconst_1
    //   109: if_icmpne +263 -> 372
    //   112: aload_1
    //   113: aload_1
    //   114: invokevirtual 72	com/tencent/mm/bj/a/b:bNF	()Lcom/tencent/mm/bj/a/a;
    //   117: putfield 76	com/tencent/mm/bj/a/b:uKD	Lcom/tencent/mm/bj/a/a;
    //   120: iconst_0
    //   121: istore 5
    //   123: iload 5
    //   125: iload 7
    ...
    //   130: aload_0
    //   131: iload 5
    //   133: invokevirtual 79	com/tencent/mm/bj/a/h:getType	(I)I
    //   136: tableswitch	default:+277->413, 0:+280->416, 1:+106->242, 2:+179->315, 3:+75->211, 4:+189->325
    //   172: aload_1
    //   173: iload 4
    //   175: iconst_1
    //   176: invokevirtual 83	com/tencent/mm/bj/a/b:dQ	(II)V
    ...
    //   189: astore 10
    //   191: aload_0
    //   192: invokevirtual 91	com/tencent/mm/bj/a/h:onCorruption	()V
    //   195: aload 10
    //   197: athrow
    //   198: astore 10
    //   200: aload_1
    //   201: invokevirtual 63	com/tencent/mm/bj/a/b:releaseReference	()V
    //   204: aload_0
    //   205: invokevirtual 64	com/tencent/mm/bj/a/h:releaseReference	()V
    //   208: aload 10
    //   210: athrow
    //   211: aload_0
    //   212: iload 5
    //   214: invokevirtual 95	com/tencent/mm/bj/a/h:getString	(I)Ljava/lang/String;
    //   217: astore 10
    //   219: aload_1
    //   220: getfield 76	com/tencent/mm/bj/a/b:uKD	Lcom/tencent/mm/bj/a/a;
    //   223: ifnull +193 -> 416
    //   226: aload_1
    //   227: getfield 76	com/tencent/mm/bj/a/b:uKD	Lcom/tencent/mm/bj/a/a;
    //   230: iload 5
    //   232: aload 10
    ...
    //   242: aload_0
    //   243: iload 5
    //   245: invokevirtual 105	com/tencent/mm/bj/a/h:getLong	(I)J
    //   248: lstore 8
    //   250: aload_1
    //   251: getfield 76	com/tencent/mm/bj/a/b:uKD	Lcom/tencent/mm/bj/a/a;
    //   254: ifnull +162 -> 416
    //   257: aload_1
    //   258: getfield 76	com/tencent/mm/bj/a/b:uKD	Lcom/tencent/mm/bj/a/a;
    //   261: iload 5
    //   263: lload 8
    ...
    //   299: aload_0
    //   300: invokevirtual 127	com/tencent/mm/bj/a/h:getSql	()Ljava/lang/String;
    ...
    //   315: aload_0
    //   316: iload 5
    //   318: invokevirtual 138	com/tencent/mm/bj/a/h:getDouble	(I)D
    //   321: pop2
    //   322: goto +94 -> 416
    //   325: aload_0
    //   326: iload 5
    //   328: invokevirtual 142	com/tencent/mm/bj/a/h:getBlob	(I)[B
    //   331: astore 10
    //   333: aload_1
    //   334: getfield 76	com/tencent/mm/bj/a/b:uKD	Lcom/tencent/mm/bj/a/a;
    //   337: ifnull +79 -> 416
    //   340: aload_1
    //   341: getfield 76	com/tencent/mm/bj/a/b:uKD	Lcom/tencent/mm/bj/a/a;
    //   344: iload 5
    //   346: aload 10
    ...
    //   357: iload 4
    //   359: iconst_0
    //   360: invokevirtual 83	com/tencent/mm/bj/a/b:dQ	(II)V
    //   363: iload 4
    //   365: iconst_1
    //   366: iadd
    //   367: istore 4
    ...
    //   382: aload_0
    //   383: ldc -109
    //   385: invokevirtual 42	com/tencent/mm/bj/a/h:step	(I)I
    //   388: iadd
    //   389: istore_2
    //   390: aload_0
    //   391: iconst_1
    //   392: invokevirtual 151	com/tencent/mm/bj/a/h:reset	(Z)V
    //   395: aload_1
    //   396: invokevirtual 63	com/tencent/mm/bj/a/b:releaseReference	()V
    //   399: aload_0
    //   400: invokevirtual 64	com/tencent/mm/bj/a/h:releaseReference	()V
    //   403: ldc2_w 29
    //   406: ldc 31
  ...
  final int a(c paramc, int paramInt1, int paramInt2)
  {
    ...
    //   8: aload_0
    //   9: invokevirtual 35	com/tencent/mm/bj/a/h:acquireReference	()V
    //   12: iload_2
    //   13: ifle +57 -> 70
    //   16: aload_0
    //   17: iload_2
    //   18: invokevirtual 42	com/tencent/mm/bj/a/h:step	(I)I
    //   21: istore 4
    //   23: iload 4
    //   25: iload_2
    //   26: if_icmpge +44 -> 70
    ...
    //   55: aload_0
    //   56: invokevirtual 64	com/tencent/mm/bj/a/h:releaseReference	()V
    //   59: ldc2_w 153
    //   62: ldc -101
    ...
    //   69: ireturn
    //   70: aload_0
    //   71: invokevirtual 68	com/tencent/mm/bj/a/h:getColumnNames	()[Ljava/lang/String;
    //   74: arraylength
    //   75: istore 6
    //   77: iload_2
    //   78: istore 4
    ...
    //   88: aload_0
    //   89: iconst_1
    //   90: invokevirtual 42	com/tencent/mm/bj/a/h:step	(I)I
    //   93: iconst_1
    //   94: if_icmpne +422 -> 516
    //   97: iload 4
    //   99: aload_1
    //   100: getfield 161	com/tencent/mm/bj/a/c:uKF	I
    //   103: idiv
    //   104: istore 5
    //   106: aload_1
    //   107: getfield 165	com/tencent/mm/bj/a/c:uKE	Landroid/util/SparseArray;
    //   110: iload 5
    //   112: invokevirtual 170	android/util/SparseArray:indexOfKey	(I)I
    //   115: ifge +165 -> 280
    //   118: aload_1
    //   119: getfield 161	com/tencent/mm/bj/a/c:uKF	I
    //   122: aload_1
    //   123: getfield 173	com/tencent/mm/bj/a/c:columnCount	I
    //   126: imul
    //   127: anewarray 48	java/lang/Object
    //   130: astore 9
    //   132: aload_1
    //   133: getfield 165	com/tencent/mm/bj/a/c:uKE	Landroid/util/SparseArray;
    //   136: iload 5
    //   138: aload 9
    //   140: invokevirtual 177	android/util/SparseArray:put	(ILjava/lang/Object;)V
    //   143: aload_1
    //   144: getfield 161	com/tencent/mm/bj/a/c:uKF	I
    //   147: istore 5
    //   149: aload_1
    //   150: getfield 173	com/tencent/mm/bj/a/c:columnCount	I
    //   153: iload 4
    //   155: iload 5
    //   157: irem
    //   158: imul
    //   159: istore 7
    //   161: aload_1
    //   162: getfield 173	com/tencent/mm/bj/a/c:columnCount	I
    //   165: istore 8
    //   167: iload 4
    //   169: iconst_1
    //   170: iadd
    ...
    //   173: iload 5
    //   175: aload_1
    //   176: getfield 180	com/tencent/mm/bj/a/c:uKG	I
    //   179: if_icmple +118 -> 297
    //   182: aload_1
    //   183: iload 5
    //   185: putfield 180	com/tencent/mm/bj/a/c:uKG	I
    //   188: new 182	com/tencent/mm/bj/a/c$a
    //   191: dup
    //   192: aload_1
    //   193: iload 7
    //   195: iload 7
    ...
    //   199: iadd
    //   200: aload 9
    //   202: invokespecial 185	com/tencent/mm/bj/a/c$a:<init>	(Lcom/tencent/mm/bj/a/c;II[Ljava/lang/Object;)V
    //   205: astore 10
    //   207: iconst_0
    //   208: istore 5
    //   210: iload 5
    ...
    //   217: aload_0
    //   218: iload 5
    //   220: invokevirtual 79	com/tencent/mm/bj/a/h:getType	(I)I
    ...
    //   266: astore_1
    //   267: aload_0
    //   268: invokevirtual 91	com/tencent/mm/bj/a/h:onCorruption	()V
    //   271: aload_1
    //   272: athrow
    //   273: astore_1
    //   274: aload_0
    //   275: invokevirtual 64	com/tencent/mm/bj/a/h:releaseReference	()V
    //   278: aload_1
    //   279: athrow
    //   280: aload_1
    //   281: getfield 165	com/tencent/mm/bj/a/c:uKE	Landroid/util/SparseArray;
    //   284: iload 5
    ...
    //   294: goto -151 -> 143
    //   297: aload_1
    //   298: getfield 180	com/tencent/mm/bj/a/c:uKG	I
    //   301: istore 5
    //   303: goto -121 -> 182
    //   306: aload_0
    //   307: iload 5
    //   309: invokevirtual 95	com/tencent/mm/bj/a/h:getString	(I)Ljava/lang/String;
    //   312: astore 9
    //   314: aload 10
    //   316: getfield 194	com/tencent/mm/bj/a/c$a:index	I
    //   319: aload 10
    //   321: getfield 197	com/tencent/mm/bj/a/c$a:endIndex	I
    ...
    //   361: aload_0
    //   362: invokevirtual 127	com/tencent/mm/bj/a/h:getSql	()Ljava/lang/String;
    ...
    //   376: aload_0
    //   377: iload 5
    //   379: invokevirtual 105	com/tencent/mm/bj/a/h:getLong	(I)J
    //   382: invokestatic 207	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   385: astore 9
    //   387: goto -73 -> 314
    //   390: aload_0
    //   391: iload 5
    //   393: invokevirtual 138	com/tencent/mm/bj/a/h:getDouble	(I)D
    //   396: invokestatic 212	java/lang/Double:valueOf	(D)Ljava/lang/Double;
    //   399: astore 9
    //   401: goto -87 -> 314
    //   404: aload_0
    //   405: iload 5
    //   407: invokevirtual 142	com/tencent/mm/bj/a/h:getBlob	(I)[B
    //   410: astore 9
    //   412: goto -98 -> 314
    //   415: aload 10
    //   417: getfield 215	com/tencent/mm/bj/a/c$a:uKH	[Ljava/lang/Object;
    //   420: astore 11
    //   422: aload 10
    //   424: getfield 194	com/tencent/mm/bj/a/c$a:index	I
    //   427: istore 7
    //   429: aload 10
    //   431: iload 7
    //   433: iconst_1
    //   434: iadd
    //   435: putfield 194	com/tencent/mm/bj/a/c$a:index	I
    //   438: aload 11
    //   440: iload 7
    //   442: aload 9
    //   444: aastore
    ...
    //   458: aload_0
    //   459: ldc -109
    //   461: invokevirtual 42	com/tencent/mm/bj/a/h:step	(I)I
    //   464: iload 4
    //   466: iadd
    //   467: istore_2
    //   468: aload_0
    //   469: iconst_1
    //   470: invokevirtual 151	com/tencent/mm/bj/a/h:reset	(Z)V
    //   473: aload_0
    //   474: invokevirtual 64	com/tencent/mm/bj/a/h:releaseReference	()V
    //   477: ldc2_w 153
    //   480: ldc -101
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/bj/a/h.class
