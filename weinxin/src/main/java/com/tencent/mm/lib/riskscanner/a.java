...
final class a
{
  private static ThreadLocal<Long> hbe;
  ...
  public static void d(Throwable paramThrowable)
  {
    ...
    //   26: aastore
    //   27: invokestatic 49	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   30: getstatic 25	com/tencent/mm/lib/riskscanner/a:hbe	Ljava/lang/ThreadLocal;
    //   33: invokevirtual 52	java/lang/ThreadLocal:remove	()V
    //   36: getstatic 58	com/tencent/mm/plugin/report/c:oRz	Lcom/tencent/mm/plugin/report/c;
    //   39: ldc2_w 59
    //   42: ldc2_w 61
    //   45: lconst_1
    //   46: iconst_1
    //   47: invokevirtual 66	com/tencent/mm/plugin/report/c:a	(JJJZ)V
    ...
    //   87: astore_0
    //   88: getstatic 58	com/tencent/mm/plugin/report/c:oRz	Lcom/tencent/mm/plugin/report/c;
    //   91: sipush 14177
    ...
    //   110: iconst_0
    //   111: iconst_1
    //   112: invokevirtual 109	com/tencent/mm/plugin/report/c:a	(ILjava/lang/String;ZZ)V
    //   115: aload_1
  ...
  public static void eT(int paramInt)
  {
    ...
    v.i("MicroMsg.RiskScannerReportService", "Report scan result, %d", new Object[] { Integer.valueOf(paramInt) });
    switch (paramInt)
    {
    default: 
      c.oRz.a(590L, 3L, 1L, true);
      GMTrace.o(17534203985920L, 130640);
      return;
    case 0: 
      Long localLong = (Long)hbe.get();
      if (localLong != null)
      {
        long l = bf.NB() - localLong.longValue();
        v.i("MicroMsg.RiskScannerReportService", "Scan cost: %d ms", new Object[] { Long.valueOf(l) });
        c.oRz.c(590, 5, 1, (int)l, true);
        GMTrace.o(17534203985920L, 130640);
        return;
      }
      c.oRz.a(590L, 1L, 1L, true);
      GMTrace.o(17534203985920L, 130640);
      return;
    }
    c.oRz.a(590L, 2L, 1L, true);
    GMTrace.o(17534203985920L, 130640);
  }
  ...
  public static void wi()
  {
    ...
    v.i("MicroMsg.RiskScannerReportService", "Report scan triggering.");
    c.oRz.a(590L, 0L, 1L, true);
    hbe.set(Long.valueOf(bf.NB()));
    GMTrace.o(17533935550464L, 130638);
  }
}


/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/lib/riskscanner/a.class
