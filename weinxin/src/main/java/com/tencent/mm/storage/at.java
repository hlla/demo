  ...
  extends m
{
  ...
  static
  {
    ...
    gUn = new String[] { "CREATE TABLE IF NOT EXISTS  MediaDuplication  (md5 text , size int , path text , createtime long, remuxing text, duration int, status int);", "DROP INDEX IF EXISTS MediaDuplicationMD5Index ", "CREATE INDEX IF NOT EXISTS MD5Index ON MediaDuplication ( md5 )" };
    GMTrace.o(1578937352192L, 11764);
  }
  
  /* Error */
  public at(com.tencent.mm.bj.g paramg)
  {
    // Byte code:
    //   0: aconst_null
    //   1: astore 11
    ...
    //   16: aload_0
    //   17: aload_1
    //   18: putfield 42	com/tencent/mm/storage/at:gUp	Lcom/tencent/mm/sdk/e/e;
    //   21: aload_0
    //   22: getfield 42	com/tencent/mm/storage/at:gUp	Lcom/tencent/mm/sdk/e/e;
    ...
    //   174: invokestatic 102	com/tencent/mm/kernel/h:vI	()Lcom/tencent/mm/kernel/e;
    //   177: getfield 108	com/tencent/mm/kernel/e:gXW	Lcom/tencent/mm/bj/g;
    //   180: invokestatic 114	java/lang/Thread:currentThread	()Ljava/lang/Thread;
    //   183: invokevirtual 118	java/lang/Thread:getId	()J
    //   186: invokevirtual 124	com/tencent/mm/bj/g:cs	(J)J
    //   189: lstore 6
    //   191: iload_2
    //   192: ifne +24 -> 216
    //   195: ldc 126
    //   197: ldc -128
    //   199: invokestatic 133	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   202: aload_0
    //   203: getfield 42	com/tencent/mm/storage/at:gUp	Lcom/tencent/mm/sdk/e/e;
    //   206: ldc 51
    //   208: ldc -121
    ...
    //   220: ldc 126
    //   222: ldc -115
    //   224: invokestatic 133	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   227: aload_0
    //   228: getfield 42	com/tencent/mm/storage/at:gUp	Lcom/tencent/mm/sdk/e/e;
    //   231: ldc 51
    //   233: ldc -113
    ...
    //   246: ldc 126
    //   248: ldc -111
    //   250: invokestatic 133	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;)V
    //   253: aload_0
    //   254: getfield 42	com/tencent/mm/storage/at:gUp	Lcom/tencent/mm/sdk/e/e;
    //   257: ldc 51
    //   259: ldc -109
    ...
    //   270: lcmp
    //   271: ifle +15 -> 286
    //   274: invokestatic 102	com/tencent/mm/kernel/h:vI	()Lcom/tencent/mm/kernel/e;
    //   277: getfield 108	com/tencent/mm/kernel/e:gXW	Lcom/tencent/mm/bj/g;
    //   280: lload 6
    //   282: invokevirtual 151	com/tencent/mm/bj/g:aD	(J)I
    //   285: pop
    //   286: lconst_0
    //   287: lstore 8
    //   289: aload_0
    //   290: getfield 42	com/tencent/mm/storage/at:gUp	Lcom/tencent/mm/sdk/e/e;
    ...
    //   370: aload_0
    //   371: getfield 42	com/tencent/mm/storage/at:gUp	Lcom/tencent/mm/sdk/e/e;
    //   374: ldc 51
    //   376: aconst_null
    //   377: aconst_null
    ...
    //   421: aastore
    //   422: invokestatic 182	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
    //   425: ldc2_w 39
    //   428: sipush 11760
    ...
    //   453: invokestatic 188	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   456: aload 10
    //   458: astore_1
    //   459: ldc 126
    ...
    //   481: invokestatic 194	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   484: aload 10
    //   486: ifnull -200 -> 286
    //   489: aload 10
    ...
    //   537: invokestatic 188	com/tencent/mm/sdk/platformtools/v:printErrStackTrace	(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    //   540: aload 10
    //   542: astore 11
    //   544: ldc 126
    ...
    //   565: invokestatic 194	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
    //   568: iload_2
    //   569: istore_3
    //   570: lload 8
    //   572: lstore 6
    ...
    //   0	655	0	this	at
    //   0	655	1	paramg	com.tencent.mm.bj.g
    //   76	576	2	i	int
    //   74	514	3	j	int
    //   71	171	4	k	int
    //   68	33	5	m	int
  ...
  public final boolean H(String paramString1, String paramString2, int paramInt)
  {
    ...
    {
      v.w("MicroMsg.MediaCheckDuplicationStorage", "insert video remuxing info, but path is null. [%s, %s] ", new Object[] { paramString1, paramString2 });
      GMTrace.o(17503602343936L, 130412);
      return false;
    }
    int i = com.tencent.mm.a.e.aN(paramString1);
    int j = com.tencent.mm.a.e.aN(paramString2);
    if ((i <= 0) || (j <= 0))
    {
      v.w("MicroMsg.MediaCheckDuplicationStorage", "insert video remuxing info, but file size is zero.[%d, %d]", new Object[] { Integer.valueOf(i), Integer.valueOf(j) });
      GMTrace.o(17503602343936L, 130412);
      return false;
    }
    String str = g.aV(paramString1);
    if (bf.mA(str))
    {
      v.w("MicroMsg.MediaCheckDuplicationStorage", "import file is not null, but md5 is null, path " + paramString1 + " size : " + i);
      GMTrace.o(17503602343936L, 130412);
      return false;
    }
    long l1 = bf.NB();
    ...
    localContentValues.put("createtime", Long.valueOf(bf.NA()));
    ...
    long l2 = this.gUp.insert("MediaDuplication", "", localContentValues);
    v.i("MicroMsg.MediaCheckDuplicationStorage", "insert video remuxing ret[%d], size[%d], md5[%s], remuxingPath[%s], importPath[%s], duration[%d], cost time[%d]", new Object[] { Long.valueOf(l2), Integer.valueOf(i), str, paramString2, paramString1, Integer.valueOf(paramInt), Long.valueOf(bf.aB(l1)) });
    if (l2 > 0L)
    {
      GMTrace.o(17503602343936L, 130412);
      return true;
  ...
  public final boolean a(String paramString, PString paramPString, PInt paramPInt)
  {
    ...
    int i = com.tencent.mm.a.e.aN(paramString);
    if (i <= 0)
    {
    ...
    try
    {
      localObject2 = this.gUp.a((String)localObject2, null, 2);
    ...
    catch (Exception localException)
    {
      for (;;)
      {
        ...
        v.printErrStackTrace("MicroMsg.MediaCheckDuplicationStorage", localException, "", new Object[0]);
        localObject1 = paramString;
    ...
    label362:
    if (com.tencent.mm.a.e.aN(paramPString.value) <= 0)
    {
      v.w("MicroMsg.MediaCheckDuplicationStorage", "remuxing file size is zero, delete db record now. remuxing path : " + paramPString.value);
      this.gUp.delete("MediaDuplication", "md5=? AND size=? AND status=?", new String[] { str, String.valueOf(i), "100" });
      paramPString.value = null;
      GMTrace.o(1578803134464L, 11763);
      return false;
    }
    v.i("MicroMsg.MediaCheckDuplicationStorage", "check remuxing file success. remuxing path[%s], duration [%d], cost time[%d]", new Object[] { paramPString.value, Integer.valueOf(paramPInt.value), Long.valueOf(bf.aB(l)) });
    GMTrace.o(1578803134464L, 11763);
    return true;
  }
  ...
  public final String cH(String paramString, int paramInt)
  {
    ...
    if ((bf.mA(paramString)) || (paramInt <= 0))
    {
    ...
    Object localObject = this.gUp.a(str, null, 2);
    if (localObject == null)
    {
    ...
    if (!bf.mA(str))
    {
      int i = com.tencent.mm.a.e.aN(str);
      localObject = str;
      if (i <= 0)
      {
        ...
        this.gUp.delete("MediaDuplication", "md5=? AND size=? AND status!=?", new String[] { paramString, String.valueOf(paramInt), "100" });
        localObject = "";
      }
    }
    GMTrace.o(1578668916736L, 11762);
  ...
  public final boolean p(String paramString1, int paramInt, String paramString2)
  {
    ...
    if (paramInt <= 0)
    {
      i = com.tencent.mm.a.e.aN(paramString2);
      if (i <= 0)
      {
    ...
    {
      paramString1 = g.aV(paramString2);
      str = paramString1;
      if (bf.mA(paramString1))
      {
    ...
    paramString1.put("createtime", Long.valueOf(bf.NA()));
    paramString1.put("status", Integer.valueOf(101));
    long l = this.gUp.insert("MediaDuplication", "", paramString1);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/storage/at.class
