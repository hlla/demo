...
{
  private static DocumentBuilder hov;
  ...
  private static String a(Node paramNode)
  {
    ...
    catch (TransformerException paramNode)
    {
      for (;;)
      {
        v.printErrStackTrace("MicroMsg.ABTestParser", paramNode, "nodeToString", new Object[0]);
      }
    }
  }
  
  public static a gC(String paramString)
  {
    GMTrace.i(637131554816L, 4747);
    a locala = new a();
    v.d("MicroMsg.ABTestParser", "ABTest msg content: %s", new Object[] { paramString });
    Object localObject1 = gE(paramString);
    ...
    if ((paramString != null) && ("newabtestinfo".equals(paramString.getNodeValue())))
    {
      ...
      {
        i = bf.getInt(paramString.item(0).getTextContent(), 1);
        ...
        if (j < ((NodeList)localObject1).getLength())
        {
          ...
          for (;;)
          {
            ...
            {
              v.printErrStackTrace("MicroMsg.ABTestParser", paramString, "parseExp", new Object[0]);
              continue;
              paramString.field_sequence = bf.getLong(((NodeList)localObject4).item(0).getTextContent(), 0L);
              localObject4 = ((Element)localObject3).getElementsByTagName("prioritylevel");
              if (((NodeList)localObject4).getLength() <= 0) {
                continue;
              }
              paramString.field_prioritylevel = bf.getInt(((NodeList)localObject4).item(0).getTextContent(), 0);
              localObject4 = ((Element)localObject3).getElementsByTagName("starttime");
              if (((NodeList)localObject4).getLength() <= 0) {
                continue;
              }
              paramString.field_startTime = bf.getLong(((NodeList)localObject4).item(0).getTextContent(), 0L);
              ...
              paramString.field_endTime = bf.getLong(((NodeList)localObject4).item(0).getTextContent(), 0L);
              ...
              if (bf.getInt(((NodeList)localObject4).item(0).getTextContent(), 0) != 0) {
                continue;
              }
              bool = true;
              ...
              paramString = null;
              continue;
              l3 = bf.getLong(((NodeList)localObject3).item(0).getTextContent(), 0L);
              localObject3 = ((Element)localObject4).getElementsByTagName("starttime");
              if (((NodeList)localObject3).getLength() <= 0) {
                continue;
              }
              l1 = bf.getLong(((NodeList)localObject3).item(0).getTextContent(), 0L);
              if (l1 != 0L) {
                break label1305;
              }
              l1 = System.currentTimeMillis() / 1000L;
            }
            locala.how.add(paramString);
          ...
          l2 = bf.getLong(((NodeList)localObject3).item(0).getTextContent(), 0L);
          if (l2 != 0L) {
            break label1302;
          }
          break label1313;
    ...
    for (;;)
    {
      ...
      if (((NodeList)localObject3).getLength() > 0)
      {
        if (bf.getInt(((NodeList)localObject3).item(0).getTextContent(), 0) != 1) {
          break label1331;
        }
        bool = true;
        break label1321;
  ...
  public static Map<String, String> gD(String paramString)
  {
  ...
  private static Element gE(String paramString)
  {
  ...
  {
    public List<c> how;
    public List<com.tencent.mm.storage.a> hox;
    
    public a()
    {
      GMTrace.i(637802643456L, 4752);
      this.how = new LinkedList();
      this.hox = new LinkedList();
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/u/c/a.class
