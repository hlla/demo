...
{
  private static Vector<WeakReference<a>> hqM;
  public static LinkedList<a> ihq;
  ...
  public static Bitmap a(i parami)
  {
    ...
    if (parami.Ns())
    {
      parami = b.a(b.ihr, parami);
      GMTrace.o(458487758848L, 3416);
      return parami;
    }
    parami = b.b(b.ihr, parami);
    GMTrace.o(458487758848L, 3416);
    return parami;
  }
  ...
  public static boolean a(a parama)
  {
    ...
    boolean bool = hqM.add(new WeakReference(parama));
  ...
  public static boolean b(i parami)
  {
    ...
    if ((parami == null) || (bf.mA(parami.No())))
    {
  ...
  public static boolean c(a parama)
  {
    ...
    boolean bool = ihq.remove(parama);
  ...
  public static void j(String paramString, Bitmap paramBitmap)
  {
    ...
    if (i < hqM.size())
    {
      WeakReference localWeakReference = (WeakReference)hqM.get(i);
  ...
  public static Bitmap mu(String paramString)
  {
    GMTrace.i(458621976576L, 3417);
    paramString = b.mu(paramString);
  ...
  private static enum b
  {
    ...
    private Map<String, c> ihs;
    private Map<String, WeakReference<Bitmap>> iht;
    private aq ihu;
    private aq ihv;
    ...
    private void b(i parami, Bitmap paramBitmap)
    {
      ...
      String str = parami.Nq();
      if (this.iht.containsKey(str)) {}
      for (parami = (Bitmap)((WeakReference)this.iht.get(str)).get();; parami = null)
      {
        if ((parami == null) || (parami.isRecycled()))
        {
          this.iht.remove(str);
          this.iht.put(str, new WeakReference(paramBitmap));
        }
    ...
    private Bitmap c(i parami)
    {
      ...
      Assert.assertTrue("picture strategy here must be validity", j.b(parami));
      String str = parami.No();
      c localc = (c)this.ihs.get(str);
      Object localObject = localc;
      if (localc == null) {
        localObject = new c();
      }
      if (((c)localObject).ihA) {
        if (((c)localObject).ihB >= 3)
        {
          if (bf.az(((c)localObject).ihC) < 120L)
          {
          ...
          ((c)localObject).ihB = 0;
          ((c)localObject).ihA = false;
          ((c)localObject).ihC = ((int)bf.Nz());
          this.ihs.put(str, localObject);
          label151:
          if (!parami.Nr()) {
            break label387;
          }
          localObject = parami.Nm();
          if (localObject == null) {
            break label315;
          }
        }
      ...
      label315:
      for (localObject = ((i.b)localObject).mt(parami.Nn());; localObject = mu(parami.Nn()))
      {
        if (localObject == null) {
          break label328;
        }
      ...
      label328:
      if ((this.ihu == null) || (this.ihu.bJn())) {
        this.ihu = new aq(1, "readerapp-pic-logic-download", 3);
      }
      this.ihu.c(new a(parami));
      GMTrace.o(466675040256L, 3477);
      return null;
      label387:
      if ((this.ihv == null) || (this.ihv.bJn())) {
        this.ihv = new aq(1, "readerapp-pic-logic-reader", 1);
      }
      this.ihv.c(new b(parami));
      GMTrace.o(466675040256L, 3477);
      return null;
    }
    ...
    protected final Bitmap a(i parami, Bitmap paramBitmap)
    {
      ...
      if (paramBitmap != null)
      {
        localBitmap = parami.a(paramBitmap, i.a.iho, parami.Nn());
      ...
      implements aq.a
    {
      ...
      public final boolean Bn()
      {
        ...
        //   9: aload_0
        //   10: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   13: ifnonnull +21 -> 34
        //   16: ldc 61
        //   18: ldc 63
        //   20: invokestatic 69	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;)V
        //   23: ldc2_w 58
        //   26: sipush 3500
        ...
        //   51: astore 8
        //   53: aload_0
        //   54: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   57: invokeinterface 74 1 0
        //   62: new 76	java/io/File
        //   65: dup
        //   66: aload_0
        //   67: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        ...
        //   125: astore 4
        //   127: aload_0
        //   128: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   131: invokeinterface 102 1 0
        //   136: aconst_null
        //   137: invokestatic 107	com/tencent/mm/network/b:a	(Ljava/lang/String;Lcom/tencent/mm/network/b$b;)Lcom/tencent/mm/network/t;
        //   140: astore 12
        //   142: aload 8
        //   144: astore 5
        //   146: aload 9
        ...
        //   153: aload 7
        //   155: astore 4
        //   157: invokestatic 112	com/tencent/mm/ah/p:Hb	()Z
        //   160: ifeq +109 -> 269
        //   163: aload 8
        //   165: astore 5
        //   167: aload 9
        ...
        //   176: astore 4
        //   178: aload_0
        //   179: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   182: invokeinterface 102 1 0
        //   187: invokestatic 116	com/tencent/mm/ah/p:jG	(Ljava/lang/String;)Z
        //   190: ifeq +79 -> 269
        //   193: aload 8
        //   195: astore 5
        //   197: aload 9
        ...
        //   204: aload 7
        //   206: astore 4
        //   208: getstatic 121	com/tencent/mm/protocal/d:sXh	I
        //   211: invokestatic 125	com/tencent/mm/ah/p:gc	(I)Ljava/lang/String;
        //   214: astore 13
        //   216: aload 8
        //   218: astore 5
        //   220: aload 9
        ...
        //   241: aload 13
        //   243: aastore
        //   244: invokestatic 131	com/tencent/mm/sdk/platformtools/v:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   247: aload 8
        //   249: astore 5
        //   251: aload 9
        //   253: astore 6
        ...
        //   262: aload 12
        //   264: aload 13
        //   266: invokevirtual 136	com/tencent/mm/network/t:mk	(Ljava/lang/String;)V
        //   269: aload 8
        //   271: astore 5
        //   273: aload 9
        //   275: astore 6
        ...
        //   284: aload 12
        //   286: sipush 10000
        //   289: invokevirtual 140	com/tencent/mm/network/t:setConnectTimeout	(I)V
        //   292: aload 8
        //   294: astore 5
        //   296: aload 9
        //   298: astore 6
        ...
        //   307: aload 12
        //   309: sipush 20000
        //   312: invokevirtual 143	com/tencent/mm/network/t:setReadTimeout	(I)V
        //   315: aload 8
        //   317: astore 5
        //   319: aload 9
        //   321: astore 6
        ...
        //   330: aload 12
        //   332: ldc -111
        //   334: invokevirtual 148	com/tencent/mm/network/t:setRequestMethod	(Ljava/lang/String;)V
        //   337: aload 8
        //   339: astore 5
        //   341: aload 9
        //   343: astore 6
        ...
        //   350: astore 4
        //   352: aload 12
        //   354: invokestatic 151	com/tencent/mm/network/b:a	(Lcom/tencent/mm/network/t;)I
        //   357: ifne +24 -> 381
        //   360: aload 8
        //   362: astore 5
        //   364: aload 9
        ...
        //   373: astore 4
        //   375: aload 12
        //   377: invokevirtual 155	com/tencent/mm/network/t:getInputStream	()Ljava/io/InputStream;
        //   380: astore_3
        //   381: aload 8
        //   383: astore 5
        //   385: aload_3
        ...
        //   392: astore 4
        //   394: aload 12
        //   396: getfield 159	com/tencent/mm/network/t:ieF	Ljava/net/HttpURLConnection;
        ...
        //   427: aload 8
        //   429: aastore
        //   430: invokestatic 131	com/tencent/mm/sdk/platformtools/v:d	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   433: aload_3
        ...
        //   459: iconst_0
        //   460: aload_0
        //   461: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   464: invokeinterface 102 1 0
        //   469: aastore
        //   470: invokestatic 171	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   473: aload 8
        //   475: astore 5
        //   477: aload_3
        //   478: astore 6
        ...
        //   484: astore 4
        //   486: aload_0
        //   487: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   490: aload 8
        //   492: iconst_0
        //   493: invokeinterface 175 3 0
        //   498: aload_3
        //   499: ifnull +7 -> 506
        //   502: aload_3
        //   503: invokevirtual 180	java/io/InputStream:close	()V
        //   506: aload 7
        //   508: invokevirtual 181	java/io/FileOutputStream:close	()V
        //   511: ldc2_w 58
        //   514: sipush 3500
        ...
        //   532: iconst_0
        //   533: aload_2
        //   534: invokestatic 189	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
        //   537: aastore
        //   538: invokestatic 191	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   541: goto -35 -> 506
        //   544: astore_2
        //   545: ldc 61
        //   547: ldc -73
        ...
        //   554: iconst_0
        //   555: aload_2
        //   556: invokestatic 189	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
        //   559: aastore
        //   560: invokestatic 191	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   563: goto -52 -> 511
        //   566: aload 8
        //   568: astore 5
        //   570: aload_3
        ...
        //   599: aload_3
        //   600: aload 9
        //   602: invokevirtual 195	java/io/InputStream:read	([B)I
        //   605: istore_1
        //   606: iload_1
        //   607: iconst_m1
        ...
        //   624: aload_0
        //   625: aload_0
        //   626: getfield 33	com/tencent/mm/platformtools/j$b$a:ihy	I
        //   629: iload_1
        //   630: iadd
        //   631: putfield 33	com/tencent/mm/platformtools/j$b$a:ihy	I
        //   634: aload 8
        //   636: astore 5
        //   638: aload_3
        //   639: astore 6
        ...
        //   651: iconst_0
        //   652: iload_1
        //   653: invokevirtual 199	java/io/FileOutputStream:write	([BII)V
        //   656: goto -70 -> 586
        //   659: astore_2
        //   660: aload 7
        //   662: astore_3
        ...
        //   685: iconst_0
        //   686: aload 5
        //   688: invokestatic 189	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
        //   691: aastore
        //   692: invokestatic 191	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   695: aload 6
        //   697: astore_2
        //   698: aload_3
        //   699: astore 4
        ...
        //   710: iconst_0
        //   711: aload_0
        //   712: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   715: invokeinterface 102 1 0
        //   720: aastore
        //   721: invokestatic 171	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   724: aload 6
        //   726: astore_2
        //   727: aload_3
        //   728: astore 4
        //   730: aload_0
        //   731: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   734: aload 7
        //   736: iconst_0
        //   737: invokeinterface 175 3 0
        //   742: aload 6
        //   744: ifnull +8 -> 752
        //   747: aload 6
        //   749: invokevirtual 180	java/io/InputStream:close	()V
        //   752: aload_3
        //   753: ifnull +7 -> 760
        //   756: aload_3
        //   757: invokevirtual 181	java/io/FileOutputStream:close	()V
        //   760: ldc2_w 58
        //   763: sipush 3500
        ...
        //   793: iconst_0
        //   794: aload_0
        //   795: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   798: invokeinterface 102 1 0
        //   803: aastore
        //   804: dup
        //   805: iconst_1
        //   806: aload_0
        //   807: getfield 33	com/tencent/mm/platformtools/j$b$a:ihy	I
        //   810: invokestatic 209	java/lang/Integer:valueOf	(I)Ljava/lang/Integer;
        //   813: aastore
        //   814: invokestatic 211	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   817: aload 8
        //   819: astore 5
        //   821: aload_3
        //   822: astore 6
        ...
        //   828: astore 4
        //   830: aload_0
        //   831: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   834: aload 8
        //   836: iconst_1
        //   837: invokeinterface 175 3 0
        //   842: aload_3
        //   843: ifnull +7 -> 850
        //   846: aload_3
        //   847: invokevirtual 180	java/io/InputStream:close	()V
        //   850: aload 7
        //   852: invokevirtual 181	java/io/FileOutputStream:close	()V
        //   855: aconst_null
        //   856: astore_2
        ...
        //   880: invokestatic 217	com/tencent/mm/a/g:aV	(Ljava/lang/String;)Ljava/lang/String;
        //   883: pop
        //   884: aload_0
        //   885: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   888: invokeinterface 221 1 0
        //   893: astore_3
        //   894: aload_3
        //   895: ifnull +325 -> 1220
        //   898: aload_3
        ...
        //   922: invokeinterface 227 2 0
        //   927: astore_3
        //   928: aload_3
        //   929: ifnull +321 -> 1250
        //   932: aload_0
        //   933: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   936: aload_3
        //   937: getstatic 233	com/tencent/mm/platformtools/i$a:ihn	Lcom/tencent/mm/platformtools/i$a;
        ...
        //   963: invokeinterface 236 4 0
        //   968: astore_2
        //   969: aload_2
        //   970: aload_3
        //   971: if_acmpeq +32 -> 1003
        //   974: aload_3
        //   975: invokevirtual 241	android/graphics/Bitmap:isRecycled	()Z
        //   978: ifne +25 -> 1003
        //   981: ldc 61
        //   983: ldc -13
        //   985: iconst_1
        ...
        //   990: iconst_0
        //   991: aload_3
        //   992: invokevirtual 244	java/lang/Object:toString	()Ljava/lang/String;
        //   995: aastore
        //   996: invokestatic 211	com/tencent/mm/sdk/platformtools/v:i	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   999: aload_3
        //   1000: invokevirtual 247	android/graphics/Bitmap:recycle	()V
        //   1003: getstatic 251	com/tencent/mm/platformtools/j$b:ihr	Lcom/tencent/mm/platformtools/j$b;
        //   1006: aload_0
        //   1007: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   1010: aload_2
        //   1011: invokestatic 254	com/tencent/mm/platformtools/j$b:a	(Lcom/tencent/mm/platformtools/j$b;Lcom/tencent/mm/platformtools/i;Landroid/graphics/Bitmap;)V
        ...
        //   1044: invokevirtual 257	java/io/File:delete	()Z
        //   1047: pop
        //   1048: aload_0
        //   1049: aload_2
        //   1050: putfield 35	com/tencent/mm/platformtools/j$b$a:hqF	Landroid/graphics/Bitmap;
        //   1053: ldc2_w 58
        //   1056: sipush 3500
        ...
        //   1074: iconst_0
        //   1075: aload_2
        //   1076: invokestatic 189	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
        //   1079: aastore
        //   1080: invokestatic 191	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   1083: goto -233 -> 850
        //   1086: astore_2
        //   1087: ldc 61
        //   1089: ldc -73
        ...
        //   1096: iconst_0
        //   1097: aload_2
        //   1098: invokestatic 189	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
        //   1101: aastore
        //   1102: invokestatic 191	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   1105: goto -250 -> 855
        //   1108: astore_2
        //   1109: ldc 61
        //   1111: ldc -73
        ...
        //   1118: iconst_0
        //   1119: aload_2
        //   1120: invokestatic 189	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
        //   1123: aastore
        //   1124: invokestatic 191	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   1127: goto -375 -> 752
        //   1130: astore_2
        //   1131: ldc 61
        //   1133: ldc -73
        ...
        //   1140: iconst_0
        //   1141: aload_2
        //   1142: invokestatic 189	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
        //   1145: aastore
        //   1146: invokestatic 191	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   1149: goto -389 -> 760
        //   1152: astore_3
        //   1153: aconst_null
        //   1154: astore 4
        ...
        //   1157: ifnull +7 -> 1164
        //   1160: aload_2
        //   1161: invokevirtual 180	java/io/InputStream:close	()V
        //   1164: aload 4
        //   1166: ifnull +8 -> 1174
        //   1169: aload 4
        //   1171: invokevirtual 181	java/io/FileOutputStream:close	()V
        //   1174: aload_3
        //   1175: athrow
        //   1176: astore_2
        //   1177: ldc 61
        ...
        //   1186: iconst_0
        //   1187: aload_2
        //   1188: invokestatic 189	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
        //   1191: aastore
        //   1192: invokestatic 191	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   1195: goto -31 -> 1164
        //   1198: astore_2
        //   1199: ldc 61
        //   1201: ldc -73
        ...
        //   1208: iconst_0
        //   1209: aload_2
        //   1210: invokestatic 189	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
        //   1213: aastore
        //   1214: invokestatic 191	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   1217: goto -43 -> 1174
        ...
        //   1243: invokestatic 260	com/tencent/mm/platformtools/j$b:mu	(Ljava/lang/String;)Landroid/graphics/Bitmap;
        //   1246: astore_3
        //   1247: goto -319 -> 928
        //   1250: aload_0
        //   1251: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   1254: getstatic 233	com/tencent/mm/platformtools/i$a:ihn	Lcom/tencent/mm/platformtools/i$a;
        //   1257: aload 8
        //   1259: invokeinterface 263 3 0
        //   1264: goto -295 -> 969
        //   1267: astore_2
        //   1268: ldc 61
        //   1270: ldc_w 265
        ...
        //   1278: iconst_0
        //   1279: aload_0
        //   1280: getfield 47	com/tencent/mm/platformtools/j$b$a:ihz	Lcom/tencent/mm/platformtools/i;
        //   1283: invokeinterface 102 1 0
        //   1288: aastore
        //   1289: invokestatic 171	com/tencent/mm/sdk/platformtools/v:w	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   1292: ldc 61
        //   1294: ldc -73
        //   1296: iconst_1
        ...
        //   1301: iconst_0
        //   1302: aload_2
        //   1303: invokestatic 189	com/tencent/mm/sdk/platformtools/bf:g	(Ljava/lang/Throwable;)Ljava/lang/String;
        //   1306: aastore
        //   1307: invokestatic 191	com/tencent/mm/sdk/platformtools/v:e	(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
        //   1310: aconst_null
        //   1311: astore_2
        //   1312: goto -264 -> 1048
        //   1315: astore_3
        ...
        //   140	255	12	localt	com.tencent.mm.network.t
      ...
      public final boolean Bo()
      {
        ...
        try
        {
          ag.a.hlB.aH(this.ihy, 0);
          j.b.a(j.b.ihr, this.ihz.No(), this.ihz.Np(), this.hqF);
          this.hqF = null;
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            v.e("MicroMsg.MMPictureLogic", "exception:%s", new Object[] { bf.g(localException) });
          }
        }
      }
    }
      ...
      implements aq.a
    {
      ...
      public final boolean Bn()
      {
        ...
        this.hqF = j.b.mu(this.ihz.Nn());
        if (this.hqF != null) {
          this.hqF = j.b.ihr.a(this.ihz, this.hqF);
        }
        String str1 = this.ihz.No();
        String str2 = this.ihz.Nn();
        if (this.hqF != null) {
          bool = true;
        }
      ...
      public final boolean Bo()
      {
        ...
        if (this.hqF == null)
        {
          v.d("MicroMsg.MMPictureLogic", "can not find bitmap on sdCard, url=%s, try to download it", new Object[] { this.ihz.No() });
          if ((j.b.a(j.b.ihr) == null) || (j.b.a(j.b.ihr).bJn())) {
            j.b.a(j.b.ihr, new aq(1, "readerapp-pic-logic-download", 3));
          }
          j.b.a(j.b.ihr).c(new j.b.a(this.ihz));
        }
        for (;;)
        {
    ...
    static final class c
    {
      ...
      public final String toString()
      {
        ...
        ((StringBuilder)localObject).append("fail[").append(this.ihA).append("],");
        ((StringBuilder)localObject).append("tryTimes[").append(this.ihB).append("],");
        ((StringBuilder)localObject).append("lastTS[").append(this.ihC).append("]");
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/platformtools/j.class
