...
{
  public static HashMap<String, String> ihM;
  ...
  public static final String mx(String paramString)
  {
    ...
    if (i < j)
    {
      ...
      if (c > '㐀')
      {
        String str = (String)ihM.get(String.valueOf(c));
        if (!bf.mA(str)) {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/platformtools/SpellMap.class
