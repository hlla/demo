...
public final class u
{
  ...
  public static void NC()
  {
    ...
    v.w("MicroMsg.Util", "memory usage: h=%s/%s, e=%s/%s, n=%s/%s", new Object[] { ay(Debug.getGlobalAllocSize()), ay(Debug.getGlobalAllocSize() + Debug.getGlobalFreedSize()), ay(Debug.getGlobalExternalAllocSize()), ay(Debug.getGlobalExternalAllocSize() + Debug.getGlobalExternalFreedSize()), ay(Debug.getNativeHeapAllocatedSize()), ay(Debug.getNativeHeapSize()) });
  ...
  public static boolean a(Context paramContext, View paramView)
  {
    ...
    catch (IllegalArgumentException paramContext)
    {
      for (;;)
      {
        v.e("MicroMsg.Util", "hide VKB(View) exception %s", new Object[] { paramContext });
        boolean bool = false;
      }
    }
  }
  ...
  public static int aC(Object paramObject)
  {
  ...
  public static List<String> aq(String paramString1, String paramString2)
  {
  ...
  public static boolean bq(Context paramContext)
  {
    ...
    if (l.y.bCk() != null)
    {
      paramContext = l.y.bCk().a(paramContext, new DialogInterface.OnCancelListener()
      {
  ...
  @Deprecated
  public static long mB(String paramString)
  {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/platformtools/u.class
