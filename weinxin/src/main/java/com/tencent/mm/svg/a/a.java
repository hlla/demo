...
public final class a
{
  ...
  protected static int uLf;
  private static String uLg;
  private static Map<Integer, com.tencent.mm.svg.c> uLh;
  private static Map<Integer, Picture> uLi;
  private static Map<String, Picture> uLj;
  private static Float uLk;
  private TypedValue uLc;
  private byte[] uLd;
  
  static
  {
    GMTrace.i(3487379226624L, 25983);
    uLe = ".svg.code.drawable";
    uLf = 3;
    uLg = "";
    uLh = new ConcurrentHashMap();
    uLi = new ConcurrentHashMap();
    uLj = new ConcurrentHashMap();
  ...
  private static Picture a(float paramFloat1, com.tencent.mm.svg.c paramc, float paramFloat2)
  {
    ...
    if (uLk == null) {
      uLk = Float.valueOf(paramFloat1 / uLf);
    }
    paramFloat1 = uLk.floatValue() * paramFloat2;
  ...
  private static Drawable a(Resources paramResources, int paramInt, float paramFloat)
  {
    ...
    for (paramResources = new c((Picture)localObject, paramInt);; paramResources = new c((Picture)localObject, paramInt))
    {
      ...
      break;
      label430:
      localPicture = (Picture)uLi.get(Integer.valueOf(paramInt));
      localObject = localPicture;
      if (localPicture == null)
      {
        localObject = a(f2, a(paramResources, paramInt, str1), f1);
        uLi.put(Integer.valueOf(paramInt), localObject);
      }
    }
  }
  ...
  private static com.tencent.mm.svg.c a(Resources paramResources, int paramInt, String paramString)
  {
    ...
    for (;;)
    {
      try
      {
        if (uLh.containsKey(Integer.valueOf(paramInt)))
        {
          localObject1 = str;
          localObject2 = str;
          localObject3 = str;
          paramResources = (com.tencent.mm.svg.c)uLh.get(Integer.valueOf(paramInt));
      ...
      {
        v.printErrStackTrace("MicroMsg.SVGCompat", paramResources, "", new Object[0]);
      ...
      localObject2 = paramResources;
      localObject3 = paramResources;
      uLh.put(Integer.valueOf(paramInt), paramString);
  ...
  public static Map<Integer, com.tencent.mm.svg.c> bNJ()
  {
  ...
  private static Drawable c(Resources paramResources, int paramInt, float paramFloat)
  {
    ...
    try
    {
      ...
      catch (IOException localIOException1)
      {
        for (;;)
        {
          v.printErrStackTrace("MicroMsg.SVGCompat", localIOException1, "", new Object[0]);
        }
      }
      float[] arrayOfFloat;
      float f2;
    ...
    finally
    {
      ...
      catch (IOException localIOException2)
      {
        for (;;)
        {
          v.printErrStackTrace("MicroMsg.SVGCompat", localIOException2, "", new Object[0]);
        }
      }
      arrayOfFloat = WeChatSVG.getViewPort(l);
      f2 = paramResources.getDisplayMetrics().density;
      f3 = arrayOfFloat[0] / uLf;
      if (paramFloat > 0.0F)
      {
        f1 = paramFloat;
        f1 *= f3 * f2;
        f3 = arrayOfFloat[1] / uLf;
        if (paramFloat <= 0.0F) {
          break label369;
        }
      }
  ...
  public final boolean d(Resources paramResources, int paramInt)
  {
    ...
    //   22: ifeq +111 -> 133
    //   25: aload_0
    //   26: getfield 67	com/tencent/mm/svg/a/a:uLd	[B
    //   29: astore 5
    //   31: aload 5
    //   33: monitorenter
    //   34: aload_0
    //   35: getfield 65	com/tencent/mm/svg/a/a:uLc	Landroid/util/TypedValue;
    //   38: astore 4
    //   40: aload 4
    //   42: astore_3
    //   43: aload 4
    ...
    //   56: aload_0
    //   57: aload_3
    //   58: putfield 65	com/tencent/mm/svg/a/a:uLc	Landroid/util/TypedValue;
    //   61: aload_1
    //   62: iload_2
    //   63: aload_3
    //   64: iconst_1
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/svg/a/a.class
