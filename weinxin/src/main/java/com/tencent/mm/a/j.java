...
public final class j
{
  public static char a(byte[] paramArrayOfByte1, byte[] paramArrayOfByte2, long paramLong, int paramInt1, byte[] paramArrayOfByte3, int paramInt2)
  {
    ...
    locali4.fuI = 0;
    locali4.fuH = locali3.fuH;
    locali5.fuI = 28;
    locali5.fuH = locali3.fuH;
    locali6.fuI = 0;
    locali6.fuH = locali8.fuH;
    locali7.fuI = 32;
    locali7.fuH = locali8.fuH;
    a(locali2, 24);
    ...
    paramInt1 = paramArrayOfByte2.fuI;
    i = paramArrayOfByte1.fuI;
    if (paramInt2 == 0)
    {
    ...
    paramArrayOfByte2.fuI = paramInt1;
    paramArrayOfByte1.fuI = i;
    GMTrace.o(13855161843712L, 103229);
    return '\001';
  }
  ...
  private static void a(i parami1, i parami2, int paramInt)
  {
    ...
    while (i < paramInt)
    {
      byte[] arrayOfByte = parami1.fuH;
      int j = parami1.fuI + i;
      arrayOfByte[j] = ((byte)(arrayOfByte[j] ^ parami2.fuH[(parami2.fuI + i)]));
      i += 1;
    }
  ...
  private static void a(i parami1, i parami2, i parami3)
  {
    ...
    while (i < 8)
    {
      parami1.fuH[(parami1.fuI + i)] = ((byte)(parami2.fuH[(parami2.fuI + i)] ^ parami3.fuH[(parami3.fuI + i)]));
      i += 1;
    }
  ...
  private static void a(i parami1, i parami2, i parami3, i parami4)
  {
    ...
    parami2 = new byte[][] { parami2, { 0, 15, 7, 4, 14, 2, 13, 1, 10, 6, 12, 11, 9, 5, 3, 8 }, localObject1, localObject2 };
    localObject1 = new byte[] { 13, 8, 10, 1, 3, 15, 4, 2, 11, 6, 7, 12, 0, 5, 14, 9 };
    localObject1 = new byte[][] { { 15, 1, 8, 14, 6, 11, 3, 4, 9, 7, 2, 13, 12, 0, 5, 10 }, { 3, 13, 4, 7, 15, 2, 8, 14, 12, 0, 1, 10, 6, 9, 11, 5 }, { 0, 14, 7, 11, 10, 4, 13, 1, 5, 8, 12, 6, 9, 3, 2, 15 }, localObject1 };
    localObject2 = new byte[] { 1, 10, 13, 0, 6, 9, 8, 7, 4, 15, 14, 3, 11, 5, 2, 12 };
    localObject2 = new byte[][] { { 10, 0, 9, 14, 6, 3, 15, 5, 1, 13, 12, 7, 11, 4, 2, 8 }, { 13, 7, 0, 9, 3, 4, 6, 10, 2, 8, 5, 14, 12, 11, 15, 1 }, { 13, 6, 4, 9, 8, 15, 3, 0, 11, 1, 2, 12, 5, 10, 14, 7 }, localObject2 };
    Object localObject3 = { 7, 13, 14, 3, 0, 6, 9, 10, 1, 2, 8, 5, 11, 12, 4, 15 };
    Object localObject4 = { 3, 15, 0, 6, 10, 1, 13, 8, 9, 4, 5, 11, 12, 7, 2, 14 };
    localObject3 = new byte[][] { localObject3, { 13, 8, 11, 5, 6, 15, 0, 3, 4, 7, 2, 12, 1, 10, 14, 9 }, { 10, 6, 9, 0, 12, 11, 7, 13, 15, 1, 3, 14, 5, 2, 8, 4 }, localObject4 };
    localObject4 = new byte[][] { { 2, 12, 4, 1, 7, 10, 11, 6, 8, 5, 3, 15, 13, 0, 14, 9 }, { 14, 11, 2, 12, 4, 7, 13, 1, 5, 0, 15, 10, 3, 9, 8, 6 }, { 4, 2, 1, 11, 10, 13, 7, 8, 15, 9, 12, 5, 6, 3, 0, 14 }, { 11, 8, 12, 7, 1, 14, 2, 13, 6, 15, 0, 9, 10, 4, 5, 3 } };
    byte[][] arrayOfByte1 = { { 12, 1, 10, 15, 9, 2, 6, 8, 0, 13, 3, 4, 14, 7, 5, 11 }, { 10, 15, 4, 2, 7, 12, 9, 5, 6, 1, 13, 14, 0, 11, 3, 8 }, { 9, 14, 15, 5, 2, 8, 12, 3, 7, 0, 4, 10, 1, 13, 11, 6 }, { 4, 3, 2, 12, 9, 5, 15, 10, 11, 14, 1, 7, 6, 0, 8, 13 } };
    byte[][] arrayOfByte2 = { { 4, 11, 2, 14, 15, 0, 8, 13, 3, 12, 9, 7, 5, 10, 6, 1 }, { 13, 0, 11, 7, 4, 9, 1, 10, 14, 3, 5, 12, 2, 15, 8, 6 }, { 1, 4, 11, 13, 12, 3, 7, 14, 10, 15, 6, 8, 0, 5, 9, 2 }, { 6, 11, 13, 8, 1, 4, 10, 7, 9, 5, 0, 15, 14, 2, 3, 12 } };
    byte[][] arrayOfByte3 = { { 13, 2, 8, 4, 6, 15, 11, 1, 10, 9, 3, 14, 5, 0, 12, 7 }, { 1, 15, 13, 8, 10, 3, 7, 4, 12, 5, 6, 11, 0, 14, 9, 2 }, { 7, 11, 4, 1, 9, 12, 14, 2, 0, 6, 10, 13, 15, 3, 5, 8 }, { 2, 1, 14, 7, 4, 10, 8, 13, 15, 12, 9, 0, 3, 5, 6, 11 } };
    int j = parami3.fuI;
    int k = parami1.fuI;
    while (i < 8)
    {
      int m = (byte)((parami3.fuH[(parami3.fuI + 0)] << 1) + parami3.fuH[(parami3.fuI + 5)]);
      int n = (byte)((parami3.fuH[(parami3.fuI + 1)] << 3) + (parami3.fuH[(parami3.fuI + 2)] << 2) + (parami3.fuH[(parami3.fuI + 3)] << 1) + parami3.fuH[(parami3.fuI + 4)]);
      b(parami1, new i(new byte[][][] { parami2, localObject1, localObject2, localObject3, localObject4, arrayOfByte1, arrayOfByte2, arrayOfByte3 }[i][m][n]), 4);
      i = (byte)(i + 1);
      parami3.fuI += 6;
      parami1.fuI += 4;
    }
  ...
  private static void a(i parami1, i parami2, byte[] paramArrayOfByte, int paramInt, i parami3)
  {
    ...
    while (i < paramInt)
    {
      parami3.fuH[(parami3.fuI + i)] = parami2.fuH[(parami2.fuI + paramArrayOfByte[i] - 1)];
      i += 1;
    }
  ...
  private static void a(i parami1, i parami2, i[] paramArrayOfi, int paramInt, i parami3, i parami4, i parami5, i parami6, i parami7, i parami8)
  {
    ...
    {
      parami2 = parami1.fuH;
      int i = parami1.fuI + (paramInt >> 3);
      parami2[i] = ((byte)(parami2[i] | parami3.fuH[(parami3.fuI + paramInt)] << (paramInt & 0x7)));
      paramInt += 1;
    }
  ...
  private static void b(i parami1, i parami2, int paramInt)
  {
    ...
    while (i < paramInt)
    {
      parami1.fuH[(parami1.fuI + i)] = ((byte)(parami2.fuH[((i >> 3) + parami2.fuI)] >> (i & 0x7) & 0x1));
      i += 1;
    }
  ...
  private static void c(i parami1, i parami2, int paramInt)
  {
    ...
    for (;;)
    {
      ...
      parami1.fuH[(parami1.fuI + i)] = parami1.fuH[(parami1.fuI + i + paramInt)];
      i += 1;
    }
    while (j < paramInt)
    {
      parami1.fuH[(parami1.fuI + j + 28 - paramInt)] = parami2.fuH[(parami2.fuI + j)];
      j += 1;
    }
  ...
  private static void d(i parami1, i parami2, int paramInt)
  {
    ...
    while (i < paramInt)
    {
      parami1.fuH[(parami1.fuI + i)] = parami2.fuH[(parami2.fuI + i)];
      i += 1;
    }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/a/j.class
