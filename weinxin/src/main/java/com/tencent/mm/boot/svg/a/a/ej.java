  ...
  extends c
{
  ...
  public ej()
  {
    GMTrace.i(15726962278400L, 117175);
    this.width = 438;
    this.height = 372;
    GMTrace.o(15726962278400L, 117175);
  }
  
  protected final int b(int paramInt, Object... paramVarArgs)
  {
    GMTrace.i(15727096496128L, 117176);
    switch (paramInt)
    {
    }
    for (;;)
    {
      GMTrace.o(15727096496128L, 117176);
      return 0;
      GMTrace.o(15727096496128L, 117176);
      return 438;
      GMTrace.o(15727096496128L, 117176);
      ...
      localPath = c.h(paramVarArgs);
      localPath.moveTo(219.0F, 204.0F);
      localPath.cubicTo(237.2254F, 204.0F, 252.0F, 189.2254F, 252.0F, 171.0F);
      localPath.cubicTo(252.0F, 152.7746F, 237.2254F, 138.0F, 219.0F, 138.0F);
      localPath.cubicTo(200.7746F, 138.0F, 186.0F, 152.7746F, 186.0F, 171.0F);
      localPath.cubicTo(186.0F, 189.2254F, 200.7746F, 204.0F, 219.0F, 204.0F);
      localPath.close();
      localPath.moveTo(219.0F, 201.0F);
      localPath.cubicTo(235.56854F, 201.0F, 249.0F, 187.56854F, 249.0F, 171.0F);
      localPath.cubicTo(249.0F, 154.43146F, 235.56854F, 141.0F, 219.0F, 141.0F);
      localPath.cubicTo(202.43146F, 141.0F, 189.0F, 154.43146F, 189.0F, 171.0F);
      localPath.cubicTo(189.0F, 187.56854F, 202.43146F, 201.0F, 219.0F, 201.0F);
      localPath.close();
      localPath.moveTo(204.31152F, 173.40608F);
      localPath.cubicTo(203.86357F, 172.9451F, 203.72925F, 172.10045F, 204.01039F, 171.52182F);
      localPath.lineTo(204.17488F, 171.18329F);
      localPath.cubicTo(204.54736F, 170.41664F, 205.41171F, 170.20854F, 206.10318F, 170.71681F);
      localPath.lineTo(213.03773F, 175.81412F);
      localPath.cubicTo(213.73022F, 176.32314F, 214.82509F, 176.2897F, 215.4827F, 175.73987F);
      localPath.lineTo(234.97403F, 159.44258F);
      localPath.cubicTo(235.47102F, 159.02704F, 236.23456F, 159.05884F, 236.6887F, 159.52309F);
      localPath.lineTo(236.48831F, 159.31824F);
      localPath.cubicTo(236.9383F, 159.77824F, 236.94164F, 160.52068F, 236.4841F, 160.98842F);
      localPath.lineTo(215.37062F, 182.57329F);
      localPath.cubicTo(214.77469F, 183.18251F, 213.814F, 183.1849F, 213.20749F, 182.56076F);
      localPath.lineTo(204.31152F, 173.40608F);
      localPath.close();
      WeChatSVGRenderC2Java.setFillType(localPath, 2);
      localCanvas.drawPath(localPath, (Paint)localObject);
      localCanvas.restore();
      ...
      ((Path)localObject).cubicTo(144.0F, 125.298386F, 149.33305F, 120.0F, 155.88837F, 120.0F);
      ((Path)localObject).lineTo(282.11163F, 120.0F);
      ((Path)localObject).cubicTo(288.66693F, 120.0F, 294.0F, 125.298386F, 294.0F, 131.81108F);
      ...
      ((Path)localObject).cubicTo(184.97136F, 255.0003F, 182.6581F, 252.7121F, 182.65118F, 249.89926F);
      ...
      ((Path)localObject).cubicTo(150.85406F, 222.5878F, 147.13077F, 218.84735F, 147.09161F, 211.1126F);
      ((Path)localObject).lineTo(147.0F, 134.37363F);
      ((Path)localObject).cubicTo(147.13213F, 125.48259F, 152.01384F, 122.979996F, 158.41283F, 123.0F);
      ...
      ((Path)localObject).lineTo(291.0916F, 211.1126F);
      ((Path)localObject).cubicTo(291.11636F, 218.63168F, 288.0281F, 222.59373F, 279.67877F, 222.48622F);
      ((Path)localObject).lineTo(217.95168F, 222.58171F);
      ((Path)localObject).lineTo(190.5552F, 250.40294F);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/boot/svg/a/a/ej.class
