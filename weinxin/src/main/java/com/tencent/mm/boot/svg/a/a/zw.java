  ...
  extends c
{
  ...
  public zw()
  {
    GMTrace.i(15887218245632L, 118369);
    this.width = 96;
    this.height = 96;
    GMTrace.o(15887218245632L, 118369);
  }
  
  protected final int b(int paramInt, Object... paramVarArgs)
  {
    GMTrace.i(15887352463360L, 118370);
    switch (paramInt)
    {
    }
    for (;;)
    {
      GMTrace.o(15887352463360L, 118370);
      return 0;
      GMTrace.o(15887352463360L, 118370);
      return 96;
      GMTrace.o(15887352463360L, 118370);
      ...
      ((Path)localObject2).cubicTo(2.69737F, -0.3197964F, 4.4556556F, 0.20921189F, 6.0F, 0.0F);
      ((Path)localObject2).cubicTo(21.349184F, 0.07945513F, 36.734184F, 0.029548686F, 52.0F, 0.0F);
      ((Path)localObject2).cubicTo(53.89745F, -0.29983383F, 55.955444F, 1.007715F, 56.0F, 3.0F);
      ((Path)localObject2).cubicTo(56.025375F, 19.303417F, 55.925472F, 35.69269F, 56.0F, 52.0F);
      ((Path)localObject2).cubicTo(56.25515F, 53.838676F, 55.016357F, 56.02458F, 53.0F, 56.0F);
      ((Path)localObject2).cubicTo(36.684235F, 56.004616F, 20.330177F, 55.914783F, 4.0F, 56.0F);
      ((Path)localObject2).cubicTo(2.1978571F, 56.27411F, -0.009990259F, 55.1063F, 3.5527137E-15F, 53.0F);
      ((Path)localObject2).cubicTo(-0.07992207F, 37.090073F, 0.06993182F, 21.050142F, 3.5527137E-15F, 5.0F);
      ((Path)localObject2).cubicTo(0.029970778F, 3.4531307F, -0.22977597F, 1.4967982F, 1.0F, 1.0F);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/boot/svg/a/a/zw.class
