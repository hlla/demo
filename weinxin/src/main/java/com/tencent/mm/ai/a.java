...
{
  public static int jN(String paramString)
  {
    k = 0;
    GMTrace.i(13332652228608L, 99336);
    if ((paramString == null) || (paramString.length() <= 0))
    {
      v.e("Big5Util", "getStrokesCount buffer is empty");
      GMTrace.o(13332652228608L, 99336);
      return 0;
    }
    for (;;)
    {
      ...
      {
        int j;
        v.e("Big5Util", "exception:%s", new Object[] { bf.g(paramString) });
        int i = k;
        continue;
      }
      GMTrace.o(13332652228608L, 99336);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/mm/ai/a.class
