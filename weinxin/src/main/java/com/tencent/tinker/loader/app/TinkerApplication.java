  ...
  extends Application
{
  ...
  private void onBaseContextAttached(Context paramContext)
  {
    ...
    if (this.useSafeMode)
    {
      paramContext = ShareTinkerInternals.hH(this);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/tinker/loader/app/TinkerApplication.class
