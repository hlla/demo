...
{
  private final PathClassLoader xeT;
  private String xeU;
  ...
  {
    if (((paramString != null) && (paramString.startsWith("com.tencent.tinker.loader.")) && (!paramString.equals("com.tencent.tinker.loader.TinkerTestDexLoad"))) || ((this.xeU != null) && (this.xeU.equals(paramString)))) {
      return this.xeT.loadClass(paramString);
    }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/tinker/loader/AndroidNClassLoader.class
