...
public class TinkerSoLoader
{
  ...
  {
    paramShareSecurityCheck = (String)paramShareSecurityCheck.xgN.get("assets/so_meta.txt");
    if (paramShareSecurityCheck == null) {
      return true;
    }
    Object localObject1 = new ArrayList();
    ShareBsDiffPatchInfo.j(paramShareSecurityCheck, (ArrayList)localObject1);
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      paramShareSecurityCheck.put(((ShareBsDiffPatchInfo)localObject2).path + "/" + ((ShareBsDiffPatchInfo)localObject2).name, ((ShareBsDiffPatchInfo)localObject2).fFN);
    }
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      if (!SharePatchFileUtil.U((File)localObject2))
      {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/tencent/tinker/loader/TinkerSoLoader.class
