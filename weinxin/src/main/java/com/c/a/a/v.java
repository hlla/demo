...
final class v
{
  ...
  static String a(List<ScanResult> paramList, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      if ((paramList.capabilities != null) && (!paramList.capabilities.contains("IBSS"))) {
        try
        {
          String str1 = new BigInteger(aD(paramList.BSSID), 16).toString();
  ...
  static String aF(String paramString)
  {
    if (paramString == null) {
      return null;
    }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/c/a/a/v.class
