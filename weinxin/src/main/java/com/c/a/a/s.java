...
final class s
{
  ...
  {
    o.m("post_processing_log_" + y.aPw, paramString);
  }
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        ...
        try
        {
          ...
          m = this.aMH.size() - 1;
          break;
          arrayOfDouble1 = (double[])this.aMH.get(n - 1);
          arrayOfDouble2 = (double[])this.aMH.get(n);
          ...
          if (d2 < 1.0D)
          {
            ...
            aC("ref_point," + arrayOfDouble1[0] + ',' + arrayOfDouble1[1] + ',' + arrayOfDouble1[2] + ',' + arrayOfDouble1[8]);
            f1 = 0.0F;
            f2 = 0.0F;
            f3 = 0.0F;
            k = 0;
            ...
            break label1457;
            if (y.aPp) {
              aC("ref_point," + arrayOfDouble2[0] + ',' + arrayOfDouble2[1] + ',' + arrayOfDouble2[2] + ',' + arrayOfDouble2[8]);
            }
            if (k > y.aPx) {
              break label1428;
            }
            f2 = f3 - f2;
            if ((f2 <= 0.0F) || ((f4 - f1) * d2 / f2 > y.aPy)) {
              break label1428;
            }
            r.np().az(localStringBuilder.toString());
            paramBoolean = true;
            if (y.aPp)
            {
              if (paramBoolean)
          ...
          else
          {
            d1 = 1.0D / d2;
            break label500;
            arrayOfFloat = (float[])this.aMG.get(i);
            ...
            if (arrayOfDouble4[0] > 90.0D)
            {
              ...
              break label1512;
              if (y.aPp) {
                aC("scan_point," + arrayOfDouble4[0] + ',' + arrayOfDouble4[1] + ',' + arrayOfFloat[3]);
              }
              localObject1 = (String)this.aMF.get(i);
  ...
  public final void a(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6, double paramDouble7, double paramDouble8)
  {
    for (;;)
    {
      try
      {
        ...
        if (j <= 0)
        {
          this.aMH.add(new double[] { paramDouble1, paramDouble2, paramDouble3, paramDouble4, paramDouble5, paramDouble6, paramDouble7, i, paramDouble8 });
          i = 1;
          if (i != 0)
          {
            i = this.aMH.size();
        ...
        double[] arrayOfDouble1 = (double[])this.aMH.get(j - 1);
        float[] arrayOfFloat;
        if (paramDouble8 - arrayOfDouble1[8] < 30000.0D)
        {
          if (paramDouble4 >= arrayOfDouble1[3])
          {
            ...
            if (j > 1)
            {
              double[] arrayOfDouble2 = (double[])this.aMH.get(j - 2);
  ...
  public final void a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt, String paramString)
  {
    try
    {
      this.aMF.add(paramString);
      this.aMG.add(new float[] { paramFloat1, paramFloat2, paramFloat3, 0.0F, paramInt, paramFloat4 });
  ...
  final boolean a(double paramDouble1, double paramDouble2, double paramDouble3, float paramFloat, double paramDouble4, double paramDouble5, double paramDouble6, long paramLong)
  {
    ...
    if ((paramLong - this.aMD < 1000L) && (paramFloat <= this.aME)) {
      return false;
    }
    ...
    implements Runnable
  {
    ...
    public a(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, int paramInt, String paramString)
    {
      this.x = paramFloat1;
      this.y = paramFloat2;
      this.aMK = paramFloat3;
      this.aML = paramFloat4;
      this.aLM = paramInt;
    ...
    {
      s.this.a(this.x, this.y, this.aMK, this.aML, this.aLM, this.aMM);
    }
  }
    ...
    implements Runnable
  {
    ...
    public b(double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6, double paramDouble7, double paramDouble8)
    {
      ...
      this.aMO = paramDouble3;
      this.aMP = paramDouble4;
      this.aMQ = paramDouble5;
      this.aMR = paramDouble6;
      this.aMS = paramDouble7;
      this.aMT = paramDouble8;
    }
    
    public final void run()
    {
      s.this.a(this.lat, this.lng, this.aMO, this.aMP, this.aMQ, this.aMR, this.aMS, this.aMT);
    }
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/c/a/a/s.class
