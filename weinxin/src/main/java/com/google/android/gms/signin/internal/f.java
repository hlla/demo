...
public abstract interface f
  extends IInterface
{
  public abstract void a(int paramInt, Account paramAccount, e parame);
  
  public abstract void a(AuthAccountRequest paramAuthAccountRequest, e parame);
  
  public abstract void a(ResolveAccountRequest paramResolveAccountRequest, t paramt);
  
  public abstract void a(p paramp, int paramInt, boolean paramBoolean);
  
  public abstract void a(CheckServerAuthResult paramCheckServerAuthResult);
  
  public abstract void a(RecordConsentRequest paramRecordConsentRequest, e parame);
  ...
  public static abstract class a
    ...
    implements f
  {
    public static f p(IBinder paramIBinder)
    {
    ...
    public boolean onTransact(int paramInt1, Parcel paramParcel1, Parcel paramParcel2, int paramInt2)
    {
      ...
      case 2: 
        ...
        {
          a((AuthAccountRequest)localObject, e.a.o(paramParcel1.readStrongBinder()));
      ...
      case 8: 
        ...
        {
          a(paramInt1, (Account)localObject, e.a.o(paramParcel1.readStrongBinder()));
          paramParcel2.writeNoException();
          return true;
        }
      case 9: 
        paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
        localObject = p.a.g(paramParcel1.readStrongBinder());
        paramInt1 = paramParcel1.readInt();
        bool1 = bool2;
        if (paramParcel1.readInt() != 0) {
          bool1 = true;
      ...
      case 10: 
        ...
        {
          a((RecordConsentRequest)localObject, e.a.o(paramParcel1.readStrongBinder()));
          paramParcel2.writeNoException();
          return true;
        }
      }
      paramParcel1.enforceInterface("com.google.android.gms.signin.internal.ISignInService");
      a(e.a.o(paramParcel1.readStrongBinder()));
      paramParcel2.writeNoException();
      return true;
    }
      ...
      implements f
    {
          ...
          try
          {
            ...
            if (paramAccount != null)
            {
              ...
              if (parame != null)
              {
                ...
                this.ahE.transact(8, localParcel1, localParcel2, 0);
          ...
          try
          {
            ...
            if (paramAuthAccountRequest != null)
            {
              ...
              if (parame != null)
              {
                ...
                this.ahE.transact(2, localParcel1, localParcel2, 0);
                localParcel2.readException();
              }
            }
            else
          ...
          try
          {
            ...
            if (paramResolveAccountRequest != null)
            {
              ...
              if (paramt != null)
              {
                ...
                this.ahE.transact(5, localParcel1, localParcel2, 0);
                localParcel2.readException();
              }
            }
            else
      ...
      public final void a(p paramp, int paramInt, boolean paramBoolean)
      {
        ...
        //   52: aload 5
        //   54: iload_2
        //   55: invokevirtual 36	android/os/Parcel:writeInt	(I)V
        //   58: aload_0
        //   59: getfield 18	com/google/android/gms/signin/internal/f$a$a:ahE	Landroid/os/IBinder;
        //   62: bipush 9
        //   64: aload 5
        //   66: aload 6
        //   68: iconst_0
      ...
      public final void a(CheckServerAuthResult paramCheckServerAuthResult)
      {
        ...
        //   29: aload_0
        //   30: getfield 18	com/google/android/gms/signin/internal/f$a$a:ahE	Landroid/os/IBinder;
        //   33: iconst_3
        //   34: aload_2
        //   35: aload_3
        //   36: iconst_0
          ...
          try
          {
            ...
            if (paramRecordConsentRequest != null)
            {
              ...
              if (parame != null)
              {
                ...
                this.ahE.transact(10, localParcel1, localParcel2, 0);
                localParcel2.readException();
              }
            }
            else
      ...
      public final void a(e parame)
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/signin/internal/f$a$a:ahE	Landroid/os/IBinder;
        //   34: bipush 11
        //   36: aload_2
        //   37: aload_3
        //   38: iconst_0
      ...
      public final void af(boolean paramBoolean)
      {
        ...
        try
        {
          ...
          this.ahE.transact(4, localParcel1, localParcel2, 0);
          localParcel2.readException();
          return;
        }
        finally
      ...
      public final void cv(int paramInt)
      {
        ...
        try
        {
          localParcel1.writeInterfaceToken("com.google.android.gms.signin.internal.ISignInService");
          localParcel1.writeInt(paramInt);
          this.ahE.transact(7, localParcel1, localParcel2, 0);
          localParcel2.readException();
          return;
        }
        finally
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/google/android/gms/signin/internal/f.class
