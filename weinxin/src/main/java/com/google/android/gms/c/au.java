...
public final class au
{
  ...
  private static av.a.a a(List<Asset> paramList, Object paramObject)
  {
    ...
    locala1.aBZ = new av.a.a.a();
    if ((paramObject instanceof String))
    {
      locala1.type = 2;
      locala1.aBZ.aCb = ((String)paramObject);
    }
    Object localObject1;
    Object localObject2;
    int i;
    ...
    for (;;)
    {
      ...
      {
        locala1.type = 6;
        locala1.aBZ.aCf = ((Integer)paramObject).intValue();
      }
      else if ((paramObject instanceof Long))
      {
        locala1.type = 5;
        locala1.aBZ.aCe = ((Long)paramObject).longValue();
      }
      else if ((paramObject instanceof Double))
      {
        locala1.type = 3;
        locala1.aBZ.aCc = ((Double)paramObject).doubleValue();
      }
      else if ((paramObject instanceof Float))
      {
        locala1.type = 4;
        locala1.aBZ.aCd = ((Float)paramObject).floatValue();
      }
      else if ((paramObject instanceof Boolean))
      {
        locala1.type = 8;
        locala1.aBZ.aCh = ((Boolean)paramObject).booleanValue();
      }
      else if ((paramObject instanceof Byte))
      {
        locala1.type = 7;
        locala1.aBZ.aCg = ((Byte)paramObject).byteValue();
      }
      else if ((paramObject instanceof byte[]))
      {
        locala1.type = 1;
        locala1.aBZ.aCa = ((byte[])paramObject);
      }
      else if ((paramObject instanceof String[]))
      {
        locala1.type = 11;
        locala1.aBZ.aCk = ((String[])paramObject);
      }
      else if ((paramObject instanceof long[]))
      {
        locala1.type = 12;
        locala1.aBZ.aCl = ((long[])paramObject);
      }
      else if ((paramObject instanceof float[]))
      {
        locala1.type = 15;
        locala1.aBZ.aCm = ((float[])paramObject);
      }
      else if ((paramObject instanceof Asset))
      {
        locala1.type = 13;
        localObject1 = locala1.aBZ;
        paramList.add((Asset)paramObject);
        ((av.a.a.a)localObject1).aCn = (paramList.size() - 1);
      }
      else
      {
        ...
        localObject2 = new TreeSet(((i)paramObject).aFO.keySet());
        ...
        while (((Iterator)localObject2).hasNext())
        {
          ...
          localObject1[i].aBX = a(paramList, ((i)paramObject).get((String)localObject3));
          i += 1;
        }
        locala1.aBZ.aCi = ((av.a[])localObject1);
      }
    }
    int j;
    label605:
    ...
    for (;;)
    {
      ...
      if (locala2.type != i)
      {
        ...
        locala1.aBZ.aCj = ((av.a.a[])localObject3);
        break;
  ...
  {
    i locali = new i();
    av.a[] arrayOfa = parama.aBT.aBV;
    int j = arrayOfa.length;
    int i = 0;
    while (i < j)
    {
      av.a locala = arrayOfa[i];
      a(parama.aBU, locali, locala.name, locala.aBX);
      i += 1;
    }
    return locali;
  }
  ...
  {
    ArrayList localArrayList = new ArrayList(parama.aCj.length);
    parama = parama.aCj;
    int k = parama.length;
    int i = 0;
    if (i < k)
    {
      ...
      for (;;)
      {
        ...
        {
          i locali = new i();
          arrayOfa = arrayOfa.aBZ.aCi;
          int m = arrayOfa.length;
          int j = 0;
          while (j < m)
          {
            av.a locala = arrayOfa[j];
            a(paramList, locali, locala.name, locala.aBX);
            j += 1;
          }
        ...
        {
          localArrayList.add(arrayOfa.aBZ.aCb);
        }
        else
        {
          if (paramInt != 6) {
          ...
          localArrayList.add(Integer.valueOf(arrayOfa.aBZ.aCf));
        }
      }
      label191:
  ...
  private static void a(List<Asset> paramList, i parami, String paramString, av.a.a parama)
  {
    ...
    Object localObject1 = parama.aBZ;
    if (i == 1)
    {
      paramList = ((av.a.a.a)localObject1).aCa;
      parami.aFO.put(paramString, paramList);
      return;
    }
    if (i == 11)
    {
      paramList = ((av.a.a.a)localObject1).aCk;
      parami.aFO.put(paramString, paramList);
      return;
    }
    if (i == 12)
    {
      paramList = ((av.a.a.a)localObject1).aCl;
      parami.aFO.put(paramString, paramList);
      return;
    }
    if (i == 15)
    {
      paramList = ((av.a.a.a)localObject1).aCm;
      parami.aFO.put(paramString, paramList);
      return;
    }
    if (i == 2)
    {
      parami.putString(paramString, ((av.a.a.a)localObject1).aCb);
      return;
    }
    if (i == 3)
    {
      double d = ((av.a.a.a)localObject1).aCc;
      parami.aFO.put(paramString, Double.valueOf(d));
      return;
    }
    if (i == 4)
    {
      float f = ((av.a.a.a)localObject1).aCd;
      parami.aFO.put(paramString, Float.valueOf(f));
      return;
    }
    if (i == 5)
    {
      parami.putLong(paramString, ((av.a.a.a)localObject1).aCe);
      return;
    }
    if (i == 6)
    {
      i = ((av.a.a.a)localObject1).aCf;
      parami.aFO.put(paramString, Integer.valueOf(i));
      return;
    }
    if (i == 7)
    {
      byte b = (byte)((av.a.a.a)localObject1).aCg;
      parami.aFO.put(paramString, Byte.valueOf(b));
      return;
    }
    if (i == 8)
    {
      boolean bool = ((av.a.a.a)localObject1).aCh;
      parami.aFO.put(paramString, Boolean.valueOf(bool));
      return;
    }
    if (i == 13)
    {
      ...
      parami.a(paramString, (Asset)paramList.get((int)((av.a.a.a)localObject1).aCn));
      return;
    }
    if (i == 9)
    {
      parama = new i();
      localObject1 = ((av.a.a.a)localObject1).aCi;
      int j = localObject1.length;
      i = 0;
      while (i < j)
      {
        Object localObject2 = localObject1[i];
        a(paramList, parama, ((av.a)localObject2).name, ((av.a)localObject2).aBX);
        i += 1;
      }
      parami.aFO.put(paramString, parama);
      return;
    }
    if (i == 10)
    {
      i = a(paramString, ((av.a.a.a)localObject1).aCj);
  ...
  {
    Object localObject1 = new TreeSet(parami.aFO.keySet());
    ...
    while (((Iterator)localObject1).hasNext())
    {
      ...
      arrayOfa[i] = new av.a();
      arrayOfa[i].name = str;
      arrayOfa[i].aBX = a(paramList, localObject2);
      i += 1;
    }
    return arrayOfa;
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/google/android/gms/c/au.class
