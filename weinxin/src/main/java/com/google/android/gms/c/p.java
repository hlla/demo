...
abstract class p<K, V>
{
  ...
  protected abstract Object k(int paramInt1, int paramInt2);
    ...
    implements Iterator<T>
  {
    ...
    public final T next()
    {
      Object localObject = p.this.k(this.mIndex, this.wa);
      this.mIndex += 1;
      this.wb = true;
    ...
    implements Set<Map.Entry<K, V>>
  {
    ...
    public final boolean contains(Object paramObject)
    {
      ...
      return n.d(p.this.k(i, 1), ((Map.Entry)paramObject).getValue());
    }
    ...
    public final int hashCode()
    {
      ...
      if (j >= 0)
      {
        Object localObject1 = p.this.k(j, 0);
        Object localObject2 = p.this.k(j, 1);
        int k;
    ...
    implements Set<K>
  {
    ...
    public final int hashCode()
    {
      ...
      if (i >= 0)
      {
        Object localObject = p.this.k(i, 0);
        if (localObject == null) {}
    ...
    implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V>
  {
    ...
    public final boolean equals(Object paramObject)
    {
      ...
      do
      {
        return false;
        paramObject = (Map.Entry)paramObject;
      } while ((!n.d(((Map.Entry)paramObject).getKey(), p.this.k(this.mIndex, 0))) || (!n.d(((Map.Entry)paramObject).getValue(), p.this.k(this.mIndex, 1))));
      return true;
    }
    ...
    public final K getKey()
    {
      ...
      return (K)p.this.k(this.mIndex, 0);
    }
    ...
    public final V getValue()
    {
      ...
      return (V)p.this.k(this.mIndex, 1);
    }
    ...
    public final int hashCode()
    {
      ...
      Object localObject1 = p.this.k(this.mIndex, 0);
      Object localObject2 = p.this.k(this.mIndex, 1);
      int i;
      if (localObject1 == null)
      {
        i = 0;
    ...
    implements Collection<V>
  {
    ...
    public final boolean removeAll(Collection<?> paramCollection)
    {
      ...
      while (i < j)
      {
        int m = i;
        int k = j;
        if (paramCollection.contains(p.this.k(i, 1)))
        {
          p.this.O(i);
          m = i - 1;
          k = j - 1;
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/google/android/gms/c/p.class
