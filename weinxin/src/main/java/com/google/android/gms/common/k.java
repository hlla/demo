...
{
  private static final k asR = new k();
  ...
  private static boolean a(PackageInfo paramPackageInfo, boolean paramBoolean)
  {
    ...
    if (paramBoolean) {}
    for (paramPackageInfo = j.kz(); paramPackageInfo.contains(localab); paramPackageInfo = j.kA()) {
      return true;
    }
    if (Log.isLoggable("GoogleSignatureVerifier", 2)) {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/google/android/gms/common/k.class
