...
public final class d
{
  ...
  public static String I(Context paramContext)
  {
    ...
    try
    {
      ...
      atH = ((ApplicationInfo)localObject1).packageName;
      atJ = ((ApplicationInfo)localObject1).uid;
      localObject1 = atH;
    ...
    catch (PackageManager.NameNotFoundException localNameNotFoundException1)
    {
      try
      {
        ...
        atH = paramContext.packageName;
        atJ = paramContext.uid;
        paramContext = atH;
        return paramContext;
      }
  ...
  private void ab(Object paramObject)
  {
    synchronized (getClass())
    {
      Iterator localIterator = this.atL.keySet().iterator();
      if (localIterator.hasNext())
      {
        String str = (String)localIterator.next();
        Object localObject = this.atL.get(str);
        this.atL.put(str, paramObject);
        i(localObject, paramObject);
      }
    }
  }
  ...
  static String h(Intent paramIntent)
  {
    if (paramIntent == null) {
  ...
  private static void i(Object paramObject1, Object paramObject2)
  {
  ...
  private void j(String paramString, Object paramObject)
  {
    synchronized (getClass())
    {
      Object localObject = this.atL.get(paramString);
      this.atL.put(paramString, paramObject);
      i(localObject, paramObject);
      return;
    }
  }
  ...
  final Intent a(android.os.Bundle arg1, java.security.KeyPair paramKeyPair)
  {
    ...
    //   7: astore 7
    //   9: invokestatic 325	com/google/android/gms/iid/d:kH	()Ljava/lang/String;
    //   12: astore 6
    //   14: aload_0
    ...
    //   22: monitorenter
    //   23: aload_0
    //   24: getfield 50	com/google/android/gms/iid/d:atL	Ljava/util/Map;
    //   27: aload 6
    //   29: aload 7
    ...
    //   43: lstore_3
    //   44: aload_0
    //   45: getfield 333	com/google/android/gms/iid/d:atS	J
    //   48: lconst_0
    //   49: lcmp
    //   50: ifeq +62 -> 112
    //   53: lload_3
    //   54: aload_0
    //   55: getfield 333	com/google/android/gms/iid/d:atS	J
    //   58: lcmp
    //   59: ifgt +53 -> 112
    ...
    //   72: aload_0
    //   73: getfield 333	com/google/android/gms/iid/d:atS	J
    //   76: lload_3
    //   77: lsub
    ...
    //   87: aload_0
    //   88: getfield 342	com/google/android/gms/iid/d:atR	I
    ...
    //   111: athrow
    //   112: aload_0
    //   113: getfield 346	com/google/android/gms/iid/d:atf	Landroid/os/Messenger;
    //   116: ifnonnull +33 -> 149
    //   119: aload_0
    //   120: getfield 52	com/google/android/gms/iid/d:context	Landroid/content/Context;
    //   123: invokestatic 348	com/google/android/gms/iid/d:I	(Landroid/content/Context;)Ljava/lang/String;
    //   126: pop
    //   127: aload_0
    ...
    //   146: putfield 346	com/google/android/gms/iid/d:atf	Landroid/os/Messenger;
    //   149: getstatic 34	com/google/android/gms/iid/d:atH	Ljava/lang/String;
    ...
    //   170: putfield 364	com/google/android/gms/iid/d:atO	J
    ...
    //   182: astore 8
    //   184: aload 8
    //   186: getstatic 34	com/google/android/gms/iid/d:atH	Ljava/lang/String;
    ...
    //   201: invokestatic 372	com/google/android/gms/gcm/a:E	(Landroid/content/Context;)I
    ...
    //   231: invokestatic 390	com/google/android/gms/iid/a:F	(Landroid/content/Context;)I
    ...
    //   321: aload_0
    //   322: aload 8
    //   324: invokespecial 423	com/google/android/gms/iid/d:g	(Landroid/content/Intent;)V
    //   327: aload_0
    //   328: invokestatic 331	android/os/SystemClock:elapsedRealtime	()J
    //   331: putfield 364	com/google/android/gms/iid/d:atO	J
    //   334: aload 8
    //   336: ldc_w 425
    ...
    //   399: pop
    //   400: ldc -113
    //   402: getstatic 34	com/google/android/gms/iid/d:atH	Ljava/lang/String;
    ...
    //   460: pop
    //   461: aload_0
    //   462: getfield 454	com/google/android/gms/iid/d:atM	Landroid/os/Messenger;
    //   465: ifnull +87 -> 552
    //   468: aload 8
    //   470: ldc_w 456
    //   473: aload_0
    //   474: getfield 346	com/google/android/gms/iid/d:atf	Landroid/os/Messenger;
    ...
    //   491: aload_0
    //   492: getfield 454	com/google/android/gms/iid/d:atM	Landroid/os/Messenger;
    //   495: aload_1
    ...
    //   514: monitorenter
    //   515: aload_0
    //   516: getfield 50	com/google/android/gms/iid/d:atL	Ljava/util/Map;
    //   519: aload 6
    ...
    //   604: ldc_w 456
    //   607: aload_0
    //   608: getfield 346	com/google/android/gms/iid/d:atf	Landroid/os/Messenger;
    ...
    //   626: pop
    //   627: aload_0
    //   628: getfield 477	com/google/android/gms/iid/d:atN	Lcom/google/android/gms/iid/MessengerCompat;
    //   631: ifnull +45 -> 676
    ...
    //   644: aload_0
    //   645: getfield 477	com/google/android/gms/iid/d:atN	Lcom/google/android/gms/iid/MessengerCompat;
    //   648: astore_2
    //   649: aload_2
    //   650: getfield 482	com/google/android/gms/iid/MessengerCompat:atE	Landroid/os/Messenger;
    //   653: ifnull +36 -> 689
    //   656: aload_2
    //   657: getfield 482	com/google/android/gms/iid/MessengerCompat:atE	Landroid/os/Messenger;
    //   660: aload_1
    ...
    //   686: goto -187 -> 499
    //   689: aload_2
    //   690: getfield 486	com/google/android/gms/iid/MessengerCompat:atF	Lcom/google/android/gms/iid/c;
    //   693: aload_1
  ...
  final void i(Intent paramIntent)
  {
    if (paramIntent == null) {
    ...
    for (;;)
    {
      ...
      if (localObject1 == null)
      {
        ...
        for (;;)
        {
          ...
          this.atR = ((int)l * 1000);
          this.atS = (SystemClock.elapsedRealtime() + this.atR);
        ...
        label343:
        if (((!"SERVICE_NOT_AVAILABLE".equals(localObject1)) && (!"AUTHENTICATION_FAILED".equals(localObject1))) || (!"com.google.android.gsf".equals(atH))) {
          break;
        }
        this.atQ += 1;
        if (this.atQ < 3) {
        ...
        this.atR *= 2;
        this.atS = (SystemClock.elapsedRealtime() + this.atR);
        new StringBuilder("Backoff due to ").append((String)localObject1).append(" for ").append(this.atR);
        return;
      }
      ...
      a.G(this.context);
      InstanceIDListenerService.a((Context)localObject1, a.kD());
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/google/android/gms/iid/d.class
