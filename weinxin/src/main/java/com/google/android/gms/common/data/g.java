  ...
  implements Parcelable.Creator<DataHolder>
{
  ...
  static void a(DataHolder paramDataHolder, Parcel paramParcel, int paramInt)
  {
    ...
    b.a(paramParcel, 1, paramDataHolder.aoE);
    b.c(paramParcel, 1000, paramDataHolder.mVersionCode);
    b.a(paramParcel, 2, paramDataHolder.aoG, paramInt);
    b.c(paramParcel, 3, paramDataHolder.alZ);
    b.a(paramParcel, 4, paramDataHolder.aoH);
    b.u(paramParcel, i);
  }
}


/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/com/google/android/gms/common/data/g.class
