  ...
  extends ViewGroup
{
  ...
  public LinearLayoutCompat(Context paramContext, AttributeSet paramAttributeSet, int paramInt)
  {
    ...
    paramContext = ap.a(paramContext, paramAttributeSet, a.k.ci, paramInt);
    paramInt = paramContext.getInt(a.k.Mc, -1);
    if (paramInt >= 0) {
      setOrientation(paramInt);
    }
    paramInt = paramContext.getInt(a.k.Mb, -1);
    if (paramInt >= 0) {
      setGravity(paramInt);
    }
    boolean bool2 = paramContext.getBoolean(a.k.LZ, true);
    if (!bool2) {
      this.Xa = bool2;
    }
    paramInt = a.k.Md;
    this.Xf = paramContext.aeG.getFloat(paramInt, -1.0F);
    this.Xb = paramContext.getInt(a.k.Ma, -1);
    this.Xg = paramContext.getBoolean(a.k.Mg, false);
    paramAttributeSet = paramContext.getDrawable(a.k.Me);
    if (paramAttributeSet != this.Xj)
    {
      this.Xj = paramAttributeSet;
      if (paramAttributeSet == null) {
        break label227;
      }
      this.Xk = paramAttributeSet.getIntrinsicWidth();
      this.Xl = paramAttributeSet.getIntrinsicHeight();
      if (paramAttributeSet != null) {
        break label240;
      }
    }
    for (;;)
    {
      ...
      requestLayout();
      this.Xm = paramContext.getInt(a.k.Mh, 0);
      this.Xn = paramContext.getDimensionPixelSize(a.k.Mf, 0);
  ...
  private void H(int paramInt1, int paramInt2)
  {
    ...
    Object localObject1 = this.Xh;
    Object localObject2 = this.Xi;
    localObject1[3] = -1;
    localObject1[2] = -1;
    localObject1[1] = -1;
    localObject1[0] = -1;
    ...
    localObject2[1] = -1;
    localObject2[0] = -1;
    boolean bool1 = this.Xa;
    boolean bool2 = this.Xg;
    if (i12 == 1073741824) {}
    int i;
    int i4;
    Object localObject3;
    ...
    if (((View)localObject3).getVisibility() != 8)
    {
      ...
      if ((i12 == 1073741824) && (localLayoutParams.width == 0) && (localLayoutParams.weight > 0.0F)) {
        if (i5 != 0)
        {
          this.Xe += localLayoutParams.leftMargin + localLayoutParams.rightMargin;
          if (!bool1) {
            break label643;
          }
    ...
    for (;;)
    {
      ...
      break;
      i6 = this.Xe;
      this.Xe = Math.max(i6, localLayoutParams.leftMargin + i6 + localLayoutParams.rightMargin);
      break label340;
      label643:
      j = 1;
      break label361;
      ...
      if (f1 == 0.0F)
      {
        ...
        this.Xe += localLayoutParams.leftMargin + i6 + localLayoutParams.rightMargin + 0;
      }
      for (;;)
      {
        if (bool2)
        {
          ...
          label786:
          i7 = this.Xe;
          this.Xe = Math.max(i7, i7 + i6 + localLayoutParams.leftMargin + localLayoutParams.rightMargin + 0);
          continue;
          label823:
          ...
          for (i4 = Math.max(i1, Math.max(localObject1[3], Math.max(localObject1[0], Math.max(localObject1[1], localObject1[2]))) + Math.max(localObject2[3], Math.max(localObject2[0], Math.max(localObject2[1], localObject2[2]))));; i4 = i1)
          {
                ...
                for (;;)
                {
                  ...
                  else
                  {
                    ...
                    if (i5 != 0)
                    {
                      ...
                      this.Xe = (((LayoutParams)localObject3).rightMargin + (i7 + i) + 0 + i6);
                    }
                    else
                    {
                      i6 = this.Xe;
                      i7 = ((LayoutParams)localObject3).leftMargin;
                      this.Xe = Math.max(i6, ((LayoutParams)localObject3).rightMargin + (i6 + i + i7) + 0);
                    }
                  }
                }
              }
            ...
            i8 = z.resolveSizeAndState(Math.max(this.Xe, getSuggestedMinimumWidth()), paramInt1, 0);
            i1 = (0xFFFFFF & i8) - this.Xe;
            if ((j != 0) || ((i1 != 0) && (f1 > 0.0F)))
            {
              if (this.Xf > 0.0F) {
                f1 = this.Xf;
              ...
              if (i3 < i10)
              {
                ...
                if ((localLayoutParams.width != 0) || (i12 != 1073741824))
                {
                  ...
                  this.Xe += ((View)localObject3).getMeasuredWidth() + localLayoutParams.leftMargin + localLayoutParams.rightMargin + 0;
                  label1551:
                  if ((i11 == 1073741824) || (localLayoutParams.height != -1)) {
                    break label1831;
                  }
            ...
            for (;;)
            {
              ...
              label1791:
              i1 = this.Xe;
              this.Xe = Math.max(i1, ((View)localObject3).getMeasuredWidth() + i1 + localLayoutParams.leftMargin + localLayoutParams.rightMargin + 0);
              break label1551;
              label1831:
              i1 = 0;
              break label1570;
  ...
  {
    this.Xj.setBounds(getPaddingLeft() + this.Xn, paramInt, getWidth() - getPaddingRight() - this.Xn, this.Xl + paramInt);
    this.Xj.draw(paramCanvas);
  }
  ...
  {
    this.Xj.setBounds(paramInt, getPaddingTop() + this.Xn, this.Xk + paramInt, getHeight() - getPaddingBottom() - this.Xn);
    this.Xj.draw(paramCanvas);
  }
  ...
  public int getBaseline()
  {
    ...
    for (;;)
    {
      ...
      continue;
      i += (getBottom() - getTop() - getPaddingTop() - getPaddingBottom() - this.Xe) / 2;
    }
  }
  ...
  protected void onDraw(Canvas paramCanvas)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        while (i < j)
        {
          ...
          if ((localView != null) && (localView.getVisibility() != 8) && (aU(i)))
          {
            ...
            a(paramCanvas, localView.getTop() - localLayoutParams.topMargin - this.Xl);
          }
          i += 1;
        }
      } while (!aU(j));
      ...
      if (localView == null) {}
      for (i = getHeight() - getPaddingBottom() - this.Xl;; i = localLayoutParams.bottomMargin + i)
      {
        a(paramCanvas, i);
        return;
        localLayoutParams = (LayoutParams)localView.getLayoutParams();
      ...
      if (i < k)
      {
        ...
        for (j = localLayoutParams.rightMargin + j;; j = localView.getLeft() - localLayoutParams.leftMargin - this.Xk)
        {
          b(paramCanvas, j);
          i += 1;
          break;
    ...
    for (;;)
    {
      b(paramCanvas, i);
      return;
      i = getWidth() - getPaddingRight() - this.Xk;
      continue;
      localLayoutParams = (LayoutParams)localView.getLayoutParams();
      if (bool)
      {
        i = localView.getLeft() - localLayoutParams.leftMargin - this.Xk;
      }
      else
      {
  ...
  public void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    for (;;)
    {
      paramInt1 += 1;
      break label93;
      paramInt1 = getPaddingTop() + paramInt4 - paramInt2 - this.Xe;
      break;
      paramInt1 = getPaddingTop() + (paramInt4 - paramInt2 - this.Xe) / 2;
      break;
      if (((View)localObject1).getVisibility() != 8)
      {
        ...
        for (paramInt4 = -1;; paramInt4 = 1)
        {
          ...
          for (;;)
          {
            ...
            break label507;
            paramInt1 = getPaddingLeft() + paramInt3 - paramInt1 - this.Xe;
            break;
            paramInt1 = getPaddingLeft() + (paramInt3 - paramInt1 - this.Xe) / 2;
            break;
            if (localView.getVisibility() != 8)
            {
      ...
      for (;;)
      {
        if (i4 < i9)
        {
          ...
          else
          {
            ...
            {
              i1 = this.Xe;
              this.Xe = Math.max(i1, localLayoutParams.topMargin + i1 + localLayoutParams.bottomMargin);
              i1 = 1;
              label283:
              if ((i12 >= 0) && (i12 == i4 + 1)) {
                this.Xc = this.Xe;
            ...
            else
            {
              ...
              for (i6 = this.Xe;; i6 = 0)
              {
                ...
                i6 = this.Xe;
                this.Xe = Math.max(i6, i6 + i5 + localLayoutParams.topMargin + localLayoutParams.bottomMargin + 0);
                if (!bool) {
                  break label1653;
                }
                n = Math.max(i5, n);
        ...
        if (i4 < i9)
        {
          ...
          for (;;)
          {
            ...
            else
            {
              ...
              this.Xe = Math.max(i5, ((LayoutParams)localObject).bottomMargin + (i5 + n + i6) + 0);
            }
          }
        }
      }
      this.Xe += getPaddingTop() + getPaddingBottom();
      i6 = z.resolveSizeAndState(Math.max(this.Xe, getSuggestedMinimumHeight()), paramInt2, 0);
      i4 = (0xFFFFFF & i6) - this.Xe;
      if ((i1 != 0) || ((i4 != 0) && (f1 > 0.0F)))
      {
        ...
        if (i3 < i9)
        {
          ...
          if ((localLayoutParams.height != 0) || (i11 != 1073741824))
          {
            ...
            this.Xe = Math.max(m, localLayoutParams.bottomMargin + (i4 + m + i5) + 0);
            m = j;
            j = i1;
          }
        }
    ...
    extends ViewGroup.MarginLayoutParams
  {
    ...
    public LayoutParams(Context paramContext, AttributeSet paramAttributeSet)
    {
      ...
      paramContext = paramContext.obtainStyledAttributes(paramAttributeSet, a.k.cj);
      this.weight = paramContext.getFloat(a.k.LY, 0.0F);
      this.gravity = paramContext.getInt(a.k.LX, -1);
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/android/support/v7/widget/LinearLayoutCompat.class
