...
class j
{
  private static final int[] PZ = { 16843067, 16843068 };
  ...
  {
    ap localap = ap.a(this.UU.getContext(), paramAttributeSet, PZ, paramInt);
    Object localObject = localap.bG(0);
    if (localObject != null)
    {
      ProgressBar localProgressBar = this.UU;
    ...
    if (paramAttributeSet != null) {
      this.UU.setProgressDrawable(b(paramAttributeSet, false));
    }
    localap.aeG.recycle();
  }
}
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/android/support/v7/widget/j.class
