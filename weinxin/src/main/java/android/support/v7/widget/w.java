...
{
  public static final Rect WC = new Rect();
  ...
  static
  {
    ...
    try
    {
      WD = Class.forName("android.graphics.Insets");
      return;
    }
  ...
  public static Rect m(Drawable paramDrawable)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        localRect = new Rect();
        Field[] arrayOfField = WD.getFields();
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/android/support/v7/widget/w.class
