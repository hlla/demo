...
public class i<K, V>
{
  ...
  public V put(K paramK, V paramV)
  {
    ...
    for (;;)
    {
      ...
      a(arrayOfInt, arrayOfObject, this.hP);
      if (m < this.hP)
      {
  ...
  {
    paramInt = (paramInt << 1) + 1;
    Object localObject = this.wm[paramInt];
    this.wm[paramInt] = paramV;
    return (V)localObject;
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/android/support/v4/e/i.class
