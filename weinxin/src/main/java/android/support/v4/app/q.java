...
final class q
{
  ...
  {
    return (!d(paramTransition.getTargetIds())) || (!d(paramTransition.getTargetNames())) || (!d(paramTransition.getTargetTypes()));
  }
  ...
  public static void b(Object paramObject, ArrayList<View> paramArrayList)
  {
    ...
    if ((!a((Transition)paramObject)) && (d(((Transition)paramObject).getTargets())))
    {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/android/support/v4/app/q.class
