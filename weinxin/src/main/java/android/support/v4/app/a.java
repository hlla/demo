  ...
  extends android.support.v4.content.a
{
  ...
  public static void a(final Activity paramActivity, String[] paramArrayOfString, final int paramInt)
  {
    ...
    new Handler(Looper.getMainLooper()).post(new Runnable()
    {
      ...
      {
        int[] arrayOfInt = new int[this.nI.length];
        PackageManager localPackageManager = paramActivity.getPackageManager();
        String str = paramActivity.getPackageName();
        int j = this.nI.length;
        int i = 0;
        while (i < j)
        {
          arrayOfInt[i] = localPackageManager.checkPermission(this.nI[i], str);
          i += 1;
        }
        ((a.a)paramActivity).onRequestPermissionsResult(paramInt, this.nI, arrayOfInt);
      }
    });
  }
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/android/support/v4/app/a.class
