...
public final class c
  extends i
{
  private BottomSheetBehavior.a fs;
  ...
  {
    CoordinatorLayout localCoordinatorLayout = (CoordinatorLayout)View.inflate(getContext(), a.f.ax, null);
    ...
    paramView = (FrameLayout)localCoordinatorLayout.findViewById(a.e.aq);
    BottomSheetBehavior.i(paramView).fj = this.fs;
    ...
    {
      if (paramInt != 0) {
        localCoordinatorLayout.findViewById(a.e.av).setOnClickListener(new View.OnClickListener()
        {
...
/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/android/support/design/widget/c.class
