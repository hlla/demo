  ...
  extends ViewOffsetBehavior<View>
{
  ...
  protected final void d(CoordinatorLayout paramCoordinatorLayout, View paramView, int paramInt)
  {
    ...
    if (localView != null)
    {
      ...
      paramCoordinatorLayout = this.he;
      ...
      this.iI = (paramCoordinatorLayout.top - localView.getBottom());
      return;
    }
  ...
  final int o(View paramView)
  {
    ...
    return n.b(Math.round(f(paramView) * this.iJ), 0, this.iJ);
  }
}


/* Location:              /home/chengjian/weinxin/weinxin_1100/classes.jar!/android/support/design/widget/HeaderScrollingViewBehavior.class
