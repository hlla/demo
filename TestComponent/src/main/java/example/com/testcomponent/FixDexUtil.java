...
public class FixDexUtil {
    ...
    public static boolean isGoingToFix(@NonNull Context context) {
        ...
        File externalStorageDirectory = new File(Environment.getExternalStorageDirectory(), "dex");
     ...
     * 反射给对象中的属性重新赋值
     */
    private static void setField(Object obj, Class<?> cl, String field, Object value) throws
     ...
     * 反射得到对象中的属性值
     */
    private static Object getField(Object obj, Class<?> cl, String field) throws
            NoSuchFieldException, IllegalAccessException {
     ...
     */
    private static Object getPathList(Object baseDexClassLoader) throws ClassNotFoundException,
            NoSuchFieldException, IllegalAccessException {
     ...
     */
    private static Object getDexElements(Object pathList) throws NoSuchFieldException,
