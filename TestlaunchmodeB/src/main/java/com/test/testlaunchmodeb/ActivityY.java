...
public class ActivityY extends BaseActivity {
    private static final String TAG = "LaunchmodeB_" + ActivityY.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.test.testlaunchmodeb.R.layout.activity_b);
