...
public class ActivityX extends BaseActivity {
    private static final String TAG = "LaunchmodeB_" + ActivityX.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.test.testlaunchmodeb.R.layout.activity_a);
