...
//
//    /**
//     * Creates encodeImpl buffer by memory-mapping file {@param f}.
//     *
//     * It may be encodeImpl good idea to dispose() the buffer if no longer needed. A garbage collection isn't
//     * guaranteed to free up the resources, and in encodeImpl long-running 32-bit JVM there's the risk of
...
//     * accesses to this buffer, otherwise this can result in encodeImpl crash and kill the JVM.
//     */
//    public void dispose() {
//        try {
...
//            }
//        } catch (Exception ex) {
//            // ignore, this is encodeImpl best effort attempt.
//        }
//    }
//
//    @Override
