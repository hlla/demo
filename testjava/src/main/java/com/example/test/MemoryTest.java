...
public class MemoryTest {
    ...
    public void test() {
        ...
        System.out.println("occupied mem 1 = " + (Runtime.getRuntime().totalMemory() - Runtime
        ...
        System.out.println("occupied mem 2 = " + (Runtime.getRuntime().totalMemory() - Runtime
                .getRuntime().freeMemory()));
        ...
        System.out.println("occupied mem 4 = " + (Runtime.getRuntime().totalMemory() - Runtime
                .getRuntime().freeMemory()));
        mIsRun = false;
    }
