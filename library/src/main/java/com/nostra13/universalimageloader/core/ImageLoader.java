 ...
 * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before any other
 * method.
 *
...
public class ImageLoader {
    ...
    private static final String WARNING_RE_INIT_CONFIG = "Try to initialize ImageLoader which had" +
            " already been initialized before. " + "To re-init ImageLoader with new configuration" +
            " " +
            "call ImageLoader.destroy() at first.";
    private static final String ERROR_WRONG_ARGUMENTS = "Wrong arguments were passed to " +
            "displayImage() method (ImageView reference must not be null)";
    private static final String ERROR_NOT_INIT = "ImageLoader must be init with configuration " +
            "before using";
    private static final String ERROR_INIT_CONFIG_WITH_NULL = "ImageLoader configuration can not " +
     ...
     * If configurations was set before ( {@link #isInited()} == true) then this method does
     * nothing.<br />
    ...
    /**
     * Returns <b>true</b> - if ImageLoader {@linkplain #init(ImageLoaderConfiguration) is
     * initialized with
     ...
     * <br/>
     * Default {@linkplain DisplayImageOptions display image options} from {@linkplain
     * ImageLoaderConfiguration
     * configuration} will be used.<br />
     * <b>NOTE:</b> {@link #init(ImageLoaderConfiguration)} method must be called before this
     * method call
     *
     * @param uri        Image URI (i.e. "http://site.com/image.png", "file:///mnt/sdcard/image
     *                   .png")
     * @param imageAware
     * {@linkplain com.nostra13.universalimageloader.core.imageaware.ImageAware Image aware view}
     *                   which should display image
     * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't
     *                                  called before
     ...
     * {@linkplain com.nostra13.universalimageloader.core.imageaware.ImageAware Image aware view}
     *                   which should display image
     * @param listener   {@linkplain ImageLoadingListener Listener} for image loading process.
     *                   Listener fires events on
     ...
     *                   which should display image
     * @param options
     * {@linkplain com.nostra13.universalimageloader.core.DisplayImageOptions Options} for image
     ...
     * @param options
     * {@linkplain com.nostra13.universalimageloader.core.DisplayImageOptions Options} for image
     *                         decoding and displaying. If <b>null</b> - default display image
     *                         options
     *                         {@linkplain ImageLoaderConfiguration
     ...
     *                         process. Listener fires
     *                         events on UI thread if this method is called on UI thread.
     * @param progressListener {@linkplain com.nostra13.universalimageloader.core.listener
     *                         .ImageLoadingProgressListener
     *                         Listener} for image loading progress. Listener fires events on UI
     *                         thread if this method
    ...
    public void displayImage(String uri, ImageAware imageAware, DisplayImageOptions options,
        ...
        if (targetSize == null) {
            targetSize = ImageSizeUtils.defineTargetSizeForView(imageAware, configuration
                    .getMaxImageSize());
        }
     ...
     *                        {@linkplain ImageLoadingListener#onLoadingComplete(String, android
     *                        .view.View,
     *                        android.graphics.Bitmap)} callback}. Downloaded image will be decoded
     *                        and scaled to {@link Bitmap} of the size which is <b>equal or
     *                        larger</b> (usually a bit
     ...
     *                         {@linkplain ImageLoadingListener#onLoadingComplete(String, android
     *                         .view.View,
     *                         android.graphics.Bitmap)} callback}. Downloaded image will be
     *                         decoded
     *                         and scaled to {@link Bitmap} of the size which is <b>equal or
     *                         larger</b> (usually a bit
     *                         larger) than incoming targetImageSize.
     ...
     *
     * @param imageAware
     * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware ImageAware} for
     ...
     * {@link android.widget.ImageView ImageView}.
     *
     * @param imageView {@link android.widget.ImageView ImageView} for which display task will be
     *                  cancelled
     */
     ...
     * {@link ImageLoadingListener#onLoadingFailed(String, View, FailReason)} callback will be
     * fired with
    ...
    /**
     * Sets option whether ImageLoader will use {@link FlushedInputStream} for network downloads
     * to handle <a
    ...
    /**
     * Pause ImageLoader. All new "load&display" tasks won't be executed until ImageLoader is
     * {@link #resume() resumed}.
     * <br />
     ...
     * {@linkplain com.nostra13.universalimageloader.core.ImageLoaderConfiguration
     * .Builder#taskExecutor(java.util.concurrent.Executor)
     ...
     * You can {@linkplain #init(ImageLoaderConfiguration) init} ImageLoader with new
