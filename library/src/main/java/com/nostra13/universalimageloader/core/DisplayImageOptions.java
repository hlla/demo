 ...
 * <ul>
 * <li>whether stub image will be displayed in {@link com.nostra13.universalimageloader.core
 ...
 * <li>whether
 * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view} should
 * be reset
 ...
 * {@link Builder#showImageOnLoading(int) showImageOnLoading()}
 * .{@link Builder#build() build()}</code><br />
 * </li>
...
public final class DisplayImageOptions {
    ...
    public static class Builder {
        ...
        /**
         * Stub image will be displayed in {@link com.nostra13.universalimageloader.core
         * .imageaware.ImageAware
        ...
        /**
         * Incoming image will be displayed in {@link com.nostra13.universalimageloader.core
         * .imageaware.ImageAware
         * image aware view} during image loading
         *
        ...
        /**
         * Incoming drawable will be displayed in {@link com.nostra13.universalimageloader.core
         * .imageaware.ImageAware
         * image aware view} during image loading.
         ...
         * string) will be passed to <b>ImageLoader.displayImage(...)</b> method.
         * This option will be ignored if
         * {@link DisplayImageOptions.Builder#showImageForEmptyUri(int)} is set.
         */
         ...
         * image aware view} if some error occurs during
         * requested image loading/decoding.
         * This option will be ignored if {@link DisplayImageOptions.Builder#showImageOnFail(int)}
         * is set.
         */
         ...
         *
         * @deprecated Use {@link #resetViewBeforeLoading(boolean) resetViewBeforeLoading(true)}
         * instead
         */
		 ...
		 * while define scale
         * size for decoding image to Bitmap. Default value -
        ...
        /**
         * Sets {@link Bitmap.Config bitmap config} for image decoding. Default value -
         ...
         * <b>NOTE:</b> {@link Options#inSampleSize} of incoming options will <b>NOT</b> be
		 * considered. Library
         * calculate the most appropriate sample size itself according yo
		 * {@link #imageScaleType(ImageScaleType)}
         * options.<br />
         * <b>NOTE:</b> This option overlaps
		 * {@link #bitmapConfig(android.graphics.Bitmap.Config) bitmapConfig()}
         * option.
         */
        public Builder decodingOptions(Options decodingOptions) {
            if (decodingOptions == null)
                throw new IllegalArgumentException("decodingOptions can't" +
                        " be null");
        ...
        /**
         * Sets bitmap processor which will be process bitmaps before they will be cached in
		 * memory. So memory cache
         ...
         * {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image aware view}
         * but
        ...
        /**
         * Sets custom {@linkplain Handler handler} for displaying images and firing {@linkplain
     ...
     * </ul>
     * <p/>
     * These option are appropriate for simple single-use image (from drawables or from Internet)
     * displaying.
     */
