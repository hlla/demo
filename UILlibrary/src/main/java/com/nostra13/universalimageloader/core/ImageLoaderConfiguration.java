...
public final class ImageLoaderConfiguration {
     ...
     * <li>memoryCache =
     * {@link DefaultConfigurationFactory#createMemoryCache(android.content.Context, int)}</li>
     * <li>diskCache = {@link com.nostra13.universalimageloader.cache.disc.impl.UnlimitedDiskCache
     * }</li>
     * <li>imageDownloader =
     ...
     * <li>diskCacheFileNameGenerator =
     * {@link DefaultConfigurationFactory#createFileNameGenerator()}</li>
     * <li>defaultDisplayImageOptions = {@link DisplayImageOptions#createSimple() Simple options
     * }</li>
    ...
    public static class Builder {
        ...
        private static final String WARNING_OVERLAP_MEMORY_CACHE = "memoryCache() and " +
                "memoryCacheSize() calls overlap each other";
        private static final String WARNING_OVERLAP_EXECUTOR = "threadPoolSize(), threadPriority" +
                "() and tasksProcessingOrder() calls "
         ...
         *
         * @param maxImageWidthForMemoryCache  Maximum image width which will be used for memory
         *                                     saving during decoding
         *                                     an image to {@link android.graphics.Bitmap Bitmap}.
         *                                     <b>Default value - device's screen width</b>
         * @param maxImageHeightForMemoryCache Maximum image height which will be used for memory
         *                                     saving during decoding
         *                                     an image to {@link android.graphics.Bitmap Bitmap}.
         *                                     <b>Default value</b> - device's screen height
         */
        public Builder memoryCacheExtraOptions(int maxImageWidthForMemoryCache, int
         ...
         */
        @Deprecated
        public Builder discCacheExtraOptions(int maxImageWidthForDiskCache, int
                maxImageHeightForDiskCache,
         ...
         * .<br />
         * <b>NOTE: Use this option only when you have appropriate needs. It can make ImageLoader
         * slower.</b>
         *
         * @param maxImageWidthForDiskCache  Maximum width of downloaded images for saving at disk
         *                                   cache
         * @param maxImageHeightForDiskCache Maximum height of downloaded images for saving at
         *                                   disk cache
         * @param processorForDiskCache      null-ok;
         *                                   {@linkplain BitmapProcessor Bitmap processor} which
         *                                   process images before saving them
         *                                   in disc cache
         */
         ...
         * .<br />
         * <br />
         * <b>NOTE:</b> If you set custom executor then following configuration options will not
        ...
        public Builder taskExecutor(Executor executor) {
            if (threadPoolSize != DEFAULT_THREAD_POOL_SIZE || threadPriority !=
                    DEFAULT_THREAD_PRIORITY || tasksProcessingType !=
        ...
        /**
         * Sets custom {@linkplain Executor executor} for tasks of displaying <b>cached on
         * disk</b> images (these tasks
        ...
        /**
         * Sets the priority for image loading threads. Should be <b>NOT</b> greater than
         * {@link Thread#MAX_PRIORITY} or
        ...
        /**
         * When you display an image in a small {@link android.widget.ImageView ImageView} and
         * later you try to display
         * this image (from identical URI) in a larger {@link android.widget.ImageView ImageView}
         * so decoded image of
         * bigger size will be cached in memory as a previous decoded image of smaller size.<br />
         * So <b>the default behavior is to allow to cache multiple sizes of one image in
         * memory</b>. You can
         * <b>deny</b> it by calling <b>this</b> method: so when some image will be cached in
         * memory then previous
         ...
         * memory cache. You can use {@link #memoryCache(MemoryCache)} method to set your own
         * implementation of
         * {@link MemoryCache}.
         */
        ...
        /**
         * Sets maximum memory cache size (in percent of available app memory) for {@link android
         * .graphics.Bitmap
         * bitmaps}.<br />
         * Default value - 1/8 of available app memory.<br />
         * <b>NOTE:</b> If you use this method then
         ...
         * Default value -
         * {@link com.nostra13.universalimageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
         * with limited memory cache size (size = 1/8 of available app memory)<br />
         * <br />
         * <b>NOTE:</b> If you set custom memory cache then following configuration option will
         * not be considered:
         * <ul>
         ...
         * will be used as disk cache. You can use {@link #diskCache(DiskCache)} method for
         * introduction your own
         * implementation of {@link DiskCache}
         */
        public Builder diskCacheSize(int maxCacheSize) {
            if (maxCacheSize <= 0) throw new IllegalArgumentException("maxCacheSize must be a " +
                    "positive number");
        ...
        public Builder diskCacheFileCount(int maxFileCount) {
            if (maxFileCount <= 0) throw new IllegalArgumentException("maxFileCount must be a " +
                    "positive number");
        ...
        /**
         * @deprecated Use
         * {@link #diskCacheFileNameGenerator(com.nostra13.universalimageloader.cache.disc.naming.FileNameGenerator)}
         */
        @Deprecated
         ...
         * Default value -
         * {@link com.nostra13.universalimageloader.core
        ...
        /**
         * @deprecated Use
         * {@link #diskCache(com.nostra13.universalimageloader.cache.disc.DiskCache)}
         */
        @Deprecated
         ...
         * Default value - {@link com.nostra13.universalimageloader.cache.disc.impl
         * .UnlimitedDiskCache
         ...
         * <br />
         * <b>NOTE:</b> If you set custom disk cache then following configuration option will not
         * be considered:
         * <ul>
        ...
        /**
         * Sets default {@linkplain DisplayImageOptions display image options} for image
         * displaying. These options will
         * be used for every
         * <p>
         * {@linkplain ImageLoader#displayImage(String, android.widget.ImageView) image display call}
        ...
        /**
         * Enables detail logging of {@link ImageLoader} work. To prevent detail logs don't call
         * this method.
        ...
        private void initEmptyFieldsWithDefaultValues() {
            ...
            if (diskCache == null) {
                ...
                diskCache = DefaultConfigurationFactory
                        .createDiskCache(context, diskCacheFileNameGenerator, diskCacheSize,
                                diskCacheFileCount);
            }
            if (memoryCache == null) {
    ...
    /**
     * Decorator. Handles <a href="http://code.google.com/p/android/issues/detail?id=6066">this
     * problem</a> on slow networks
