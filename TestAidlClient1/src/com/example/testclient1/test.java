...
public interface test extends android.os.IInterface {
    ...
    public static abstract class Stub extends android.os.Binder implements test {
         ...
         */
        public static test asInterface(android.os.IBinder obj) {
            if ((obj == null)) {
                return null;
            }
            ...
            return new test.Stub.Proxy(obj);
        }
        ...
        private static class Proxy implements test {
