...
//
//public class TestReferenceActivity_bk extends Activity {
...
//    private ReferenceQueue<TestReferenceActivity_bk> mPhantomReferenceQueue = new
//            ReferenceQueue<TestReferenceActivity_bk>();
//    private ReferenceQueue mWeakReferenceQueue = new ReferenceQueue<>();
//    private TestPhantomReference<TestObjectWithFinalize> mPhantomReference;
...
//
//
//    private class TestObjectWithFinalize extends Object {
...
//                    try {
//                        Thread.sleep(1000);
//                        Reference<? extends TestReferenceActivity_bk> phantomreference =
...
//                try {
//                    Thread.sleep(5000);
//                    TestReference dd = new TestReference();
//                } catch (InterruptedException e) {
//                    e.printStackTrace();
//                }
//            }
...
//////        mPhantomReference = new TestPhantomReference<TestObjectWithFinalize>(object,
///// mPhantomReferenceQueue);
