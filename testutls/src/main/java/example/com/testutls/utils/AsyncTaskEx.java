...
/**
 * Created by chengjian on 17-10-10.
 */
...
public abstract class AsyncTaskEx<Params, Progress, Result> {
     ...
     */
    public AsyncTaskEx() {
        if (!((ThreadPoolExecutor) THREAD_POOL_EXECUTOR).allowsCoreThreadTimeOut()) {
    ...
    private Result postResult(Result result) {
        ...
        Message message = getHandler().obtainMessage(MESSAGE_POST_RESULT,
                new AsyncTaskExResult<Result>(this, result));
     ...
     * introduced, AsyncTaskExs were executed serially on a single background thread.
     ...
     * AsyncTaskEx, however you can also use your own {@link Executor} for custom
     * behavior.
     * <p>
     ...
     * @see #execute(Object[])
     */
    public final AsyncTaskEx<Params, Progress, Result> executeOnExecutor(Executor exec,
                                                                         Params... params) {
