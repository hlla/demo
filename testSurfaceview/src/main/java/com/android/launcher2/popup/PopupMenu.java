...
{
  private static boolean sPopIconsShowed;
  ...
  public PopupMenu(Context paramContext, View paramView)
  {
    ...
    sPopIconsShowed = false;
    this.mPopup.setForceShowIcon(sPopIconsShowed);
  }
...
/* Location:              /home/chengjian/CM/phone_launcher/samsung_launcher/apk/1.jar!/com/android/launcher2/popup/PopupMenu.class
