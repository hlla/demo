  ...
  extends ViewGroup
{
  ...
  private boolean mDisableBounceBack = false;
  ...
  private int determineTargetPage(int paramInt1, float paramFloat, int paramInt2, int paramInt3)
  {
    ...
    for (paramInt2 = paramInt1;; paramInt2 = paramInt1 + 1)
    {
      ...
      if (this.mItems.size() > 0)
      {
        ...
        paramInt1 = Math.max(localItemInfo1.position, Math.min(paramInt2, localItemInfo2.position));
      }
      return paramInt1;
      f = paramFloat;
      paramInt2 = i;
    ...
    for (paramFloat = 0.4F;; paramFloat = 0.6F)
    {
      paramInt2 = (int)(paramInt1 + f + paramFloat);
      if (!this.mDisableBounceBack) {
        break;
      }
  ...
  public void disableBounceBack(boolean paramBoolean)
  {
    this.mDisableBounceBack = paramBoolean;
  }
...
/* Location:              /home/chengjian/CM/phone_launcher/samsung_launcher/apk/1.jar!/android/support/v4/view/ViewPager.class
