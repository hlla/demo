...
class MediaRouterJellybean
{
  ...
  public static final class GetDefaultRouteWorkaround
  {
    ...
    public Object getDefaultRoute(Object paramObject)
    {
      ...
      try
      {
        Object localObject = this.mGetSystemAudioRouteMethod.invoke(paramObject, new Object[0]);
        return localObject;
      }
  ...
  public static final class SelectRouteWorkaround
  {
    ...
    public void selectRoute(Object paramObject1, int paramInt, Object paramObject2)
    {
      ...
      if (((0x800000 & ((MediaRouter.RouteInfo)paramObject2).getSupportedTypes()) != 0) || (this.mSelectRouteIntMethod != null)) {}
      for (;;)
      {
        try
        {
          this.mSelectRouteIntMethod.invoke(paramObject1, new Object[] { Integer.valueOf(paramInt), paramObject2 });
          return;
        }
        catch (IllegalAccessException localIllegalAccessException)
        {
...
/* Location:              /home/chengjian/CM/phone_launcher/samsung_launcher/apk/1.jar!/android/support/v4/media/routing/MediaRouterJellybean.class
